...
const file_vitess_topodata_dev_topodata_proto_rawDesc = "" +
	"\n" +
	"\"vitess/topodata/dev/topodata.proto\x12\x13vitess.topodata.dev\x1a\x1evitess/vttime/dev/vttime.proto\"2\n" +
	"\bKeyRange\x12\x14\n" +
	...
	"\x06Tablet\x126\n" +
	"\x05alias\x18\x01 \x01(\v2 .vitess.topodata.dev.TabletAliasR\x05alias\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x12C\n" +
	"\bport_map\x18\x04 \x03(\v2(.vitess.topodata.dev.Tablet.PortMapEntryR\aportMap\x12\x1a\n" +
	"\bkeyspace\x18\x05 \x01(\tR\bkeyspace\x12\x14\n" +
	"\x05shard\x18\x06 \x01(\tR\x05shard\x12:\n" +
	"\tkey_range\x18\a \x01(\v2\x1d.vitess.topodata.dev.KeyRangeR\bkeyRange\x123\n" +
	"\x04type\x18\b \x01(\x0e2\x1f.vitess.topodata.dev.TabletTypeR\x04type\x12(\n" +
	"\x10db_name_override\x18\t \x01(\tR\x0edbNameOverride\x129\n" +
	"\x04tags\x18\n" +
	" \x03(\v2%.vitess.topodata.dev.Tablet.TagsEntryR\x04tags\x12%\n" +
	"\x0emysql_hostname\x18\f \x01(\tR\rmysqlHostname\x12\x1d\n" +
	"\n" +
	"mysql_port\x18\r \x01(\x05R\tmysqlPort\x12N\n" +
	"\x17primary_term_start_time\x18\x0e \x01(\v2\x17.vitess.vttime.dev.TimeR\x14primaryTermStartTime\x124\n" +
	...
	"\x05Shard\x12E\n" +
	"\rprimary_alias\x18\x01 \x01(\v2 .vitess.topodata.dev.TabletAliasR\fprimaryAlias\x12N\n" +
	"\x17primary_term_start_time\x18\b \x01(\v2\x17.vitess.vttime.dev.TimeR\x14primaryTermStartTime\x12:\n" +
	"\tkey_range\x18\x02 \x01(\v2\x1d.vitess.topodata.dev.KeyRangeR\bkeyRange\x12K\n" +
	"\rsource_shards\x18\x04 \x03(\v2&.vitess.topodata.dev.Shard.SourceShardR\fsourceShards\x12Q\n" +
	"\x0ftablet_controls\x18\x06 \x03(\v2(.vitess.topodata.dev.Shard.TabletControlR\x0etabletControls\x12,\n" +
	...
	"\bKeyspace\x12F\n" +
	"\rkeyspace_type\x18\x05 \x01(\x0e2!.vitess.topodata.dev.KeyspaceTypeR\fkeyspaceType\x12#\n" +
	"\rbase_keyspace\x18\x06 \x01(\tR\fbaseKeyspace\x12<\n" +
	"\rsnapshot_time\x18\a \x01(\v2\x17.vitess.vttime.dev.TimeR\fsnapshotTime\x12+\n" +
	"\x11durability_policy\x18\b \x01(\tR\x10durabilityPolicy\x12O\n" +
	"\x10throttler_config\x18\t \x01(\v2$.vitess.topodata.dev.ThrottlerConfigR\x0fthrottlerConfig\x12&\n" +
	...
	"\x05nodes\x18\x01 \x03(\v2*.vitess.topodata.dev.ShardReplication.NodeR\x05nodes\x1aK\n" +
	"\x04Node\x12C\n" +
	"\ftablet_alias\x18\x01 \x01(\v2 .vitess.topodata.dev.TabletAliasR\vtabletAlias\"\xdc\x01\n" +
	"\x15ShardReplicationError\x12C\n" +
	"\x04type\x18\x01 \x01(\x0e2/.vitess.topodata.dev.ShardReplicationError.TypeR\x04type\x12C\n" +
	"\ftablet_alias\x18\x02 \x01(\v2 .vitess.topodata.dev.TabletAliasR\vtabletAlias\"9\n" +
	"\x04Type\x12\v\n" +
	...
	"\tkey_range\x18\x02 \x01(\v2\x1d.vitess.topodata.dev.KeyRangeR\bkeyRange\"\x9a\x01\n" +
	"\x12ShardTabletControl\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12:\n" +
	"\tkey_range\x18\x02 \x01(\v2\x1d.vitess.topodata.dev.KeyRangeR\bkeyRange\x124\n" +
	...
	"\n" +
	"expires_at\x18\x03 \x01(\v2\x17.vitess.vttime.dev.TimeR\texpiresAt\x12\x16\n" +
	...
	"\x0ethrottled_apps\x18\x05 \x03(\v27.vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntryR\rthrottledApps\x12k\n" +
	"\x13app_checked_metrics\x18\x06 \x03(\v2;.vitess.topodata.dev.ThrottlerConfig.AppCheckedMetricsEntryR\x11appCheckedMetrics\x12g\n" +
	"\x11metric_thresholds\x18\a \x03(\v2:.vitess.topodata.dev.ThrottlerConfig.MetricThresholdsEntryR\x10metricThresholds\x1ag\n" +
	"\x12ThrottledAppsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.vitess.topodata.dev.ThrottledAppRuleR\x05value:\x028\x01\x1a#\n" +
	...
	"\x05value\x18\x02 \x01(\v20.vitess.topodata.dev.ThrottlerConfig.MetricNamesR\x05value:\x028\x01\x1aC\n" +
	"\x15MetricThresholdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xcf\x03\n" +
	"\vSrvKeyspace\x12R\n" +
	"\n" +
	"partitions\x18\x01 \x03(\v22.vitess.topodata.dev.SrvKeyspace.KeyspacePartitionR\n" +
	"partitions\x12O\n" +
	"\x10throttler_config\x18\x06 \x01(\v2$.vitess.topodata.dev.ThrottlerConfigR\x0fthrottlerConfig\x1a\x82\x02\n" +
	"\x11KeyspacePartition\x12@\n" +
	"\vserved_type\x18\x01 \x01(\x0e2\x1f.vitess.topodata.dev.TabletTypeR\n" +
	"servedType\x12N\n" +
	"\x10shard_references\x18\x02 \x03(\v2#.vitess.topodata.dev.ShardReferenceR\x0fshardReferences\x12[\n" +
	"\x15shard_tablet_controls\x18\x03 \x03(\v2'.vitess.topodata.dev.ShardTabletControlR\x13shardTabletControlsJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"K\n" +
	"\bCellInfo\x12%\n" +
	...
	"\vtopo_config\x18\x01 \x01(\v2\x1f.vitess.topodata.dev.TopoConfigR\n" +
	"topoConfig\"e\n" +
	"\x10ExternalClusters\x12Q\n" +
	"\x0evitess_cluster\x18\x01 \x03(\v2*.vitess.topodata.dev.ExternalVitessClusterR\rvitessCluster*(\n" +
	"\fKeyspaceType\x12\n" +
	"\n" +
	...
	"\aDRAINED\x10\b\x1a\x02\x10\x01BIZGgithub.com/planetscale/vitess-types/gen/vitess/topodata/dev;topodatadevb\x06proto3"
