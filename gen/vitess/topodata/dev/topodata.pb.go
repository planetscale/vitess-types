...
func (*Keyspace_ServedFrom) Descriptor() ([]byte, []int) {
	return file_vitess_topodata_dev_topodata_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *ShardReplication_Node) Reset() {
	*x = ShardReplication_Node{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vitess_topodata_dev_topodata_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *SrvKeyspace_KeyspacePartition) Reset() {
	*x = SrvKeyspace_KeyspacePartition{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vitess_topodata_dev_topodata_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *SrvKeyspace_ServedFrom) Reset() {
	*x = SrvKeyspace_ServedFrom{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vitess_topodata_dev_topodata_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SrvKeyspace_ServedFrom) Descriptor() ([]byte, []int) {
	return file_vitess_topodata_dev_topodata_proto_rawDescGZIP(), []int{11, 1}
}
...
var file_vitess_topodata_dev_topodata_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2e,
	...
	0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64,
	0x65, 0x76, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0a, 0x74,
	...
	0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x4b, 0x65, 0x79, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52,
	...
	0x6d, 0x65, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x09, 0x65, 0x78, 0x70,
	...
	0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x68, 0x72, 0x6f, 0x74,
	...
	0x2e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61,
	0x2e, 0x64, 0x65, 0x76, 0x2e, 0x53, 0x72, 0x76, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65,
	...
	0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x6f, 0x70, 0x6f, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x73, 0x2f, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x64, 0x65, 0x76, 0x3b, 0x74,
	0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x64, 0x65, 0x76, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_vitess_topodata_dev_topodata_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_vitess_topodata_dev_topodata_proto_goTypes = []interface{}{
	...
	(*Keyspace_ServedFrom)(nil),           // 24: vitess.topodata.dev.Keyspace.ServedFrom
	(*ShardReplication_Node)(nil),         // 25: vitess.topodata.dev.ShardReplication.Node
	nil,                                   // 26: vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntry
	(*SrvKeyspace_KeyspacePartition)(nil), // 27: vitess.topodata.dev.SrvKeyspace.KeyspacePartition
	(*SrvKeyspace_ServedFrom)(nil),        // 28: vitess.topodata.dev.SrvKeyspace.ServedFrom
	(*dev.Time)(nil),                      // 29: vitess.vttime.dev.Time
}
var file_vitess_topodata_dev_topodata_proto_depIdxs = []int32{
	...
	29, // 5: vitess.topodata.dev.Tablet.primary_term_start_time:type_name -> vitess.vttime.dev.Time
	4,  // 6: vitess.topodata.dev.Shard.primary_alias:type_name -> vitess.topodata.dev.TabletAlias
	29, // 7: vitess.topodata.dev.Shard.primary_term_start_time:type_name -> vitess.vttime.dev.Time
	...
	24, // 11: vitess.topodata.dev.Keyspace.served_froms:type_name -> vitess.topodata.dev.Keyspace.ServedFrom
	0,  // 12: vitess.topodata.dev.Keyspace.keyspace_type:type_name -> vitess.topodata.dev.KeyspaceType
	29, // 13: vitess.topodata.dev.Keyspace.snapshot_time:type_name -> vitess.vttime.dev.Time
	13, // 14: vitess.topodata.dev.Keyspace.throttler_config:type_name -> vitess.topodata.dev.ThrottlerConfig
	25, // 15: vitess.topodata.dev.ShardReplication.nodes:type_name -> vitess.topodata.dev.ShardReplication.Node
	2,  // 16: vitess.topodata.dev.ShardReplicationError.type:type_name -> vitess.topodata.dev.ShardReplicationError.Type
	4,  // 17: vitess.topodata.dev.ShardReplicationError.tablet_alias:type_name -> vitess.topodata.dev.TabletAlias
	3,  // 18: vitess.topodata.dev.ShardReference.key_range:type_name -> vitess.topodata.dev.KeyRange
	3,  // 19: vitess.topodata.dev.ShardTabletControl.key_range:type_name -> vitess.topodata.dev.KeyRange
	29, // 20: vitess.topodata.dev.ThrottledAppRule.expires_at:type_name -> vitess.vttime.dev.Time
	26, // 21: vitess.topodata.dev.ThrottlerConfig.throttled_apps:type_name -> vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntry
	27, // 22: vitess.topodata.dev.SrvKeyspace.partitions:type_name -> vitess.topodata.dev.SrvKeyspace.KeyspacePartition
	28, // 23: vitess.topodata.dev.SrvKeyspace.served_from:type_name -> vitess.topodata.dev.SrvKeyspace.ServedFrom
	...
	1,  // 29: vitess.topodata.dev.Keyspace.ServedFrom.tablet_type:type_name -> vitess.topodata.dev.TabletType
	4,  // 30: vitess.topodata.dev.ShardReplication.Node.tablet_alias:type_name -> vitess.topodata.dev.TabletAlias
	12, // 31: vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntry.value:type_name -> vitess.topodata.dev.ThrottledAppRule
	...
	1,  // 35: vitess.topodata.dev.SrvKeyspace.ServedFrom.tablet_type:type_name -> vitess.topodata.dev.TabletType
...
func file_vitess_topodata_dev_topodata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_vitess_topodata_dev_topodata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tablet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Shard); i {
			case 0:
				return &v.state
			case 1:
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
