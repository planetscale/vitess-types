...
var file_vitess_topodata_dev_topodata_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x1a, 0x1e, 0x76, 0x69, 0x74, 0x65, 0x73,
	0x73, 0x2f, 0x76, 0x74, 0x74, 0x69, 0x6d, 0x65, 0x2f, 0x64, 0x65, 0x76, 0x2f, 0x76, 0x74, 0x74,
	...
	0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x2e, 0x54,
	...
	0x69, 0x6d, 0x65, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x14, 0x70, 0x72,
	...
	0x65, 0x76, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x0c, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	...
	0x69, 0x74, 0x65, 0x73, 0x73, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64,
	0x65, 0x76, 0x2e, 0x54, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x4b, 0x65, 0x79, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x08,
	...
	0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x54, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x65, 0x64, 0x41,
	...
	0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x53, 0x72,
	...
	0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x64, 0x54, 0x61, 0x62, 0x6c, 0x65,
	...
	0x74, 0x65, 0x73, 0x73, 0x2e, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64, 0x65,
	0x76, 0x2e, 0x54, 0x6f, 0x70, 0x6f, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0a, 0x74, 0x6f,
	...
	0x70, 0x6f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x72,
	...
	0x64, 0x61, 0x74, 0x61, 0x2f, 0x64, 0x65, 0x76, 0x3b, 0x74, 0x6f, 0x70, 0x6f, 0x64, 0x61, 0x74,
...
var file_vitess_topodata_dev_topodata_proto_depIdxs = []int32{
	...
	4,  // 6: vitess.topodata.dev.Shard.primary_alias:type_name -> vitess.topodata.dev.TabletAlias
	30, // 7: vitess.topodata.dev.Shard.primary_term_start_time:type_name -> vitess.vttime.dev.Time
	3,  // 8: vitess.topodata.dev.Shard.key_range:type_name -> vitess.topodata.dev.KeyRange
	22, // 9: vitess.topodata.dev.Shard.source_shards:type_name -> vitess.topodata.dev.Shard.SourceShard
	23, // 10: vitess.topodata.dev.Shard.tablet_controls:type_name -> vitess.topodata.dev.Shard.TabletControl
	0,  // 11: vitess.topodata.dev.Keyspace.keyspace_type:type_name -> vitess.topodata.dev.KeyspaceType
	30, // 12: vitess.topodata.dev.Keyspace.snapshot_time:type_name -> vitess.vttime.dev.Time
	13, // 13: vitess.topodata.dev.Keyspace.throttler_config:type_name -> vitess.topodata.dev.ThrottlerConfig
	24, // 14: vitess.topodata.dev.ShardReplication.nodes:type_name -> vitess.topodata.dev.ShardReplication.Node
	2,  // 15: vitess.topodata.dev.ShardReplicationError.type:type_name -> vitess.topodata.dev.ShardReplicationError.Type
	4,  // 16: vitess.topodata.dev.ShardReplicationError.tablet_alias:type_name -> vitess.topodata.dev.TabletAlias
	3,  // 17: vitess.topodata.dev.ShardReference.key_range:type_name -> vitess.topodata.dev.KeyRange
	3,  // 18: vitess.topodata.dev.ShardTabletControl.key_range:type_name -> vitess.topodata.dev.KeyRange
	30, // 19: vitess.topodata.dev.ThrottledAppRule.expires_at:type_name -> vitess.vttime.dev.Time
	25, // 20: vitess.topodata.dev.ThrottlerConfig.throttled_apps:type_name -> vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntry
	27, // 21: vitess.topodata.dev.ThrottlerConfig.app_checked_metrics:type_name -> vitess.topodata.dev.ThrottlerConfig.AppCheckedMetricsEntry
	28, // 22: vitess.topodata.dev.ThrottlerConfig.metric_thresholds:type_name -> vitess.topodata.dev.ThrottlerConfig.MetricThresholdsEntry
	29, // 23: vitess.topodata.dev.SrvKeyspace.partitions:type_name -> vitess.topodata.dev.SrvKeyspace.KeyspacePartition
	13, // 24: vitess.topodata.dev.SrvKeyspace.throttler_config:type_name -> vitess.topodata.dev.ThrottlerConfig
	17, // 25: vitess.topodata.dev.ExternalVitessCluster.topo_config:type_name -> vitess.topodata.dev.TopoConfig
	18, // 26: vitess.topodata.dev.ExternalClusters.vitess_cluster:type_name -> vitess.topodata.dev.ExternalVitessCluster
	3,  // 27: vitess.topodata.dev.Shard.SourceShard.key_range:type_name -> vitess.topodata.dev.KeyRange
	1,  // 28: vitess.topodata.dev.Shard.TabletControl.tablet_type:type_name -> vitess.topodata.dev.TabletType
	4,  // 29: vitess.topodata.dev.ShardReplication.Node.tablet_alias:type_name -> vitess.topodata.dev.TabletAlias
	12, // 30: vitess.topodata.dev.ThrottlerConfig.ThrottledAppsEntry.value:type_name -> vitess.topodata.dev.ThrottledAppRule
	26, // 31: vitess.topodata.dev.ThrottlerConfig.AppCheckedMetricsEntry.value:type_name -> vitess.topodata.dev.ThrottlerConfig.MetricNames
	1,  // 32: vitess.topodata.dev.SrvKeyspace.KeyspacePartition.served_type:type_name -> vitess.topodata.dev.TabletType
	10, // 33: vitess.topodata.dev.SrvKeyspace.KeyspacePartition.shard_references:type_name -> vitess.topodata.dev.ShardReference
	11, // 34: vitess.topodata.dev.SrvKeyspace.KeyspacePartition.shard_tablet_controls:type_name -> vitess.topodata.dev.ShardTabletControl
...
func file_vitess_topodata_dev_topodata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_vitess_topodata_dev_topodata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Tablet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Shard); i {
			case 0:
				return &v.state
			case 1:
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_vitess_topodata_dev_topodata_proto_msgTypes[26].Exporter = func(v any, i int) any {
