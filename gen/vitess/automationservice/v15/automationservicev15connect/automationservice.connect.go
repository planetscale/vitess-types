...
func NewAutomationClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) AutomationClient {
	...
	return &automationClient{
		enqueueClusterOperation: connect_go.NewClient[v15.EnqueueClusterOperationRequest, v15.EnqueueClusterOperationResponse](
			httpClient,
			baseURL+AutomationEnqueueClusterOperationProcedure,
			opts...,
		),
		getClusterOperationDetails: connect_go.NewClient[v15.GetClusterOperationDetailsRequest, v15.GetClusterOperationDetailsResponse](
			httpClient,
...
type automationClient struct {
	enqueueClusterOperation    *connect_go.Client[v15.EnqueueClusterOperationRequest, v15.EnqueueClusterOperationResponse]
