...
var (
	mysqlCtlServiceDescriptor                         = v19.File_vitess_mysqlctl_v19_mysqlctl_proto.Services().ByName("MysqlCtl")
...
type MysqlCtlClient interface {
	Start(context.Context, *connect.Request[v19.StartRequest]) (*connect.Response[v19.StartResponse], error)
	Shutdown(context.Context, *connect.Request[v19.ShutdownRequest]) (*connect.Response[v19.ShutdownResponse], error)
	RunMysqlUpgrade(context.Context, *connect.Request[v19.RunMysqlUpgradeRequest]) (*connect.Response[v19.RunMysqlUpgradeResponse], error)
	ApplyBinlogFile(context.Context, *connect.Request[v19.ApplyBinlogFileRequest]) (*connect.Response[v19.ApplyBinlogFileResponse], error)
	ReadBinlogFilesTimestamps(context.Context, *connect.Request[v19.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v19.ReadBinlogFilesTimestampsResponse], error)
	ReinitConfig(context.Context, *connect.Request[v19.ReinitConfigRequest]) (*connect.Response[v19.ReinitConfigResponse], error)
	RefreshConfig(context.Context, *connect.Request[v19.RefreshConfigRequest]) (*connect.Response[v19.RefreshConfigResponse], error)
	VersionString(context.Context, *connect.Request[v19.VersionStringRequest]) (*connect.Response[v19.VersionStringResponse], error)
}
...
type mysqlCtlClient struct {
	start                     *connect.Client[v19.StartRequest, v19.StartResponse]
	shutdown                  *connect.Client[v19.ShutdownRequest, v19.ShutdownResponse]
	runMysqlUpgrade           *connect.Client[v19.RunMysqlUpgradeRequest, v19.RunMysqlUpgradeResponse]
	applyBinlogFile           *connect.Client[v19.ApplyBinlogFileRequest, v19.ApplyBinlogFileResponse]
	readBinlogFilesTimestamps *connect.Client[v19.ReadBinlogFilesTimestampsRequest, v19.ReadBinlogFilesTimestampsResponse]
	reinitConfig              *connect.Client[v19.ReinitConfigRequest, v19.ReinitConfigResponse]
	refreshConfig             *connect.Client[v19.RefreshConfigRequest, v19.RefreshConfigResponse]
	versionString             *connect.Client[v19.VersionStringRequest, v19.VersionStringResponse]
}

// Start calls mysqlctl.MysqlCtl.Start.
func (c *mysqlCtlClient) Start(ctx context.Context, req *connect.Request[v19.StartRequest]) (*connect.Response[v19.StartResponse], error) {
	return c.start.CallUnary(ctx, req)
}

// Shutdown calls mysqlctl.MysqlCtl.Shutdown.
func (c *mysqlCtlClient) Shutdown(ctx context.Context, req *connect.Request[v19.ShutdownRequest]) (*connect.Response[v19.ShutdownResponse], error) {
	return c.shutdown.CallUnary(ctx, req)
}

// RunMysqlUpgrade calls mysqlctl.MysqlCtl.RunMysqlUpgrade.
func (c *mysqlCtlClient) RunMysqlUpgrade(ctx context.Context, req *connect.Request[v19.RunMysqlUpgradeRequest]) (*connect.Response[v19.RunMysqlUpgradeResponse], error) {
	return c.runMysqlUpgrade.CallUnary(ctx, req)
}

// ApplyBinlogFile calls mysqlctl.MysqlCtl.ApplyBinlogFile.
func (c *mysqlCtlClient) ApplyBinlogFile(ctx context.Context, req *connect.Request[v19.ApplyBinlogFileRequest]) (*connect.Response[v19.ApplyBinlogFileResponse], error) {
	return c.applyBinlogFile.CallUnary(ctx, req)
}

// ReadBinlogFilesTimestamps calls mysqlctl.MysqlCtl.ReadBinlogFilesTimestamps.
func (c *mysqlCtlClient) ReadBinlogFilesTimestamps(ctx context.Context, req *connect.Request[v19.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v19.ReadBinlogFilesTimestampsResponse], error) {
	return c.readBinlogFilesTimestamps.CallUnary(ctx, req)
}

// ReinitConfig calls mysqlctl.MysqlCtl.ReinitConfig.
func (c *mysqlCtlClient) ReinitConfig(ctx context.Context, req *connect.Request[v19.ReinitConfigRequest]) (*connect.Response[v19.ReinitConfigResponse], error) {
	return c.reinitConfig.CallUnary(ctx, req)
}

// RefreshConfig calls mysqlctl.MysqlCtl.RefreshConfig.
func (c *mysqlCtlClient) RefreshConfig(ctx context.Context, req *connect.Request[v19.RefreshConfigRequest]) (*connect.Response[v19.RefreshConfigResponse], error) {
	return c.refreshConfig.CallUnary(ctx, req)
}

// VersionString calls mysqlctl.MysqlCtl.VersionString.
func (c *mysqlCtlClient) VersionString(ctx context.Context, req *connect.Request[v19.VersionStringRequest]) (*connect.Response[v19.VersionStringResponse], error) {
...
func (UnimplementedMysqlCtlHandler) Start(context.Context, *connect.Request[v19.StartRequest]) (*connect.Response[v19.StartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Start is not implemented"))
}

func (UnimplementedMysqlCtlHandler) Shutdown(context.Context, *connect.Request[v19.ShutdownRequest]) (*connect.Response[v19.ShutdownResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Shutdown is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RunMysqlUpgrade(context.Context, *connect.Request[v19.RunMysqlUpgradeRequest]) (*connect.Response[v19.RunMysqlUpgradeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RunMysqlUpgrade is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ApplyBinlogFile(context.Context, *connect.Request[v19.ApplyBinlogFileRequest]) (*connect.Response[v19.ApplyBinlogFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ApplyBinlogFile is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ReadBinlogFilesTimestamps(context.Context, *connect.Request[v19.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v19.ReadBinlogFilesTimestampsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) ReinitConfig(context.Context, *connect.Request[v19.ReinitConfigRequest]) (*connect.Response[v19.ReinitConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ReinitConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RefreshConfig(context.Context, *connect.Request[v19.RefreshConfigRequest]) (*connect.Response[v19.RefreshConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RefreshConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) VersionString(context.Context, *connect.Request[v19.VersionStringRequest]) (*connect.Response[v19.VersionStringResponse], error) {
