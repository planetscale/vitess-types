...
type MysqlCtlClient interface {
	Start(context.Context, *connect.Request[v23.StartRequest]) (*connect.Response[v23.StartResponse], error)
	Shutdown(context.Context, *connect.Request[v23.ShutdownRequest]) (*connect.Response[v23.ShutdownResponse], error)
	RunMysqlUpgrade(context.Context, *connect.Request[v23.RunMysqlUpgradeRequest]) (*connect.Response[v23.RunMysqlUpgradeResponse], error)
	ApplyBinlogFile(context.Context, *connect.Request[v23.ApplyBinlogFileRequest]) (*connect.Response[v23.ApplyBinlogFileResponse], error)
	ReadBinlogFilesTimestamps(context.Context, *connect.Request[v23.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v23.ReadBinlogFilesTimestampsResponse], error)
	ReinitConfig(context.Context, *connect.Request[v23.ReinitConfigRequest]) (*connect.Response[v23.ReinitConfigResponse], error)
	RefreshConfig(context.Context, *connect.Request[v23.RefreshConfigRequest]) (*connect.Response[v23.RefreshConfigResponse], error)
	VersionString(context.Context, *connect.Request[v23.VersionStringRequest]) (*connect.Response[v23.VersionStringResponse], error)
	HostMetrics(context.Context, *connect.Request[v23.HostMetricsRequest]) (*connect.Response[v23.HostMetricsResponse], error)
}
...
func NewMysqlCtlClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MysqlCtlClient {
	...
	mysqlCtlMethods := v23.File_vitess_mysqlctl_v23_mysqlctl_proto.Services().ByName("MysqlCtl").Methods()
	return &mysqlCtlClient{
		start: connect.NewClient[v23.StartRequest, v23.StartResponse](
			httpClient,
			baseURL+MysqlCtlStartProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("Start")),
			connect.WithClientOptions(opts...),
		),
		shutdown: connect.NewClient[v23.ShutdownRequest, v23.ShutdownResponse](
			httpClient,
			baseURL+MysqlCtlShutdownProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("Shutdown")),
			connect.WithClientOptions(opts...),
		),
		runMysqlUpgrade: connect.NewClient[v23.RunMysqlUpgradeRequest, v23.RunMysqlUpgradeResponse](
			httpClient,
			baseURL+MysqlCtlRunMysqlUpgradeProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("RunMysqlUpgrade")),
			connect.WithClientOptions(opts...),
		),
		applyBinlogFile: connect.NewClient[v23.ApplyBinlogFileRequest, v23.ApplyBinlogFileResponse](
			httpClient,
			baseURL+MysqlCtlApplyBinlogFileProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ApplyBinlogFile")),
			connect.WithClientOptions(opts...),
		),
		readBinlogFilesTimestamps: connect.NewClient[v23.ReadBinlogFilesTimestampsRequest, v23.ReadBinlogFilesTimestampsResponse](
			httpClient,
			baseURL+MysqlCtlReadBinlogFilesTimestampsProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ReadBinlogFilesTimestamps")),
			connect.WithClientOptions(opts...),
		),
		reinitConfig: connect.NewClient[v23.ReinitConfigRequest, v23.ReinitConfigResponse](
			httpClient,
			baseURL+MysqlCtlReinitConfigProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ReinitConfig")),
			connect.WithClientOptions(opts...),
		),
		refreshConfig: connect.NewClient[v23.RefreshConfigRequest, v23.RefreshConfigResponse](
			httpClient,
			baseURL+MysqlCtlRefreshConfigProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("RefreshConfig")),
			connect.WithClientOptions(opts...),
		),
		versionString: connect.NewClient[v23.VersionStringRequest, v23.VersionStringResponse](
			httpClient,
			baseURL+MysqlCtlVersionStringProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("VersionString")),
			connect.WithClientOptions(opts...),
		),
		hostMetrics: connect.NewClient[v23.HostMetricsRequest, v23.HostMetricsResponse](
			httpClient,
...
type mysqlCtlClient struct {
	start                     *connect.Client[v23.StartRequest, v23.StartResponse]
	shutdown                  *connect.Client[v23.ShutdownRequest, v23.ShutdownResponse]
	runMysqlUpgrade           *connect.Client[v23.RunMysqlUpgradeRequest, v23.RunMysqlUpgradeResponse]
	applyBinlogFile           *connect.Client[v23.ApplyBinlogFileRequest, v23.ApplyBinlogFileResponse]
	readBinlogFilesTimestamps *connect.Client[v23.ReadBinlogFilesTimestampsRequest, v23.ReadBinlogFilesTimestampsResponse]
	reinitConfig              *connect.Client[v23.ReinitConfigRequest, v23.ReinitConfigResponse]
	refreshConfig             *connect.Client[v23.RefreshConfigRequest, v23.RefreshConfigResponse]
	versionString             *connect.Client[v23.VersionStringRequest, v23.VersionStringResponse]
	hostMetrics               *connect.Client[v23.HostMetricsRequest, v23.HostMetricsResponse]
}

// Start calls mysqlctl.MysqlCtl.Start.
func (c *mysqlCtlClient) Start(ctx context.Context, req *connect.Request[v23.StartRequest]) (*connect.Response[v23.StartResponse], error) {
	return c.start.CallUnary(ctx, req)
}

// Shutdown calls mysqlctl.MysqlCtl.Shutdown.
func (c *mysqlCtlClient) Shutdown(ctx context.Context, req *connect.Request[v23.ShutdownRequest]) (*connect.Response[v23.ShutdownResponse], error) {
	return c.shutdown.CallUnary(ctx, req)
}

// RunMysqlUpgrade calls mysqlctl.MysqlCtl.RunMysqlUpgrade.
func (c *mysqlCtlClient) RunMysqlUpgrade(ctx context.Context, req *connect.Request[v23.RunMysqlUpgradeRequest]) (*connect.Response[v23.RunMysqlUpgradeResponse], error) {
	return c.runMysqlUpgrade.CallUnary(ctx, req)
}

// ApplyBinlogFile calls mysqlctl.MysqlCtl.ApplyBinlogFile.
func (c *mysqlCtlClient) ApplyBinlogFile(ctx context.Context, req *connect.Request[v23.ApplyBinlogFileRequest]) (*connect.Response[v23.ApplyBinlogFileResponse], error) {
	return c.applyBinlogFile.CallUnary(ctx, req)
}

// ReadBinlogFilesTimestamps calls mysqlctl.MysqlCtl.ReadBinlogFilesTimestamps.
func (c *mysqlCtlClient) ReadBinlogFilesTimestamps(ctx context.Context, req *connect.Request[v23.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v23.ReadBinlogFilesTimestampsResponse], error) {
	return c.readBinlogFilesTimestamps.CallUnary(ctx, req)
}

// ReinitConfig calls mysqlctl.MysqlCtl.ReinitConfig.
func (c *mysqlCtlClient) ReinitConfig(ctx context.Context, req *connect.Request[v23.ReinitConfigRequest]) (*connect.Response[v23.ReinitConfigResponse], error) {
	return c.reinitConfig.CallUnary(ctx, req)
}

// RefreshConfig calls mysqlctl.MysqlCtl.RefreshConfig.
func (c *mysqlCtlClient) RefreshConfig(ctx context.Context, req *connect.Request[v23.RefreshConfigRequest]) (*connect.Response[v23.RefreshConfigResponse], error) {
	return c.refreshConfig.CallUnary(ctx, req)
}

// VersionString calls mysqlctl.MysqlCtl.VersionString.
func (c *mysqlCtlClient) VersionString(ctx context.Context, req *connect.Request[v23.VersionStringRequest]) (*connect.Response[v23.VersionStringResponse], error) {
	return c.versionString.CallUnary(ctx, req)
}

// HostMetrics calls mysqlctl.MysqlCtl.HostMetrics.
func (c *mysqlCtlClient) HostMetrics(ctx context.Context, req *connect.Request[v23.HostMetricsRequest]) (*connect.Response[v23.HostMetricsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) Start(context.Context, *connect.Request[v23.StartRequest]) (*connect.Response[v23.StartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Start is not implemented"))
}

func (UnimplementedMysqlCtlHandler) Shutdown(context.Context, *connect.Request[v23.ShutdownRequest]) (*connect.Response[v23.ShutdownResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Shutdown is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RunMysqlUpgrade(context.Context, *connect.Request[v23.RunMysqlUpgradeRequest]) (*connect.Response[v23.RunMysqlUpgradeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RunMysqlUpgrade is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ApplyBinlogFile(context.Context, *connect.Request[v23.ApplyBinlogFileRequest]) (*connect.Response[v23.ApplyBinlogFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ApplyBinlogFile is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ReadBinlogFilesTimestamps(context.Context, *connect.Request[v23.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v23.ReadBinlogFilesTimestampsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) ReinitConfig(context.Context, *connect.Request[v23.ReinitConfigRequest]) (*connect.Response[v23.ReinitConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ReinitConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RefreshConfig(context.Context, *connect.Request[v23.RefreshConfigRequest]) (*connect.Response[v23.RefreshConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RefreshConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) VersionString(context.Context, *connect.Request[v23.VersionStringRequest]) (*connect.Response[v23.VersionStringResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.VersionString is not implemented"))
}

func (UnimplementedMysqlCtlHandler) HostMetrics(context.Context, *connect.Request[v23.HostMetricsRequest]) (*connect.Response[v23.HostMetricsResponse], error) {
