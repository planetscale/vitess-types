...
type MysqlCtlClient interface {
	...
	Shutdown(context.Context, *connect.Request[v18.ShutdownRequest]) (*connect.Response[v18.ShutdownResponse], error)
	RunMysqlUpgrade(context.Context, *connect.Request[v18.RunMysqlUpgradeRequest]) (*connect.Response[v18.RunMysqlUpgradeResponse], error)
	ApplyBinlogFile(context.Context, *connect.Request[v18.ApplyBinlogFileRequest]) (*connect.Response[v18.ApplyBinlogFileResponse], error)
	ReadBinlogFilesTimestamps(context.Context, *connect.Request[v18.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v18.ReadBinlogFilesTimestampsResponse], error)
	ReinitConfig(context.Context, *connect.Request[v18.ReinitConfigRequest]) (*connect.Response[v18.ReinitConfigResponse], error)
	RefreshConfig(context.Context, *connect.Request[v18.RefreshConfigRequest]) (*connect.Response[v18.RefreshConfigResponse], error)
	VersionString(context.Context, *connect.Request[v18.VersionStringRequest]) (*connect.Response[v18.VersionStringResponse], error)
}
...
type mysqlCtlClient struct {
	start                     *connect.Client[v18.StartRequest, v18.StartResponse]
	shutdown                  *connect.Client[v18.ShutdownRequest, v18.ShutdownResponse]
	runMysqlUpgrade           *connect.Client[v18.RunMysqlUpgradeRequest, v18.RunMysqlUpgradeResponse]
	applyBinlogFile           *connect.Client[v18.ApplyBinlogFileRequest, v18.ApplyBinlogFileResponse]
	readBinlogFilesTimestamps *connect.Client[v18.ReadBinlogFilesTimestampsRequest, v18.ReadBinlogFilesTimestampsResponse]
	reinitConfig              *connect.Client[v18.ReinitConfigRequest, v18.ReinitConfigResponse]
	refreshConfig             *connect.Client[v18.RefreshConfigRequest, v18.RefreshConfigResponse]
	versionString             *connect.Client[v18.VersionStringRequest, v18.VersionStringResponse]
}

// Start calls mysqlctl.MysqlCtl.Start.
func (c *mysqlCtlClient) Start(ctx context.Context, req *connect.Request[v18.StartRequest]) (*connect.Response[v18.StartResponse], error) {
	return c.start.CallUnary(ctx, req)
}

// Shutdown calls mysqlctl.MysqlCtl.Shutdown.
func (c *mysqlCtlClient) Shutdown(ctx context.Context, req *connect.Request[v18.ShutdownRequest]) (*connect.Response[v18.ShutdownResponse], error) {
	return c.shutdown.CallUnary(ctx, req)
}

// RunMysqlUpgrade calls mysqlctl.MysqlCtl.RunMysqlUpgrade.
func (c *mysqlCtlClient) RunMysqlUpgrade(ctx context.Context, req *connect.Request[v18.RunMysqlUpgradeRequest]) (*connect.Response[v18.RunMysqlUpgradeResponse], error) {
	return c.runMysqlUpgrade.CallUnary(ctx, req)
}

// ApplyBinlogFile calls mysqlctl.MysqlCtl.ApplyBinlogFile.
func (c *mysqlCtlClient) ApplyBinlogFile(ctx context.Context, req *connect.Request[v18.ApplyBinlogFileRequest]) (*connect.Response[v18.ApplyBinlogFileResponse], error) {
	return c.applyBinlogFile.CallUnary(ctx, req)
}

// ReadBinlogFilesTimestamps calls mysqlctl.MysqlCtl.ReadBinlogFilesTimestamps.
func (c *mysqlCtlClient) ReadBinlogFilesTimestamps(ctx context.Context, req *connect.Request[v18.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v18.ReadBinlogFilesTimestampsResponse], error) {
	return c.readBinlogFilesTimestamps.CallUnary(ctx, req)
}

// ReinitConfig calls mysqlctl.MysqlCtl.ReinitConfig.
func (c *mysqlCtlClient) ReinitConfig(ctx context.Context, req *connect.Request[v18.ReinitConfigRequest]) (*connect.Response[v18.ReinitConfigResponse], error) {
	return c.reinitConfig.CallUnary(ctx, req)
}

// RefreshConfig calls mysqlctl.MysqlCtl.RefreshConfig.
func (c *mysqlCtlClient) RefreshConfig(ctx context.Context, req *connect.Request[v18.RefreshConfigRequest]) (*connect.Response[v18.RefreshConfigResponse], error) {
	return c.refreshConfig.CallUnary(ctx, req)
}

// VersionString calls mysqlctl.MysqlCtl.VersionString.
func (c *mysqlCtlClient) VersionString(ctx context.Context, req *connect.Request[v18.VersionStringRequest]) (*connect.Response[v18.VersionStringResponse], error) {
...
func (UnimplementedMysqlCtlHandler) Start(context.Context, *connect.Request[v18.StartRequest]) (*connect.Response[v18.StartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Start is not implemented"))
}

func (UnimplementedMysqlCtlHandler) Shutdown(context.Context, *connect.Request[v18.ShutdownRequest]) (*connect.Response[v18.ShutdownResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Shutdown is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RunMysqlUpgrade(context.Context, *connect.Request[v18.RunMysqlUpgradeRequest]) (*connect.Response[v18.RunMysqlUpgradeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RunMysqlUpgrade is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ApplyBinlogFile(context.Context, *connect.Request[v18.ApplyBinlogFileRequest]) (*connect.Response[v18.ApplyBinlogFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ApplyBinlogFile is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ReadBinlogFilesTimestamps(context.Context, *connect.Request[v18.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v18.ReadBinlogFilesTimestampsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) ReinitConfig(context.Context, *connect.Request[v18.ReinitConfigRequest]) (*connect.Response[v18.ReinitConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ReinitConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RefreshConfig(context.Context, *connect.Request[v18.RefreshConfigRequest]) (*connect.Response[v18.RefreshConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RefreshConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) VersionString(context.Context, *connect.Request[v18.VersionStringRequest]) (*connect.Response[v18.VersionStringResponse], error) {
