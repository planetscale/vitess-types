...
type MysqlCtlClient interface {
	Start(context.Context, *connect.Request[v24.StartRequest]) (*connect.Response[v24.StartResponse], error)
	Shutdown(context.Context, *connect.Request[v24.ShutdownRequest]) (*connect.Response[v24.ShutdownResponse], error)
	RunMysqlUpgrade(context.Context, *connect.Request[v24.RunMysqlUpgradeRequest]) (*connect.Response[v24.RunMysqlUpgradeResponse], error)
	ApplyBinlogFile(context.Context, *connect.Request[v24.ApplyBinlogFileRequest]) (*connect.Response[v24.ApplyBinlogFileResponse], error)
	ReadBinlogFilesTimestamps(context.Context, *connect.Request[v24.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v24.ReadBinlogFilesTimestampsResponse], error)
	ReinitConfig(context.Context, *connect.Request[v24.ReinitConfigRequest]) (*connect.Response[v24.ReinitConfigResponse], error)
	RefreshConfig(context.Context, *connect.Request[v24.RefreshConfigRequest]) (*connect.Response[v24.RefreshConfigResponse], error)
	VersionString(context.Context, *connect.Request[v24.VersionStringRequest]) (*connect.Response[v24.VersionStringResponse], error)
	HostMetrics(context.Context, *connect.Request[v24.HostMetricsRequest]) (*connect.Response[v24.HostMetricsResponse], error)
}
...
func NewMysqlCtlClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MysqlCtlClient {
	...
	mysqlCtlMethods := v24.File_vitess_mysqlctl_v24_mysqlctl_proto.Services().ByName("MysqlCtl").Methods()
	return &mysqlCtlClient{
		start: connect.NewClient[v24.StartRequest, v24.StartResponse](
			httpClient,
			baseURL+MysqlCtlStartProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("Start")),
			connect.WithClientOptions(opts...),
		),
		shutdown: connect.NewClient[v24.ShutdownRequest, v24.ShutdownResponse](
			httpClient,
			baseURL+MysqlCtlShutdownProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("Shutdown")),
			connect.WithClientOptions(opts...),
		),
		runMysqlUpgrade: connect.NewClient[v24.RunMysqlUpgradeRequest, v24.RunMysqlUpgradeResponse](
			httpClient,
			baseURL+MysqlCtlRunMysqlUpgradeProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("RunMysqlUpgrade")),
			connect.WithClientOptions(opts...),
		),
		applyBinlogFile: connect.NewClient[v24.ApplyBinlogFileRequest, v24.ApplyBinlogFileResponse](
			httpClient,
			baseURL+MysqlCtlApplyBinlogFileProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ApplyBinlogFile")),
			connect.WithClientOptions(opts...),
		),
		readBinlogFilesTimestamps: connect.NewClient[v24.ReadBinlogFilesTimestampsRequest, v24.ReadBinlogFilesTimestampsResponse](
			httpClient,
			baseURL+MysqlCtlReadBinlogFilesTimestampsProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ReadBinlogFilesTimestamps")),
			connect.WithClientOptions(opts...),
		),
		reinitConfig: connect.NewClient[v24.ReinitConfigRequest, v24.ReinitConfigResponse](
			httpClient,
			baseURL+MysqlCtlReinitConfigProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("ReinitConfig")),
			connect.WithClientOptions(opts...),
		),
		refreshConfig: connect.NewClient[v24.RefreshConfigRequest, v24.RefreshConfigResponse](
			httpClient,
			baseURL+MysqlCtlRefreshConfigProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("RefreshConfig")),
			connect.WithClientOptions(opts...),
		),
		versionString: connect.NewClient[v24.VersionStringRequest, v24.VersionStringResponse](
			httpClient,
			baseURL+MysqlCtlVersionStringProcedure,
			connect.WithSchema(mysqlCtlMethods.ByName("VersionString")),
			connect.WithClientOptions(opts...),
		),
		hostMetrics: connect.NewClient[v24.HostMetricsRequest, v24.HostMetricsResponse](
			httpClient,
...
type mysqlCtlClient struct {
	start                     *connect.Client[v24.StartRequest, v24.StartResponse]
	shutdown                  *connect.Client[v24.ShutdownRequest, v24.ShutdownResponse]
	runMysqlUpgrade           *connect.Client[v24.RunMysqlUpgradeRequest, v24.RunMysqlUpgradeResponse]
	applyBinlogFile           *connect.Client[v24.ApplyBinlogFileRequest, v24.ApplyBinlogFileResponse]
	readBinlogFilesTimestamps *connect.Client[v24.ReadBinlogFilesTimestampsRequest, v24.ReadBinlogFilesTimestampsResponse]
	reinitConfig              *connect.Client[v24.ReinitConfigRequest, v24.ReinitConfigResponse]
	refreshConfig             *connect.Client[v24.RefreshConfigRequest, v24.RefreshConfigResponse]
	versionString             *connect.Client[v24.VersionStringRequest, v24.VersionStringResponse]
	hostMetrics               *connect.Client[v24.HostMetricsRequest, v24.HostMetricsResponse]
}

// Start calls mysqlctl.MysqlCtl.Start.
func (c *mysqlCtlClient) Start(ctx context.Context, req *connect.Request[v24.StartRequest]) (*connect.Response[v24.StartResponse], error) {
	return c.start.CallUnary(ctx, req)
}

// Shutdown calls mysqlctl.MysqlCtl.Shutdown.
func (c *mysqlCtlClient) Shutdown(ctx context.Context, req *connect.Request[v24.ShutdownRequest]) (*connect.Response[v24.ShutdownResponse], error) {
	return c.shutdown.CallUnary(ctx, req)
}

// RunMysqlUpgrade calls mysqlctl.MysqlCtl.RunMysqlUpgrade.
func (c *mysqlCtlClient) RunMysqlUpgrade(ctx context.Context, req *connect.Request[v24.RunMysqlUpgradeRequest]) (*connect.Response[v24.RunMysqlUpgradeResponse], error) {
	return c.runMysqlUpgrade.CallUnary(ctx, req)
}

// ApplyBinlogFile calls mysqlctl.MysqlCtl.ApplyBinlogFile.
func (c *mysqlCtlClient) ApplyBinlogFile(ctx context.Context, req *connect.Request[v24.ApplyBinlogFileRequest]) (*connect.Response[v24.ApplyBinlogFileResponse], error) {
	return c.applyBinlogFile.CallUnary(ctx, req)
}

// ReadBinlogFilesTimestamps calls mysqlctl.MysqlCtl.ReadBinlogFilesTimestamps.
func (c *mysqlCtlClient) ReadBinlogFilesTimestamps(ctx context.Context, req *connect.Request[v24.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v24.ReadBinlogFilesTimestampsResponse], error) {
	return c.readBinlogFilesTimestamps.CallUnary(ctx, req)
}

// ReinitConfig calls mysqlctl.MysqlCtl.ReinitConfig.
func (c *mysqlCtlClient) ReinitConfig(ctx context.Context, req *connect.Request[v24.ReinitConfigRequest]) (*connect.Response[v24.ReinitConfigResponse], error) {
	return c.reinitConfig.CallUnary(ctx, req)
}

// RefreshConfig calls mysqlctl.MysqlCtl.RefreshConfig.
func (c *mysqlCtlClient) RefreshConfig(ctx context.Context, req *connect.Request[v24.RefreshConfigRequest]) (*connect.Response[v24.RefreshConfigResponse], error) {
	return c.refreshConfig.CallUnary(ctx, req)
}

// VersionString calls mysqlctl.MysqlCtl.VersionString.
func (c *mysqlCtlClient) VersionString(ctx context.Context, req *connect.Request[v24.VersionStringRequest]) (*connect.Response[v24.VersionStringResponse], error) {
	return c.versionString.CallUnary(ctx, req)
}

// HostMetrics calls mysqlctl.MysqlCtl.HostMetrics.
func (c *mysqlCtlClient) HostMetrics(ctx context.Context, req *connect.Request[v24.HostMetricsRequest]) (*connect.Response[v24.HostMetricsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) Start(context.Context, *connect.Request[v24.StartRequest]) (*connect.Response[v24.StartResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Start is not implemented"))
}

func (UnimplementedMysqlCtlHandler) Shutdown(context.Context, *connect.Request[v24.ShutdownRequest]) (*connect.Response[v24.ShutdownResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.Shutdown is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RunMysqlUpgrade(context.Context, *connect.Request[v24.RunMysqlUpgradeRequest]) (*connect.Response[v24.RunMysqlUpgradeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RunMysqlUpgrade is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ApplyBinlogFile(context.Context, *connect.Request[v24.ApplyBinlogFileRequest]) (*connect.Response[v24.ApplyBinlogFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ApplyBinlogFile is not implemented"))
}

func (UnimplementedMysqlCtlHandler) ReadBinlogFilesTimestamps(context.Context, *connect.Request[v24.ReadBinlogFilesTimestampsRequest]) (*connect.Response[v24.ReadBinlogFilesTimestampsResponse], error) {
...
func (UnimplementedMysqlCtlHandler) ReinitConfig(context.Context, *connect.Request[v24.ReinitConfigRequest]) (*connect.Response[v24.ReinitConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.ReinitConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) RefreshConfig(context.Context, *connect.Request[v24.RefreshConfigRequest]) (*connect.Response[v24.RefreshConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.RefreshConfig is not implemented"))
}

func (UnimplementedMysqlCtlHandler) VersionString(context.Context, *connect.Request[v24.VersionStringRequest]) (*connect.Response[v24.VersionStringResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mysqlctl.MysqlCtl.VersionString is not implemented"))
}

func (UnimplementedMysqlCtlHandler) HostMetrics(context.Context, *connect.Request[v24.HostMetricsRequest]) (*connect.Response[v24.HostMetricsResponse], error) {
