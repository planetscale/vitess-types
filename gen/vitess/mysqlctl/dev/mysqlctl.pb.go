...
const file_vitess_mysqlctl_dev_mysqlctl_proto_rawDesc = "" +
	"\n" +
	"\"vitess/mysqlctl/dev/mysqlctl.proto\x12\x13vitess.mysqlctl.dev\x1a\"vitess/topodata/dev/topodata.proto\x1a\x1evitess/vttime/dev/vttime.proto\x1a\x1cvitess/vtrpc/dev/vtrpc.proto\"/\n" +
	...
	"\x16mysql_shutdown_timeout\x18\x02 \x01(\v2\x1b.vitess.vttime.dev.DurationR\x14mysqlShutdownTimeout\"\x12\n" +
	...
	"\x17binlog_restore_datetime\x18\x03 \x01(\v2\x17.vitess.vttime.dev.TimeR\x15binlogRestoreDatetime\"\x19\n" +
	...
	"\x0ffirst_timestamp\x18\x01 \x01(\v2\x17.vitess.vttime.dev.TimeR\x0efirstTimestamp\x124\n" +
	"\x16first_timestamp_binlog\x18\x02 \x01(\tR\x14firstTimestampBinlog\x12>\n" +
	"\x0elast_timestamp\x18\x03 \x01(\v2\x17.vitess.vttime.dev.TimeR\rlastTimestamp\x122\n" +
	...
	"\ametrics\x18\x01 \x03(\v25.vitess.mysqlctl.dev.HostMetricsResponse.MetricsEntryR\ametrics\x1ad\n" +
	"\x06Metric\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value\x120\n" +
	"\x05error\x18\x03 \x01(\v2\x1a.vitess.vtrpc.dev.RPCErrorR\x05error\x1ak\n" +
	"\fMetricsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12E\n" +
	"\x05value\x18\x02 \x01(\v2/.vitess.mysqlctl.dev.HostMetricsResponse.MetricR\x05value:\x028\x01\"\x87\x03\n" +
	"\n" +
	"BackupInfo\x12\x12\n" +
	...
	"\ftablet_alias\x18\x05 \x01(\v2 .vitess.topodata.dev.TabletAliasR\vtabletAlias\x12+\n" +
	"\x04time\x18\x06 \x01(\v2\x17.vitess.vttime.dev.TimeR\x04time\x12\x16\n" +
	"\x06engine\x18\a \x01(\tR\x06engine\x12>\n" +
	"\x06status\x18\b \x01(\x0e2&.vitess.mysqlctl.dev.BackupInfo.StatusR\x06status\"K\n" +
	"\x06Status\x12\v\n" +
	...
	"\bMysqlCtl\x12P\n" +
	"\x05Start\x12!.vitess.mysqlctl.dev.StartRequest\x1a\".vitess.mysqlctl.dev.StartResponse\"\x00\x12Y\n" +
	"\bShutdown\x12$.vitess.mysqlctl.dev.ShutdownRequest\x1a%.vitess.mysqlctl.dev.ShutdownResponse\"\x00\x12n\n" +
	"\x0fRunMysqlUpgrade\x12+.vitess.mysqlctl.dev.RunMysqlUpgradeRequest\x1a,.vitess.mysqlctl.dev.RunMysqlUpgradeResponse\"\x00\x12n\n" +
	"\x0fApplyBinlogFile\x12+.vitess.mysqlctl.dev.ApplyBinlogFileRequest\x1a,.vitess.mysqlctl.dev.ApplyBinlogFileResponse\"\x00\x12\x8c\x01\n" +
	"\x19ReadBinlogFilesTimestamps\x125.vitess.mysqlctl.dev.ReadBinlogFilesTimestampsRequest\x1a6.vitess.mysqlctl.dev.ReadBinlogFilesTimestampsResponse\"\x00\x12e\n" +
	"\fReinitConfig\x12(.vitess.mysqlctl.dev.ReinitConfigRequest\x1a).vitess.mysqlctl.dev.ReinitConfigResponse\"\x00\x12h\n" +
	"\rRefreshConfig\x12).vitess.mysqlctl.dev.RefreshConfigRequest\x1a*.vitess.mysqlctl.dev.RefreshConfigResponse\"\x00\x12h\n" +
	"\rVersionString\x12).vitess.mysqlctl.dev.VersionStringRequest\x1a*.vitess.mysqlctl.dev.VersionStringResponse\"\x00\x12b\n" +
	"\vHostMetrics\x12'.vitess.mysqlctl.dev.HostMetricsRequest\x1a(.vitess.mysqlctl.dev.HostMetricsResponse\"\x00BIZGgithub.com/planetscale/vitess-types/gen/vitess/mysqlctl/dev;mysqlctldevb\x06proto3"

var (
	file_vitess_mysqlctl_dev_mysqlctl_proto_rawDescOnce sync.Once
	file_vitess_mysqlctl_dev_mysqlctl_proto_rawDescData []byte
)

func file_vitess_mysqlctl_dev_mysqlctl_proto_rawDescGZIP() []byte {
	file_vitess_mysqlctl_dev_mysqlctl_proto_rawDescOnce.Do(func() {
		file_vitess_mysqlctl_dev_mysqlctl_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_mysqlctl_dev_mysqlctl_proto_rawDesc), len(file_vitess_mysqlctl_dev_mysqlctl_proto_rawDesc)))
	})
...
func file_vitess_mysqlctl_dev_mysqlctl_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_mysqlctl_dev_mysqlctl_proto_rawDesc), len(file_vitess_mysqlctl_dev_mysqlctl_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   1,
