...
func (m *ApplyBinlogFileRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BinlogRestoreDatetime != nil {
		if vtmsg, ok := interface{}(m.BinlogRestoreDatetime).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.BinlogRestoreDatetime)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *ReadBinlogFilesTimestampsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastTimestamp != nil {
		if vtmsg, ok := interface{}(m.LastTimestamp).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.FirstTimestamp != nil {
		if vtmsg, ok := interface{}(m.FirstTimestamp).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *ApplyBinlogFileRequest) SizeVT() (n int) {
	...
	if m.BinlogRestoreDatetime != nil {
		if size, ok := interface{}(m.BinlogRestoreDatetime).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.BinlogRestoreDatetime)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *ShutdownRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.MysqlShutdownTimeout == nil {
				m.MysqlShutdownTimeout = &v22.Duration{}
			}
...
func (m *ApplyBinlogFileRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.BinlogRestoreDatetime == nil {
				m.BinlogRestoreDatetime = &v22.Time{}
			}
			if unmarshal, ok := interface{}(m.BinlogRestoreDatetime).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.BinlogRestoreDatetime); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *BackupInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &v222.TabletAlias{}
			}
