...
package binlogservicev17connect
...
import (
	...
	v17 "github.com/planetscale/vitess-types/gen/vitess/binlogservice/v17"
	http "net/http"
	strings "strings"
)
...
var (
	updateStreamServiceDescriptor              = v17.File_vitess_binlogservice_v17_binlogservice_proto.Services().ByName("UpdateStream")
...
type UpdateStreamClient interface {
	...
	StreamKeyRange(context.Context, *connect.Request[v171.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v171.StreamKeyRangeResponse], error)
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v171.StreamTablesRequest]) (*connect.ServerStreamForClient[v171.StreamTablesResponse], error)
}
...
func NewUpdateStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UpdateStreamClient {
	...
	return &updateStreamClient{
		streamKeyRange: connect.NewClient[v171.StreamKeyRangeRequest, v171.StreamKeyRangeResponse](
			httpClient,
			baseURL+UpdateStreamStreamKeyRangeProcedure,
			connect.WithSchema(updateStreamStreamKeyRangeMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		streamTables: connect.NewClient[v171.StreamTablesRequest, v171.StreamTablesResponse](
			httpClient,
...
type updateStreamClient struct {
	streamKeyRange *connect.Client[v171.StreamKeyRangeRequest, v171.StreamKeyRangeResponse]
	streamTables   *connect.Client[v171.StreamTablesRequest, v171.StreamTablesResponse]
}

// StreamKeyRange calls binlogservice.UpdateStream.StreamKeyRange.
func (c *updateStreamClient) StreamKeyRange(ctx context.Context, req *connect.Request[v171.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v171.StreamKeyRangeResponse], error) {
	return c.streamKeyRange.CallServerStream(ctx, req)
}

// StreamTables calls binlogservice.UpdateStream.StreamTables.
func (c *updateStreamClient) StreamTables(ctx context.Context, req *connect.Request[v171.StreamTablesRequest]) (*connect.ServerStreamForClient[v171.StreamTablesResponse], error) {
...
type UpdateStreamHandler interface {
	// StreamKeyRange returns the binlog transactions related to
	// the specified Keyrange.
	StreamKeyRange(context.Context, *connect.Request[v171.StreamKeyRangeRequest], *connect.ServerStream[v171.StreamKeyRangeResponse]) error
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v171.StreamTablesRequest], *connect.ServerStream[v171.StreamTablesResponse]) error
}
...
func (UnimplementedUpdateStreamHandler) StreamKeyRange(context.Context, *connect.Request[v171.StreamKeyRangeRequest], *connect.ServerStream[v171.StreamKeyRangeResponse]) error {
...
func (UnimplementedUpdateStreamHandler) StreamTables(context.Context, *connect.Request[v171.StreamTablesRequest], *connect.ServerStream[v171.StreamTablesResponse]) error {
