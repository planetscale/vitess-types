...
package binlogservicev24connect
...
import (
	...
	v241 "github.com/planetscale/vitess-types/gen/vitess/binlogservice/v24"
	http "net/http"
	strings "strings"
)
...
type UpdateStreamClient interface {
	...
	StreamKeyRange(context.Context, *connect.Request[v24.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v24.StreamKeyRangeResponse], error)
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v24.StreamTablesRequest]) (*connect.ServerStreamForClient[v24.StreamTablesResponse], error)
}
...
func NewUpdateStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UpdateStreamClient {
	...
	updateStreamMethods := v241.File_vitess_binlogservice_v24_binlogservice_proto.Services().ByName("UpdateStream").Methods()
	return &updateStreamClient{
		streamKeyRange: connect.NewClient[v24.StreamKeyRangeRequest, v24.StreamKeyRangeResponse](
			httpClient,
			baseURL+UpdateStreamStreamKeyRangeProcedure,
			connect.WithSchema(updateStreamMethods.ByName("StreamKeyRange")),
			connect.WithClientOptions(opts...),
		),
		streamTables: connect.NewClient[v24.StreamTablesRequest, v24.StreamTablesResponse](
			httpClient,
...
type updateStreamClient struct {
	streamKeyRange *connect.Client[v24.StreamKeyRangeRequest, v24.StreamKeyRangeResponse]
	streamTables   *connect.Client[v24.StreamTablesRequest, v24.StreamTablesResponse]
}

// StreamKeyRange calls binlogservice.UpdateStream.StreamKeyRange.
func (c *updateStreamClient) StreamKeyRange(ctx context.Context, req *connect.Request[v24.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v24.StreamKeyRangeResponse], error) {
	return c.streamKeyRange.CallServerStream(ctx, req)
}

// StreamTables calls binlogservice.UpdateStream.StreamTables.
func (c *updateStreamClient) StreamTables(ctx context.Context, req *connect.Request[v24.StreamTablesRequest]) (*connect.ServerStreamForClient[v24.StreamTablesResponse], error) {
...
type UpdateStreamHandler interface {
	// StreamKeyRange returns the binlog transactions related to
	// the specified Keyrange.
	StreamKeyRange(context.Context, *connect.Request[v24.StreamKeyRangeRequest], *connect.ServerStream[v24.StreamKeyRangeResponse]) error
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v24.StreamTablesRequest], *connect.ServerStream[v24.StreamTablesResponse]) error
}
...
func (UnimplementedUpdateStreamHandler) StreamKeyRange(context.Context, *connect.Request[v24.StreamKeyRangeRequest], *connect.ServerStream[v24.StreamKeyRangeResponse]) error {
...
func (UnimplementedUpdateStreamHandler) StreamTables(context.Context, *connect.Request[v24.StreamTablesRequest], *connect.ServerStream[v24.StreamTablesResponse]) error {
