...
import (
	...
	dev1 "github.com/planetscale/vitess-types/gen/vitess/binlogservice/dev"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UpdateStreamName = "vitess.binlogservice.dev.UpdateStream"
)
...
const (
	...
	// StreamKeyRange RPC.
	UpdateStreamStreamKeyRangeProcedure = "/vitess.binlogservice.dev.UpdateStream/StreamKeyRange"
	// UpdateStreamStreamTablesProcedure is the fully-qualified name of the UpdateStream's StreamTables
	// RPC.
	UpdateStreamStreamTablesProcedure = "/vitess.binlogservice.dev.UpdateStream/StreamTables"
)

// UpdateStreamClient is a client for the vitess.binlogservice.dev.UpdateStream service.
...
// NewUpdateStreamClient constructs a client for the vitess.binlogservice.dev.UpdateStream service.
...
func NewUpdateStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UpdateStreamClient {
	...
	updateStreamMethods := dev1.File_vitess_binlogservice_dev_binlogservice_proto.Services().ByName("UpdateStream").Methods()
...
// StreamKeyRange calls vitess.binlogservice.dev.UpdateStream.StreamKeyRange.
...
// StreamTables calls vitess.binlogservice.dev.UpdateStream.StreamTables.
...
// UpdateStreamHandler is an implementation of the vitess.binlogservice.dev.UpdateStream service.
...
func NewUpdateStreamHandler(svc UpdateStreamHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vitess.binlogservice.dev.UpdateStream/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUpdateStreamHandler) StreamKeyRange(context.Context, *connect.Request[dev.StreamKeyRangeRequest], *connect.ServerStream[dev.StreamKeyRangeResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vitess.binlogservice.dev.UpdateStream.StreamKeyRange is not implemented"))
}
...
func (UnimplementedUpdateStreamHandler) StreamTables(context.Context, *connect.Request[dev.StreamTablesRequest], *connect.ServerStream[dev.StreamTablesResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vitess.binlogservice.dev.UpdateStream.StreamTables is not implemented"))
}
