...
package binlogservicev23connect
...
import (
	...
	v231 "github.com/planetscale/vitess-types/gen/vitess/binlogservice/v23"
	http "net/http"
	strings "strings"
)
...
type UpdateStreamClient interface {
	...
	StreamKeyRange(context.Context, *connect.Request[v23.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v23.StreamKeyRangeResponse], error)
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v23.StreamTablesRequest]) (*connect.ServerStreamForClient[v23.StreamTablesResponse], error)
}
...
func NewUpdateStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UpdateStreamClient {
	...
	updateStreamMethods := v231.File_vitess_binlogservice_v23_binlogservice_proto.Services().ByName("UpdateStream").Methods()
	return &updateStreamClient{
		streamKeyRange: connect.NewClient[v23.StreamKeyRangeRequest, v23.StreamKeyRangeResponse](
			httpClient,
			baseURL+UpdateStreamStreamKeyRangeProcedure,
			connect.WithSchema(updateStreamMethods.ByName("StreamKeyRange")),
			connect.WithClientOptions(opts...),
		),
		streamTables: connect.NewClient[v23.StreamTablesRequest, v23.StreamTablesResponse](
			httpClient,
...
type updateStreamClient struct {
	streamKeyRange *connect.Client[v23.StreamKeyRangeRequest, v23.StreamKeyRangeResponse]
	streamTables   *connect.Client[v23.StreamTablesRequest, v23.StreamTablesResponse]
}

// StreamKeyRange calls binlogservice.UpdateStream.StreamKeyRange.
func (c *updateStreamClient) StreamKeyRange(ctx context.Context, req *connect.Request[v23.StreamKeyRangeRequest]) (*connect.ServerStreamForClient[v23.StreamKeyRangeResponse], error) {
	return c.streamKeyRange.CallServerStream(ctx, req)
}

// StreamTables calls binlogservice.UpdateStream.StreamTables.
func (c *updateStreamClient) StreamTables(ctx context.Context, req *connect.Request[v23.StreamTablesRequest]) (*connect.ServerStreamForClient[v23.StreamTablesResponse], error) {
...
type UpdateStreamHandler interface {
	// StreamKeyRange returns the binlog transactions related to
	// the specified Keyrange.
	StreamKeyRange(context.Context, *connect.Request[v23.StreamKeyRangeRequest], *connect.ServerStream[v23.StreamKeyRangeResponse]) error
	// StreamTables returns the binlog transactions related to
	// the specified Tables.
	StreamTables(context.Context, *connect.Request[v23.StreamTablesRequest], *connect.ServerStream[v23.StreamTablesResponse]) error
}
...
func (UnimplementedUpdateStreamHandler) StreamKeyRange(context.Context, *connect.Request[v23.StreamKeyRangeRequest], *connect.ServerStream[v23.StreamKeyRangeResponse]) error {
...
func (UnimplementedUpdateStreamHandler) StreamTables(context.Context, *connect.Request[v23.StreamTablesRequest], *connect.ServerStream[v23.StreamTablesResponse]) error {
