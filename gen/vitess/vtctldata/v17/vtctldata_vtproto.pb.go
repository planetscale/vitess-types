...
import (
	...
	v178 "github.com/planetscale/vitess-types/gen/vitess/mysqlctl/v17"
	v176 "github.com/planetscale/vitess-types/gen/vitess/query/v17"
	v179 "github.com/planetscale/vitess-types/gen/vitess/replicationdata/v17"
	v177 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerdata/v17"
	...
	v175 "github.com/planetscale/vitess-types/gen/vitess/vtrpc/v17"
	v172 "github.com/planetscale/vitess-types/gen/vitess/vttime/v17"
...
func (m *CreateKeyspaceRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ServedFroms) > 0 {
		for iNdEx := len(m.ServedFroms) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.ServedFroms[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.ServedFroms[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
...
func (m *Workflow_ShardStream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TabletControls = append(m.TabletControls, &v171.Shard_TabletControl{})
...
func (m *Workflow_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.BinlogSource == nil {
				m.BinlogSource = &v173.BinlogSource{}
			}
		...
		case 9:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &v172.Time{}
			}
...
func (m *ApplyRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RoutingRules == nil {
				m.RoutingRules = &v174.RoutingRules{}
			}
...
func (m *ApplyShardRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ShardRoutingRules == nil {
				m.ShardRoutingRules = &v174.ShardRoutingRules{}
			}
...
func (m *ApplySchemaRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.WaitReplicasTimeout == nil {
				m.WaitReplicasTimeout = &v172.Duration{}
			}
...
func (m *BackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &v171.TabletAlias{}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DbType |= v171.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CreateKeyspaceRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ServedFroms = append(m.ServedFroms, &v171.Keyspace_ServedFrom{})
			if unmarshal, ok := interface{}(m.ServedFroms[len(m.ServedFroms)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.ServedFroms[len(m.ServedFroms)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= v171.KeyspaceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DeleteTabletsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TabletAliases = append(m.TabletAliases, &v171.TabletAlias{})
...
func (m *EmergencyReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.IgnoreReplicas = append(m.IgnoreReplicas, &v171.TabletAlias{})
...
func (m *EmergencyReparentShardResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Events = append(m.Events, &v17.Event{})
...
func (m *ExecuteHookRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletHookRequest == nil {
				m.TabletHookRequest = &v177.ExecuteHookRequest{}
			}
...
func (m *ExecuteHookResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HookResult == nil {
				m.HookResult = &v177.ExecuteHookResponse{}
			}
...
func (m *GetBackupsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Backups = append(m.Backups, &v178.BackupInfo{})
...
func (m *GetPermissionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Permissions == nil {
				m.Permissions = &v177.Permissions{}
			}
...
func (m *GetSchemaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Schema == nil {
				m.Schema = &v177.SchemaDefinition{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvKeyspaces == nil {
				m.SrvKeyspaces = make(map[string]*v171.SrvKeyspace)
			}
			var mapkey string
			var mapvalue *v171.SrvKeyspace
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvVSchemas == nil {
				m.SrvVSchemas = make(map[string]*v174.SrvVSchema)
			}
			var mapkey string
			var mapvalue *v174.SrvVSchema
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= v171.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GetTabletsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tablets = append(m.Tablets, &v171.Tablet{})
...
func (m *InitShardPrimaryRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryElectTabletAlias == nil {
				m.PrimaryElectTabletAlias = &v171.TabletAlias{}
			}
...
func (m *PlannedReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.AvoidPrimary == nil {
				m.AvoidPrimary = &v171.TabletAlias{}
			}
...
func (m *ShardReplicationFixResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Error == nil {
				m.Error = &v171.ShardReplicationError{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ReplicationStatuses == nil {
				m.ReplicationStatuses = make(map[string]*v179.Status)
			}
			var mapkey string
			var mapvalue *v179.Status
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.TabletMap == nil {
				m.TabletMap = make(map[string]*v171.Tablet)
			}
			var mapkey string
			var mapvalue *v171.Tablet
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *WorkflowUpdateRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletRequest == nil {
				m.TabletRequest = &v177.UpdateVRWorkflowRequest{}
			}
