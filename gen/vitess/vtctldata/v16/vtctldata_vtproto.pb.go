...
import (
	...
	v168 "github.com/planetscale/vitess-types/gen/vitess/mysqlctl/v16"
	v166 "github.com/planetscale/vitess-types/gen/vitess/query/v16"
	v169 "github.com/planetscale/vitess-types/gen/vitess/replicationdata/v16"
	v167 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerdata/v16"
	...
	v165 "github.com/planetscale/vitess-types/gen/vitess/vtrpc/v16"
	v162 "github.com/planetscale/vitess-types/gen/vitess/vttime/v16"
...
func (m *Workflow_ShardStream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TabletControls = append(m.TabletControls, &v161.Shard_TabletControl{})
...
func (m *Workflow_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.BinlogSource == nil {
				m.BinlogSource = &v163.BinlogSource{}
			}
		...
		case 9:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &v162.Time{}
			}
...
func (m *ApplyRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RoutingRules == nil {
				m.RoutingRules = &v164.RoutingRules{}
			}
...
func (m *ApplyShardRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ShardRoutingRules == nil {
				m.ShardRoutingRules = &v164.ShardRoutingRules{}
			}
...
func (m *ApplySchemaRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.WaitReplicasTimeout == nil {
				m.WaitReplicasTimeout = &v162.Duration{}
			}
...
func (m *BackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &v161.TabletAlias{}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DbType |= v161.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CreateKeyspaceRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ServedFroms = append(m.ServedFroms, &v161.Keyspace_ServedFrom{})
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= v161.KeyspaceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DeleteTabletsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TabletAliases = append(m.TabletAliases, &v161.TabletAlias{})
...
func (m *EmergencyReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.IgnoreReplicas = append(m.IgnoreReplicas, &v161.TabletAlias{})
...
func (m *EmergencyReparentShardResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PromotedPrimary == nil {
				m.PromotedPrimary = &v161.TabletAlias{}
			}
		...
		case 4:
			...
			m.Events = append(m.Events, &v16.Event{})
...
func (m *ExecuteHookRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletHookRequest == nil {
				m.TabletHookRequest = &v167.ExecuteHookRequest{}
			}
...
func (m *ExecuteHookResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HookResult == nil {
				m.HookResult = &v167.ExecuteHookResponse{}
			}
...
func (m *GetBackupsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Backups = append(m.Backups, &v168.BackupInfo{})
...
func (m *GetCellsAliasesResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Aliases == nil {
				m.Aliases = make(map[string]*v161.CellsAlias)
			}
			var mapkey string
			var mapvalue *v161.CellsAlias
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *GetPermissionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Permissions == nil {
				m.Permissions = &v167.Permissions{}
			}
...
func (m *GetSchemaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Schema == nil {
				m.Schema = &v167.SchemaDefinition{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvKeyspaces == nil {
				m.SrvKeyspaces = make(map[string]*v161.SrvKeyspace)
			}
			var mapkey string
			var mapvalue *v161.SrvKeyspace
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvVSchemas == nil {
				m.SrvVSchemas = make(map[string]*v164.SrvVSchema)
			}
			var mapkey string
			var mapvalue *v164.SrvVSchema
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= v161.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GetTabletsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tablets = append(m.Tablets, &v161.Tablet{})
...
func (m *InitShardPrimaryRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryElectTabletAlias == nil {
				m.PrimaryElectTabletAlias = &v161.TabletAlias{}
			}
...
func (m *PlannedReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.AvoidPrimary == nil {
				m.AvoidPrimary = &v161.TabletAlias{}
			}
...
func (m *ShardReplicationFixResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Error == nil {
				m.Error = &v161.ShardReplicationError{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ReplicationStatuses == nil {
				m.ReplicationStatuses = make(map[string]*v169.Status)
			}
			var mapkey string
			var mapvalue *v169.Status
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.TabletMap == nil {
				m.TabletMap = make(map[string]*v161.Tablet)
			}
			var mapkey string
			var mapvalue *v161.Tablet
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
