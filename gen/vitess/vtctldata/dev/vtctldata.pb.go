...
type GetCellsAliasesResponse struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Aliases       map[string]*dev2.CellsAlias `protobuf:"bytes,1,rep,name=aliases,proto3" json:"aliases,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetShardReplicationResponse struct {
	state                  protoimpl.MessageState            `protogen:"open.v1"`
	ShardReplicationByCell map[string]*dev2.ShardReplication `protobuf:"bytes,1,rep,name=shard_replication_by_cell,json=shardReplicationByCell,proto3" json:"shard_replication_by_cell,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type GetSrvKeyspacesResponse struct {
	...
	SrvKeyspaces  map[string]*dev2.SrvKeyspace `protobuf:"bytes,1,rep,name=srv_keyspaces,json=srvKeyspaces,proto3" json:"srv_keyspaces,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetSrvVSchemasResponse struct {
	...
	SrvVSchemas   map[string]*dev4.SrvVSchema `protobuf:"bytes,1,rep,name=srv_v_schemas,json=srvVSchemas,proto3" json:"srv_v_schemas,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ShardReplicationPositionsResponse struct {
	...
	ReplicationStatuses map[string]*dev8.Status `protobuf:"bytes,1,rep,name=replication_statuses,json=replicationStatuses,proto3" json:"replication_statuses,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// TabletMap is the set of tablets whose replication statuses were queried,
	// keyed by tablet alias.
	TabletMap     map[string]*dev2.Tablet `protobuf:"bytes,2,rep,name=tablet_map,json=tabletMap,proto3" json:"tablet_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VDiffShowResponse struct {
	...
	TabletResponses map[string]*dev1.VDiffResponse `protobuf:"bytes,1,rep,name=tablet_responses,json=tabletResponses,proto3" json:"tablet_responses,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
var file_vitess_vtctldata_dev_vtctldata_proto_rawDesc = string([]byte{
...
var (
	...
	file_vitess_vtctldata_dev_vtctldata_proto_rawDescData []byte
)
...
func file_vitess_vtctldata_dev_vtctldata_proto_rawDescGZIP() []byte {
	file_vitess_vtctldata_dev_vtctldata_proto_rawDescOnce.Do(func() {
		file_vitess_vtctldata_dev_vtctldata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_vtctldata_dev_vtctldata_proto_rawDesc), len(file_vitess_vtctldata_dev_vtctldata_proto_rawDesc)))
	})
...
func file_vitess_vtctldata_dev_vtctldata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_vtctldata_dev_vtctldata_proto_rawDesc), len(file_vitess_vtctldata_dev_vtctldata_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   313,
			NumExtensions: 0,
			NumServices:   0,
