...
import (
	...
	dev8 "github.com/planetscale/vitess-types/gen/vitess/mysqlctl/dev"
	dev6 "github.com/planetscale/vitess-types/gen/vitess/query/dev"
	dev9 "github.com/planetscale/vitess-types/gen/vitess/replicationdata/dev"
	dev7 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerdata/dev"
	...
	dev2 "github.com/planetscale/vitess-types/gen/vitess/vttime/dev"
...
func (m *Workflow_ShardStream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TabletControls = append(m.TabletControls, &dev1.Shard_TabletControl{})
...
func (m *Workflow_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.BinlogSource == nil {
				m.BinlogSource = &dev3.BinlogSource{}
			}
		...
		case 9:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &dev2.Time{}
			}
...
func (m *ApplyRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RoutingRules == nil {
				m.RoutingRules = &dev4.RoutingRules{}
			}
...
func (m *ApplyShardRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ShardRoutingRules == nil {
				m.ShardRoutingRules = &dev4.ShardRoutingRules{}
			}
...
func (m *ApplySchemaRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.WaitReplicasTimeout == nil {
				m.WaitReplicasTimeout = &dev2.Duration{}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DbType |= dev1.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CreateKeyspaceRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ServedFroms = append(m.ServedFroms, &dev1.Keyspace_ServedFrom{})
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= dev1.KeyspaceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DeleteTabletsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TabletAliases = append(m.TabletAliases, &dev1.TabletAlias{})
...
func (m *EmergencyReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.IgnoreReplicas = append(m.IgnoreReplicas, &dev1.TabletAlias{})
...
func (m *EmergencyReparentShardResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Events = append(m.Events, &dev.Event{})
...
func (m *ExecuteHookRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletHookRequest == nil {
				m.TabletHookRequest = &dev7.ExecuteHookRequest{}
			}
...
func (m *ExecuteHookResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HookResult == nil {
				m.HookResult = &dev7.ExecuteHookResponse{}
			}
...
func (m *GetBackupsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Backups = append(m.Backups, &dev8.BackupInfo{})
...
func (m *GetPermissionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Permissions == nil {
				m.Permissions = &dev7.Permissions{}
			}
...
func (m *GetSchemaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Schema == nil {
				m.Schema = &dev7.SchemaDefinition{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvKeyspaces == nil {
				m.SrvKeyspaces = make(map[string]*dev1.SrvKeyspace)
			}
			var mapkey string
			var mapvalue *dev1.SrvKeyspace
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvVSchemas == nil {
				m.SrvVSchemas = make(map[string]*dev4.SrvVSchema)
			}
			var mapkey string
			var mapvalue *dev4.SrvVSchema
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *GetTabletsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tablets = append(m.Tablets, &dev1.Tablet{})
...
func (m *InitShardPrimaryRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryElectTabletAlias == nil {
				m.PrimaryElectTabletAlias = &dev1.TabletAlias{}
			}
...
func (m *PlannedReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.AvoidPrimary == nil {
				m.AvoidPrimary = &dev1.TabletAlias{}
			}
...
func (m *ShardReplicationFixResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Error == nil {
				m.Error = &dev1.ShardReplicationError{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ReplicationStatuses == nil {
				m.ReplicationStatuses = make(map[string]*dev9.Status)
			}
			var mapkey string
			var mapvalue *dev9.Status
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.TabletMap == nil {
				m.TabletMap = make(map[string]*dev1.Tablet)
			}
			var mapkey string
			var mapvalue *dev1.Tablet
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *WorkflowUpdateRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletRequest == nil {
				m.TabletRequest = &dev7.UpdateVRWorkflowRequest{}
			}
