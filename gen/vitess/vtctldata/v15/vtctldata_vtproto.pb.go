...
import (
	...
	v158 "github.com/planetscale/vitess-types/gen/vitess/mysqlctl/v15"
	v156 "github.com/planetscale/vitess-types/gen/vitess/query/v15"
	v159 "github.com/planetscale/vitess-types/gen/vitess/replicationdata/v15"
	v157 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerdata/v15"
	...
	v155 "github.com/planetscale/vitess-types/gen/vitess/vtrpc/v15"
	v152 "github.com/planetscale/vitess-types/gen/vitess/vttime/v15"
...
func (m *Workflow_ShardStream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TabletControls = append(m.TabletControls, &v151.Shard_TabletControl{})
...
func (m *Workflow_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.BinlogSource == nil {
				m.BinlogSource = &v153.BinlogSource{}
			}
		...
		case 9:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &v152.Time{}
			}
...
func (m *ApplyRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RoutingRules == nil {
				m.RoutingRules = &v154.RoutingRules{}
			}
...
func (m *ApplyShardRoutingRulesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ShardRoutingRules == nil {
				m.ShardRoutingRules = &v154.ShardRoutingRules{}
			}
...
func (m *ApplySchemaRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.WaitReplicasTimeout == nil {
				m.WaitReplicasTimeout = &v152.Duration{}
			}
...
func (m *BackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &v151.TabletAlias{}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DbType |= v151.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *CreateKeyspaceRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ServedFroms = append(m.ServedFroms, &v151.Keyspace_ServedFrom{})
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= v151.KeyspaceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DeleteTabletsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TabletAliases = append(m.TabletAliases, &v151.TabletAlias{})
...
func (m *EmergencyReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.IgnoreReplicas = append(m.IgnoreReplicas, &v151.TabletAlias{})
...
func (m *EmergencyReparentShardResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PromotedPrimary == nil {
				m.PromotedPrimary = &v151.TabletAlias{}
			}
		...
		case 4:
			...
			m.Events = append(m.Events, &v15.Event{})
...
func (m *ExecuteHookRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TabletHookRequest == nil {
				m.TabletHookRequest = &v157.ExecuteHookRequest{}
			}
...
func (m *ExecuteHookResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HookResult == nil {
				m.HookResult = &v157.ExecuteHookResponse{}
			}
...
func (m *GetBackupsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Backups = append(m.Backups, &v158.BackupInfo{})
...
func (m *GetCellsAliasesResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Aliases == nil {
				m.Aliases = make(map[string]*v151.CellsAlias)
			}
			var mapkey string
			var mapvalue *v151.CellsAlias
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *GetPermissionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Permissions == nil {
				m.Permissions = &v157.Permissions{}
			}
...
func (m *GetSchemaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Schema == nil {
				m.Schema = &v157.SchemaDefinition{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvKeyspaces == nil {
				m.SrvKeyspaces = make(map[string]*v151.SrvKeyspace)
			}
			var mapkey string
			var mapvalue *v151.SrvKeyspace
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SrvVSchemas == nil {
				m.SrvVSchemas = make(map[string]*v154.SrvVSchema)
			}
			var mapkey string
			var mapvalue *v154.SrvVSchema
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= v151.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GetTabletsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tablets = append(m.Tablets, &v151.Tablet{})
...
func (m *InitShardPrimaryRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryElectTabletAlias == nil {
				m.PrimaryElectTabletAlias = &v151.TabletAlias{}
			}
...
func (m *PlannedReparentShardRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.AvoidPrimary == nil {
				m.AvoidPrimary = &v151.TabletAlias{}
			}
...
func (m *ShardReplicationFixResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Error == nil {
				m.Error = &v151.ShardReplicationError{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ReplicationStatuses == nil {
				m.ReplicationStatuses = make(map[string]*v159.Status)
			}
			var mapkey string
			var mapvalue *v159.Status
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.TabletMap == nil {
				m.TabletMap = make(map[string]*v151.Tablet)
			}
			var mapkey string
			var mapvalue *v151.Tablet
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
