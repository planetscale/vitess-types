...
import (
	...
	_ "github.com/planetscale/vitess-types/gen/vitess/vtgateservice/v18"
	http "net/http"
	strings "strings"
)
...
type VitessClient interface {
	...
	// information in conjunction with the vindexes to route the query.
	// API group: v3
	ExecuteBatch(context.Context, *connect.Request[v18.ExecuteBatchRequest]) (*connect.Response[v18.ExecuteBatchResponse], error)
	...
	ResolveTransaction(context.Context, *connect.Request[v18.ResolveTransactionRequest]) (*connect.Response[v18.ResolveTransactionResponse], error)
	// VStream streams binlog events from the requested sources.
	VStream(context.Context, *connect.Request[v18.VStreamRequest]) (*connect.ServerStreamForClient[v18.VStreamResponse], error)
	...
	CloseSession(context.Context, *connect.Request[v18.CloseSessionRequest]) (*connect.Response[v18.CloseSessionResponse], error)
}
...
func NewVitessClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VitessClient {
	...
	return &vitessClient{
		...
		executeBatch: connect.NewClient[v18.ExecuteBatchRequest, v18.ExecuteBatchResponse](
			httpClient,
		...
		resolveTransaction: connect.NewClient[v18.ResolveTransactionRequest, v18.ResolveTransactionResponse](
			httpClient,
			baseURL+VitessResolveTransactionProcedure,
			opts...,
		),
		vStream: connect.NewClient[v18.VStreamRequest, v18.VStreamResponse](
			httpClient,
		...
		closeSession: connect.NewClient[v18.CloseSessionRequest, v18.CloseSessionResponse](
			httpClient,
...
type vitessClient struct {
	...
	executeBatch       *connect.Client[v18.ExecuteBatchRequest, v18.ExecuteBatchResponse]
	streamExecute      *connect.Client[v18.StreamExecuteRequest, v18.StreamExecuteResponse]
	resolveTransaction *connect.Client[v18.ResolveTransactionRequest, v18.ResolveTransactionResponse]
	vStream            *connect.Client[v18.VStreamRequest, v18.VStreamResponse]
	prepare            *connect.Client[v18.PrepareRequest, v18.PrepareResponse]
	closeSession       *connect.Client[v18.CloseSessionRequest, v18.CloseSessionResponse]
}

// Execute calls vtgateservice.Vitess.Execute.
func (c *vitessClient) Execute(ctx context.Context, req *connect.Request[v18.ExecuteRequest]) (*connect.Response[v18.ExecuteResponse], error) {
	return c.execute.CallUnary(ctx, req)
}

// ExecuteBatch calls vtgateservice.Vitess.ExecuteBatch.
func (c *vitessClient) ExecuteBatch(ctx context.Context, req *connect.Request[v18.ExecuteBatchRequest]) (*connect.Response[v18.ExecuteBatchResponse], error) {
	return c.executeBatch.CallUnary(ctx, req)
}

// StreamExecute calls vtgateservice.Vitess.StreamExecute.
func (c *vitessClient) StreamExecute(ctx context.Context, req *connect.Request[v18.StreamExecuteRequest]) (*connect.ServerStreamForClient[v18.StreamExecuteResponse], error) {
	return c.streamExecute.CallServerStream(ctx, req)
}

// ResolveTransaction calls vtgateservice.Vitess.ResolveTransaction.
func (c *vitessClient) ResolveTransaction(ctx context.Context, req *connect.Request[v18.ResolveTransactionRequest]) (*connect.Response[v18.ResolveTransactionResponse], error) {
	return c.resolveTransaction.CallUnary(ctx, req)
}

// VStream calls vtgateservice.Vitess.VStream.
func (c *vitessClient) VStream(ctx context.Context, req *connect.Request[v18.VStreamRequest]) (*connect.ServerStreamForClient[v18.VStreamResponse], error) {
	return c.vStream.CallServerStream(ctx, req)
}

// Prepare calls vtgateservice.Vitess.Prepare.
func (c *vitessClient) Prepare(ctx context.Context, req *connect.Request[v18.PrepareRequest]) (*connect.Response[v18.PrepareResponse], error) {
	return c.prepare.CallUnary(ctx, req)
}

// CloseSession calls vtgateservice.Vitess.CloseSession.
func (c *vitessClient) CloseSession(ctx context.Context, req *connect.Request[v18.CloseSessionRequest]) (*connect.Response[v18.CloseSessionResponse], error) {
...
type VitessHandler interface {
	...
	ResolveTransaction(context.Context, *connect.Request[v18.ResolveTransactionRequest]) (*connect.Response[v18.ResolveTransactionResponse], error)
	// VStream streams binlog events from the requested sources.
	VStream(context.Context, *connect.Request[v18.VStreamRequest], *connect.ServerStream[v18.VStreamResponse]) error
	// Prepare is used by the MySQL server plugin as part of supporting prepared statements.
	Prepare(context.Context, *connect.Request[v18.PrepareRequest]) (*connect.Response[v18.PrepareResponse], error)
	// CloseSession closes the session, rolling back any implicit transactions.
	// This has the same effect as if a "rollback" statement was executed,
...
func (UnimplementedVitessHandler) Execute(context.Context, *connect.Request[v18.ExecuteRequest]) (*connect.Response[v18.ExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.Execute is not implemented"))
}

func (UnimplementedVitessHandler) ExecuteBatch(context.Context, *connect.Request[v18.ExecuteBatchRequest]) (*connect.Response[v18.ExecuteBatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.ExecuteBatch is not implemented"))
}

func (UnimplementedVitessHandler) StreamExecute(context.Context, *connect.Request[v18.StreamExecuteRequest], *connect.ServerStream[v18.StreamExecuteResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.StreamExecute is not implemented"))
}

func (UnimplementedVitessHandler) ResolveTransaction(context.Context, *connect.Request[v18.ResolveTransactionRequest]) (*connect.Response[v18.ResolveTransactionResponse], error) {
...
func (UnimplementedVitessHandler) VStream(context.Context, *connect.Request[v18.VStreamRequest], *connect.ServerStream[v18.VStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.VStream is not implemented"))
}

func (UnimplementedVitessHandler) Prepare(context.Context, *connect.Request[v18.PrepareRequest]) (*connect.Response[v18.PrepareResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.Prepare is not implemented"))
}

func (UnimplementedVitessHandler) CloseSession(context.Context, *connect.Request[v18.CloseSessionRequest]) (*connect.Response[v18.CloseSessionResponse], error) {
