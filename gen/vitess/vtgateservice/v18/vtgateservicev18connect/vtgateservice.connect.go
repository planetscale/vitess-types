...
package vtgateservicev18connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v181 "github.com/planetscale/vitess-types/gen/vitess/vtgate/v18"
	v18 "github.com/planetscale/vitess-types/gen/vitess/vtgateservice/v18"
	http "net/http"
	strings "strings"
)
...
var (
	vitessServiceDescriptor                  = v18.File_vitess_vtgateservice_v18_vtgateservice_proto.Services().ByName("Vitess")
...
type VitessClient interface {
	...
	// information in conjunction with the vindexes to route the query.
	// API group: v3
	ExecuteBatch(context.Context, *connect.Request[v181.ExecuteBatchRequest]) (*connect.Response[v181.ExecuteBatchResponse], error)
	...
	ResolveTransaction(context.Context, *connect.Request[v181.ResolveTransactionRequest]) (*connect.Response[v181.ResolveTransactionResponse], error)
	...
	CloseSession(context.Context, *connect.Request[v181.CloseSessionRequest]) (*connect.Response[v181.CloseSessionResponse], error)
}
...
func NewVitessClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VitessClient {
	...
	return &vitessClient{
		...
		executeBatch: connect.NewClient[v181.ExecuteBatchRequest, v181.ExecuteBatchResponse](
			httpClient,
		...
		resolveTransaction: connect.NewClient[v181.ResolveTransactionRequest, v181.ResolveTransactionResponse](
			httpClient,
		...
		closeSession: connect.NewClient[v181.CloseSessionRequest, v181.CloseSessionResponse](
			httpClient,
...
type vitessClient struct {
	...
	executeBatch       *connect.Client[v181.ExecuteBatchRequest, v181.ExecuteBatchResponse]
	streamExecute      *connect.Client[v181.StreamExecuteRequest, v181.StreamExecuteResponse]
	resolveTransaction *connect.Client[v181.ResolveTransactionRequest, v181.ResolveTransactionResponse]
	...
	closeSession       *connect.Client[v181.CloseSessionRequest, v181.CloseSessionResponse]
}

// Execute calls vtgateservice.Vitess.Execute.
func (c *vitessClient) Execute(ctx context.Context, req *connect.Request[v181.ExecuteRequest]) (*connect.Response[v181.ExecuteResponse], error) {
	return c.execute.CallUnary(ctx, req)
}

// ExecuteBatch calls vtgateservice.Vitess.ExecuteBatch.
func (c *vitessClient) ExecuteBatch(ctx context.Context, req *connect.Request[v181.ExecuteBatchRequest]) (*connect.Response[v181.ExecuteBatchResponse], error) {
	return c.executeBatch.CallUnary(ctx, req)
}

// StreamExecute calls vtgateservice.Vitess.StreamExecute.
func (c *vitessClient) StreamExecute(ctx context.Context, req *connect.Request[v181.StreamExecuteRequest]) (*connect.ServerStreamForClient[v181.StreamExecuteResponse], error) {
	return c.streamExecute.CallServerStream(ctx, req)
}

// ResolveTransaction calls vtgateservice.Vitess.ResolveTransaction.
func (c *vitessClient) ResolveTransaction(ctx context.Context, req *connect.Request[v181.ResolveTransactionRequest]) (*connect.Response[v181.ResolveTransactionResponse], error) {
	return c.resolveTransaction.CallUnary(ctx, req)
}

// VStream calls vtgateservice.Vitess.VStream.
func (c *vitessClient) VStream(ctx context.Context, req *connect.Request[v181.VStreamRequest]) (*connect.ServerStreamForClient[v181.VStreamResponse], error) {
	return c.vStream.CallServerStream(ctx, req)
}

// Prepare calls vtgateservice.Vitess.Prepare.
func (c *vitessClient) Prepare(ctx context.Context, req *connect.Request[v181.PrepareRequest]) (*connect.Response[v181.PrepareResponse], error) {
	return c.prepare.CallUnary(ctx, req)
}

// CloseSession calls vtgateservice.Vitess.CloseSession.
func (c *vitessClient) CloseSession(ctx context.Context, req *connect.Request[v181.CloseSessionRequest]) (*connect.Response[v181.CloseSessionResponse], error) {
...
func (UnimplementedVitessHandler) Execute(context.Context, *connect.Request[v181.ExecuteRequest]) (*connect.Response[v181.ExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.Execute is not implemented"))
}

func (UnimplementedVitessHandler) ExecuteBatch(context.Context, *connect.Request[v181.ExecuteBatchRequest]) (*connect.Response[v181.ExecuteBatchResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.ExecuteBatch is not implemented"))
}

func (UnimplementedVitessHandler) StreamExecute(context.Context, *connect.Request[v181.StreamExecuteRequest], *connect.ServerStream[v181.StreamExecuteResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.StreamExecute is not implemented"))
}

func (UnimplementedVitessHandler) ResolveTransaction(context.Context, *connect.Request[v181.ResolveTransactionRequest]) (*connect.Response[v181.ResolveTransactionResponse], error) {
...
func (UnimplementedVitessHandler) VStream(context.Context, *connect.Request[v181.VStreamRequest], *connect.ServerStream[v181.VStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.VStream is not implemented"))
}

func (UnimplementedVitessHandler) Prepare(context.Context, *connect.Request[v181.PrepareRequest]) (*connect.Response[v181.PrepareResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtgateservice.Vitess.Prepare is not implemented"))
}

func (UnimplementedVitessHandler) CloseSession(context.Context, *connect.Request[v181.CloseSessionRequest]) (*connect.Response[v181.CloseSessionResponse], error) {
