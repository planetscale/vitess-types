...
type VitessClient interface {
	...
	// information in conjunction with the vindexes to route the query.
	// API group: v3
	ExecuteBatch(context.Context, *connect_go.Request[v15.ExecuteBatchRequest]) (*connect_go.Response[v15.ExecuteBatchResponse], error)
	...
	ResolveTransaction(context.Context, *connect_go.Request[v15.ResolveTransactionRequest]) (*connect_go.Response[v15.ResolveTransactionResponse], error)
	// VStream streams binlog events from the requested sources.
	VStream(context.Context, *connect_go.Request[v15.VStreamRequest]) (*connect_go.ServerStreamForClient[v15.VStreamResponse], error)
...
func NewVitessClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) VitessClient {
	...
	return &vitessClient{
		...
		executeBatch: connect_go.NewClient[v15.ExecuteBatchRequest, v15.ExecuteBatchResponse](
			httpClient,
		...
		resolveTransaction: connect_go.NewClient[v15.ResolveTransactionRequest, v15.ResolveTransactionResponse](
			httpClient,
			baseURL+VitessResolveTransactionProcedure,
			opts...,
		),
		vStream: connect_go.NewClient[v15.VStreamRequest, v15.VStreamResponse](
			httpClient,
		...
		closeSession: connect_go.NewClient[v15.CloseSessionRequest, v15.CloseSessionResponse](
			httpClient,
...
type vitessClient struct {
	...
	executeBatch       *connect_go.Client[v15.ExecuteBatchRequest, v15.ExecuteBatchResponse]
	streamExecute      *connect_go.Client[v15.StreamExecuteRequest, v15.StreamExecuteResponse]
	resolveTransaction *connect_go.Client[v15.ResolveTransactionRequest, v15.ResolveTransactionResponse]
	vStream            *connect_go.Client[v15.VStreamRequest, v15.VStreamResponse]
...
type VitessHandler interface {
	...
	ResolveTransaction(context.Context, *connect_go.Request[v15.ResolveTransactionRequest]) (*connect_go.Response[v15.ResolveTransactionResponse], error)
	// VStream streams binlog events from the requested sources.
	VStream(context.Context, *connect_go.Request[v15.VStreamRequest], *connect_go.ServerStream[v15.VStreamResponse]) error
	// Prepare is used by the MySQL server plugin as part of supporting prepared statements.
	Prepare(context.Context, *connect_go.Request[v15.PrepareRequest]) (*connect_go.Response[v15.PrepareResponse], error)
	// CloseSession closes the session, rolling back any implicit transactions.
	// This has the same effect as if a "rollback" statement was executed,
