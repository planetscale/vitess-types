...
package tabletmanagerservicev23connect
...
import (
	...
	v231 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerservice/v23"
	http "net/http"
	strings "strings"
)
...
type TabletManagerClient interface {
	...
	Ping(context.Context, *connect.Request[v23.PingRequest]) (*connect.Response[v23.PingResponse], error)
	// Sleep sleeps for the provided duration
	Sleep(context.Context, *connect.Request[v23.SleepRequest]) (*connect.Response[v23.SleepResponse], error)
	...
	GetGlobalStatusVars(context.Context, *connect.Request[v23.GetGlobalStatusVarsRequest]) (*connect.Response[v23.GetGlobalStatusVarsResponse], error)
	SetReadOnly(context.Context, *connect.Request[v23.SetReadOnlyRequest]) (*connect.Response[v23.SetReadOnlyResponse], error)
	SetReadWrite(context.Context, *connect.Request[v23.SetReadWriteRequest]) (*connect.Response[v23.SetReadWriteResponse], error)
	// ChangeTags asks the remote tablet to change its tags
	ChangeTags(context.Context, *connect.Request[v23.ChangeTagsRequest]) (*connect.Response[v23.ChangeTagsResponse], error)
	// ChangeType asks the remote tablet to change its type
	ChangeType(context.Context, *connect.Request[v23.ChangeTypeRequest]) (*connect.Response[v23.ChangeTypeResponse], error)
	...
	PreflightSchema(context.Context, *connect.Request[v23.PreflightSchemaRequest]) (*connect.Response[v23.PreflightSchemaResponse], error)
	ApplySchema(context.Context, *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v23.ApplySchemaResponse], error)
	ResetSequences(context.Context, *connect.Request[v23.ResetSequencesRequest]) (*connect.Response[v23.ResetSequencesResponse], error)
	LockTables(context.Context, *connect.Request[v23.LockTablesRequest]) (*connect.Response[v23.LockTablesResponse], error)
	UnlockTables(context.Context, *connect.Request[v23.UnlockTablesRequest]) (*connect.Response[v23.UnlockTablesResponse], error)
	ExecuteQuery(context.Context, *connect.Request[v23.ExecuteQueryRequest]) (*connect.Response[v23.ExecuteQueryResponse], error)
	...
	ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v23.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v23.ExecuteFetchAsAllPrivsResponse], error)
	...
	ReadTransaction(context.Context, *connect.Request[v23.ReadTransactionRequest]) (*connect.Response[v23.ReadTransactionResponse], error)
	...
	MysqlHostMetrics(context.Context, *connect.Request[v23.MysqlHostMetricsRequest]) (*connect.Response[v23.MysqlHostMetricsResponse], error)
	// ReplicationStatus returns the current replication status.
	ReplicationStatus(context.Context, *connect.Request[v23.ReplicationStatusRequest]) (*connect.Response[v23.ReplicationStatusResponse], error)
	// PrimaryStatus returns the current primary status.
	PrimaryStatus(context.Context, *connect.Request[v23.PrimaryStatusRequest]) (*connect.Response[v23.PrimaryStatusResponse], error)
	// PrimaryPosition returns the current primary position
	PrimaryPosition(context.Context, *connect.Request[v23.PrimaryPositionRequest]) (*connect.Response[v23.PrimaryPositionResponse], error)
	// WaitForPosition waits for the position to be reached
	WaitForPosition(context.Context, *connect.Request[v23.WaitForPositionRequest]) (*connect.Response[v23.WaitForPositionResponse], error)
	...
	StopReplicationMinimum(context.Context, *connect.Request[v23.StopReplicationMinimumRequest]) (*connect.Response[v23.StopReplicationMinimumResponse], error)
	...
	RestartReplication(context.Context, *connect.Request[v23.RestartReplicationRequest]) (*connect.Response[v23.RestartReplicationResponse], error)
	// StartReplicationUnitAfter starts the mysql replication until and including
	// the provided position
	StartReplicationUntilAfter(context.Context, *connect.Request[v23.StartReplicationUntilAfterRequest]) (*connect.Response[v23.StartReplicationUntilAfterResponse], error)
	// GetReplicas asks for the list of mysql replicas
	GetReplicas(context.Context, *connect.Request[v23.GetReplicasRequest]) (*connect.Response[v23.GetReplicasResponse], error)
	// VReplication API
	CreateVReplicationWorkflow(context.Context, *connect.Request[v23.CreateVReplicationWorkflowRequest]) (*connect.Response[v23.CreateVReplicationWorkflowResponse], error)
	DeleteTableData(context.Context, *connect.Request[v23.DeleteTableDataRequest]) (*connect.Response[v23.DeleteTableDataResponse], error)
	DeleteVReplicationWorkflow(context.Context, *connect.Request[v23.DeleteVReplicationWorkflowRequest]) (*connect.Response[v23.DeleteVReplicationWorkflowResponse], error)
	HasVReplicationWorkflows(context.Context, *connect.Request[v23.HasVReplicationWorkflowsRequest]) (*connect.Response[v23.HasVReplicationWorkflowsResponse], error)
	ReadVReplicationWorkflow(context.Context, *connect.Request[v23.ReadVReplicationWorkflowRequest]) (*connect.Response[v23.ReadVReplicationWorkflowResponse], error)
	ReadVReplicationWorkflows(context.Context, *connect.Request[v23.ReadVReplicationWorkflowsRequest]) (*connect.Response[v23.ReadVReplicationWorkflowsResponse], error)
	UpdateVReplicationWorkflow(context.Context, *connect.Request[v23.UpdateVReplicationWorkflowRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowResponse], error)
	UpdateVReplicationWorkflows(context.Context, *connect.Request[v23.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowsResponse], error)
	ValidateVReplicationPermissions(context.Context, *connect.Request[v23.ValidateVReplicationPermissionsRequest]) (*connect.Response[v23.ValidateVReplicationPermissionsResponse], error)
	VReplicationExec(context.Context, *connect.Request[v23.VReplicationExecRequest]) (*connect.Response[v23.VReplicationExecResponse], error)
	VReplicationWaitForPos(context.Context, *connect.Request[v23.VReplicationWaitForPosRequest]) (*connect.Response[v23.VReplicationWaitForPosResponse], error)
	UpdateSequenceTables(context.Context, *connect.Request[v23.UpdateSequenceTablesRequest]) (*connect.Response[v23.UpdateSequenceTablesResponse], error)
	GetMaxValueForSequences(context.Context, *connect.Request[v23.GetMaxValueForSequencesRequest]) (*connect.Response[v23.GetMaxValueForSequencesResponse], error)
	// VDiff API
	VDiff(context.Context, *connect.Request[v23.VDiffRequest]) (*connect.Response[v23.VDiffResponse], error)
	// ResetReplication makes the target not replicating
	ResetReplication(context.Context, *connect.Request[v23.ResetReplicationRequest]) (*connect.Response[v23.ResetReplicationResponse], error)
	// InitPrimary initializes the tablet as a primary
	InitPrimary(context.Context, *connect.Request[v23.InitPrimaryRequest]) (*connect.Response[v23.InitPrimaryResponse], error)
	// PopulateReparentJournal tells the tablet to add an entry to its
	// reparent journal
	PopulateReparentJournal(context.Context, *connect.Request[v23.PopulateReparentJournalRequest]) (*connect.Response[v23.PopulateReparentJournalResponse], error)
	// ReadReparentJournalInfo reads the information from reparent journal
	ReadReparentJournalInfo(context.Context, *connect.Request[v23.ReadReparentJournalInfoRequest]) (*connect.Response[v23.ReadReparentJournalInfoResponse], error)
	// InitReplica tells the tablet to reparent to the primary unconditionally
	InitReplica(context.Context, *connect.Request[v23.InitReplicaRequest]) (*connect.Response[v23.InitReplicaResponse], error)
	// DemotePrimary tells the soon-to-be-former primary it's gonna change
	DemotePrimary(context.Context, *connect.Request[v23.DemotePrimaryRequest]) (*connect.Response[v23.DemotePrimaryResponse], error)
	// UndoDemotePrimary reverts all changes made by DemotePrimary
	UndoDemotePrimary(context.Context, *connect.Request[v23.UndoDemotePrimaryRequest]) (*connect.Response[v23.UndoDemotePrimaryResponse], error)
	// ReplicaWasPromoted tells the remote tablet it is now the primary
	ReplicaWasPromoted(context.Context, *connect.Request[v23.ReplicaWasPromotedRequest]) (*connect.Response[v23.ReplicaWasPromotedResponse], error)
	// ResetReplicationParameters resets the replica replication parameters
	ResetReplicationParameters(context.Context, *connect.Request[v23.ResetReplicationParametersRequest]) (*connect.Response[v23.ResetReplicationParametersResponse], error)
	...
	FullStatus(context.Context, *connect.Request[v23.FullStatusRequest]) (*connect.Response[v23.FullStatusResponse], error)
	// SetReplicationSource tells the replica to reparent
	SetReplicationSource(context.Context, *connect.Request[v23.SetReplicationSourceRequest]) (*connect.Response[v23.SetReplicationSourceResponse], error)
	// ReplicaWasRestarted tells the remote tablet its primary has changed
	ReplicaWasRestarted(context.Context, *connect.Request[v23.ReplicaWasRestartedRequest]) (*connect.Response[v23.ReplicaWasRestartedResponse], error)
	// StopReplicationAndGetStatus stops MySQL replication, and returns the
	// replication status
	StopReplicationAndGetStatus(context.Context, *connect.Request[v23.StopReplicationAndGetStatusRequest]) (*connect.Response[v23.StopReplicationAndGetStatusResponse], error)
	// PromoteReplica makes the replica the new primary
	PromoteReplica(context.Context, *connect.Request[v23.PromoteReplicaRequest]) (*connect.Response[v23.PromoteReplicaResponse], error)
...
func NewTabletManagerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TabletManagerClient {
	...
	tabletManagerMethods := v231.File_vitess_tabletmanagerservice_v23_tabletmanagerservice_proto.Services().ByName("TabletManager").Methods()
	return &tabletManagerClient{
		ping: connect.NewClient[v23.PingRequest, v23.PingResponse](
			httpClient,
			baseURL+TabletManagerPingProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("Ping")),
			connect.WithClientOptions(opts...),
		),
		sleep: connect.NewClient[v23.SleepRequest, v23.SleepResponse](
			httpClient,
		...
		preflightSchema: connect.NewClient[v23.PreflightSchemaRequest, v23.PreflightSchemaResponse](
			httpClient,
		...
		resetSequences: connect.NewClient[v23.ResetSequencesRequest, v23.ResetSequencesResponse](
			httpClient,
			baseURL+TabletManagerResetSequencesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ResetSequences")),
			connect.WithClientOptions(opts...),
		),
		lockTables: connect.NewClient[v23.LockTablesRequest, v23.LockTablesResponse](
			httpClient,
			baseURL+TabletManagerLockTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("LockTables")),
			connect.WithClientOptions(opts...),
		),
		unlockTables: connect.NewClient[v23.UnlockTablesRequest, v23.UnlockTablesResponse](
			httpClient,
			baseURL+TabletManagerUnlockTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UnlockTables")),
			connect.WithClientOptions(opts...),
		),
		executeQuery: connect.NewClient[v23.ExecuteQueryRequest, v23.ExecuteQueryResponse](
			httpClient,
		...
		executeFetchAsAllPrivs: connect.NewClient[v23.ExecuteFetchAsAllPrivsRequest, v23.ExecuteFetchAsAllPrivsResponse](
			httpClient,
		...
		readTransaction: connect.NewClient[v23.ReadTransactionRequest, v23.ReadTransactionResponse](
			httpClient,
		...
		mysqlHostMetrics: connect.NewClient[v23.MysqlHostMetricsRequest, v23.MysqlHostMetricsResponse](
			httpClient,
			baseURL+TabletManagerMysqlHostMetricsProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("MysqlHostMetrics")),
			connect.WithClientOptions(opts...),
		),
		replicationStatus: connect.NewClient[v23.ReplicationStatusRequest, v23.ReplicationStatusResponse](
			httpClient,
			baseURL+TabletManagerReplicationStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicationStatus")),
			connect.WithClientOptions(opts...),
		),
		primaryStatus: connect.NewClient[v23.PrimaryStatusRequest, v23.PrimaryStatusResponse](
			httpClient,
			baseURL+TabletManagerPrimaryStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("PrimaryStatus")),
			connect.WithClientOptions(opts...),
		),
		primaryPosition: connect.NewClient[v23.PrimaryPositionRequest, v23.PrimaryPositionResponse](
			httpClient,
			baseURL+TabletManagerPrimaryPositionProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("PrimaryPosition")),
			connect.WithClientOptions(opts...),
		),
		waitForPosition: connect.NewClient[v23.WaitForPositionRequest, v23.WaitForPositionResponse](
			httpClient,
		...
		stopReplicationMinimum: connect.NewClient[v23.StopReplicationMinimumRequest, v23.StopReplicationMinimumResponse](
			httpClient,
		...
		restartReplication: connect.NewClient[v23.RestartReplicationRequest, v23.RestartReplicationResponse](
			httpClient,
			baseURL+TabletManagerRestartReplicationProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("RestartReplication")),
			connect.WithClientOptions(opts...),
		),
		startReplicationUntilAfter: connect.NewClient[v23.StartReplicationUntilAfterRequest, v23.StartReplicationUntilAfterResponse](
			httpClient,
		...
		getReplicas: connect.NewClient[v23.GetReplicasRequest, v23.GetReplicasResponse](
			httpClient,
			baseURL+TabletManagerGetReplicasProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("GetReplicas")),
			connect.WithClientOptions(opts...),
		),
		createVReplicationWorkflow: connect.NewClient[v23.CreateVReplicationWorkflowRequest, v23.CreateVReplicationWorkflowResponse](
			httpClient,
		...
		deleteTableData: connect.NewClient[v23.DeleteTableDataRequest, v23.DeleteTableDataResponse](
			httpClient,
			baseURL+TabletManagerDeleteTableDataProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("DeleteTableData")),
			connect.WithClientOptions(opts...),
		),
		deleteVReplicationWorkflow: connect.NewClient[v23.DeleteVReplicationWorkflowRequest, v23.DeleteVReplicationWorkflowResponse](
			httpClient,
		...
		hasVReplicationWorkflows: connect.NewClient[v23.HasVReplicationWorkflowsRequest, v23.HasVReplicationWorkflowsResponse](
			httpClient,
		...
		readVReplicationWorkflow: connect.NewClient[v23.ReadVReplicationWorkflowRequest, v23.ReadVReplicationWorkflowResponse](
			httpClient,
		...
		readVReplicationWorkflows: connect.NewClient[v23.ReadVReplicationWorkflowsRequest, v23.ReadVReplicationWorkflowsResponse](
			httpClient,
		...
		updateVReplicationWorkflow: connect.NewClient[v23.UpdateVReplicationWorkflowRequest, v23.UpdateVReplicationWorkflowResponse](
			httpClient,
		...
		updateVReplicationWorkflows: connect.NewClient[v23.UpdateVReplicationWorkflowsRequest, v23.UpdateVReplicationWorkflowsResponse](
			httpClient,
		...
		validateVReplicationPermissions: connect.NewClient[v23.ValidateVReplicationPermissionsRequest, v23.ValidateVReplicationPermissionsResponse](
			httpClient,
		...
		vReplicationExec: connect.NewClient[v23.VReplicationExecRequest, v23.VReplicationExecResponse](
			httpClient,
			baseURL+TabletManagerVReplicationExecProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("VReplicationExec")),
			connect.WithClientOptions(opts...),
		),
		vReplicationWaitForPos: connect.NewClient[v23.VReplicationWaitForPosRequest, v23.VReplicationWaitForPosResponse](
			httpClient,
		...
		updateSequenceTables: connect.NewClient[v23.UpdateSequenceTablesRequest, v23.UpdateSequenceTablesResponse](
			httpClient,
			baseURL+TabletManagerUpdateSequenceTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UpdateSequenceTables")),
			connect.WithClientOptions(opts...),
		),
		getMaxValueForSequences: connect.NewClient[v23.GetMaxValueForSequencesRequest, v23.GetMaxValueForSequencesResponse](
			httpClient,
		...
		vDiff: connect.NewClient[v23.VDiffRequest, v23.VDiffResponse](
			httpClient,
			baseURL+TabletManagerVDiffProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("VDiff")),
			connect.WithClientOptions(opts...),
		),
		resetReplication: connect.NewClient[v23.ResetReplicationRequest, v23.ResetReplicationResponse](
			httpClient,
			baseURL+TabletManagerResetReplicationProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ResetReplication")),
			connect.WithClientOptions(opts...),
		),
		initPrimary: connect.NewClient[v23.InitPrimaryRequest, v23.InitPrimaryResponse](
			httpClient,
			baseURL+TabletManagerInitPrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("InitPrimary")),
			connect.WithClientOptions(opts...),
		),
		populateReparentJournal: connect.NewClient[v23.PopulateReparentJournalRequest, v23.PopulateReparentJournalResponse](
			httpClient,
		...
		readReparentJournalInfo: connect.NewClient[v23.ReadReparentJournalInfoRequest, v23.ReadReparentJournalInfoResponse](
			httpClient,
		...
		initReplica: connect.NewClient[v23.InitReplicaRequest, v23.InitReplicaResponse](
			httpClient,
			baseURL+TabletManagerInitReplicaProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("InitReplica")),
			connect.WithClientOptions(opts...),
		),
		demotePrimary: connect.NewClient[v23.DemotePrimaryRequest, v23.DemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerDemotePrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("DemotePrimary")),
			connect.WithClientOptions(opts...),
		),
		undoDemotePrimary: connect.NewClient[v23.UndoDemotePrimaryRequest, v23.UndoDemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerUndoDemotePrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UndoDemotePrimary")),
			connect.WithClientOptions(opts...),
		),
		replicaWasPromoted: connect.NewClient[v23.ReplicaWasPromotedRequest, v23.ReplicaWasPromotedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasPromotedProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicaWasPromoted")),
			connect.WithClientOptions(opts...),
		),
		resetReplicationParameters: connect.NewClient[v23.ResetReplicationParametersRequest, v23.ResetReplicationParametersResponse](
			httpClient,
		...
		fullStatus: connect.NewClient[v23.FullStatusRequest, v23.FullStatusResponse](
			httpClient,
			baseURL+TabletManagerFullStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("FullStatus")),
			connect.WithClientOptions(opts...),
		),
		setReplicationSource: connect.NewClient[v23.SetReplicationSourceRequest, v23.SetReplicationSourceResponse](
			httpClient,
			baseURL+TabletManagerSetReplicationSourceProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("SetReplicationSource")),
			connect.WithClientOptions(opts...),
		),
		replicaWasRestarted: connect.NewClient[v23.ReplicaWasRestartedRequest, v23.ReplicaWasRestartedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasRestartedProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicaWasRestarted")),
			connect.WithClientOptions(opts...),
		),
		stopReplicationAndGetStatus: connect.NewClient[v23.StopReplicationAndGetStatusRequest, v23.StopReplicationAndGetStatusResponse](
			httpClient,
		...
		promoteReplica: connect.NewClient[v23.PromoteReplicaRequest, v23.PromoteReplicaResponse](
			httpClient,
...
type tabletManagerClient struct {
	ping                            *connect.Client[v23.PingRequest, v23.PingResponse]
	sleep                           *connect.Client[v23.SleepRequest, v23.SleepResponse]
	...
	getGlobalStatusVars             *connect.Client[v23.GetGlobalStatusVarsRequest, v23.GetGlobalStatusVarsResponse]
	setReadOnly                     *connect.Client[v23.SetReadOnlyRequest, v23.SetReadOnlyResponse]
	setReadWrite                    *connect.Client[v23.SetReadWriteRequest, v23.SetReadWriteResponse]
	changeTags                      *connect.Client[v23.ChangeTagsRequest, v23.ChangeTagsResponse]
	changeType                      *connect.Client[v23.ChangeTypeRequest, v23.ChangeTypeResponse]
	...
	preflightSchema                 *connect.Client[v23.PreflightSchemaRequest, v23.PreflightSchemaResponse]
	applySchema                     *connect.Client[v23.ApplySchemaRequest, v23.ApplySchemaResponse]
	resetSequences                  *connect.Client[v23.ResetSequencesRequest, v23.ResetSequencesResponse]
	lockTables                      *connect.Client[v23.LockTablesRequest, v23.LockTablesResponse]
	unlockTables                    *connect.Client[v23.UnlockTablesRequest, v23.UnlockTablesResponse]
	executeQuery                    *connect.Client[v23.ExecuteQueryRequest, v23.ExecuteQueryResponse]
	...
	executeFetchAsAllPrivs          *connect.Client[v23.ExecuteFetchAsAllPrivsRequest, v23.ExecuteFetchAsAllPrivsResponse]
	...
	readTransaction                 *connect.Client[v23.ReadTransactionRequest, v23.ReadTransactionResponse]
	...
	mysqlHostMetrics                *connect.Client[v23.MysqlHostMetricsRequest, v23.MysqlHostMetricsResponse]
	replicationStatus               *connect.Client[v23.ReplicationStatusRequest, v23.ReplicationStatusResponse]
	primaryStatus                   *connect.Client[v23.PrimaryStatusRequest, v23.PrimaryStatusResponse]
	primaryPosition                 *connect.Client[v23.PrimaryPositionRequest, v23.PrimaryPositionResponse]
	waitForPosition                 *connect.Client[v23.WaitForPositionRequest, v23.WaitForPositionResponse]
	stopReplication                 *connect.Client[v23.StopReplicationRequest, v23.StopReplicationResponse]
	stopReplicationMinimum          *connect.Client[v23.StopReplicationMinimumRequest, v23.StopReplicationMinimumResponse]
	startReplication                *connect.Client[v23.StartReplicationRequest, v23.StartReplicationResponse]
	restartReplication              *connect.Client[v23.RestartReplicationRequest, v23.RestartReplicationResponse]
	startReplicationUntilAfter      *connect.Client[v23.StartReplicationUntilAfterRequest, v23.StartReplicationUntilAfterResponse]
	getReplicas                     *connect.Client[v23.GetReplicasRequest, v23.GetReplicasResponse]
	createVReplicationWorkflow      *connect.Client[v23.CreateVReplicationWorkflowRequest, v23.CreateVReplicationWorkflowResponse]
	deleteTableData                 *connect.Client[v23.DeleteTableDataRequest, v23.DeleteTableDataResponse]
	deleteVReplicationWorkflow      *connect.Client[v23.DeleteVReplicationWorkflowRequest, v23.DeleteVReplicationWorkflowResponse]
	hasVReplicationWorkflows        *connect.Client[v23.HasVReplicationWorkflowsRequest, v23.HasVReplicationWorkflowsResponse]
	readVReplicationWorkflow        *connect.Client[v23.ReadVReplicationWorkflowRequest, v23.ReadVReplicationWorkflowResponse]
	readVReplicationWorkflows       *connect.Client[v23.ReadVReplicationWorkflowsRequest, v23.ReadVReplicationWorkflowsResponse]
	updateVReplicationWorkflow      *connect.Client[v23.UpdateVReplicationWorkflowRequest, v23.UpdateVReplicationWorkflowResponse]
	updateVReplicationWorkflows     *connect.Client[v23.UpdateVReplicationWorkflowsRequest, v23.UpdateVReplicationWorkflowsResponse]
	validateVReplicationPermissions *connect.Client[v23.ValidateVReplicationPermissionsRequest, v23.ValidateVReplicationPermissionsResponse]
	vReplicationExec                *connect.Client[v23.VReplicationExecRequest, v23.VReplicationExecResponse]
	vReplicationWaitForPos          *connect.Client[v23.VReplicationWaitForPosRequest, v23.VReplicationWaitForPosResponse]
	updateSequenceTables            *connect.Client[v23.UpdateSequenceTablesRequest, v23.UpdateSequenceTablesResponse]
	getMaxValueForSequences         *connect.Client[v23.GetMaxValueForSequencesRequest, v23.GetMaxValueForSequencesResponse]
	vDiff                           *connect.Client[v23.VDiffRequest, v23.VDiffResponse]
	resetReplication                *connect.Client[v23.ResetReplicationRequest, v23.ResetReplicationResponse]
	initPrimary                     *connect.Client[v23.InitPrimaryRequest, v23.InitPrimaryResponse]
	populateReparentJournal         *connect.Client[v23.PopulateReparentJournalRequest, v23.PopulateReparentJournalResponse]
	readReparentJournalInfo         *connect.Client[v23.ReadReparentJournalInfoRequest, v23.ReadReparentJournalInfoResponse]
	initReplica                     *connect.Client[v23.InitReplicaRequest, v23.InitReplicaResponse]
	demotePrimary                   *connect.Client[v23.DemotePrimaryRequest, v23.DemotePrimaryResponse]
	undoDemotePrimary               *connect.Client[v23.UndoDemotePrimaryRequest, v23.UndoDemotePrimaryResponse]
	replicaWasPromoted              *connect.Client[v23.ReplicaWasPromotedRequest, v23.ReplicaWasPromotedResponse]
	resetReplicationParameters      *connect.Client[v23.ResetReplicationParametersRequest, v23.ResetReplicationParametersResponse]
	fullStatus                      *connect.Client[v23.FullStatusRequest, v23.FullStatusResponse]
	setReplicationSource            *connect.Client[v23.SetReplicationSourceRequest, v23.SetReplicationSourceResponse]
	replicaWasRestarted             *connect.Client[v23.ReplicaWasRestartedRequest, v23.ReplicaWasRestartedResponse]
	stopReplicationAndGetStatus     *connect.Client[v23.StopReplicationAndGetStatusRequest, v23.StopReplicationAndGetStatusResponse]
	promoteReplica                  *connect.Client[v23.PromoteReplicaRequest, v23.PromoteReplicaResponse]
...
func (c *tabletManagerClient) Ping(ctx context.Context, req *connect.Request[v23.PingRequest]) (*connect.Response[v23.PingResponse], error) {
	return c.ping.CallUnary(ctx, req)
}

// Sleep calls tabletmanagerservice.TabletManager.Sleep.
func (c *tabletManagerClient) Sleep(ctx context.Context, req *connect.Request[v23.SleepRequest]) (*connect.Response[v23.SleepResponse], error) {
	return c.sleep.CallUnary(ctx, req)
}

// ExecuteHook calls tabletmanagerservice.TabletManager.ExecuteHook.
func (c *tabletManagerClient) ExecuteHook(ctx context.Context, req *connect.Request[v23.ExecuteHookRequest]) (*connect.Response[v23.ExecuteHookResponse], error) {
	return c.executeHook.CallUnary(ctx, req)
}

// GetSchema calls tabletmanagerservice.TabletManager.GetSchema.
func (c *tabletManagerClient) GetSchema(ctx context.Context, req *connect.Request[v23.GetSchemaRequest]) (*connect.Response[v23.GetSchemaResponse], error) {
	return c.getSchema.CallUnary(ctx, req)
}

// GetPermissions calls tabletmanagerservice.TabletManager.GetPermissions.
func (c *tabletManagerClient) GetPermissions(ctx context.Context, req *connect.Request[v23.GetPermissionsRequest]) (*connect.Response[v23.GetPermissionsResponse], error) {
...
func (c *tabletManagerClient) GetGlobalStatusVars(ctx context.Context, req *connect.Request[v23.GetGlobalStatusVarsRequest]) (*connect.Response[v23.GetGlobalStatusVarsResponse], error) {
	return c.getGlobalStatusVars.CallUnary(ctx, req)
}

// SetReadOnly calls tabletmanagerservice.TabletManager.SetReadOnly.
func (c *tabletManagerClient) SetReadOnly(ctx context.Context, req *connect.Request[v23.SetReadOnlyRequest]) (*connect.Response[v23.SetReadOnlyResponse], error) {
	return c.setReadOnly.CallUnary(ctx, req)
}

// SetReadWrite calls tabletmanagerservice.TabletManager.SetReadWrite.
func (c *tabletManagerClient) SetReadWrite(ctx context.Context, req *connect.Request[v23.SetReadWriteRequest]) (*connect.Response[v23.SetReadWriteResponse], error) {
	return c.setReadWrite.CallUnary(ctx, req)
}

// ChangeTags calls tabletmanagerservice.TabletManager.ChangeTags.
func (c *tabletManagerClient) ChangeTags(ctx context.Context, req *connect.Request[v23.ChangeTagsRequest]) (*connect.Response[v23.ChangeTagsResponse], error) {
	return c.changeTags.CallUnary(ctx, req)
}

// ChangeType calls tabletmanagerservice.TabletManager.ChangeType.
func (c *tabletManagerClient) ChangeType(ctx context.Context, req *connect.Request[v23.ChangeTypeRequest]) (*connect.Response[v23.ChangeTypeResponse], error) {
	return c.changeType.CallUnary(ctx, req)
}

// RefreshState calls tabletmanagerservice.TabletManager.RefreshState.
func (c *tabletManagerClient) RefreshState(ctx context.Context, req *connect.Request[v23.RefreshStateRequest]) (*connect.Response[v23.RefreshStateResponse], error) {
	return c.refreshState.CallUnary(ctx, req)
}

// RunHealthCheck calls tabletmanagerservice.TabletManager.RunHealthCheck.
func (c *tabletManagerClient) RunHealthCheck(ctx context.Context, req *connect.Request[v23.RunHealthCheckRequest]) (*connect.Response[v23.RunHealthCheckResponse], error) {
	return c.runHealthCheck.CallUnary(ctx, req)
}

// ReloadSchema calls tabletmanagerservice.TabletManager.ReloadSchema.
func (c *tabletManagerClient) ReloadSchema(ctx context.Context, req *connect.Request[v23.ReloadSchemaRequest]) (*connect.Response[v23.ReloadSchemaResponse], error) {
	return c.reloadSchema.CallUnary(ctx, req)
}

// PreflightSchema calls tabletmanagerservice.TabletManager.PreflightSchema.
func (c *tabletManagerClient) PreflightSchema(ctx context.Context, req *connect.Request[v23.PreflightSchemaRequest]) (*connect.Response[v23.PreflightSchemaResponse], error) {
	return c.preflightSchema.CallUnary(ctx, req)
}

// ApplySchema calls tabletmanagerservice.TabletManager.ApplySchema.
func (c *tabletManagerClient) ApplySchema(ctx context.Context, req *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v23.ApplySchemaResponse], error) {
	return c.applySchema.CallUnary(ctx, req)
}

// ResetSequences calls tabletmanagerservice.TabletManager.ResetSequences.
func (c *tabletManagerClient) ResetSequences(ctx context.Context, req *connect.Request[v23.ResetSequencesRequest]) (*connect.Response[v23.ResetSequencesResponse], error) {
	return c.resetSequences.CallUnary(ctx, req)
}

// LockTables calls tabletmanagerservice.TabletManager.LockTables.
func (c *tabletManagerClient) LockTables(ctx context.Context, req *connect.Request[v23.LockTablesRequest]) (*connect.Response[v23.LockTablesResponse], error) {
	return c.lockTables.CallUnary(ctx, req)
}

// UnlockTables calls tabletmanagerservice.TabletManager.UnlockTables.
func (c *tabletManagerClient) UnlockTables(ctx context.Context, req *connect.Request[v23.UnlockTablesRequest]) (*connect.Response[v23.UnlockTablesResponse], error) {
	return c.unlockTables.CallUnary(ctx, req)
}

// ExecuteQuery calls tabletmanagerservice.TabletManager.ExecuteQuery.
func (c *tabletManagerClient) ExecuteQuery(ctx context.Context, req *connect.Request[v23.ExecuteQueryRequest]) (*connect.Response[v23.ExecuteQueryResponse], error) {
	return c.executeQuery.CallUnary(ctx, req)
}

// ExecuteFetchAsDba calls tabletmanagerservice.TabletManager.ExecuteFetchAsDba.
func (c *tabletManagerClient) ExecuteFetchAsDba(ctx context.Context, req *connect.Request[v23.ExecuteFetchAsDbaRequest]) (*connect.Response[v23.ExecuteFetchAsDbaResponse], error) {
...
func (c *tabletManagerClient) ExecuteMultiFetchAsDba(ctx context.Context, req *connect.Request[v23.ExecuteMultiFetchAsDbaRequest]) (*connect.Response[v23.ExecuteMultiFetchAsDbaResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsAllPrivs(ctx context.Context, req *connect.Request[v23.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v23.ExecuteFetchAsAllPrivsResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsApp(ctx context.Context, req *connect.Request[v23.ExecuteFetchAsAppRequest]) (*connect.Response[v23.ExecuteFetchAsAppResponse], error) {
...
func (c *tabletManagerClient) GetUnresolvedTransactions(ctx context.Context, req *connect.Request[v23.GetUnresolvedTransactionsRequest]) (*connect.Response[v23.GetUnresolvedTransactionsResponse], error) {
...
func (c *tabletManagerClient) ReadTransaction(ctx context.Context, req *connect.Request[v23.ReadTransactionRequest]) (*connect.Response[v23.ReadTransactionResponse], error) {
	return c.readTransaction.CallUnary(ctx, req)
}

// GetTransactionInfo calls tabletmanagerservice.TabletManager.GetTransactionInfo.
func (c *tabletManagerClient) GetTransactionInfo(ctx context.Context, req *connect.Request[v23.GetTransactionInfoRequest]) (*connect.Response[v23.GetTransactionInfoResponse], error) {
...
func (c *tabletManagerClient) ConcludeTransaction(ctx context.Context, req *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v23.ConcludeTransactionResponse], error) {
	return c.concludeTransaction.CallUnary(ctx, req)
}

// MysqlHostMetrics calls tabletmanagerservice.TabletManager.MysqlHostMetrics.
func (c *tabletManagerClient) MysqlHostMetrics(ctx context.Context, req *connect.Request[v23.MysqlHostMetricsRequest]) (*connect.Response[v23.MysqlHostMetricsResponse], error) {
	return c.mysqlHostMetrics.CallUnary(ctx, req)
}

// ReplicationStatus calls tabletmanagerservice.TabletManager.ReplicationStatus.
func (c *tabletManagerClient) ReplicationStatus(ctx context.Context, req *connect.Request[v23.ReplicationStatusRequest]) (*connect.Response[v23.ReplicationStatusResponse], error) {
	return c.replicationStatus.CallUnary(ctx, req)
}

// PrimaryStatus calls tabletmanagerservice.TabletManager.PrimaryStatus.
func (c *tabletManagerClient) PrimaryStatus(ctx context.Context, req *connect.Request[v23.PrimaryStatusRequest]) (*connect.Response[v23.PrimaryStatusResponse], error) {
	return c.primaryStatus.CallUnary(ctx, req)
}

// PrimaryPosition calls tabletmanagerservice.TabletManager.PrimaryPosition.
func (c *tabletManagerClient) PrimaryPosition(ctx context.Context, req *connect.Request[v23.PrimaryPositionRequest]) (*connect.Response[v23.PrimaryPositionResponse], error) {
	return c.primaryPosition.CallUnary(ctx, req)
}

// WaitForPosition calls tabletmanagerservice.TabletManager.WaitForPosition.
func (c *tabletManagerClient) WaitForPosition(ctx context.Context, req *connect.Request[v23.WaitForPositionRequest]) (*connect.Response[v23.WaitForPositionResponse], error) {
	return c.waitForPosition.CallUnary(ctx, req)
}

// StopReplication calls tabletmanagerservice.TabletManager.StopReplication.
func (c *tabletManagerClient) StopReplication(ctx context.Context, req *connect.Request[v23.StopReplicationRequest]) (*connect.Response[v23.StopReplicationResponse], error) {
...
func (c *tabletManagerClient) StopReplicationMinimum(ctx context.Context, req *connect.Request[v23.StopReplicationMinimumRequest]) (*connect.Response[v23.StopReplicationMinimumResponse], error) {
...
func (c *tabletManagerClient) StartReplication(ctx context.Context, req *connect.Request[v23.StartReplicationRequest]) (*connect.Response[v23.StartReplicationResponse], error) {
...
func (c *tabletManagerClient) RestartReplication(ctx context.Context, req *connect.Request[v23.RestartReplicationRequest]) (*connect.Response[v23.RestartReplicationResponse], error) {
...
func (c *tabletManagerClient) StartReplicationUntilAfter(ctx context.Context, req *connect.Request[v23.StartReplicationUntilAfterRequest]) (*connect.Response[v23.StartReplicationUntilAfterResponse], error) {
	return c.startReplicationUntilAfter.CallUnary(ctx, req)
}

// GetReplicas calls tabletmanagerservice.TabletManager.GetReplicas.
func (c *tabletManagerClient) GetReplicas(ctx context.Context, req *connect.Request[v23.GetReplicasRequest]) (*connect.Response[v23.GetReplicasResponse], error) {
...
func (c *tabletManagerClient) CreateVReplicationWorkflow(ctx context.Context, req *connect.Request[v23.CreateVReplicationWorkflowRequest]) (*connect.Response[v23.CreateVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) DeleteTableData(ctx context.Context, req *connect.Request[v23.DeleteTableDataRequest]) (*connect.Response[v23.DeleteTableDataResponse], error) {
...
func (c *tabletManagerClient) DeleteVReplicationWorkflow(ctx context.Context, req *connect.Request[v23.DeleteVReplicationWorkflowRequest]) (*connect.Response[v23.DeleteVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) HasVReplicationWorkflows(ctx context.Context, req *connect.Request[v23.HasVReplicationWorkflowsRequest]) (*connect.Response[v23.HasVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) ReadVReplicationWorkflow(ctx context.Context, req *connect.Request[v23.ReadVReplicationWorkflowRequest]) (*connect.Response[v23.ReadVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) ReadVReplicationWorkflows(ctx context.Context, req *connect.Request[v23.ReadVReplicationWorkflowsRequest]) (*connect.Response[v23.ReadVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) UpdateVReplicationWorkflow(ctx context.Context, req *connect.Request[v23.UpdateVReplicationWorkflowRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) UpdateVReplicationWorkflows(ctx context.Context, req *connect.Request[v23.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) ValidateVReplicationPermissions(ctx context.Context, req *connect.Request[v23.ValidateVReplicationPermissionsRequest]) (*connect.Response[v23.ValidateVReplicationPermissionsResponse], error) {
...
func (c *tabletManagerClient) VReplicationExec(ctx context.Context, req *connect.Request[v23.VReplicationExecRequest]) (*connect.Response[v23.VReplicationExecResponse], error) {
...
func (c *tabletManagerClient) VReplicationWaitForPos(ctx context.Context, req *connect.Request[v23.VReplicationWaitForPosRequest]) (*connect.Response[v23.VReplicationWaitForPosResponse], error) {
...
func (c *tabletManagerClient) UpdateSequenceTables(ctx context.Context, req *connect.Request[v23.UpdateSequenceTablesRequest]) (*connect.Response[v23.UpdateSequenceTablesResponse], error) {
...
func (c *tabletManagerClient) GetMaxValueForSequences(ctx context.Context, req *connect.Request[v23.GetMaxValueForSequencesRequest]) (*connect.Response[v23.GetMaxValueForSequencesResponse], error) {
	return c.getMaxValueForSequences.CallUnary(ctx, req)
}

// VDiff calls tabletmanagerservice.TabletManager.VDiff.
func (c *tabletManagerClient) VDiff(ctx context.Context, req *connect.Request[v23.VDiffRequest]) (*connect.Response[v23.VDiffResponse], error) {
	return c.vDiff.CallUnary(ctx, req)
}

// ResetReplication calls tabletmanagerservice.TabletManager.ResetReplication.
func (c *tabletManagerClient) ResetReplication(ctx context.Context, req *connect.Request[v23.ResetReplicationRequest]) (*connect.Response[v23.ResetReplicationResponse], error) {
	return c.resetReplication.CallUnary(ctx, req)
}

// InitPrimary calls tabletmanagerservice.TabletManager.InitPrimary.
func (c *tabletManagerClient) InitPrimary(ctx context.Context, req *connect.Request[v23.InitPrimaryRequest]) (*connect.Response[v23.InitPrimaryResponse], error) {
...
func (c *tabletManagerClient) PopulateReparentJournal(ctx context.Context, req *connect.Request[v23.PopulateReparentJournalRequest]) (*connect.Response[v23.PopulateReparentJournalResponse], error) {
...
func (c *tabletManagerClient) ReadReparentJournalInfo(ctx context.Context, req *connect.Request[v23.ReadReparentJournalInfoRequest]) (*connect.Response[v23.ReadReparentJournalInfoResponse], error) {
	return c.readReparentJournalInfo.CallUnary(ctx, req)
}

// InitReplica calls tabletmanagerservice.TabletManager.InitReplica.
func (c *tabletManagerClient) InitReplica(ctx context.Context, req *connect.Request[v23.InitReplicaRequest]) (*connect.Response[v23.InitReplicaResponse], error) {
	return c.initReplica.CallUnary(ctx, req)
}

// DemotePrimary calls tabletmanagerservice.TabletManager.DemotePrimary.
func (c *tabletManagerClient) DemotePrimary(ctx context.Context, req *connect.Request[v23.DemotePrimaryRequest]) (*connect.Response[v23.DemotePrimaryResponse], error) {
	return c.demotePrimary.CallUnary(ctx, req)
}

// UndoDemotePrimary calls tabletmanagerservice.TabletManager.UndoDemotePrimary.
func (c *tabletManagerClient) UndoDemotePrimary(ctx context.Context, req *connect.Request[v23.UndoDemotePrimaryRequest]) (*connect.Response[v23.UndoDemotePrimaryResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasPromoted(ctx context.Context, req *connect.Request[v23.ReplicaWasPromotedRequest]) (*connect.Response[v23.ReplicaWasPromotedResponse], error) {
...
func (c *tabletManagerClient) ResetReplicationParameters(ctx context.Context, req *connect.Request[v23.ResetReplicationParametersRequest]) (*connect.Response[v23.ResetReplicationParametersResponse], error) {
	return c.resetReplicationParameters.CallUnary(ctx, req)
}

// FullStatus calls tabletmanagerservice.TabletManager.FullStatus.
func (c *tabletManagerClient) FullStatus(ctx context.Context, req *connect.Request[v23.FullStatusRequest]) (*connect.Response[v23.FullStatusResponse], error) {
	return c.fullStatus.CallUnary(ctx, req)
}

// SetReplicationSource calls tabletmanagerservice.TabletManager.SetReplicationSource.
func (c *tabletManagerClient) SetReplicationSource(ctx context.Context, req *connect.Request[v23.SetReplicationSourceRequest]) (*connect.Response[v23.SetReplicationSourceResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasRestarted(ctx context.Context, req *connect.Request[v23.ReplicaWasRestartedRequest]) (*connect.Response[v23.ReplicaWasRestartedResponse], error) {
...
func (c *tabletManagerClient) StopReplicationAndGetStatus(ctx context.Context, req *connect.Request[v23.StopReplicationAndGetStatusRequest]) (*connect.Response[v23.StopReplicationAndGetStatusResponse], error) {
...
func (c *tabletManagerClient) PromoteReplica(ctx context.Context, req *connect.Request[v23.PromoteReplicaRequest]) (*connect.Response[v23.PromoteReplicaResponse], error) {
	return c.promoteReplica.CallUnary(ctx, req)
}

// Backup calls tabletmanagerservice.TabletManager.Backup.
func (c *tabletManagerClient) Backup(ctx context.Context, req *connect.Request[v23.BackupRequest]) (*connect.ServerStreamForClient[v23.BackupResponse], error) {
	return c.backup.CallServerStream(ctx, req)
}

// RestoreFromBackup calls tabletmanagerservice.TabletManager.RestoreFromBackup.
func (c *tabletManagerClient) RestoreFromBackup(ctx context.Context, req *connect.Request[v23.RestoreFromBackupRequest]) (*connect.ServerStreamForClient[v23.RestoreFromBackupResponse], error) {
...
func (c *tabletManagerClient) CheckThrottler(ctx context.Context, req *connect.Request[v23.CheckThrottlerRequest]) (*connect.Response[v23.CheckThrottlerResponse], error) {
	return c.checkThrottler.CallUnary(ctx, req)
}

// GetThrottlerStatus calls tabletmanagerservice.TabletManager.GetThrottlerStatus.
func (c *tabletManagerClient) GetThrottlerStatus(ctx context.Context, req *connect.Request[v23.GetThrottlerStatusRequest]) (*connect.Response[v23.GetThrottlerStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) Ping(context.Context, *connect.Request[v23.PingRequest]) (*connect.Response[v23.PingResponse], error) {
...
func (UnimplementedTabletManagerHandler) Sleep(context.Context, *connect.Request[v23.SleepRequest]) (*connect.Response[v23.SleepResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteHook(context.Context, *connect.Request[v23.ExecuteHookRequest]) (*connect.Response[v23.ExecuteHookResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest]) (*connect.Response[v23.GetSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetPermissions(context.Context, *connect.Request[v23.GetPermissionsRequest]) (*connect.Response[v23.GetPermissionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetGlobalStatusVars(context.Context, *connect.Request[v23.GetGlobalStatusVarsRequest]) (*connect.Response[v23.GetGlobalStatusVarsResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadOnly(context.Context, *connect.Request[v23.SetReadOnlyRequest]) (*connect.Response[v23.SetReadOnlyResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadWrite(context.Context, *connect.Request[v23.SetReadWriteRequest]) (*connect.Response[v23.SetReadWriteResponse], error) {
...
func (UnimplementedTabletManagerHandler) ChangeTags(context.Context, *connect.Request[v23.ChangeTagsRequest]) (*connect.Response[v23.ChangeTagsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ChangeType(context.Context, *connect.Request[v23.ChangeTypeRequest]) (*connect.Response[v23.ChangeTypeResponse], error) {
...
func (UnimplementedTabletManagerHandler) RefreshState(context.Context, *connect.Request[v23.RefreshStateRequest]) (*connect.Response[v23.RefreshStateResponse], error) {
...
func (UnimplementedTabletManagerHandler) RunHealthCheck(context.Context, *connect.Request[v23.RunHealthCheckRequest]) (*connect.Response[v23.RunHealthCheckResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReloadSchema(context.Context, *connect.Request[v23.ReloadSchemaRequest]) (*connect.Response[v23.ReloadSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) PreflightSchema(context.Context, *connect.Request[v23.PreflightSchemaRequest]) (*connect.Response[v23.PreflightSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ApplySchema(context.Context, *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v23.ApplySchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetSequences(context.Context, *connect.Request[v23.ResetSequencesRequest]) (*connect.Response[v23.ResetSequencesResponse], error) {
...
func (UnimplementedTabletManagerHandler) LockTables(context.Context, *connect.Request[v23.LockTablesRequest]) (*connect.Response[v23.LockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) UnlockTables(context.Context, *connect.Request[v23.UnlockTablesRequest]) (*connect.Response[v23.UnlockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteQuery(context.Context, *connect.Request[v23.ExecuteQueryRequest]) (*connect.Response[v23.ExecuteQueryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsDba(context.Context, *connect.Request[v23.ExecuteFetchAsDbaRequest]) (*connect.Response[v23.ExecuteFetchAsDbaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteMultiFetchAsDba(context.Context, *connect.Request[v23.ExecuteMultiFetchAsDbaRequest]) (*connect.Response[v23.ExecuteMultiFetchAsDbaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v23.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v23.ExecuteFetchAsAllPrivsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsApp(context.Context, *connect.Request[v23.ExecuteFetchAsAppRequest]) (*connect.Response[v23.ExecuteFetchAsAppResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetUnresolvedTransactions(context.Context, *connect.Request[v23.GetUnresolvedTransactionsRequest]) (*connect.Response[v23.GetUnresolvedTransactionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadTransaction(context.Context, *connect.Request[v23.ReadTransactionRequest]) (*connect.Response[v23.ReadTransactionResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetTransactionInfo(context.Context, *connect.Request[v23.GetTransactionInfoRequest]) (*connect.Response[v23.GetTransactionInfoResponse], error) {
...
func (UnimplementedTabletManagerHandler) ConcludeTransaction(context.Context, *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v23.ConcludeTransactionResponse], error) {
...
func (UnimplementedTabletManagerHandler) MysqlHostMetrics(context.Context, *connect.Request[v23.MysqlHostMetricsRequest]) (*connect.Response[v23.MysqlHostMetricsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicationStatus(context.Context, *connect.Request[v23.ReplicationStatusRequest]) (*connect.Response[v23.ReplicationStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryStatus(context.Context, *connect.Request[v23.PrimaryStatusRequest]) (*connect.Response[v23.PrimaryStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryPosition(context.Context, *connect.Request[v23.PrimaryPositionRequest]) (*connect.Response[v23.PrimaryPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) WaitForPosition(context.Context, *connect.Request[v23.WaitForPositionRequest]) (*connect.Response[v23.WaitForPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplication(context.Context, *connect.Request[v23.StopReplicationRequest]) (*connect.Response[v23.StopReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationMinimum(context.Context, *connect.Request[v23.StopReplicationMinimumRequest]) (*connect.Response[v23.StopReplicationMinimumResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplication(context.Context, *connect.Request[v23.StartReplicationRequest]) (*connect.Response[v23.StartReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) RestartReplication(context.Context, *connect.Request[v23.RestartReplicationRequest]) (*connect.Response[v23.RestartReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplicationUntilAfter(context.Context, *connect.Request[v23.StartReplicationUntilAfterRequest]) (*connect.Response[v23.StartReplicationUntilAfterResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetReplicas(context.Context, *connect.Request[v23.GetReplicasRequest]) (*connect.Response[v23.GetReplicasResponse], error) {
...
func (UnimplementedTabletManagerHandler) CreateVReplicationWorkflow(context.Context, *connect.Request[v23.CreateVReplicationWorkflowRequest]) (*connect.Response[v23.CreateVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) DeleteTableData(context.Context, *connect.Request[v23.DeleteTableDataRequest]) (*connect.Response[v23.DeleteTableDataResponse], error) {
...
func (UnimplementedTabletManagerHandler) DeleteVReplicationWorkflow(context.Context, *connect.Request[v23.DeleteVReplicationWorkflowRequest]) (*connect.Response[v23.DeleteVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) HasVReplicationWorkflows(context.Context, *connect.Request[v23.HasVReplicationWorkflowsRequest]) (*connect.Response[v23.HasVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadVReplicationWorkflow(context.Context, *connect.Request[v23.ReadVReplicationWorkflowRequest]) (*connect.Response[v23.ReadVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadVReplicationWorkflows(context.Context, *connect.Request[v23.ReadVReplicationWorkflowsRequest]) (*connect.Response[v23.ReadVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateVReplicationWorkflow(context.Context, *connect.Request[v23.UpdateVReplicationWorkflowRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateVReplicationWorkflows(context.Context, *connect.Request[v23.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v23.UpdateVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ValidateVReplicationPermissions(context.Context, *connect.Request[v23.ValidateVReplicationPermissionsRequest]) (*connect.Response[v23.ValidateVReplicationPermissionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationExec(context.Context, *connect.Request[v23.VReplicationExecRequest]) (*connect.Response[v23.VReplicationExecResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationWaitForPos(context.Context, *connect.Request[v23.VReplicationWaitForPosRequest]) (*connect.Response[v23.VReplicationWaitForPosResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateSequenceTables(context.Context, *connect.Request[v23.UpdateSequenceTablesRequest]) (*connect.Response[v23.UpdateSequenceTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetMaxValueForSequences(context.Context, *connect.Request[v23.GetMaxValueForSequencesRequest]) (*connect.Response[v23.GetMaxValueForSequencesResponse], error) {
...
func (UnimplementedTabletManagerHandler) VDiff(context.Context, *connect.Request[v23.VDiffRequest]) (*connect.Response[v23.VDiffResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplication(context.Context, *connect.Request[v23.ResetReplicationRequest]) (*connect.Response[v23.ResetReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitPrimary(context.Context, *connect.Request[v23.InitPrimaryRequest]) (*connect.Response[v23.InitPrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) PopulateReparentJournal(context.Context, *connect.Request[v23.PopulateReparentJournalRequest]) (*connect.Response[v23.PopulateReparentJournalResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadReparentJournalInfo(context.Context, *connect.Request[v23.ReadReparentJournalInfoRequest]) (*connect.Response[v23.ReadReparentJournalInfoResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitReplica(context.Context, *connect.Request[v23.InitReplicaRequest]) (*connect.Response[v23.InitReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) DemotePrimary(context.Context, *connect.Request[v23.DemotePrimaryRequest]) (*connect.Response[v23.DemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) UndoDemotePrimary(context.Context, *connect.Request[v23.UndoDemotePrimaryRequest]) (*connect.Response[v23.UndoDemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasPromoted(context.Context, *connect.Request[v23.ReplicaWasPromotedRequest]) (*connect.Response[v23.ReplicaWasPromotedResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplicationParameters(context.Context, *connect.Request[v23.ResetReplicationParametersRequest]) (*connect.Response[v23.ResetReplicationParametersResponse], error) {
...
func (UnimplementedTabletManagerHandler) FullStatus(context.Context, *connect.Request[v23.FullStatusRequest]) (*connect.Response[v23.FullStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReplicationSource(context.Context, *connect.Request[v23.SetReplicationSourceRequest]) (*connect.Response[v23.SetReplicationSourceResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasRestarted(context.Context, *connect.Request[v23.ReplicaWasRestartedRequest]) (*connect.Response[v23.ReplicaWasRestartedResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationAndGetStatus(context.Context, *connect.Request[v23.StopReplicationAndGetStatusRequest]) (*connect.Response[v23.StopReplicationAndGetStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PromoteReplica(context.Context, *connect.Request[v23.PromoteReplicaRequest]) (*connect.Response[v23.PromoteReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) Backup(context.Context, *connect.Request[v23.BackupRequest], *connect.ServerStream[v23.BackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) RestoreFromBackup(context.Context, *connect.Request[v23.RestoreFromBackupRequest], *connect.ServerStream[v23.RestoreFromBackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) CheckThrottler(context.Context, *connect.Request[v23.CheckThrottlerRequest]) (*connect.Response[v23.CheckThrottlerResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetThrottlerStatus(context.Context, *connect.Request[v23.GetThrottlerStatusRequest]) (*connect.Response[v23.GetThrottlerStatusResponse], error) {
