...
package tabletmanagerservicev24connect
...
import (
	...
	v241 "github.com/planetscale/vitess-types/gen/vitess/tabletmanagerservice/v24"
	http "net/http"
	strings "strings"
)
...
type TabletManagerClient interface {
	...
	Ping(context.Context, *connect.Request[v24.PingRequest]) (*connect.Response[v24.PingResponse], error)
	// Sleep sleeps for the provided duration
	Sleep(context.Context, *connect.Request[v24.SleepRequest]) (*connect.Response[v24.SleepResponse], error)
	...
	GetGlobalStatusVars(context.Context, *connect.Request[v24.GetGlobalStatusVarsRequest]) (*connect.Response[v24.GetGlobalStatusVarsResponse], error)
	SetReadOnly(context.Context, *connect.Request[v24.SetReadOnlyRequest]) (*connect.Response[v24.SetReadOnlyResponse], error)
	SetReadWrite(context.Context, *connect.Request[v24.SetReadWriteRequest]) (*connect.Response[v24.SetReadWriteResponse], error)
	// ChangeTags asks the remote tablet to change its tags
	ChangeTags(context.Context, *connect.Request[v24.ChangeTagsRequest]) (*connect.Response[v24.ChangeTagsResponse], error)
	// ChangeType asks the remote tablet to change its type
	ChangeType(context.Context, *connect.Request[v24.ChangeTypeRequest]) (*connect.Response[v24.ChangeTypeResponse], error)
	...
	PreflightSchema(context.Context, *connect.Request[v24.PreflightSchemaRequest]) (*connect.Response[v24.PreflightSchemaResponse], error)
	ApplySchema(context.Context, *connect.Request[v24.ApplySchemaRequest]) (*connect.Response[v24.ApplySchemaResponse], error)
	ResetSequences(context.Context, *connect.Request[v24.ResetSequencesRequest]) (*connect.Response[v24.ResetSequencesResponse], error)
	LockTables(context.Context, *connect.Request[v24.LockTablesRequest]) (*connect.Response[v24.LockTablesResponse], error)
	UnlockTables(context.Context, *connect.Request[v24.UnlockTablesRequest]) (*connect.Response[v24.UnlockTablesResponse], error)
	ExecuteQuery(context.Context, *connect.Request[v24.ExecuteQueryRequest]) (*connect.Response[v24.ExecuteQueryResponse], error)
	...
	ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v24.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v24.ExecuteFetchAsAllPrivsResponse], error)
	...
	MysqlHostMetrics(context.Context, *connect.Request[v24.MysqlHostMetricsRequest]) (*connect.Response[v24.MysqlHostMetricsResponse], error)
	// ReplicationStatus returns the current replication status.
	ReplicationStatus(context.Context, *connect.Request[v24.ReplicationStatusRequest]) (*connect.Response[v24.ReplicationStatusResponse], error)
	// PrimaryStatus returns the current primary status.
	PrimaryStatus(context.Context, *connect.Request[v24.PrimaryStatusRequest]) (*connect.Response[v24.PrimaryStatusResponse], error)
	// PrimaryPosition returns the current primary position
	PrimaryPosition(context.Context, *connect.Request[v24.PrimaryPositionRequest]) (*connect.Response[v24.PrimaryPositionResponse], error)
	// WaitForPosition waits for the position to be reached
	WaitForPosition(context.Context, *connect.Request[v24.WaitForPositionRequest]) (*connect.Response[v24.WaitForPositionResponse], error)
	...
	StopReplicationMinimum(context.Context, *connect.Request[v24.StopReplicationMinimumRequest]) (*connect.Response[v24.StopReplicationMinimumResponse], error)
	...
	RestartReplication(context.Context, *connect.Request[v24.RestartReplicationRequest]) (*connect.Response[v24.RestartReplicationResponse], error)
	// StartReplicationUnitAfter starts the mysql replication until and including
	// the provided position
	StartReplicationUntilAfter(context.Context, *connect.Request[v24.StartReplicationUntilAfterRequest]) (*connect.Response[v24.StartReplicationUntilAfterResponse], error)
	// GetReplicas asks for the list of mysql replicas
	GetReplicas(context.Context, *connect.Request[v24.GetReplicasRequest]) (*connect.Response[v24.GetReplicasResponse], error)
	// VReplication API
	CreateVReplicationWorkflow(context.Context, *connect.Request[v24.CreateVReplicationWorkflowRequest]) (*connect.Response[v24.CreateVReplicationWorkflowResponse], error)
	DeleteTableData(context.Context, *connect.Request[v24.DeleteTableDataRequest]) (*connect.Response[v24.DeleteTableDataResponse], error)
	DeleteVReplicationWorkflow(context.Context, *connect.Request[v24.DeleteVReplicationWorkflowRequest]) (*connect.Response[v24.DeleteVReplicationWorkflowResponse], error)
	HasVReplicationWorkflows(context.Context, *connect.Request[v24.HasVReplicationWorkflowsRequest]) (*connect.Response[v24.HasVReplicationWorkflowsResponse], error)
	ReadVReplicationWorkflow(context.Context, *connect.Request[v24.ReadVReplicationWorkflowRequest]) (*connect.Response[v24.ReadVReplicationWorkflowResponse], error)
	ReadVReplicationWorkflows(context.Context, *connect.Request[v24.ReadVReplicationWorkflowsRequest]) (*connect.Response[v24.ReadVReplicationWorkflowsResponse], error)
	UpdateVReplicationWorkflow(context.Context, *connect.Request[v24.UpdateVReplicationWorkflowRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowResponse], error)
	UpdateVReplicationWorkflows(context.Context, *connect.Request[v24.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowsResponse], error)
	ValidateVReplicationPermissions(context.Context, *connect.Request[v24.ValidateVReplicationPermissionsRequest]) (*connect.Response[v24.ValidateVReplicationPermissionsResponse], error)
	VReplicationExec(context.Context, *connect.Request[v24.VReplicationExecRequest]) (*connect.Response[v24.VReplicationExecResponse], error)
	VReplicationWaitForPos(context.Context, *connect.Request[v24.VReplicationWaitForPosRequest]) (*connect.Response[v24.VReplicationWaitForPosResponse], error)
	UpdateSequenceTables(context.Context, *connect.Request[v24.UpdateSequenceTablesRequest]) (*connect.Response[v24.UpdateSequenceTablesResponse], error)
	GetMaxValueForSequences(context.Context, *connect.Request[v24.GetMaxValueForSequencesRequest]) (*connect.Response[v24.GetMaxValueForSequencesResponse], error)
	// VDiff API
	VDiff(context.Context, *connect.Request[v24.VDiffRequest]) (*connect.Response[v24.VDiffResponse], error)
	// ResetReplication makes the target not replicating
	ResetReplication(context.Context, *connect.Request[v24.ResetReplicationRequest]) (*connect.Response[v24.ResetReplicationResponse], error)
	// InitPrimary initializes the tablet as a primary
	InitPrimary(context.Context, *connect.Request[v24.InitPrimaryRequest]) (*connect.Response[v24.InitPrimaryResponse], error)
	// PopulateReparentJournal tells the tablet to add an entry to its
	// reparent journal
	PopulateReparentJournal(context.Context, *connect.Request[v24.PopulateReparentJournalRequest]) (*connect.Response[v24.PopulateReparentJournalResponse], error)
	// ReadReparentJournalInfo reads the information from reparent journal
	ReadReparentJournalInfo(context.Context, *connect.Request[v24.ReadReparentJournalInfoRequest]) (*connect.Response[v24.ReadReparentJournalInfoResponse], error)
	// InitReplica tells the tablet to reparent to the primary unconditionally
	InitReplica(context.Context, *connect.Request[v24.InitReplicaRequest]) (*connect.Response[v24.InitReplicaResponse], error)
	// DemotePrimary tells the soon-to-be-former primary it's gonna change
	DemotePrimary(context.Context, *connect.Request[v24.DemotePrimaryRequest]) (*connect.Response[v24.DemotePrimaryResponse], error)
	// UndoDemotePrimary reverts all changes made by DemotePrimary
	UndoDemotePrimary(context.Context, *connect.Request[v24.UndoDemotePrimaryRequest]) (*connect.Response[v24.UndoDemotePrimaryResponse], error)
	// ReplicaWasPromoted tells the remote tablet it is now the primary
	ReplicaWasPromoted(context.Context, *connect.Request[v24.ReplicaWasPromotedRequest]) (*connect.Response[v24.ReplicaWasPromotedResponse], error)
	// ResetReplicationParameters resets the replica replication parameters
	ResetReplicationParameters(context.Context, *connect.Request[v24.ResetReplicationParametersRequest]) (*connect.Response[v24.ResetReplicationParametersResponse], error)
	...
	FullStatus(context.Context, *connect.Request[v24.FullStatusRequest]) (*connect.Response[v24.FullStatusResponse], error)
	// SetReplicationSource tells the replica to reparent
	SetReplicationSource(context.Context, *connect.Request[v24.SetReplicationSourceRequest]) (*connect.Response[v24.SetReplicationSourceResponse], error)
	// ReplicaWasRestarted tells the remote tablet its primary has changed
	ReplicaWasRestarted(context.Context, *connect.Request[v24.ReplicaWasRestartedRequest]) (*connect.Response[v24.ReplicaWasRestartedResponse], error)
	// StopReplicationAndGetStatus stops MySQL replication, and returns the
	// replication status
	StopReplicationAndGetStatus(context.Context, *connect.Request[v24.StopReplicationAndGetStatusRequest]) (*connect.Response[v24.StopReplicationAndGetStatusResponse], error)
	// PromoteReplica makes the replica the new primary
	PromoteReplica(context.Context, *connect.Request[v24.PromoteReplicaRequest]) (*connect.Response[v24.PromoteReplicaResponse], error)
...
func NewTabletManagerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TabletManagerClient {
	...
	tabletManagerMethods := v241.File_vitess_tabletmanagerservice_v24_tabletmanagerservice_proto.Services().ByName("TabletManager").Methods()
	return &tabletManagerClient{
		ping: connect.NewClient[v24.PingRequest, v24.PingResponse](
			httpClient,
			baseURL+TabletManagerPingProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("Ping")),
			connect.WithClientOptions(opts...),
		),
		sleep: connect.NewClient[v24.SleepRequest, v24.SleepResponse](
			httpClient,
		...
		preflightSchema: connect.NewClient[v24.PreflightSchemaRequest, v24.PreflightSchemaResponse](
			httpClient,
		...
		resetSequences: connect.NewClient[v24.ResetSequencesRequest, v24.ResetSequencesResponse](
			httpClient,
			baseURL+TabletManagerResetSequencesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ResetSequences")),
			connect.WithClientOptions(opts...),
		),
		lockTables: connect.NewClient[v24.LockTablesRequest, v24.LockTablesResponse](
			httpClient,
			baseURL+TabletManagerLockTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("LockTables")),
			connect.WithClientOptions(opts...),
		),
		unlockTables: connect.NewClient[v24.UnlockTablesRequest, v24.UnlockTablesResponse](
			httpClient,
			baseURL+TabletManagerUnlockTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UnlockTables")),
			connect.WithClientOptions(opts...),
		),
		executeQuery: connect.NewClient[v24.ExecuteQueryRequest, v24.ExecuteQueryResponse](
			httpClient,
		...
		executeFetchAsAllPrivs: connect.NewClient[v24.ExecuteFetchAsAllPrivsRequest, v24.ExecuteFetchAsAllPrivsResponse](
			httpClient,
		...
		mysqlHostMetrics: connect.NewClient[v24.MysqlHostMetricsRequest, v24.MysqlHostMetricsResponse](
			httpClient,
			baseURL+TabletManagerMysqlHostMetricsProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("MysqlHostMetrics")),
			connect.WithClientOptions(opts...),
		),
		replicationStatus: connect.NewClient[v24.ReplicationStatusRequest, v24.ReplicationStatusResponse](
			httpClient,
			baseURL+TabletManagerReplicationStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicationStatus")),
			connect.WithClientOptions(opts...),
		),
		primaryStatus: connect.NewClient[v24.PrimaryStatusRequest, v24.PrimaryStatusResponse](
			httpClient,
			baseURL+TabletManagerPrimaryStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("PrimaryStatus")),
			connect.WithClientOptions(opts...),
		),
		primaryPosition: connect.NewClient[v24.PrimaryPositionRequest, v24.PrimaryPositionResponse](
			httpClient,
			baseURL+TabletManagerPrimaryPositionProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("PrimaryPosition")),
			connect.WithClientOptions(opts...),
		),
		waitForPosition: connect.NewClient[v24.WaitForPositionRequest, v24.WaitForPositionResponse](
			httpClient,
		...
		stopReplicationMinimum: connect.NewClient[v24.StopReplicationMinimumRequest, v24.StopReplicationMinimumResponse](
			httpClient,
		...
		restartReplication: connect.NewClient[v24.RestartReplicationRequest, v24.RestartReplicationResponse](
			httpClient,
			baseURL+TabletManagerRestartReplicationProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("RestartReplication")),
			connect.WithClientOptions(opts...),
		),
		startReplicationUntilAfter: connect.NewClient[v24.StartReplicationUntilAfterRequest, v24.StartReplicationUntilAfterResponse](
			httpClient,
		...
		getReplicas: connect.NewClient[v24.GetReplicasRequest, v24.GetReplicasResponse](
			httpClient,
			baseURL+TabletManagerGetReplicasProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("GetReplicas")),
			connect.WithClientOptions(opts...),
		),
		createVReplicationWorkflow: connect.NewClient[v24.CreateVReplicationWorkflowRequest, v24.CreateVReplicationWorkflowResponse](
			httpClient,
		...
		deleteTableData: connect.NewClient[v24.DeleteTableDataRequest, v24.DeleteTableDataResponse](
			httpClient,
			baseURL+TabletManagerDeleteTableDataProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("DeleteTableData")),
			connect.WithClientOptions(opts...),
		),
		deleteVReplicationWorkflow: connect.NewClient[v24.DeleteVReplicationWorkflowRequest, v24.DeleteVReplicationWorkflowResponse](
			httpClient,
		...
		hasVReplicationWorkflows: connect.NewClient[v24.HasVReplicationWorkflowsRequest, v24.HasVReplicationWorkflowsResponse](
			httpClient,
		...
		readVReplicationWorkflow: connect.NewClient[v24.ReadVReplicationWorkflowRequest, v24.ReadVReplicationWorkflowResponse](
			httpClient,
		...
		readVReplicationWorkflows: connect.NewClient[v24.ReadVReplicationWorkflowsRequest, v24.ReadVReplicationWorkflowsResponse](
			httpClient,
		...
		updateVReplicationWorkflow: connect.NewClient[v24.UpdateVReplicationWorkflowRequest, v24.UpdateVReplicationWorkflowResponse](
			httpClient,
		...
		updateVReplicationWorkflows: connect.NewClient[v24.UpdateVReplicationWorkflowsRequest, v24.UpdateVReplicationWorkflowsResponse](
			httpClient,
		...
		validateVReplicationPermissions: connect.NewClient[v24.ValidateVReplicationPermissionsRequest, v24.ValidateVReplicationPermissionsResponse](
			httpClient,
		...
		vReplicationExec: connect.NewClient[v24.VReplicationExecRequest, v24.VReplicationExecResponse](
			httpClient,
			baseURL+TabletManagerVReplicationExecProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("VReplicationExec")),
			connect.WithClientOptions(opts...),
		),
		vReplicationWaitForPos: connect.NewClient[v24.VReplicationWaitForPosRequest, v24.VReplicationWaitForPosResponse](
			httpClient,
		...
		updateSequenceTables: connect.NewClient[v24.UpdateSequenceTablesRequest, v24.UpdateSequenceTablesResponse](
			httpClient,
			baseURL+TabletManagerUpdateSequenceTablesProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UpdateSequenceTables")),
			connect.WithClientOptions(opts...),
		),
		getMaxValueForSequences: connect.NewClient[v24.GetMaxValueForSequencesRequest, v24.GetMaxValueForSequencesResponse](
			httpClient,
		...
		vDiff: connect.NewClient[v24.VDiffRequest, v24.VDiffResponse](
			httpClient,
			baseURL+TabletManagerVDiffProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("VDiff")),
			connect.WithClientOptions(opts...),
		),
		resetReplication: connect.NewClient[v24.ResetReplicationRequest, v24.ResetReplicationResponse](
			httpClient,
			baseURL+TabletManagerResetReplicationProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ResetReplication")),
			connect.WithClientOptions(opts...),
		),
		initPrimary: connect.NewClient[v24.InitPrimaryRequest, v24.InitPrimaryResponse](
			httpClient,
			baseURL+TabletManagerInitPrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("InitPrimary")),
			connect.WithClientOptions(opts...),
		),
		populateReparentJournal: connect.NewClient[v24.PopulateReparentJournalRequest, v24.PopulateReparentJournalResponse](
			httpClient,
		...
		readReparentJournalInfo: connect.NewClient[v24.ReadReparentJournalInfoRequest, v24.ReadReparentJournalInfoResponse](
			httpClient,
		...
		initReplica: connect.NewClient[v24.InitReplicaRequest, v24.InitReplicaResponse](
			httpClient,
			baseURL+TabletManagerInitReplicaProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("InitReplica")),
			connect.WithClientOptions(opts...),
		),
		demotePrimary: connect.NewClient[v24.DemotePrimaryRequest, v24.DemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerDemotePrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("DemotePrimary")),
			connect.WithClientOptions(opts...),
		),
		undoDemotePrimary: connect.NewClient[v24.UndoDemotePrimaryRequest, v24.UndoDemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerUndoDemotePrimaryProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("UndoDemotePrimary")),
			connect.WithClientOptions(opts...),
		),
		replicaWasPromoted: connect.NewClient[v24.ReplicaWasPromotedRequest, v24.ReplicaWasPromotedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasPromotedProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicaWasPromoted")),
			connect.WithClientOptions(opts...),
		),
		resetReplicationParameters: connect.NewClient[v24.ResetReplicationParametersRequest, v24.ResetReplicationParametersResponse](
			httpClient,
		...
		fullStatus: connect.NewClient[v24.FullStatusRequest, v24.FullStatusResponse](
			httpClient,
			baseURL+TabletManagerFullStatusProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("FullStatus")),
			connect.WithClientOptions(opts...),
		),
		setReplicationSource: connect.NewClient[v24.SetReplicationSourceRequest, v24.SetReplicationSourceResponse](
			httpClient,
			baseURL+TabletManagerSetReplicationSourceProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("SetReplicationSource")),
			connect.WithClientOptions(opts...),
		),
		replicaWasRestarted: connect.NewClient[v24.ReplicaWasRestartedRequest, v24.ReplicaWasRestartedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasRestartedProcedure,
			connect.WithSchema(tabletManagerMethods.ByName("ReplicaWasRestarted")),
			connect.WithClientOptions(opts...),
		),
		stopReplicationAndGetStatus: connect.NewClient[v24.StopReplicationAndGetStatusRequest, v24.StopReplicationAndGetStatusResponse](
			httpClient,
		...
		promoteReplica: connect.NewClient[v24.PromoteReplicaRequest, v24.PromoteReplicaResponse](
			httpClient,
...
type tabletManagerClient struct {
	ping                            *connect.Client[v24.PingRequest, v24.PingResponse]
	sleep                           *connect.Client[v24.SleepRequest, v24.SleepResponse]
	...
	getGlobalStatusVars             *connect.Client[v24.GetGlobalStatusVarsRequest, v24.GetGlobalStatusVarsResponse]
	setReadOnly                     *connect.Client[v24.SetReadOnlyRequest, v24.SetReadOnlyResponse]
	setReadWrite                    *connect.Client[v24.SetReadWriteRequest, v24.SetReadWriteResponse]
	changeTags                      *connect.Client[v24.ChangeTagsRequest, v24.ChangeTagsResponse]
	changeType                      *connect.Client[v24.ChangeTypeRequest, v24.ChangeTypeResponse]
	...
	preflightSchema                 *connect.Client[v24.PreflightSchemaRequest, v24.PreflightSchemaResponse]
	applySchema                     *connect.Client[v24.ApplySchemaRequest, v24.ApplySchemaResponse]
	resetSequences                  *connect.Client[v24.ResetSequencesRequest, v24.ResetSequencesResponse]
	lockTables                      *connect.Client[v24.LockTablesRequest, v24.LockTablesResponse]
	unlockTables                    *connect.Client[v24.UnlockTablesRequest, v24.UnlockTablesResponse]
	executeQuery                    *connect.Client[v24.ExecuteQueryRequest, v24.ExecuteQueryResponse]
	...
	executeFetchAsAllPrivs          *connect.Client[v24.ExecuteFetchAsAllPrivsRequest, v24.ExecuteFetchAsAllPrivsResponse]
	...
	mysqlHostMetrics                *connect.Client[v24.MysqlHostMetricsRequest, v24.MysqlHostMetricsResponse]
	replicationStatus               *connect.Client[v24.ReplicationStatusRequest, v24.ReplicationStatusResponse]
	primaryStatus                   *connect.Client[v24.PrimaryStatusRequest, v24.PrimaryStatusResponse]
	primaryPosition                 *connect.Client[v24.PrimaryPositionRequest, v24.PrimaryPositionResponse]
	waitForPosition                 *connect.Client[v24.WaitForPositionRequest, v24.WaitForPositionResponse]
	stopReplication                 *connect.Client[v24.StopReplicationRequest, v24.StopReplicationResponse]
	stopReplicationMinimum          *connect.Client[v24.StopReplicationMinimumRequest, v24.StopReplicationMinimumResponse]
	startReplication                *connect.Client[v24.StartReplicationRequest, v24.StartReplicationResponse]
	restartReplication              *connect.Client[v24.RestartReplicationRequest, v24.RestartReplicationResponse]
	startReplicationUntilAfter      *connect.Client[v24.StartReplicationUntilAfterRequest, v24.StartReplicationUntilAfterResponse]
	getReplicas                     *connect.Client[v24.GetReplicasRequest, v24.GetReplicasResponse]
	createVReplicationWorkflow      *connect.Client[v24.CreateVReplicationWorkflowRequest, v24.CreateVReplicationWorkflowResponse]
	deleteTableData                 *connect.Client[v24.DeleteTableDataRequest, v24.DeleteTableDataResponse]
	deleteVReplicationWorkflow      *connect.Client[v24.DeleteVReplicationWorkflowRequest, v24.DeleteVReplicationWorkflowResponse]
	hasVReplicationWorkflows        *connect.Client[v24.HasVReplicationWorkflowsRequest, v24.HasVReplicationWorkflowsResponse]
	readVReplicationWorkflow        *connect.Client[v24.ReadVReplicationWorkflowRequest, v24.ReadVReplicationWorkflowResponse]
	readVReplicationWorkflows       *connect.Client[v24.ReadVReplicationWorkflowsRequest, v24.ReadVReplicationWorkflowsResponse]
	updateVReplicationWorkflow      *connect.Client[v24.UpdateVReplicationWorkflowRequest, v24.UpdateVReplicationWorkflowResponse]
	updateVReplicationWorkflows     *connect.Client[v24.UpdateVReplicationWorkflowsRequest, v24.UpdateVReplicationWorkflowsResponse]
	validateVReplicationPermissions *connect.Client[v24.ValidateVReplicationPermissionsRequest, v24.ValidateVReplicationPermissionsResponse]
	vReplicationExec                *connect.Client[v24.VReplicationExecRequest, v24.VReplicationExecResponse]
	vReplicationWaitForPos          *connect.Client[v24.VReplicationWaitForPosRequest, v24.VReplicationWaitForPosResponse]
	updateSequenceTables            *connect.Client[v24.UpdateSequenceTablesRequest, v24.UpdateSequenceTablesResponse]
	getMaxValueForSequences         *connect.Client[v24.GetMaxValueForSequencesRequest, v24.GetMaxValueForSequencesResponse]
	vDiff                           *connect.Client[v24.VDiffRequest, v24.VDiffResponse]
	resetReplication                *connect.Client[v24.ResetReplicationRequest, v24.ResetReplicationResponse]
	initPrimary                     *connect.Client[v24.InitPrimaryRequest, v24.InitPrimaryResponse]
	populateReparentJournal         *connect.Client[v24.PopulateReparentJournalRequest, v24.PopulateReparentJournalResponse]
	readReparentJournalInfo         *connect.Client[v24.ReadReparentJournalInfoRequest, v24.ReadReparentJournalInfoResponse]
	initReplica                     *connect.Client[v24.InitReplicaRequest, v24.InitReplicaResponse]
	demotePrimary                   *connect.Client[v24.DemotePrimaryRequest, v24.DemotePrimaryResponse]
	undoDemotePrimary               *connect.Client[v24.UndoDemotePrimaryRequest, v24.UndoDemotePrimaryResponse]
	replicaWasPromoted              *connect.Client[v24.ReplicaWasPromotedRequest, v24.ReplicaWasPromotedResponse]
	resetReplicationParameters      *connect.Client[v24.ResetReplicationParametersRequest, v24.ResetReplicationParametersResponse]
	fullStatus                      *connect.Client[v24.FullStatusRequest, v24.FullStatusResponse]
	setReplicationSource            *connect.Client[v24.SetReplicationSourceRequest, v24.SetReplicationSourceResponse]
	replicaWasRestarted             *connect.Client[v24.ReplicaWasRestartedRequest, v24.ReplicaWasRestartedResponse]
	stopReplicationAndGetStatus     *connect.Client[v24.StopReplicationAndGetStatusRequest, v24.StopReplicationAndGetStatusResponse]
	promoteReplica                  *connect.Client[v24.PromoteReplicaRequest, v24.PromoteReplicaResponse]
...
func (c *tabletManagerClient) Ping(ctx context.Context, req *connect.Request[v24.PingRequest]) (*connect.Response[v24.PingResponse], error) {
	return c.ping.CallUnary(ctx, req)
}

// Sleep calls tabletmanagerservice.TabletManager.Sleep.
func (c *tabletManagerClient) Sleep(ctx context.Context, req *connect.Request[v24.SleepRequest]) (*connect.Response[v24.SleepResponse], error) {
	return c.sleep.CallUnary(ctx, req)
}

// ExecuteHook calls tabletmanagerservice.TabletManager.ExecuteHook.
func (c *tabletManagerClient) ExecuteHook(ctx context.Context, req *connect.Request[v24.ExecuteHookRequest]) (*connect.Response[v24.ExecuteHookResponse], error) {
	return c.executeHook.CallUnary(ctx, req)
}

// GetSchema calls tabletmanagerservice.TabletManager.GetSchema.
func (c *tabletManagerClient) GetSchema(ctx context.Context, req *connect.Request[v24.GetSchemaRequest]) (*connect.Response[v24.GetSchemaResponse], error) {
	return c.getSchema.CallUnary(ctx, req)
}

// GetPermissions calls tabletmanagerservice.TabletManager.GetPermissions.
func (c *tabletManagerClient) GetPermissions(ctx context.Context, req *connect.Request[v24.GetPermissionsRequest]) (*connect.Response[v24.GetPermissionsResponse], error) {
...
func (c *tabletManagerClient) GetGlobalStatusVars(ctx context.Context, req *connect.Request[v24.GetGlobalStatusVarsRequest]) (*connect.Response[v24.GetGlobalStatusVarsResponse], error) {
	return c.getGlobalStatusVars.CallUnary(ctx, req)
}

// SetReadOnly calls tabletmanagerservice.TabletManager.SetReadOnly.
func (c *tabletManagerClient) SetReadOnly(ctx context.Context, req *connect.Request[v24.SetReadOnlyRequest]) (*connect.Response[v24.SetReadOnlyResponse], error) {
	return c.setReadOnly.CallUnary(ctx, req)
}

// SetReadWrite calls tabletmanagerservice.TabletManager.SetReadWrite.
func (c *tabletManagerClient) SetReadWrite(ctx context.Context, req *connect.Request[v24.SetReadWriteRequest]) (*connect.Response[v24.SetReadWriteResponse], error) {
	return c.setReadWrite.CallUnary(ctx, req)
}

// ChangeTags calls tabletmanagerservice.TabletManager.ChangeTags.
func (c *tabletManagerClient) ChangeTags(ctx context.Context, req *connect.Request[v24.ChangeTagsRequest]) (*connect.Response[v24.ChangeTagsResponse], error) {
	return c.changeTags.CallUnary(ctx, req)
}

// ChangeType calls tabletmanagerservice.TabletManager.ChangeType.
func (c *tabletManagerClient) ChangeType(ctx context.Context, req *connect.Request[v24.ChangeTypeRequest]) (*connect.Response[v24.ChangeTypeResponse], error) {
	return c.changeType.CallUnary(ctx, req)
}

// RefreshState calls tabletmanagerservice.TabletManager.RefreshState.
func (c *tabletManagerClient) RefreshState(ctx context.Context, req *connect.Request[v24.RefreshStateRequest]) (*connect.Response[v24.RefreshStateResponse], error) {
	return c.refreshState.CallUnary(ctx, req)
}

// RunHealthCheck calls tabletmanagerservice.TabletManager.RunHealthCheck.
func (c *tabletManagerClient) RunHealthCheck(ctx context.Context, req *connect.Request[v24.RunHealthCheckRequest]) (*connect.Response[v24.RunHealthCheckResponse], error) {
	return c.runHealthCheck.CallUnary(ctx, req)
}

// ReloadSchema calls tabletmanagerservice.TabletManager.ReloadSchema.
func (c *tabletManagerClient) ReloadSchema(ctx context.Context, req *connect.Request[v24.ReloadSchemaRequest]) (*connect.Response[v24.ReloadSchemaResponse], error) {
	return c.reloadSchema.CallUnary(ctx, req)
}

// PreflightSchema calls tabletmanagerservice.TabletManager.PreflightSchema.
func (c *tabletManagerClient) PreflightSchema(ctx context.Context, req *connect.Request[v24.PreflightSchemaRequest]) (*connect.Response[v24.PreflightSchemaResponse], error) {
	return c.preflightSchema.CallUnary(ctx, req)
}

// ApplySchema calls tabletmanagerservice.TabletManager.ApplySchema.
func (c *tabletManagerClient) ApplySchema(ctx context.Context, req *connect.Request[v24.ApplySchemaRequest]) (*connect.Response[v24.ApplySchemaResponse], error) {
	return c.applySchema.CallUnary(ctx, req)
}

// ResetSequences calls tabletmanagerservice.TabletManager.ResetSequences.
func (c *tabletManagerClient) ResetSequences(ctx context.Context, req *connect.Request[v24.ResetSequencesRequest]) (*connect.Response[v24.ResetSequencesResponse], error) {
	return c.resetSequences.CallUnary(ctx, req)
}

// LockTables calls tabletmanagerservice.TabletManager.LockTables.
func (c *tabletManagerClient) LockTables(ctx context.Context, req *connect.Request[v24.LockTablesRequest]) (*connect.Response[v24.LockTablesResponse], error) {
	return c.lockTables.CallUnary(ctx, req)
}

// UnlockTables calls tabletmanagerservice.TabletManager.UnlockTables.
func (c *tabletManagerClient) UnlockTables(ctx context.Context, req *connect.Request[v24.UnlockTablesRequest]) (*connect.Response[v24.UnlockTablesResponse], error) {
	return c.unlockTables.CallUnary(ctx, req)
}

// ExecuteQuery calls tabletmanagerservice.TabletManager.ExecuteQuery.
func (c *tabletManagerClient) ExecuteQuery(ctx context.Context, req *connect.Request[v24.ExecuteQueryRequest]) (*connect.Response[v24.ExecuteQueryResponse], error) {
	return c.executeQuery.CallUnary(ctx, req)
}

// ExecuteFetchAsDba calls tabletmanagerservice.TabletManager.ExecuteFetchAsDba.
func (c *tabletManagerClient) ExecuteFetchAsDba(ctx context.Context, req *connect.Request[v24.ExecuteFetchAsDbaRequest]) (*connect.Response[v24.ExecuteFetchAsDbaResponse], error) {
...
func (c *tabletManagerClient) ExecuteMultiFetchAsDba(ctx context.Context, req *connect.Request[v24.ExecuteMultiFetchAsDbaRequest]) (*connect.Response[v24.ExecuteMultiFetchAsDbaResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsAllPrivs(ctx context.Context, req *connect.Request[v24.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v24.ExecuteFetchAsAllPrivsResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsApp(ctx context.Context, req *connect.Request[v24.ExecuteFetchAsAppRequest]) (*connect.Response[v24.ExecuteFetchAsAppResponse], error) {
...
func (c *tabletManagerClient) GetUnresolvedTransactions(ctx context.Context, req *connect.Request[v24.GetUnresolvedTransactionsRequest]) (*connect.Response[v24.GetUnresolvedTransactionsResponse], error) {
...
func (c *tabletManagerClient) ReadTransaction(ctx context.Context, req *connect.Request[v24.ReadTransactionRequest]) (*connect.Response[v24.ReadTransactionResponse], error) {
	return c.readTransaction.CallUnary(ctx, req)
}

// GetTransactionInfo calls tabletmanagerservice.TabletManager.GetTransactionInfo.
func (c *tabletManagerClient) GetTransactionInfo(ctx context.Context, req *connect.Request[v24.GetTransactionInfoRequest]) (*connect.Response[v24.GetTransactionInfoResponse], error) {
...
func (c *tabletManagerClient) ConcludeTransaction(ctx context.Context, req *connect.Request[v24.ConcludeTransactionRequest]) (*connect.Response[v24.ConcludeTransactionResponse], error) {
	return c.concludeTransaction.CallUnary(ctx, req)
}

// MysqlHostMetrics calls tabletmanagerservice.TabletManager.MysqlHostMetrics.
func (c *tabletManagerClient) MysqlHostMetrics(ctx context.Context, req *connect.Request[v24.MysqlHostMetricsRequest]) (*connect.Response[v24.MysqlHostMetricsResponse], error) {
	return c.mysqlHostMetrics.CallUnary(ctx, req)
}

// ReplicationStatus calls tabletmanagerservice.TabletManager.ReplicationStatus.
func (c *tabletManagerClient) ReplicationStatus(ctx context.Context, req *connect.Request[v24.ReplicationStatusRequest]) (*connect.Response[v24.ReplicationStatusResponse], error) {
	return c.replicationStatus.CallUnary(ctx, req)
}

// PrimaryStatus calls tabletmanagerservice.TabletManager.PrimaryStatus.
func (c *tabletManagerClient) PrimaryStatus(ctx context.Context, req *connect.Request[v24.PrimaryStatusRequest]) (*connect.Response[v24.PrimaryStatusResponse], error) {
	return c.primaryStatus.CallUnary(ctx, req)
}

// PrimaryPosition calls tabletmanagerservice.TabletManager.PrimaryPosition.
func (c *tabletManagerClient) PrimaryPosition(ctx context.Context, req *connect.Request[v24.PrimaryPositionRequest]) (*connect.Response[v24.PrimaryPositionResponse], error) {
	return c.primaryPosition.CallUnary(ctx, req)
}

// WaitForPosition calls tabletmanagerservice.TabletManager.WaitForPosition.
func (c *tabletManagerClient) WaitForPosition(ctx context.Context, req *connect.Request[v24.WaitForPositionRequest]) (*connect.Response[v24.WaitForPositionResponse], error) {
	return c.waitForPosition.CallUnary(ctx, req)
}

// StopReplication calls tabletmanagerservice.TabletManager.StopReplication.
func (c *tabletManagerClient) StopReplication(ctx context.Context, req *connect.Request[v24.StopReplicationRequest]) (*connect.Response[v24.StopReplicationResponse], error) {
...
func (c *tabletManagerClient) StopReplicationMinimum(ctx context.Context, req *connect.Request[v24.StopReplicationMinimumRequest]) (*connect.Response[v24.StopReplicationMinimumResponse], error) {
...
func (c *tabletManagerClient) StartReplication(ctx context.Context, req *connect.Request[v24.StartReplicationRequest]) (*connect.Response[v24.StartReplicationResponse], error) {
...
func (c *tabletManagerClient) RestartReplication(ctx context.Context, req *connect.Request[v24.RestartReplicationRequest]) (*connect.Response[v24.RestartReplicationResponse], error) {
...
func (c *tabletManagerClient) StartReplicationUntilAfter(ctx context.Context, req *connect.Request[v24.StartReplicationUntilAfterRequest]) (*connect.Response[v24.StartReplicationUntilAfterResponse], error) {
	return c.startReplicationUntilAfter.CallUnary(ctx, req)
}

// GetReplicas calls tabletmanagerservice.TabletManager.GetReplicas.
func (c *tabletManagerClient) GetReplicas(ctx context.Context, req *connect.Request[v24.GetReplicasRequest]) (*connect.Response[v24.GetReplicasResponse], error) {
...
func (c *tabletManagerClient) CreateVReplicationWorkflow(ctx context.Context, req *connect.Request[v24.CreateVReplicationWorkflowRequest]) (*connect.Response[v24.CreateVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) DeleteTableData(ctx context.Context, req *connect.Request[v24.DeleteTableDataRequest]) (*connect.Response[v24.DeleteTableDataResponse], error) {
...
func (c *tabletManagerClient) DeleteVReplicationWorkflow(ctx context.Context, req *connect.Request[v24.DeleteVReplicationWorkflowRequest]) (*connect.Response[v24.DeleteVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) HasVReplicationWorkflows(ctx context.Context, req *connect.Request[v24.HasVReplicationWorkflowsRequest]) (*connect.Response[v24.HasVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) ReadVReplicationWorkflow(ctx context.Context, req *connect.Request[v24.ReadVReplicationWorkflowRequest]) (*connect.Response[v24.ReadVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) ReadVReplicationWorkflows(ctx context.Context, req *connect.Request[v24.ReadVReplicationWorkflowsRequest]) (*connect.Response[v24.ReadVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) UpdateVReplicationWorkflow(ctx context.Context, req *connect.Request[v24.UpdateVReplicationWorkflowRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowResponse], error) {
...
func (c *tabletManagerClient) UpdateVReplicationWorkflows(ctx context.Context, req *connect.Request[v24.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowsResponse], error) {
...
func (c *tabletManagerClient) ValidateVReplicationPermissions(ctx context.Context, req *connect.Request[v24.ValidateVReplicationPermissionsRequest]) (*connect.Response[v24.ValidateVReplicationPermissionsResponse], error) {
...
func (c *tabletManagerClient) VReplicationExec(ctx context.Context, req *connect.Request[v24.VReplicationExecRequest]) (*connect.Response[v24.VReplicationExecResponse], error) {
...
func (c *tabletManagerClient) VReplicationWaitForPos(ctx context.Context, req *connect.Request[v24.VReplicationWaitForPosRequest]) (*connect.Response[v24.VReplicationWaitForPosResponse], error) {
...
func (c *tabletManagerClient) UpdateSequenceTables(ctx context.Context, req *connect.Request[v24.UpdateSequenceTablesRequest]) (*connect.Response[v24.UpdateSequenceTablesResponse], error) {
...
func (c *tabletManagerClient) GetMaxValueForSequences(ctx context.Context, req *connect.Request[v24.GetMaxValueForSequencesRequest]) (*connect.Response[v24.GetMaxValueForSequencesResponse], error) {
	return c.getMaxValueForSequences.CallUnary(ctx, req)
}

// VDiff calls tabletmanagerservice.TabletManager.VDiff.
func (c *tabletManagerClient) VDiff(ctx context.Context, req *connect.Request[v24.VDiffRequest]) (*connect.Response[v24.VDiffResponse], error) {
	return c.vDiff.CallUnary(ctx, req)
}

// ResetReplication calls tabletmanagerservice.TabletManager.ResetReplication.
func (c *tabletManagerClient) ResetReplication(ctx context.Context, req *connect.Request[v24.ResetReplicationRequest]) (*connect.Response[v24.ResetReplicationResponse], error) {
	return c.resetReplication.CallUnary(ctx, req)
}

// InitPrimary calls tabletmanagerservice.TabletManager.InitPrimary.
func (c *tabletManagerClient) InitPrimary(ctx context.Context, req *connect.Request[v24.InitPrimaryRequest]) (*connect.Response[v24.InitPrimaryResponse], error) {
...
func (c *tabletManagerClient) PopulateReparentJournal(ctx context.Context, req *connect.Request[v24.PopulateReparentJournalRequest]) (*connect.Response[v24.PopulateReparentJournalResponse], error) {
...
func (c *tabletManagerClient) ReadReparentJournalInfo(ctx context.Context, req *connect.Request[v24.ReadReparentJournalInfoRequest]) (*connect.Response[v24.ReadReparentJournalInfoResponse], error) {
	return c.readReparentJournalInfo.CallUnary(ctx, req)
}

// InitReplica calls tabletmanagerservice.TabletManager.InitReplica.
func (c *tabletManagerClient) InitReplica(ctx context.Context, req *connect.Request[v24.InitReplicaRequest]) (*connect.Response[v24.InitReplicaResponse], error) {
	return c.initReplica.CallUnary(ctx, req)
}

// DemotePrimary calls tabletmanagerservice.TabletManager.DemotePrimary.
func (c *tabletManagerClient) DemotePrimary(ctx context.Context, req *connect.Request[v24.DemotePrimaryRequest]) (*connect.Response[v24.DemotePrimaryResponse], error) {
	return c.demotePrimary.CallUnary(ctx, req)
}

// UndoDemotePrimary calls tabletmanagerservice.TabletManager.UndoDemotePrimary.
func (c *tabletManagerClient) UndoDemotePrimary(ctx context.Context, req *connect.Request[v24.UndoDemotePrimaryRequest]) (*connect.Response[v24.UndoDemotePrimaryResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasPromoted(ctx context.Context, req *connect.Request[v24.ReplicaWasPromotedRequest]) (*connect.Response[v24.ReplicaWasPromotedResponse], error) {
...
func (c *tabletManagerClient) ResetReplicationParameters(ctx context.Context, req *connect.Request[v24.ResetReplicationParametersRequest]) (*connect.Response[v24.ResetReplicationParametersResponse], error) {
	return c.resetReplicationParameters.CallUnary(ctx, req)
}

// FullStatus calls tabletmanagerservice.TabletManager.FullStatus.
func (c *tabletManagerClient) FullStatus(ctx context.Context, req *connect.Request[v24.FullStatusRequest]) (*connect.Response[v24.FullStatusResponse], error) {
	return c.fullStatus.CallUnary(ctx, req)
}

// SetReplicationSource calls tabletmanagerservice.TabletManager.SetReplicationSource.
func (c *tabletManagerClient) SetReplicationSource(ctx context.Context, req *connect.Request[v24.SetReplicationSourceRequest]) (*connect.Response[v24.SetReplicationSourceResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasRestarted(ctx context.Context, req *connect.Request[v24.ReplicaWasRestartedRequest]) (*connect.Response[v24.ReplicaWasRestartedResponse], error) {
...
func (c *tabletManagerClient) StopReplicationAndGetStatus(ctx context.Context, req *connect.Request[v24.StopReplicationAndGetStatusRequest]) (*connect.Response[v24.StopReplicationAndGetStatusResponse], error) {
...
func (c *tabletManagerClient) PromoteReplica(ctx context.Context, req *connect.Request[v24.PromoteReplicaRequest]) (*connect.Response[v24.PromoteReplicaResponse], error) {
	return c.promoteReplica.CallUnary(ctx, req)
}

// Backup calls tabletmanagerservice.TabletManager.Backup.
func (c *tabletManagerClient) Backup(ctx context.Context, req *connect.Request[v24.BackupRequest]) (*connect.ServerStreamForClient[v24.BackupResponse], error) {
	return c.backup.CallServerStream(ctx, req)
}

// RestoreFromBackup calls tabletmanagerservice.TabletManager.RestoreFromBackup.
func (c *tabletManagerClient) RestoreFromBackup(ctx context.Context, req *connect.Request[v24.RestoreFromBackupRequest]) (*connect.ServerStreamForClient[v24.RestoreFromBackupResponse], error) {
...
func (c *tabletManagerClient) CheckThrottler(ctx context.Context, req *connect.Request[v24.CheckThrottlerRequest]) (*connect.Response[v24.CheckThrottlerResponse], error) {
	return c.checkThrottler.CallUnary(ctx, req)
}

// GetThrottlerStatus calls tabletmanagerservice.TabletManager.GetThrottlerStatus.
func (c *tabletManagerClient) GetThrottlerStatus(ctx context.Context, req *connect.Request[v24.GetThrottlerStatusRequest]) (*connect.Response[v24.GetThrottlerStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) Ping(context.Context, *connect.Request[v24.PingRequest]) (*connect.Response[v24.PingResponse], error) {
...
func (UnimplementedTabletManagerHandler) Sleep(context.Context, *connect.Request[v24.SleepRequest]) (*connect.Response[v24.SleepResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteHook(context.Context, *connect.Request[v24.ExecuteHookRequest]) (*connect.Response[v24.ExecuteHookResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetSchema(context.Context, *connect.Request[v24.GetSchemaRequest]) (*connect.Response[v24.GetSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetPermissions(context.Context, *connect.Request[v24.GetPermissionsRequest]) (*connect.Response[v24.GetPermissionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetGlobalStatusVars(context.Context, *connect.Request[v24.GetGlobalStatusVarsRequest]) (*connect.Response[v24.GetGlobalStatusVarsResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadOnly(context.Context, *connect.Request[v24.SetReadOnlyRequest]) (*connect.Response[v24.SetReadOnlyResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadWrite(context.Context, *connect.Request[v24.SetReadWriteRequest]) (*connect.Response[v24.SetReadWriteResponse], error) {
...
func (UnimplementedTabletManagerHandler) ChangeTags(context.Context, *connect.Request[v24.ChangeTagsRequest]) (*connect.Response[v24.ChangeTagsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ChangeType(context.Context, *connect.Request[v24.ChangeTypeRequest]) (*connect.Response[v24.ChangeTypeResponse], error) {
...
func (UnimplementedTabletManagerHandler) RefreshState(context.Context, *connect.Request[v24.RefreshStateRequest]) (*connect.Response[v24.RefreshStateResponse], error) {
...
func (UnimplementedTabletManagerHandler) RunHealthCheck(context.Context, *connect.Request[v24.RunHealthCheckRequest]) (*connect.Response[v24.RunHealthCheckResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReloadSchema(context.Context, *connect.Request[v24.ReloadSchemaRequest]) (*connect.Response[v24.ReloadSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) PreflightSchema(context.Context, *connect.Request[v24.PreflightSchemaRequest]) (*connect.Response[v24.PreflightSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ApplySchema(context.Context, *connect.Request[v24.ApplySchemaRequest]) (*connect.Response[v24.ApplySchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetSequences(context.Context, *connect.Request[v24.ResetSequencesRequest]) (*connect.Response[v24.ResetSequencesResponse], error) {
...
func (UnimplementedTabletManagerHandler) LockTables(context.Context, *connect.Request[v24.LockTablesRequest]) (*connect.Response[v24.LockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) UnlockTables(context.Context, *connect.Request[v24.UnlockTablesRequest]) (*connect.Response[v24.UnlockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteQuery(context.Context, *connect.Request[v24.ExecuteQueryRequest]) (*connect.Response[v24.ExecuteQueryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsDba(context.Context, *connect.Request[v24.ExecuteFetchAsDbaRequest]) (*connect.Response[v24.ExecuteFetchAsDbaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteMultiFetchAsDba(context.Context, *connect.Request[v24.ExecuteMultiFetchAsDbaRequest]) (*connect.Response[v24.ExecuteMultiFetchAsDbaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v24.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v24.ExecuteFetchAsAllPrivsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsApp(context.Context, *connect.Request[v24.ExecuteFetchAsAppRequest]) (*connect.Response[v24.ExecuteFetchAsAppResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetUnresolvedTransactions(context.Context, *connect.Request[v24.GetUnresolvedTransactionsRequest]) (*connect.Response[v24.GetUnresolvedTransactionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadTransaction(context.Context, *connect.Request[v24.ReadTransactionRequest]) (*connect.Response[v24.ReadTransactionResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetTransactionInfo(context.Context, *connect.Request[v24.GetTransactionInfoRequest]) (*connect.Response[v24.GetTransactionInfoResponse], error) {
...
func (UnimplementedTabletManagerHandler) ConcludeTransaction(context.Context, *connect.Request[v24.ConcludeTransactionRequest]) (*connect.Response[v24.ConcludeTransactionResponse], error) {
...
func (UnimplementedTabletManagerHandler) MysqlHostMetrics(context.Context, *connect.Request[v24.MysqlHostMetricsRequest]) (*connect.Response[v24.MysqlHostMetricsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicationStatus(context.Context, *connect.Request[v24.ReplicationStatusRequest]) (*connect.Response[v24.ReplicationStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryStatus(context.Context, *connect.Request[v24.PrimaryStatusRequest]) (*connect.Response[v24.PrimaryStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryPosition(context.Context, *connect.Request[v24.PrimaryPositionRequest]) (*connect.Response[v24.PrimaryPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) WaitForPosition(context.Context, *connect.Request[v24.WaitForPositionRequest]) (*connect.Response[v24.WaitForPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplication(context.Context, *connect.Request[v24.StopReplicationRequest]) (*connect.Response[v24.StopReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationMinimum(context.Context, *connect.Request[v24.StopReplicationMinimumRequest]) (*connect.Response[v24.StopReplicationMinimumResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplication(context.Context, *connect.Request[v24.StartReplicationRequest]) (*connect.Response[v24.StartReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) RestartReplication(context.Context, *connect.Request[v24.RestartReplicationRequest]) (*connect.Response[v24.RestartReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplicationUntilAfter(context.Context, *connect.Request[v24.StartReplicationUntilAfterRequest]) (*connect.Response[v24.StartReplicationUntilAfterResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetReplicas(context.Context, *connect.Request[v24.GetReplicasRequest]) (*connect.Response[v24.GetReplicasResponse], error) {
...
func (UnimplementedTabletManagerHandler) CreateVReplicationWorkflow(context.Context, *connect.Request[v24.CreateVReplicationWorkflowRequest]) (*connect.Response[v24.CreateVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) DeleteTableData(context.Context, *connect.Request[v24.DeleteTableDataRequest]) (*connect.Response[v24.DeleteTableDataResponse], error) {
...
func (UnimplementedTabletManagerHandler) DeleteVReplicationWorkflow(context.Context, *connect.Request[v24.DeleteVReplicationWorkflowRequest]) (*connect.Response[v24.DeleteVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) HasVReplicationWorkflows(context.Context, *connect.Request[v24.HasVReplicationWorkflowsRequest]) (*connect.Response[v24.HasVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadVReplicationWorkflow(context.Context, *connect.Request[v24.ReadVReplicationWorkflowRequest]) (*connect.Response[v24.ReadVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadVReplicationWorkflows(context.Context, *connect.Request[v24.ReadVReplicationWorkflowsRequest]) (*connect.Response[v24.ReadVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateVReplicationWorkflow(context.Context, *connect.Request[v24.UpdateVReplicationWorkflowRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateVReplicationWorkflows(context.Context, *connect.Request[v24.UpdateVReplicationWorkflowsRequest]) (*connect.Response[v24.UpdateVReplicationWorkflowsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ValidateVReplicationPermissions(context.Context, *connect.Request[v24.ValidateVReplicationPermissionsRequest]) (*connect.Response[v24.ValidateVReplicationPermissionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationExec(context.Context, *connect.Request[v24.VReplicationExecRequest]) (*connect.Response[v24.VReplicationExecResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationWaitForPos(context.Context, *connect.Request[v24.VReplicationWaitForPosRequest]) (*connect.Response[v24.VReplicationWaitForPosResponse], error) {
...
func (UnimplementedTabletManagerHandler) UpdateSequenceTables(context.Context, *connect.Request[v24.UpdateSequenceTablesRequest]) (*connect.Response[v24.UpdateSequenceTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetMaxValueForSequences(context.Context, *connect.Request[v24.GetMaxValueForSequencesRequest]) (*connect.Response[v24.GetMaxValueForSequencesResponse], error) {
...
func (UnimplementedTabletManagerHandler) VDiff(context.Context, *connect.Request[v24.VDiffRequest]) (*connect.Response[v24.VDiffResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplication(context.Context, *connect.Request[v24.ResetReplicationRequest]) (*connect.Response[v24.ResetReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitPrimary(context.Context, *connect.Request[v24.InitPrimaryRequest]) (*connect.Response[v24.InitPrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) PopulateReparentJournal(context.Context, *connect.Request[v24.PopulateReparentJournalRequest]) (*connect.Response[v24.PopulateReparentJournalResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReadReparentJournalInfo(context.Context, *connect.Request[v24.ReadReparentJournalInfoRequest]) (*connect.Response[v24.ReadReparentJournalInfoResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitReplica(context.Context, *connect.Request[v24.InitReplicaRequest]) (*connect.Response[v24.InitReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) DemotePrimary(context.Context, *connect.Request[v24.DemotePrimaryRequest]) (*connect.Response[v24.DemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) UndoDemotePrimary(context.Context, *connect.Request[v24.UndoDemotePrimaryRequest]) (*connect.Response[v24.UndoDemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasPromoted(context.Context, *connect.Request[v24.ReplicaWasPromotedRequest]) (*connect.Response[v24.ReplicaWasPromotedResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplicationParameters(context.Context, *connect.Request[v24.ResetReplicationParametersRequest]) (*connect.Response[v24.ResetReplicationParametersResponse], error) {
...
func (UnimplementedTabletManagerHandler) FullStatus(context.Context, *connect.Request[v24.FullStatusRequest]) (*connect.Response[v24.FullStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReplicationSource(context.Context, *connect.Request[v24.SetReplicationSourceRequest]) (*connect.Response[v24.SetReplicationSourceResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasRestarted(context.Context, *connect.Request[v24.ReplicaWasRestartedRequest]) (*connect.Response[v24.ReplicaWasRestartedResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationAndGetStatus(context.Context, *connect.Request[v24.StopReplicationAndGetStatusRequest]) (*connect.Response[v24.StopReplicationAndGetStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PromoteReplica(context.Context, *connect.Request[v24.PromoteReplicaRequest]) (*connect.Response[v24.PromoteReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) Backup(context.Context, *connect.Request[v24.BackupRequest], *connect.ServerStream[v24.BackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) RestoreFromBackup(context.Context, *connect.Request[v24.RestoreFromBackupRequest], *connect.ServerStream[v24.RestoreFromBackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) CheckThrottler(context.Context, *connect.Request[v24.CheckThrottlerRequest]) (*connect.Response[v24.CheckThrottlerResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetThrottlerStatus(context.Context, *connect.Request[v24.GetThrottlerStatusRequest]) (*connect.Response[v24.GetThrottlerStatusResponse], error) {
