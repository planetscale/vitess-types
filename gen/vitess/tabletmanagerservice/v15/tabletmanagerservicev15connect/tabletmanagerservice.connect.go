...
type TabletManagerClient interface {
	...
	Ping(context.Context, *connect.Request[v15.PingRequest]) (*connect.Response[v15.PingResponse], error)
	// Sleep sleeps for the provided duration
	Sleep(context.Context, *connect.Request[v15.SleepRequest]) (*connect.Response[v15.SleepResponse], error)
	...
	SetReadOnly(context.Context, *connect.Request[v15.SetReadOnlyRequest]) (*connect.Response[v15.SetReadOnlyResponse], error)
	SetReadWrite(context.Context, *connect.Request[v15.SetReadWriteRequest]) (*connect.Response[v15.SetReadWriteResponse], error)
	// ChangeType asks the remote tablet to change its type
	ChangeType(context.Context, *connect.Request[v15.ChangeTypeRequest]) (*connect.Response[v15.ChangeTypeResponse], error)
	...
	PreflightSchema(context.Context, *connect.Request[v15.PreflightSchemaRequest]) (*connect.Response[v15.PreflightSchemaResponse], error)
	ApplySchema(context.Context, *connect.Request[v15.ApplySchemaRequest]) (*connect.Response[v15.ApplySchemaResponse], error)
	LockTables(context.Context, *connect.Request[v15.LockTablesRequest]) (*connect.Response[v15.LockTablesResponse], error)
	UnlockTables(context.Context, *connect.Request[v15.UnlockTablesRequest]) (*connect.Response[v15.UnlockTablesResponse], error)
	ExecuteQuery(context.Context, *connect.Request[v15.ExecuteQueryRequest]) (*connect.Response[v15.ExecuteQueryResponse], error)
	...
	ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v15.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v15.ExecuteFetchAsAllPrivsResponse], error)
	...
	ReplicationStatus(context.Context, *connect.Request[v15.ReplicationStatusRequest]) (*connect.Response[v15.ReplicationStatusResponse], error)
	// PrimaryStatus returns the current primary status.
	PrimaryStatus(context.Context, *connect.Request[v15.PrimaryStatusRequest]) (*connect.Response[v15.PrimaryStatusResponse], error)
	// PrimaryPosition returns the current primary position
	PrimaryPosition(context.Context, *connect.Request[v15.PrimaryPositionRequest]) (*connect.Response[v15.PrimaryPositionResponse], error)
	// WaitForPosition waits for the position to be reached
	WaitForPosition(context.Context, *connect.Request[v15.WaitForPositionRequest]) (*connect.Response[v15.WaitForPositionResponse], error)
	...
	StopReplicationMinimum(context.Context, *connect.Request[v15.StopReplicationMinimumRequest]) (*connect.Response[v15.StopReplicationMinimumResponse], error)
	...
	StartReplicationUntilAfter(context.Context, *connect.Request[v15.StartReplicationUntilAfterRequest]) (*connect.Response[v15.StartReplicationUntilAfterResponse], error)
	// GetReplicas asks for the list of mysql replicas
	GetReplicas(context.Context, *connect.Request[v15.GetReplicasRequest]) (*connect.Response[v15.GetReplicasResponse], error)
	// VReplication API
	VReplicationExec(context.Context, *connect.Request[v15.VReplicationExecRequest]) (*connect.Response[v15.VReplicationExecResponse], error)
	VReplicationWaitForPos(context.Context, *connect.Request[v15.VReplicationWaitForPosRequest]) (*connect.Response[v15.VReplicationWaitForPosResponse], error)
	// VDiff API
	VDiff(context.Context, *connect.Request[v15.VDiffRequest]) (*connect.Response[v15.VDiffResponse], error)
	// ResetReplication makes the target not replicating
	ResetReplication(context.Context, *connect.Request[v15.ResetReplicationRequest]) (*connect.Response[v15.ResetReplicationResponse], error)
	// InitPrimary initializes the tablet as a primary
	InitPrimary(context.Context, *connect.Request[v15.InitPrimaryRequest]) (*connect.Response[v15.InitPrimaryResponse], error)
	// PopulateReparentJournal tells the tablet to add an entry to its
	// reparent journal
	PopulateReparentJournal(context.Context, *connect.Request[v15.PopulateReparentJournalRequest]) (*connect.Response[v15.PopulateReparentJournalResponse], error)
	// InitReplica tells the tablet to reparent to the primary unconditionally
	InitReplica(context.Context, *connect.Request[v15.InitReplicaRequest]) (*connect.Response[v15.InitReplicaResponse], error)
	// DemotePrimary tells the soon-to-be-former primary it's gonna change
	DemotePrimary(context.Context, *connect.Request[v15.DemotePrimaryRequest]) (*connect.Response[v15.DemotePrimaryResponse], error)
	// UndoDemotePrimary reverts all changes made by DemotePrimary
	UndoDemotePrimary(context.Context, *connect.Request[v15.UndoDemotePrimaryRequest]) (*connect.Response[v15.UndoDemotePrimaryResponse], error)
	// ReplicaWasPromoted tells the remote tablet it is now the primary
	ReplicaWasPromoted(context.Context, *connect.Request[v15.ReplicaWasPromotedRequest]) (*connect.Response[v15.ReplicaWasPromotedResponse], error)
	// ResetReplicationParameters resets the replica replication parameters
	ResetReplicationParameters(context.Context, *connect.Request[v15.ResetReplicationParametersRequest]) (*connect.Response[v15.ResetReplicationParametersResponse], error)
	...
	FullStatus(context.Context, *connect.Request[v15.FullStatusRequest]) (*connect.Response[v15.FullStatusResponse], error)
	// SetReplicationSource tells the replica to reparent
	SetReplicationSource(context.Context, *connect.Request[v15.SetReplicationSourceRequest]) (*connect.Response[v15.SetReplicationSourceResponse], error)
	// ReplicaWasRestarted tells the remote tablet its primary has changed
	ReplicaWasRestarted(context.Context, *connect.Request[v15.ReplicaWasRestartedRequest]) (*connect.Response[v15.ReplicaWasRestartedResponse], error)
	// StopReplicationAndGetStatus stops MySQL replication, and returns the
	// replication status
	StopReplicationAndGetStatus(context.Context, *connect.Request[v15.StopReplicationAndGetStatusRequest]) (*connect.Response[v15.StopReplicationAndGetStatusResponse], error)
	// PromoteReplica makes the replica the new primary
	PromoteReplica(context.Context, *connect.Request[v15.PromoteReplicaRequest]) (*connect.Response[v15.PromoteReplicaResponse], error)
	...
	VExec(context.Context, *connect.Request[v15.VExecRequest]) (*connect.Response[v15.VExecResponse], error)
}
...
func NewTabletManagerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TabletManagerClient {
	...
	return &tabletManagerClient{
		ping: connect.NewClient[v15.PingRequest, v15.PingResponse](
			httpClient,
			baseURL+TabletManagerPingProcedure,
			opts...,
		),
		sleep: connect.NewClient[v15.SleepRequest, v15.SleepResponse](
			httpClient,
		...
		setReadOnly: connect.NewClient[v15.SetReadOnlyRequest, v15.SetReadOnlyResponse](
			httpClient,
			baseURL+TabletManagerSetReadOnlyProcedure,
			opts...,
		),
		setReadWrite: connect.NewClient[v15.SetReadWriteRequest, v15.SetReadWriteResponse](
			httpClient,
			baseURL+TabletManagerSetReadWriteProcedure,
			opts...,
		),
		changeType: connect.NewClient[v15.ChangeTypeRequest, v15.ChangeTypeResponse](
			httpClient,
		...
		preflightSchema: connect.NewClient[v15.PreflightSchemaRequest, v15.PreflightSchemaResponse](
			httpClient,
		...
		lockTables: connect.NewClient[v15.LockTablesRequest, v15.LockTablesResponse](
			httpClient,
			baseURL+TabletManagerLockTablesProcedure,
			opts...,
		),
		unlockTables: connect.NewClient[v15.UnlockTablesRequest, v15.UnlockTablesResponse](
			httpClient,
			baseURL+TabletManagerUnlockTablesProcedure,
			opts...,
		),
		executeQuery: connect.NewClient[v15.ExecuteQueryRequest, v15.ExecuteQueryResponse](
			httpClient,
		...
		executeFetchAsAllPrivs: connect.NewClient[v15.ExecuteFetchAsAllPrivsRequest, v15.ExecuteFetchAsAllPrivsResponse](
			httpClient,
		...
		replicationStatus: connect.NewClient[v15.ReplicationStatusRequest, v15.ReplicationStatusResponse](
			httpClient,
			baseURL+TabletManagerReplicationStatusProcedure,
			opts...,
		),
		primaryStatus: connect.NewClient[v15.PrimaryStatusRequest, v15.PrimaryStatusResponse](
			httpClient,
			baseURL+TabletManagerPrimaryStatusProcedure,
			opts...,
		),
		primaryPosition: connect.NewClient[v15.PrimaryPositionRequest, v15.PrimaryPositionResponse](
			httpClient,
			baseURL+TabletManagerPrimaryPositionProcedure,
			opts...,
		),
		waitForPosition: connect.NewClient[v15.WaitForPositionRequest, v15.WaitForPositionResponse](
			httpClient,
		...
		stopReplicationMinimum: connect.NewClient[v15.StopReplicationMinimumRequest, v15.StopReplicationMinimumResponse](
			httpClient,
		...
		startReplicationUntilAfter: connect.NewClient[v15.StartReplicationUntilAfterRequest, v15.StartReplicationUntilAfterResponse](
			httpClient,
			baseURL+TabletManagerStartReplicationUntilAfterProcedure,
			opts...,
		),
		getReplicas: connect.NewClient[v15.GetReplicasRequest, v15.GetReplicasResponse](
			httpClient,
			baseURL+TabletManagerGetReplicasProcedure,
			opts...,
		),
		vReplicationExec: connect.NewClient[v15.VReplicationExecRequest, v15.VReplicationExecResponse](
			httpClient,
			baseURL+TabletManagerVReplicationExecProcedure,
			opts...,
		),
		vReplicationWaitForPos: connect.NewClient[v15.VReplicationWaitForPosRequest, v15.VReplicationWaitForPosResponse](
			httpClient,
			baseURL+TabletManagerVReplicationWaitForPosProcedure,
			opts...,
		),
		vDiff: connect.NewClient[v15.VDiffRequest, v15.VDiffResponse](
			httpClient,
			baseURL+TabletManagerVDiffProcedure,
			opts...,
		),
		resetReplication: connect.NewClient[v15.ResetReplicationRequest, v15.ResetReplicationResponse](
			httpClient,
			baseURL+TabletManagerResetReplicationProcedure,
			opts...,
		),
		initPrimary: connect.NewClient[v15.InitPrimaryRequest, v15.InitPrimaryResponse](
			httpClient,
			baseURL+TabletManagerInitPrimaryProcedure,
			opts...,
		),
		populateReparentJournal: connect.NewClient[v15.PopulateReparentJournalRequest, v15.PopulateReparentJournalResponse](
			httpClient,
			baseURL+TabletManagerPopulateReparentJournalProcedure,
			opts...,
		),
		initReplica: connect.NewClient[v15.InitReplicaRequest, v15.InitReplicaResponse](
			httpClient,
			baseURL+TabletManagerInitReplicaProcedure,
			opts...,
		),
		demotePrimary: connect.NewClient[v15.DemotePrimaryRequest, v15.DemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerDemotePrimaryProcedure,
			opts...,
		),
		undoDemotePrimary: connect.NewClient[v15.UndoDemotePrimaryRequest, v15.UndoDemotePrimaryResponse](
			httpClient,
			baseURL+TabletManagerUndoDemotePrimaryProcedure,
			opts...,
		),
		replicaWasPromoted: connect.NewClient[v15.ReplicaWasPromotedRequest, v15.ReplicaWasPromotedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasPromotedProcedure,
			opts...,
		),
		resetReplicationParameters: connect.NewClient[v15.ResetReplicationParametersRequest, v15.ResetReplicationParametersResponse](
			httpClient,
			baseURL+TabletManagerResetReplicationParametersProcedure,
			opts...,
		),
		fullStatus: connect.NewClient[v15.FullStatusRequest, v15.FullStatusResponse](
			httpClient,
			baseURL+TabletManagerFullStatusProcedure,
			opts...,
		),
		setReplicationSource: connect.NewClient[v15.SetReplicationSourceRequest, v15.SetReplicationSourceResponse](
			httpClient,
			baseURL+TabletManagerSetReplicationSourceProcedure,
			opts...,
		),
		replicaWasRestarted: connect.NewClient[v15.ReplicaWasRestartedRequest, v15.ReplicaWasRestartedResponse](
			httpClient,
			baseURL+TabletManagerReplicaWasRestartedProcedure,
			opts...,
		),
		stopReplicationAndGetStatus: connect.NewClient[v15.StopReplicationAndGetStatusRequest, v15.StopReplicationAndGetStatusResponse](
			httpClient,
			baseURL+TabletManagerStopReplicationAndGetStatusProcedure,
			opts...,
		),
		promoteReplica: connect.NewClient[v15.PromoteReplicaRequest, v15.PromoteReplicaResponse](
			httpClient,
		...
		vExec: connect.NewClient[v15.VExecRequest, v15.VExecResponse](
			httpClient,
...
type tabletManagerClient struct {
	ping                        *connect.Client[v15.PingRequest, v15.PingResponse]
	sleep                       *connect.Client[v15.SleepRequest, v15.SleepResponse]
	...
	setReadOnly                 *connect.Client[v15.SetReadOnlyRequest, v15.SetReadOnlyResponse]
	setReadWrite                *connect.Client[v15.SetReadWriteRequest, v15.SetReadWriteResponse]
	changeType                  *connect.Client[v15.ChangeTypeRequest, v15.ChangeTypeResponse]
	...
	preflightSchema             *connect.Client[v15.PreflightSchemaRequest, v15.PreflightSchemaResponse]
	applySchema                 *connect.Client[v15.ApplySchemaRequest, v15.ApplySchemaResponse]
	lockTables                  *connect.Client[v15.LockTablesRequest, v15.LockTablesResponse]
	unlockTables                *connect.Client[v15.UnlockTablesRequest, v15.UnlockTablesResponse]
	executeQuery                *connect.Client[v15.ExecuteQueryRequest, v15.ExecuteQueryResponse]
	executeFetchAsDba           *connect.Client[v15.ExecuteFetchAsDbaRequest, v15.ExecuteFetchAsDbaResponse]
	executeFetchAsAllPrivs      *connect.Client[v15.ExecuteFetchAsAllPrivsRequest, v15.ExecuteFetchAsAllPrivsResponse]
	executeFetchAsApp           *connect.Client[v15.ExecuteFetchAsAppRequest, v15.ExecuteFetchAsAppResponse]
	replicationStatus           *connect.Client[v15.ReplicationStatusRequest, v15.ReplicationStatusResponse]
	primaryStatus               *connect.Client[v15.PrimaryStatusRequest, v15.PrimaryStatusResponse]
	primaryPosition             *connect.Client[v15.PrimaryPositionRequest, v15.PrimaryPositionResponse]
	waitForPosition             *connect.Client[v15.WaitForPositionRequest, v15.WaitForPositionResponse]
	stopReplication             *connect.Client[v15.StopReplicationRequest, v15.StopReplicationResponse]
	stopReplicationMinimum      *connect.Client[v15.StopReplicationMinimumRequest, v15.StopReplicationMinimumResponse]
	startReplication            *connect.Client[v15.StartReplicationRequest, v15.StartReplicationResponse]
	startReplicationUntilAfter  *connect.Client[v15.StartReplicationUntilAfterRequest, v15.StartReplicationUntilAfterResponse]
	getReplicas                 *connect.Client[v15.GetReplicasRequest, v15.GetReplicasResponse]
	vReplicationExec            *connect.Client[v15.VReplicationExecRequest, v15.VReplicationExecResponse]
	vReplicationWaitForPos      *connect.Client[v15.VReplicationWaitForPosRequest, v15.VReplicationWaitForPosResponse]
	vDiff                       *connect.Client[v15.VDiffRequest, v15.VDiffResponse]
	resetReplication            *connect.Client[v15.ResetReplicationRequest, v15.ResetReplicationResponse]
	initPrimary                 *connect.Client[v15.InitPrimaryRequest, v15.InitPrimaryResponse]
	populateReparentJournal     *connect.Client[v15.PopulateReparentJournalRequest, v15.PopulateReparentJournalResponse]
	initReplica                 *connect.Client[v15.InitReplicaRequest, v15.InitReplicaResponse]
	demotePrimary               *connect.Client[v15.DemotePrimaryRequest, v15.DemotePrimaryResponse]
	undoDemotePrimary           *connect.Client[v15.UndoDemotePrimaryRequest, v15.UndoDemotePrimaryResponse]
	replicaWasPromoted          *connect.Client[v15.ReplicaWasPromotedRequest, v15.ReplicaWasPromotedResponse]
	resetReplicationParameters  *connect.Client[v15.ResetReplicationParametersRequest, v15.ResetReplicationParametersResponse]
	fullStatus                  *connect.Client[v15.FullStatusRequest, v15.FullStatusResponse]
	setReplicationSource        *connect.Client[v15.SetReplicationSourceRequest, v15.SetReplicationSourceResponse]
	replicaWasRestarted         *connect.Client[v15.ReplicaWasRestartedRequest, v15.ReplicaWasRestartedResponse]
	stopReplicationAndGetStatus *connect.Client[v15.StopReplicationAndGetStatusRequest, v15.StopReplicationAndGetStatusResponse]
	promoteReplica              *connect.Client[v15.PromoteReplicaRequest, v15.PromoteReplicaResponse]
	...
	vExec                       *connect.Client[v15.VExecRequest, v15.VExecResponse]
}

// Ping calls tabletmanagerservice.TabletManager.Ping.
func (c *tabletManagerClient) Ping(ctx context.Context, req *connect.Request[v15.PingRequest]) (*connect.Response[v15.PingResponse], error) {
	return c.ping.CallUnary(ctx, req)
}

// Sleep calls tabletmanagerservice.TabletManager.Sleep.
func (c *tabletManagerClient) Sleep(ctx context.Context, req *connect.Request[v15.SleepRequest]) (*connect.Response[v15.SleepResponse], error) {
	return c.sleep.CallUnary(ctx, req)
}

// ExecuteHook calls tabletmanagerservice.TabletManager.ExecuteHook.
func (c *tabletManagerClient) ExecuteHook(ctx context.Context, req *connect.Request[v15.ExecuteHookRequest]) (*connect.Response[v15.ExecuteHookResponse], error) {
	return c.executeHook.CallUnary(ctx, req)
}

// GetSchema calls tabletmanagerservice.TabletManager.GetSchema.
func (c *tabletManagerClient) GetSchema(ctx context.Context, req *connect.Request[v15.GetSchemaRequest]) (*connect.Response[v15.GetSchemaResponse], error) {
	return c.getSchema.CallUnary(ctx, req)
}

// GetPermissions calls tabletmanagerservice.TabletManager.GetPermissions.
func (c *tabletManagerClient) GetPermissions(ctx context.Context, req *connect.Request[v15.GetPermissionsRequest]) (*connect.Response[v15.GetPermissionsResponse], error) {
	return c.getPermissions.CallUnary(ctx, req)
}

// SetReadOnly calls tabletmanagerservice.TabletManager.SetReadOnly.
func (c *tabletManagerClient) SetReadOnly(ctx context.Context, req *connect.Request[v15.SetReadOnlyRequest]) (*connect.Response[v15.SetReadOnlyResponse], error) {
	return c.setReadOnly.CallUnary(ctx, req)
}

// SetReadWrite calls tabletmanagerservice.TabletManager.SetReadWrite.
func (c *tabletManagerClient) SetReadWrite(ctx context.Context, req *connect.Request[v15.SetReadWriteRequest]) (*connect.Response[v15.SetReadWriteResponse], error) {
	return c.setReadWrite.CallUnary(ctx, req)
}

// ChangeType calls tabletmanagerservice.TabletManager.ChangeType.
func (c *tabletManagerClient) ChangeType(ctx context.Context, req *connect.Request[v15.ChangeTypeRequest]) (*connect.Response[v15.ChangeTypeResponse], error) {
	return c.changeType.CallUnary(ctx, req)
}

// RefreshState calls tabletmanagerservice.TabletManager.RefreshState.
func (c *tabletManagerClient) RefreshState(ctx context.Context, req *connect.Request[v15.RefreshStateRequest]) (*connect.Response[v15.RefreshStateResponse], error) {
	return c.refreshState.CallUnary(ctx, req)
}

// RunHealthCheck calls tabletmanagerservice.TabletManager.RunHealthCheck.
func (c *tabletManagerClient) RunHealthCheck(ctx context.Context, req *connect.Request[v15.RunHealthCheckRequest]) (*connect.Response[v15.RunHealthCheckResponse], error) {
	return c.runHealthCheck.CallUnary(ctx, req)
}

// ReloadSchema calls tabletmanagerservice.TabletManager.ReloadSchema.
func (c *tabletManagerClient) ReloadSchema(ctx context.Context, req *connect.Request[v15.ReloadSchemaRequest]) (*connect.Response[v15.ReloadSchemaResponse], error) {
	return c.reloadSchema.CallUnary(ctx, req)
}

// PreflightSchema calls tabletmanagerservice.TabletManager.PreflightSchema.
func (c *tabletManagerClient) PreflightSchema(ctx context.Context, req *connect.Request[v15.PreflightSchemaRequest]) (*connect.Response[v15.PreflightSchemaResponse], error) {
	return c.preflightSchema.CallUnary(ctx, req)
}

// ApplySchema calls tabletmanagerservice.TabletManager.ApplySchema.
func (c *tabletManagerClient) ApplySchema(ctx context.Context, req *connect.Request[v15.ApplySchemaRequest]) (*connect.Response[v15.ApplySchemaResponse], error) {
	return c.applySchema.CallUnary(ctx, req)
}

// LockTables calls tabletmanagerservice.TabletManager.LockTables.
func (c *tabletManagerClient) LockTables(ctx context.Context, req *connect.Request[v15.LockTablesRequest]) (*connect.Response[v15.LockTablesResponse], error) {
	return c.lockTables.CallUnary(ctx, req)
}

// UnlockTables calls tabletmanagerservice.TabletManager.UnlockTables.
func (c *tabletManagerClient) UnlockTables(ctx context.Context, req *connect.Request[v15.UnlockTablesRequest]) (*connect.Response[v15.UnlockTablesResponse], error) {
	return c.unlockTables.CallUnary(ctx, req)
}

// ExecuteQuery calls tabletmanagerservice.TabletManager.ExecuteQuery.
func (c *tabletManagerClient) ExecuteQuery(ctx context.Context, req *connect.Request[v15.ExecuteQueryRequest]) (*connect.Response[v15.ExecuteQueryResponse], error) {
	return c.executeQuery.CallUnary(ctx, req)
}

// ExecuteFetchAsDba calls tabletmanagerservice.TabletManager.ExecuteFetchAsDba.
func (c *tabletManagerClient) ExecuteFetchAsDba(ctx context.Context, req *connect.Request[v15.ExecuteFetchAsDbaRequest]) (*connect.Response[v15.ExecuteFetchAsDbaResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsAllPrivs(ctx context.Context, req *connect.Request[v15.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v15.ExecuteFetchAsAllPrivsResponse], error) {
...
func (c *tabletManagerClient) ExecuteFetchAsApp(ctx context.Context, req *connect.Request[v15.ExecuteFetchAsAppRequest]) (*connect.Response[v15.ExecuteFetchAsAppResponse], error) {
	return c.executeFetchAsApp.CallUnary(ctx, req)
}

// ReplicationStatus calls tabletmanagerservice.TabletManager.ReplicationStatus.
func (c *tabletManagerClient) ReplicationStatus(ctx context.Context, req *connect.Request[v15.ReplicationStatusRequest]) (*connect.Response[v15.ReplicationStatusResponse], error) {
	return c.replicationStatus.CallUnary(ctx, req)
}

// PrimaryStatus calls tabletmanagerservice.TabletManager.PrimaryStatus.
func (c *tabletManagerClient) PrimaryStatus(ctx context.Context, req *connect.Request[v15.PrimaryStatusRequest]) (*connect.Response[v15.PrimaryStatusResponse], error) {
	return c.primaryStatus.CallUnary(ctx, req)
}

// PrimaryPosition calls tabletmanagerservice.TabletManager.PrimaryPosition.
func (c *tabletManagerClient) PrimaryPosition(ctx context.Context, req *connect.Request[v15.PrimaryPositionRequest]) (*connect.Response[v15.PrimaryPositionResponse], error) {
	return c.primaryPosition.CallUnary(ctx, req)
}

// WaitForPosition calls tabletmanagerservice.TabletManager.WaitForPosition.
func (c *tabletManagerClient) WaitForPosition(ctx context.Context, req *connect.Request[v15.WaitForPositionRequest]) (*connect.Response[v15.WaitForPositionResponse], error) {
	return c.waitForPosition.CallUnary(ctx, req)
}

// StopReplication calls tabletmanagerservice.TabletManager.StopReplication.
func (c *tabletManagerClient) StopReplication(ctx context.Context, req *connect.Request[v15.StopReplicationRequest]) (*connect.Response[v15.StopReplicationResponse], error) {
...
func (c *tabletManagerClient) StopReplicationMinimum(ctx context.Context, req *connect.Request[v15.StopReplicationMinimumRequest]) (*connect.Response[v15.StopReplicationMinimumResponse], error) {
...
func (c *tabletManagerClient) StartReplication(ctx context.Context, req *connect.Request[v15.StartReplicationRequest]) (*connect.Response[v15.StartReplicationResponse], error) {
...
func (c *tabletManagerClient) StartReplicationUntilAfter(ctx context.Context, req *connect.Request[v15.StartReplicationUntilAfterRequest]) (*connect.Response[v15.StartReplicationUntilAfterResponse], error) {
	return c.startReplicationUntilAfter.CallUnary(ctx, req)
}

// GetReplicas calls tabletmanagerservice.TabletManager.GetReplicas.
func (c *tabletManagerClient) GetReplicas(ctx context.Context, req *connect.Request[v15.GetReplicasRequest]) (*connect.Response[v15.GetReplicasResponse], error) {
	return c.getReplicas.CallUnary(ctx, req)
}

// VReplicationExec calls tabletmanagerservice.TabletManager.VReplicationExec.
func (c *tabletManagerClient) VReplicationExec(ctx context.Context, req *connect.Request[v15.VReplicationExecRequest]) (*connect.Response[v15.VReplicationExecResponse], error) {
...
func (c *tabletManagerClient) VReplicationWaitForPos(ctx context.Context, req *connect.Request[v15.VReplicationWaitForPosRequest]) (*connect.Response[v15.VReplicationWaitForPosResponse], error) {
	return c.vReplicationWaitForPos.CallUnary(ctx, req)
}

// VDiff calls tabletmanagerservice.TabletManager.VDiff.
func (c *tabletManagerClient) VDiff(ctx context.Context, req *connect.Request[v15.VDiffRequest]) (*connect.Response[v15.VDiffResponse], error) {
	return c.vDiff.CallUnary(ctx, req)
}

// ResetReplication calls tabletmanagerservice.TabletManager.ResetReplication.
func (c *tabletManagerClient) ResetReplication(ctx context.Context, req *connect.Request[v15.ResetReplicationRequest]) (*connect.Response[v15.ResetReplicationResponse], error) {
	return c.resetReplication.CallUnary(ctx, req)
}

// InitPrimary calls tabletmanagerservice.TabletManager.InitPrimary.
func (c *tabletManagerClient) InitPrimary(ctx context.Context, req *connect.Request[v15.InitPrimaryRequest]) (*connect.Response[v15.InitPrimaryResponse], error) {
...
func (c *tabletManagerClient) PopulateReparentJournal(ctx context.Context, req *connect.Request[v15.PopulateReparentJournalRequest]) (*connect.Response[v15.PopulateReparentJournalResponse], error) {
	return c.populateReparentJournal.CallUnary(ctx, req)
}

// InitReplica calls tabletmanagerservice.TabletManager.InitReplica.
func (c *tabletManagerClient) InitReplica(ctx context.Context, req *connect.Request[v15.InitReplicaRequest]) (*connect.Response[v15.InitReplicaResponse], error) {
	return c.initReplica.CallUnary(ctx, req)
}

// DemotePrimary calls tabletmanagerservice.TabletManager.DemotePrimary.
func (c *tabletManagerClient) DemotePrimary(ctx context.Context, req *connect.Request[v15.DemotePrimaryRequest]) (*connect.Response[v15.DemotePrimaryResponse], error) {
	return c.demotePrimary.CallUnary(ctx, req)
}

// UndoDemotePrimary calls tabletmanagerservice.TabletManager.UndoDemotePrimary.
func (c *tabletManagerClient) UndoDemotePrimary(ctx context.Context, req *connect.Request[v15.UndoDemotePrimaryRequest]) (*connect.Response[v15.UndoDemotePrimaryResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasPromoted(ctx context.Context, req *connect.Request[v15.ReplicaWasPromotedRequest]) (*connect.Response[v15.ReplicaWasPromotedResponse], error) {
...
func (c *tabletManagerClient) ResetReplicationParameters(ctx context.Context, req *connect.Request[v15.ResetReplicationParametersRequest]) (*connect.Response[v15.ResetReplicationParametersResponse], error) {
	return c.resetReplicationParameters.CallUnary(ctx, req)
}

// FullStatus calls tabletmanagerservice.TabletManager.FullStatus.
func (c *tabletManagerClient) FullStatus(ctx context.Context, req *connect.Request[v15.FullStatusRequest]) (*connect.Response[v15.FullStatusResponse], error) {
	return c.fullStatus.CallUnary(ctx, req)
}

// SetReplicationSource calls tabletmanagerservice.TabletManager.SetReplicationSource.
func (c *tabletManagerClient) SetReplicationSource(ctx context.Context, req *connect.Request[v15.SetReplicationSourceRequest]) (*connect.Response[v15.SetReplicationSourceResponse], error) {
...
func (c *tabletManagerClient) ReplicaWasRestarted(ctx context.Context, req *connect.Request[v15.ReplicaWasRestartedRequest]) (*connect.Response[v15.ReplicaWasRestartedResponse], error) {
...
func (c *tabletManagerClient) StopReplicationAndGetStatus(ctx context.Context, req *connect.Request[v15.StopReplicationAndGetStatusRequest]) (*connect.Response[v15.StopReplicationAndGetStatusResponse], error) {
...
func (c *tabletManagerClient) PromoteReplica(ctx context.Context, req *connect.Request[v15.PromoteReplicaRequest]) (*connect.Response[v15.PromoteReplicaResponse], error) {
	return c.promoteReplica.CallUnary(ctx, req)
}

// Backup calls tabletmanagerservice.TabletManager.Backup.
func (c *tabletManagerClient) Backup(ctx context.Context, req *connect.Request[v15.BackupRequest]) (*connect.ServerStreamForClient[v15.BackupResponse], error) {
	return c.backup.CallServerStream(ctx, req)
}

// RestoreFromBackup calls tabletmanagerservice.TabletManager.RestoreFromBackup.
func (c *tabletManagerClient) RestoreFromBackup(ctx context.Context, req *connect.Request[v15.RestoreFromBackupRequest]) (*connect.ServerStreamForClient[v15.RestoreFromBackupResponse], error) {
	return c.restoreFromBackup.CallServerStream(ctx, req)
}

// VExec calls tabletmanagerservice.TabletManager.VExec.
func (c *tabletManagerClient) VExec(ctx context.Context, req *connect.Request[v15.VExecRequest]) (*connect.Response[v15.VExecResponse], error) {
...
func (UnimplementedTabletManagerHandler) Ping(context.Context, *connect.Request[v15.PingRequest]) (*connect.Response[v15.PingResponse], error) {
...
func (UnimplementedTabletManagerHandler) Sleep(context.Context, *connect.Request[v15.SleepRequest]) (*connect.Response[v15.SleepResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteHook(context.Context, *connect.Request[v15.ExecuteHookRequest]) (*connect.Response[v15.ExecuteHookResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetSchema(context.Context, *connect.Request[v15.GetSchemaRequest]) (*connect.Response[v15.GetSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetPermissions(context.Context, *connect.Request[v15.GetPermissionsRequest]) (*connect.Response[v15.GetPermissionsResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadOnly(context.Context, *connect.Request[v15.SetReadOnlyRequest]) (*connect.Response[v15.SetReadOnlyResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReadWrite(context.Context, *connect.Request[v15.SetReadWriteRequest]) (*connect.Response[v15.SetReadWriteResponse], error) {
...
func (UnimplementedTabletManagerHandler) ChangeType(context.Context, *connect.Request[v15.ChangeTypeRequest]) (*connect.Response[v15.ChangeTypeResponse], error) {
...
func (UnimplementedTabletManagerHandler) RefreshState(context.Context, *connect.Request[v15.RefreshStateRequest]) (*connect.Response[v15.RefreshStateResponse], error) {
...
func (UnimplementedTabletManagerHandler) RunHealthCheck(context.Context, *connect.Request[v15.RunHealthCheckRequest]) (*connect.Response[v15.RunHealthCheckResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReloadSchema(context.Context, *connect.Request[v15.ReloadSchemaRequest]) (*connect.Response[v15.ReloadSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) PreflightSchema(context.Context, *connect.Request[v15.PreflightSchemaRequest]) (*connect.Response[v15.PreflightSchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ApplySchema(context.Context, *connect.Request[v15.ApplySchemaRequest]) (*connect.Response[v15.ApplySchemaResponse], error) {
...
func (UnimplementedTabletManagerHandler) LockTables(context.Context, *connect.Request[v15.LockTablesRequest]) (*connect.Response[v15.LockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) UnlockTables(context.Context, *connect.Request[v15.UnlockTablesRequest]) (*connect.Response[v15.UnlockTablesResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteQuery(context.Context, *connect.Request[v15.ExecuteQueryRequest]) (*connect.Response[v15.ExecuteQueryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsDba(context.Context, *connect.Request[v15.ExecuteFetchAsDbaRequest]) (*connect.Response[v15.ExecuteFetchAsDbaResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsAllPrivs(context.Context, *connect.Request[v15.ExecuteFetchAsAllPrivsRequest]) (*connect.Response[v15.ExecuteFetchAsAllPrivsResponse], error) {
...
func (UnimplementedTabletManagerHandler) ExecuteFetchAsApp(context.Context, *connect.Request[v15.ExecuteFetchAsAppRequest]) (*connect.Response[v15.ExecuteFetchAsAppResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicationStatus(context.Context, *connect.Request[v15.ReplicationStatusRequest]) (*connect.Response[v15.ReplicationStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryStatus(context.Context, *connect.Request[v15.PrimaryStatusRequest]) (*connect.Response[v15.PrimaryStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PrimaryPosition(context.Context, *connect.Request[v15.PrimaryPositionRequest]) (*connect.Response[v15.PrimaryPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) WaitForPosition(context.Context, *connect.Request[v15.WaitForPositionRequest]) (*connect.Response[v15.WaitForPositionResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplication(context.Context, *connect.Request[v15.StopReplicationRequest]) (*connect.Response[v15.StopReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationMinimum(context.Context, *connect.Request[v15.StopReplicationMinimumRequest]) (*connect.Response[v15.StopReplicationMinimumResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplication(context.Context, *connect.Request[v15.StartReplicationRequest]) (*connect.Response[v15.StartReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) StartReplicationUntilAfter(context.Context, *connect.Request[v15.StartReplicationUntilAfterRequest]) (*connect.Response[v15.StartReplicationUntilAfterResponse], error) {
...
func (UnimplementedTabletManagerHandler) GetReplicas(context.Context, *connect.Request[v15.GetReplicasRequest]) (*connect.Response[v15.GetReplicasResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationExec(context.Context, *connect.Request[v15.VReplicationExecRequest]) (*connect.Response[v15.VReplicationExecResponse], error) {
...
func (UnimplementedTabletManagerHandler) VReplicationWaitForPos(context.Context, *connect.Request[v15.VReplicationWaitForPosRequest]) (*connect.Response[v15.VReplicationWaitForPosResponse], error) {
...
func (UnimplementedTabletManagerHandler) VDiff(context.Context, *connect.Request[v15.VDiffRequest]) (*connect.Response[v15.VDiffResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplication(context.Context, *connect.Request[v15.ResetReplicationRequest]) (*connect.Response[v15.ResetReplicationResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitPrimary(context.Context, *connect.Request[v15.InitPrimaryRequest]) (*connect.Response[v15.InitPrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) PopulateReparentJournal(context.Context, *connect.Request[v15.PopulateReparentJournalRequest]) (*connect.Response[v15.PopulateReparentJournalResponse], error) {
...
func (UnimplementedTabletManagerHandler) InitReplica(context.Context, *connect.Request[v15.InitReplicaRequest]) (*connect.Response[v15.InitReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) DemotePrimary(context.Context, *connect.Request[v15.DemotePrimaryRequest]) (*connect.Response[v15.DemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) UndoDemotePrimary(context.Context, *connect.Request[v15.UndoDemotePrimaryRequest]) (*connect.Response[v15.UndoDemotePrimaryResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasPromoted(context.Context, *connect.Request[v15.ReplicaWasPromotedRequest]) (*connect.Response[v15.ReplicaWasPromotedResponse], error) {
...
func (UnimplementedTabletManagerHandler) ResetReplicationParameters(context.Context, *connect.Request[v15.ResetReplicationParametersRequest]) (*connect.Response[v15.ResetReplicationParametersResponse], error) {
...
func (UnimplementedTabletManagerHandler) FullStatus(context.Context, *connect.Request[v15.FullStatusRequest]) (*connect.Response[v15.FullStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) SetReplicationSource(context.Context, *connect.Request[v15.SetReplicationSourceRequest]) (*connect.Response[v15.SetReplicationSourceResponse], error) {
...
func (UnimplementedTabletManagerHandler) ReplicaWasRestarted(context.Context, *connect.Request[v15.ReplicaWasRestartedRequest]) (*connect.Response[v15.ReplicaWasRestartedResponse], error) {
...
func (UnimplementedTabletManagerHandler) StopReplicationAndGetStatus(context.Context, *connect.Request[v15.StopReplicationAndGetStatusRequest]) (*connect.Response[v15.StopReplicationAndGetStatusResponse], error) {
...
func (UnimplementedTabletManagerHandler) PromoteReplica(context.Context, *connect.Request[v15.PromoteReplicaRequest]) (*connect.Response[v15.PromoteReplicaResponse], error) {
...
func (UnimplementedTabletManagerHandler) Backup(context.Context, *connect.Request[v15.BackupRequest], *connect.ServerStream[v15.BackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) RestoreFromBackup(context.Context, *connect.Request[v15.RestoreFromBackupRequest], *connect.ServerStream[v15.RestoreFromBackupResponse]) error {
...
func (UnimplementedTabletManagerHandler) VExec(context.Context, *connect.Request[v15.VExecRequest]) (*connect.Response[v15.VExecResponse], error) {
