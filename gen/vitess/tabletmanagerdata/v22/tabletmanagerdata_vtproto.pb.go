...
func (m *TableDefinition) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Fields = append(m.Fields, &v22.Field{})
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= v221.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ExecuteMultiFetchAsDbaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Results = append(m.Results, &v22.QueryResult{})
...
func (m *GetUnresolvedTransactionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Transactions = append(m.Transactions, &v22.TransactionMetadata{})
...
func (m *ReadTransactionResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Transaction == nil {
				m.Transaction = &v22.TransactionMetadata{}
			}
...
func (m *MysqlHostMetricsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HostMetrics == nil {
				m.HostMetrics = &v223.HostMetricsResponse{}
			}
...
func (m *PopulateReparentJournalRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryAlias == nil {
				m.PrimaryAlias = &v221.TabletAlias{}
			}
...
func (m *DemotePrimaryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrimaryStatus == nil {
				m.PrimaryStatus = &v224.PrimaryStatus{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StopReplicationMode |= v224.StopReplicationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StopReplicationAndGetStatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Status == nil {
				m.Status = &v224.StopReplicationStatus{}
			}
			if unmarshal, ok := interface{}(m.Status).(interface {
				UnmarshalVT([]byte) error
			}); ok {
...
func (m *BackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.MysqlShutdownTimeout == nil {
				m.MysqlShutdownTimeout = &v225.Duration{}
			}
...
func (m *RestoreFromBackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.RestoreToTimestamp == nil {
				m.RestoreToTimestamp = &v225.Time{}
			}
...
func (m *CreateVReplicationWorkflowRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.BinlogSource = append(m.BinlogSource, &v227.BinlogSource{})
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= v221.TabletType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.TabletTypes) == 0 {
					m.TabletTypes = make([]v221.TabletType, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v v221.TabletType
					for shift := uint(0); ; shift += 7 {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowType |= v227.VReplicationWorkflowType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowSubType |= v227.VReplicationWorkflowSubType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ReadVReplicationWorkflowsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				var v v227.VReplicationWorkflowState
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protohelpers.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= v227.VReplicationWorkflowState(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.IncludeStates) == 0 {
					m.IncludeStates = make([]v227.VReplicationWorkflowState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v v227.VReplicationWorkflowState
					for shift := uint(0); ; shift += 7 {
		...
		case 5:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.ExcludeStates) == 0 {
					m.ExcludeStates = make([]v227.VReplicationWorkflowState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v v227.VReplicationWorkflowState
					for shift := uint(0); ; shift += 7 {
...
func (m *ReadVReplicationWorkflowResponse_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &v225.Time{}
			}
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= v227.VReplicationWorkflowState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= v227.OnDDLAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 15:
			...
			if m.ThrottledApps == nil {
				m.ThrottledApps = make(map[string]*v221.ThrottledAppRule)
			}
			var mapkey string
			var mapvalue *v221.ThrottledAppRule
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &v221.ThrottledAppRule{}
