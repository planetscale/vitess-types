...
func (m *TableDefinition) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Fields = append(m.Fields, &v18.Field{})
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= v181.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PopulateReparentJournalRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryAlias == nil {
				m.PrimaryAlias = &v181.TabletAlias{}
			}
...
func (m *DemotePrimaryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrimaryStatus == nil {
				m.PrimaryStatus = &v183.PrimaryStatus{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StopReplicationMode |= v183.StopReplicationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StopReplicationAndGetStatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Status == nil {
				m.Status = &v183.StopReplicationStatus{}
			}
			if unmarshal, ok := interface{}(m.Status).(interface {
				UnmarshalVT([]byte) error
			}); ok {
...
func (m *RestoreFromBackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.RestoreToTimestamp == nil {
				m.RestoreToTimestamp = &v185.Time{}
			}
...
func (m *CreateVReplicationWorkflowRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.BinlogSource = append(m.BinlogSource, &v186.BinlogSource{})
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= v181.TabletType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.TabletTypes) == 0 {
					m.TabletTypes = make([]v181.TabletType, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v v181.TabletType
					for shift := uint(0); ; shift += 7 {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowType |= v186.VReplicationWorkflowType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowSubType |= v186.VReplicationWorkflowSubType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ReadVReplicationWorkflowResponse_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &v185.Time{}
			}
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= v186.VReplicationWorkflowState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnDdl |= v186.OnDDLAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
