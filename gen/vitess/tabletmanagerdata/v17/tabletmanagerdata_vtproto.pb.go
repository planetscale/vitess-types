...
func (m *PopulateReparentJournalRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryAlias == nil {
				m.PrimaryAlias = &v171.TabletAlias{}
			}
...
func (m *DemotePrimaryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrimaryStatus == nil {
				m.PrimaryStatus = &v173.PrimaryStatus{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StopReplicationMode |= v173.StopReplicationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StopReplicationAndGetStatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Status == nil {
				m.Status = &v173.StopReplicationStatus{}
			}
			if unmarshal, ok := interface{}(m.Status).(interface {
				UnmarshalVT([]byte) error
			}); ok {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnDdl |= v176.OnDDLAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
