...
func (m *TableDefinition) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Fields = append(m.Fields, &dev.Field{})
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletType |= dev1.TabletType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ExecuteMultiFetchAsDbaResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Results = append(m.Results, &dev.QueryResult{})
...
func (m *GetUnresolvedTransactionsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Transactions = append(m.Transactions, &dev.TransactionMetadata{})
...
func (m *ReadTransactionResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Transaction == nil {
				m.Transaction = &dev.TransactionMetadata{}
			}
...
func (m *MysqlHostMetricsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.HostMetrics == nil {
				m.HostMetrics = &dev3.HostMetricsResponse{}
			}
...
func (m *PopulateReparentJournalRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.PrimaryAlias == nil {
				m.PrimaryAlias = &dev1.TabletAlias{}
			}
...
func (m *DemotePrimaryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrimaryStatus == nil {
				m.PrimaryStatus = &dev4.PrimaryStatus{}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StopReplicationMode |= dev4.StopReplicationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *StopReplicationAndGetStatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Status == nil {
				m.Status = &dev4.StopReplicationStatus{}
			}
			if unmarshal, ok := interface{}(m.Status).(interface {
				UnmarshalVT([]byte) error
			}); ok {
		...
		case 2:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= dev1.TabletType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.TabletTypes) == 0 {
					m.TabletTypes = make([]dev1.TabletType, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v dev1.TabletType
					for shift := uint(0); ; shift += 7 {
...
func (m *BackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.MysqlShutdownTimeout == nil {
				m.MysqlShutdownTimeout = &dev5.Duration{}
			}
...
func (m *RestoreFromBackupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.RestoreToTimestamp == nil {
				m.RestoreToTimestamp = &dev5.Time{}
			}
...
func (m *CreateVReplicationWorkflowRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.BinlogSource = append(m.BinlogSource, &dev7.BinlogSource{})
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowType |= dev7.VReplicationWorkflowType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WorkflowSubType |= dev7.VReplicationWorkflowSubType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ReadVReplicationWorkflowsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				var v dev7.VReplicationWorkflowState
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protohelpers.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= dev7.VReplicationWorkflowState(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.IncludeStates) == 0 {
					m.IncludeStates = make([]dev7.VReplicationWorkflowState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v dev7.VReplicationWorkflowState
					for shift := uint(0); ; shift += 7 {
		...
		case 5:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.ExcludeStates) == 0 {
					m.ExcludeStates = make([]dev7.VReplicationWorkflowState, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v dev7.VReplicationWorkflowState
					for shift := uint(0); ; shift += 7 {
...
func (m *ReadVReplicationWorkflowResponse_Stream) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.TransactionTimestamp == nil {
				m.TransactionTimestamp = &dev5.Time{}
			}
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= dev7.VReplicationWorkflowState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= dev7.OnDDLAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			...
			m.FilterRules = append(m.FilterRules, &dev7.Rule{})
	...
	for iNdEx < l {
		...
		case 15:
			...
			if m.ThrottledApps == nil {
				m.ThrottledApps = make(map[string]*dev1.ThrottledAppRule)
			}
			var mapkey string
			var mapvalue *dev1.ThrottledAppRule
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &dev1.ThrottledAppRule{}
