...
type GetMaxValueForSequencesResponse struct {
	...
	MaxValuesBySequenceTable map[string]int64 `protobuf:"bytes,1,rep,name=max_values_by_sequence_table,json=maxValuesBySequenceTable,proto3" json:"max_values_by_sequence_table,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
