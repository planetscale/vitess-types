...
const file_vitess_replicationdata_v19_replicationdata_proto_rawDesc = "" +
	"\n" +
	"0vitess/replicationdata/v19/replicationdata.proto\x12\x1avitess.replicationdata.v19\"\x96\a\n" +
	"\x06Status\x12\x1a\n" +
	...
	"sslAllowed\x126\n" +
	"\x17replication_lag_unknown\x18\x18 \x01(\bR\x15replicationLagUnknownJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"\x8d\x01\n" +
	"\x15StopReplicationStatus\x12:\n" +
	"\x06before\x18\x01 \x01(\v2\".vitess.replicationdata.v19.StatusR\x06before\x128\n" +
	"\x05after\x18\x02 \x01(\v2\".vitess.replicationdata.v19.StatusR\x05after\"P\n" +
	"\rPrimaryStatus\x12\x1a\n" +
	"\bposition\x18\x01 \x01(\tR\bposition\x12#\n" +
	"\rfile_position\x18\x02 \x01(\tR\ffilePosition\"\x81\b\n" +
	"\n" +
	"FullStatus\x12\x1b\n" +
	"\tserver_id\x18\x01 \x01(\rR\bserverId\x12\x1f\n" +
	"\vserver_uuid\x18\x02 \x01(\tR\n" +
	"serverUuid\x12Q\n" +
	"\x12replication_status\x18\x03 \x01(\v2\".vitess.replicationdata.v19.StatusR\x11replicationStatus\x12P\n" +
	"\x0eprimary_status\x18\x04 \x01(\v2).vitess.replicationdata.v19.PrimaryStatusR\rprimaryStatus\x12\x1f\n" +
	...
	"\x0fsuper_read_only\x18\x15 \x01(\bR\rsuperReadOnly*;\n" +
	"\x13StopReplicationMode\x12\x12\n" +
	"\x0eIOANDSQLTHREAD\x10\x00\x12\x10\n" +
	"\fIOTHREADONLY\x10\x01BWZUgithub.com/planetscale/vitess-types/gen/vitess/replicationdata/v19;replicationdatav19b\x06proto3"

var (
	file_vitess_replicationdata_v19_replicationdata_proto_rawDescOnce sync.Once
	file_vitess_replicationdata_v19_replicationdata_proto_rawDescData []byte
)
...
func file_vitess_replicationdata_v19_replicationdata_proto_rawDescGZIP() []byte {
	file_vitess_replicationdata_v19_replicationdata_proto_rawDescOnce.Do(func() {
		file_vitess_replicationdata_v19_replicationdata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_replicationdata_v19_replicationdata_proto_rawDesc), len(file_vitess_replicationdata_v19_replicationdata_proto_rawDesc)))
	})
...
func file_vitess_replicationdata_v19_replicationdata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_replicationdata_v19_replicationdata_proto_rawDesc), len(file_vitess_replicationdata_v19_replicationdata_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
