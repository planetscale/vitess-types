...
const file_vitess_replicationdata_dev_replicationdata_proto_rawDesc = "" +
	"\n" +
	"0vitess/replicationdata/dev/replicationdata.proto\x12\x1avitess.replicationdata.dev\x1a\"vitess/topodata/dev/topodata.proto\"\xbd\a\n" +
	"\x06Status\x12\x1a\n" +
	...
	"\x13replica_net_timeout\x18\x02 \x01(\x05R\x11replicaNetTimeout\"\x8d\x01\n" +
	"\x15StopReplicationStatus\x12:\n" +
	"\x06before\x18\x01 \x01(\v2\".vitess.replicationdata.dev.StatusR\x06before\x128\n" +
	"\x05after\x18\x02 \x01(\v2\".vitess.replicationdata.dev.StatusR\x05after\"q\n" +
	...
	"serverUuid\x12Q\n" +
	"\x12replication_status\x18\x03 \x01(\v2\".vitess.replicationdata.dev.StatusR\x11replicationStatus\x12P\n" +
	"\x0eprimary_status\x18\x04 \x01(\v2).vitess.replicationdata.dev.PrimaryStatusR\rprimaryStatus\x12\x1f\n" +
	...
	"\x0fsuper_read_only\x18\x15 \x01(\bR\rsuperReadOnly\x12f\n" +
	"\x19replication_configuration\x18\x16 \x01(\v2).vitess.replicationdata.dev.ConfigurationR\x18replicationConfiguration\x12!\n" +
	"\fdisk_stalled\x18\x17 \x01(\bR\vdiskStalled\x12*\n" +
	"\x11semi_sync_blocked\x18\x18 \x01(\bR\x0fsemiSyncBlocked\x12@\n" +
	"\vtablet_type\x18\x19 \x01(\x0e2\x1f.vitess.topodata.dev.TabletTypeR\n" +
	"tabletType*;\n" +
	"\x13StopReplicationMode\x12\x12\n" +
	"\x0eIOANDSQLTHREAD\x10\x00\x12\x10\n" +
	"\fIOTHREADONLY\x10\x01BWZUgithub.com/planetscale/vitess-types/gen/vitess/replicationdata/dev;replicationdatadevb\x06proto3"
