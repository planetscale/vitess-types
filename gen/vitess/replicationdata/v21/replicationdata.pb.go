...
const file_vitess_replicationdata_v21_replicationdata_proto_rawDesc = "" +
	"\n" +
	"0vitess/replicationdata/v21/replicationdata.proto\x12\x1avitess.replicationdata.v21\"\x96\a\n" +
	"\x06Status\x12\x1a\n" +
	...
	"sslAllowed\x126\n" +
	"\x17replication_lag_unknown\x18\x18 \x01(\bR\x15replicationLagUnknownJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"n\n" +
	"\rConfiguration\x12-\n" +
	...
	"\x06before\x18\x01 \x01(\v2\".vitess.replicationdata.v21.StatusR\x06before\x128\n" +
	"\x05after\x18\x02 \x01(\v2\".vitess.replicationdata.v21.StatusR\x05after\"q\n" +
	...
	"serverUuid\x12Q\n" +
	"\x12replication_status\x18\x03 \x01(\v2\".vitess.replicationdata.v21.StatusR\x11replicationStatus\x12P\n" +
	"\x0eprimary_status\x18\x04 \x01(\v2).vitess.replicationdata.v21.PrimaryStatusR\rprimaryStatus\x12\x1f\n" +
	...
	"\x19replication_configuration\x18\x16 \x01(\v2).vitess.replicationdata.v21.ConfigurationR\x18replicationConfiguration*;\n" +
	"\x13StopReplicationMode\x12\x12\n" +
	"\x0eIOANDSQLTHREAD\x10\x00\x12\x10\n" +
	"\fIOTHREADONLY\x10\x01BWZUgithub.com/planetscale/vitess-types/gen/vitess/replicationdata/v21;replicationdatav21b\x06proto3"
