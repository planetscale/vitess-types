...
// 	protoc        (unknown)
// source: vitess/vtrpc/v17/vtrpc.proto
...
func (Code) Descriptor() protoreflect.EnumDescriptor {
	return file_vitess_vtrpc_v17_vtrpc_proto_enumTypes[0].Descriptor()
}

func (Code) Type() protoreflect.EnumType {
	return &file_vitess_vtrpc_v17_vtrpc_proto_enumTypes[0]
}
...
func (Code) EnumDescriptor() ([]byte, []int) {
	return file_vitess_vtrpc_v17_vtrpc_proto_rawDescGZIP(), []int{0}
}
...
func (x *CallerID) Reset() {
	*x = CallerID{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vitess_vtrpc_v17_vtrpc_proto_msgTypes[0]
...
type RPCError struct {
	...
	Code    Code   `protobuf:"varint,3,opt,name=code,proto3,enum=vitess.vtrpc.v17.Code" json:"code,omitempty"`
}

func (x *RPCError) Reset() {
	*x = RPCError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vitess_vtrpc_v17_vtrpc_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RPCError) Descriptor() ([]byte, []int) {
	return file_vitess_vtrpc_v17_vtrpc_proto_rawDescGZIP(), []int{1}
}
...
var File_vitess_vtrpc_v17_vtrpc_proto protoreflect.FileDescriptor

var file_vitess_vtrpc_v17_vtrpc_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2f, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2f, 0x76,
	0x31, 0x37, 0x2f, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10,
	...
	0x73, 0x73, 0x2e, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x43, 0x6f, 0x64,
	...
	0x37, 0x3b, 0x76, 0x74, 0x72, 0x70, 0x63, 0x76, 0x31, 0x37, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_vitess_vtrpc_v17_vtrpc_proto_rawDescOnce sync.Once
	file_vitess_vtrpc_v17_vtrpc_proto_rawDescData = file_vitess_vtrpc_v17_vtrpc_proto_rawDesc
)

func file_vitess_vtrpc_v17_vtrpc_proto_rawDescGZIP() []byte {
	file_vitess_vtrpc_v17_vtrpc_proto_rawDescOnce.Do(func() {
		file_vitess_vtrpc_v17_vtrpc_proto_rawDescData = protoimpl.X.CompressGZIP(file_vitess_vtrpc_v17_vtrpc_proto_rawDescData)
	})
	return file_vitess_vtrpc_v17_vtrpc_proto_rawDescData
}

var file_vitess_vtrpc_v17_vtrpc_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_vitess_vtrpc_v17_vtrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_vitess_vtrpc_v17_vtrpc_proto_goTypes = []interface{}{
	(Code)(0),        // 0: vitess.vtrpc.v17.Code
	(*CallerID)(nil), // 1: vitess.vtrpc.v17.CallerID
	(*RPCError)(nil), // 2: vitess.vtrpc.v17.RPCError
}
var file_vitess_vtrpc_v17_vtrpc_proto_depIdxs = []int32{
	0, // 0: vitess.vtrpc.v17.RPCError.code:type_name -> vitess.vtrpc.v17.Code
...
func init() { file_vitess_vtrpc_v17_vtrpc_proto_init() }
func file_vitess_vtrpc_v17_vtrpc_proto_init() {
	if File_vitess_vtrpc_v17_vtrpc_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vitess_vtrpc_v17_vtrpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vitess_vtrpc_v17_vtrpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vitess_vtrpc_v17_vtrpc_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vitess_vtrpc_v17_vtrpc_proto_goTypes,
		DependencyIndexes: file_vitess_vtrpc_v17_vtrpc_proto_depIdxs,
		EnumInfos:         file_vitess_vtrpc_v17_vtrpc_proto_enumTypes,
		MessageInfos:      file_vitess_vtrpc_v17_vtrpc_proto_msgTypes,
	}.Build()
	File_vitess_vtrpc_v17_vtrpc_proto = out.File
	file_vitess_vtrpc_v17_vtrpc_proto_rawDesc = nil
	file_vitess_vtrpc_v17_vtrpc_proto_goTypes = nil
	file_vitess_vtrpc_v17_vtrpc_proto_depIdxs = nil
}
