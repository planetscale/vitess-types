...
var file_vitess_vtrpc_v18_vtrpc_proto_goTypes = []any{
...
func file_vitess_vtrpc_v18_vtrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_vitess_vtrpc_v18_vtrpc_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_vitess_vtrpc_v18_vtrpc_proto_msgTypes[1].Exporter = func(v any, i int) any {
