...
const file_vitess_vtrpc_v19_vtrpc_proto_rawDesc = "" +
	"\n" +
	"\x1cvitess/vtrpc/v19/vtrpc.proto\x12\x10vitess.vtrpc.v19\"\x82\x01\n" +
	"\bCallerID\x12\x1c\n" +
	...
	"\x06groups\x18\x04 \x03(\tR\x06groups\"c\n" +
	"\bRPCError\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12*\n" +
	"\x04code\x18\x03 \x01(\x0e2\x16.vitess.vtrpc.v19.CodeR\x04codeJ\x04\b\x01\x10\x02R\vlegacy_code*\xd8\x02\n" +
	"\x04Code\x12\x06\n" +
	"\x02OK\x10\x00\x12\f\n" +
	...
	"\tREAD_ONLY\x10\x12BCZAgithub.com/planetscale/vitess-types/gen/vitess/vtrpc/v19;vtrpcv19b\x06proto3"

var (
	file_vitess_vtrpc_v19_vtrpc_proto_rawDescOnce sync.Once
	file_vitess_vtrpc_v19_vtrpc_proto_rawDescData []byte
)

func file_vitess_vtrpc_v19_vtrpc_proto_rawDescGZIP() []byte {
	file_vitess_vtrpc_v19_vtrpc_proto_rawDescOnce.Do(func() {
		file_vitess_vtrpc_v19_vtrpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_vtrpc_v19_vtrpc_proto_rawDesc), len(file_vitess_vtrpc_v19_vtrpc_proto_rawDesc)))
	})
...
func file_vitess_vtrpc_v19_vtrpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_vtrpc_v19_vtrpc_proto_rawDesc), len(file_vitess_vtrpc_v19_vtrpc_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
