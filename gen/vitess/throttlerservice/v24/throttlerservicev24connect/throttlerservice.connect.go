...
package throttlerservicev24connect
...
import (
	...
	v241 "github.com/planetscale/vitess-types/gen/vitess/throttlerservice/v24"
	http "net/http"
	strings "strings"
)
...
type ThrottlerClient interface {
	...
	MaxRates(context.Context, *connect.Request[v24.MaxRatesRequest]) (*connect.Response[v24.MaxRatesResponse], error)
	// SetMaxRate allows to change the current max rate for all throttlers
	// of the process.
	SetMaxRate(context.Context, *connect.Request[v24.SetMaxRateRequest]) (*connect.Response[v24.SetMaxRateResponse], error)
	...
	GetConfiguration(context.Context, *connect.Request[v24.GetConfigurationRequest]) (*connect.Response[v24.GetConfigurationResponse], error)
	...
	// as well.
	UpdateConfiguration(context.Context, *connect.Request[v24.UpdateConfigurationRequest]) (*connect.Response[v24.UpdateConfigurationResponse], error)
	...
	// "throttler_name" is empty.
	ResetConfiguration(context.Context, *connect.Request[v24.ResetConfigurationRequest]) (*connect.Response[v24.ResetConfigurationResponse], error)
}
...
func NewThrottlerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ThrottlerClient {
	...
	throttlerMethods := v241.File_vitess_throttlerservice_v24_throttlerservice_proto.Services().ByName("Throttler").Methods()
	return &throttlerClient{
		maxRates: connect.NewClient[v24.MaxRatesRequest, v24.MaxRatesResponse](
			httpClient,
			baseURL+ThrottlerMaxRatesProcedure,
			connect.WithSchema(throttlerMethods.ByName("MaxRates")),
			connect.WithClientOptions(opts...),
		),
		setMaxRate: connect.NewClient[v24.SetMaxRateRequest, v24.SetMaxRateResponse](
			httpClient,
			baseURL+ThrottlerSetMaxRateProcedure,
			connect.WithSchema(throttlerMethods.ByName("SetMaxRate")),
			connect.WithClientOptions(opts...),
		),
		getConfiguration: connect.NewClient[v24.GetConfigurationRequest, v24.GetConfigurationResponse](
			httpClient,
			baseURL+ThrottlerGetConfigurationProcedure,
			connect.WithSchema(throttlerMethods.ByName("GetConfiguration")),
			connect.WithClientOptions(opts...),
		),
		updateConfiguration: connect.NewClient[v24.UpdateConfigurationRequest, v24.UpdateConfigurationResponse](
			httpClient,
			baseURL+ThrottlerUpdateConfigurationProcedure,
			connect.WithSchema(throttlerMethods.ByName("UpdateConfiguration")),
			connect.WithClientOptions(opts...),
		),
		resetConfiguration: connect.NewClient[v24.ResetConfigurationRequest, v24.ResetConfigurationResponse](
			httpClient,
...
type throttlerClient struct {
	maxRates            *connect.Client[v24.MaxRatesRequest, v24.MaxRatesResponse]
	setMaxRate          *connect.Client[v24.SetMaxRateRequest, v24.SetMaxRateResponse]
	getConfiguration    *connect.Client[v24.GetConfigurationRequest, v24.GetConfigurationResponse]
	updateConfiguration *connect.Client[v24.UpdateConfigurationRequest, v24.UpdateConfigurationResponse]
	resetConfiguration  *connect.Client[v24.ResetConfigurationRequest, v24.ResetConfigurationResponse]
}

// MaxRates calls throttlerservice.Throttler.MaxRates.
func (c *throttlerClient) MaxRates(ctx context.Context, req *connect.Request[v24.MaxRatesRequest]) (*connect.Response[v24.MaxRatesResponse], error) {
	return c.maxRates.CallUnary(ctx, req)
}

// SetMaxRate calls throttlerservice.Throttler.SetMaxRate.
func (c *throttlerClient) SetMaxRate(ctx context.Context, req *connect.Request[v24.SetMaxRateRequest]) (*connect.Response[v24.SetMaxRateResponse], error) {
	return c.setMaxRate.CallUnary(ctx, req)
}

// GetConfiguration calls throttlerservice.Throttler.GetConfiguration.
func (c *throttlerClient) GetConfiguration(ctx context.Context, req *connect.Request[v24.GetConfigurationRequest]) (*connect.Response[v24.GetConfigurationResponse], error) {
	return c.getConfiguration.CallUnary(ctx, req)
}

// UpdateConfiguration calls throttlerservice.Throttler.UpdateConfiguration.
func (c *throttlerClient) UpdateConfiguration(ctx context.Context, req *connect.Request[v24.UpdateConfigurationRequest]) (*connect.Response[v24.UpdateConfigurationResponse], error) {
	return c.updateConfiguration.CallUnary(ctx, req)
}

// ResetConfiguration calls throttlerservice.Throttler.ResetConfiguration.
func (c *throttlerClient) ResetConfiguration(ctx context.Context, req *connect.Request[v24.ResetConfigurationRequest]) (*connect.Response[v24.ResetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) MaxRates(context.Context, *connect.Request[v24.MaxRatesRequest]) (*connect.Response[v24.MaxRatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("throttlerservice.Throttler.MaxRates is not implemented"))
}

func (UnimplementedThrottlerHandler) SetMaxRate(context.Context, *connect.Request[v24.SetMaxRateRequest]) (*connect.Response[v24.SetMaxRateResponse], error) {
...
func (UnimplementedThrottlerHandler) GetConfiguration(context.Context, *connect.Request[v24.GetConfigurationRequest]) (*connect.Response[v24.GetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) UpdateConfiguration(context.Context, *connect.Request[v24.UpdateConfigurationRequest]) (*connect.Response[v24.UpdateConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) ResetConfiguration(context.Context, *connect.Request[v24.ResetConfigurationRequest]) (*connect.Response[v24.ResetConfigurationResponse], error) {
