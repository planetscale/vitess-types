...
package throttlerservicev18connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v181 "github.com/planetscale/vitess-types/gen/vitess/throttlerdata/v18"
	v18 "github.com/planetscale/vitess-types/gen/vitess/throttlerservice/v18"
	http "net/http"
	strings "strings"
)
...
var (
	throttlerServiceDescriptor                   = v18.File_vitess_throttlerservice_v18_throttlerservice_proto.Services().ByName("Throttler")
...
type ThrottlerClient interface {
	...
	// of the process.
	SetMaxRate(context.Context, *connect.Request[v181.SetMaxRateRequest]) (*connect.Response[v181.SetMaxRateResponse], error)
	...
	GetConfiguration(context.Context, *connect.Request[v181.GetConfigurationRequest]) (*connect.Response[v181.GetConfigurationResponse], error)
	...
	// as well.
	UpdateConfiguration(context.Context, *connect.Request[v181.UpdateConfigurationRequest]) (*connect.Response[v181.UpdateConfigurationResponse], error)
	...
	// "throttler_name" is empty.
	ResetConfiguration(context.Context, *connect.Request[v181.ResetConfigurationRequest]) (*connect.Response[v181.ResetConfigurationResponse], error)
}
...
func NewThrottlerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ThrottlerClient {
	...
	return &throttlerClient{
		maxRates: connect.NewClient[v181.MaxRatesRequest, v181.MaxRatesResponse](
			httpClient,
			baseURL+ThrottlerMaxRatesProcedure,
			connect.WithSchema(throttlerMaxRatesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		setMaxRate: connect.NewClient[v181.SetMaxRateRequest, v181.SetMaxRateResponse](
			httpClient,
			baseURL+ThrottlerSetMaxRateProcedure,
			connect.WithSchema(throttlerSetMaxRateMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getConfiguration: connect.NewClient[v181.GetConfigurationRequest, v181.GetConfigurationResponse](
			httpClient,
			baseURL+ThrottlerGetConfigurationProcedure,
			connect.WithSchema(throttlerGetConfigurationMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		updateConfiguration: connect.NewClient[v181.UpdateConfigurationRequest, v181.UpdateConfigurationResponse](
			httpClient,
			baseURL+ThrottlerUpdateConfigurationProcedure,
			connect.WithSchema(throttlerUpdateConfigurationMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		resetConfiguration: connect.NewClient[v181.ResetConfigurationRequest, v181.ResetConfigurationResponse](
			httpClient,
...
type throttlerClient struct {
	maxRates            *connect.Client[v181.MaxRatesRequest, v181.MaxRatesResponse]
	setMaxRate          *connect.Client[v181.SetMaxRateRequest, v181.SetMaxRateResponse]
	getConfiguration    *connect.Client[v181.GetConfigurationRequest, v181.GetConfigurationResponse]
	updateConfiguration *connect.Client[v181.UpdateConfigurationRequest, v181.UpdateConfigurationResponse]
	resetConfiguration  *connect.Client[v181.ResetConfigurationRequest, v181.ResetConfigurationResponse]
}
...
func (c *throttlerClient) SetMaxRate(ctx context.Context, req *connect.Request[v181.SetMaxRateRequest]) (*connect.Response[v181.SetMaxRateResponse], error) {
	return c.setMaxRate.CallUnary(ctx, req)
}

// GetConfiguration calls throttlerservice.Throttler.GetConfiguration.
func (c *throttlerClient) GetConfiguration(ctx context.Context, req *connect.Request[v181.GetConfigurationRequest]) (*connect.Response[v181.GetConfigurationResponse], error) {
	return c.getConfiguration.CallUnary(ctx, req)
}

// UpdateConfiguration calls throttlerservice.Throttler.UpdateConfiguration.
func (c *throttlerClient) UpdateConfiguration(ctx context.Context, req *connect.Request[v181.UpdateConfigurationRequest]) (*connect.Response[v181.UpdateConfigurationResponse], error) {
	return c.updateConfiguration.CallUnary(ctx, req)
}

// ResetConfiguration calls throttlerservice.Throttler.ResetConfiguration.
func (c *throttlerClient) ResetConfiguration(ctx context.Context, req *connect.Request[v181.ResetConfigurationRequest]) (*connect.Response[v181.ResetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) MaxRates(context.Context, *connect.Request[v181.MaxRatesRequest]) (*connect.Response[v181.MaxRatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("throttlerservice.Throttler.MaxRates is not implemented"))
}

func (UnimplementedThrottlerHandler) SetMaxRate(context.Context, *connect.Request[v181.SetMaxRateRequest]) (*connect.Response[v181.SetMaxRateResponse], error) {
...
func (UnimplementedThrottlerHandler) GetConfiguration(context.Context, *connect.Request[v181.GetConfigurationRequest]) (*connect.Response[v181.GetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) UpdateConfiguration(context.Context, *connect.Request[v181.UpdateConfigurationRequest]) (*connect.Response[v181.UpdateConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) ResetConfiguration(context.Context, *connect.Request[v181.ResetConfigurationRequest]) (*connect.Response[v181.ResetConfigurationResponse], error) {
