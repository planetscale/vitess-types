...
import (
	...
	_ "github.com/planetscale/vitess-types/gen/vitess/throttlerservice/v18"
	http "net/http"
	strings "strings"
)
...
type ThrottlerClient interface {
	...
	// of the process.
	SetMaxRate(context.Context, *connect.Request[v18.SetMaxRateRequest]) (*connect.Response[v18.SetMaxRateResponse], error)
	...
	GetConfiguration(context.Context, *connect.Request[v18.GetConfigurationRequest]) (*connect.Response[v18.GetConfigurationResponse], error)
	...
	// as well.
	UpdateConfiguration(context.Context, *connect.Request[v18.UpdateConfigurationRequest]) (*connect.Response[v18.UpdateConfigurationResponse], error)
	...
	// "throttler_name" is empty.
	ResetConfiguration(context.Context, *connect.Request[v18.ResetConfigurationRequest]) (*connect.Response[v18.ResetConfigurationResponse], error)
}
...
func NewThrottlerClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ThrottlerClient {
	...
	return &throttlerClient{
		maxRates: connect.NewClient[v18.MaxRatesRequest, v18.MaxRatesResponse](
			httpClient,
			baseURL+ThrottlerMaxRatesProcedure,
			opts...,
		),
		setMaxRate: connect.NewClient[v18.SetMaxRateRequest, v18.SetMaxRateResponse](
			httpClient,
			baseURL+ThrottlerSetMaxRateProcedure,
			opts...,
		),
		getConfiguration: connect.NewClient[v18.GetConfigurationRequest, v18.GetConfigurationResponse](
			httpClient,
			baseURL+ThrottlerGetConfigurationProcedure,
			opts...,
		),
		updateConfiguration: connect.NewClient[v18.UpdateConfigurationRequest, v18.UpdateConfigurationResponse](
			httpClient,
			baseURL+ThrottlerUpdateConfigurationProcedure,
			opts...,
		),
		resetConfiguration: connect.NewClient[v18.ResetConfigurationRequest, v18.ResetConfigurationResponse](
			httpClient,
...
type throttlerClient struct {
	maxRates            *connect.Client[v18.MaxRatesRequest, v18.MaxRatesResponse]
	setMaxRate          *connect.Client[v18.SetMaxRateRequest, v18.SetMaxRateResponse]
	getConfiguration    *connect.Client[v18.GetConfigurationRequest, v18.GetConfigurationResponse]
	updateConfiguration *connect.Client[v18.UpdateConfigurationRequest, v18.UpdateConfigurationResponse]
	resetConfiguration  *connect.Client[v18.ResetConfigurationRequest, v18.ResetConfigurationResponse]
}

// MaxRates calls throttlerservice.Throttler.MaxRates.
func (c *throttlerClient) MaxRates(ctx context.Context, req *connect.Request[v18.MaxRatesRequest]) (*connect.Response[v18.MaxRatesResponse], error) {
	return c.maxRates.CallUnary(ctx, req)
}

// SetMaxRate calls throttlerservice.Throttler.SetMaxRate.
func (c *throttlerClient) SetMaxRate(ctx context.Context, req *connect.Request[v18.SetMaxRateRequest]) (*connect.Response[v18.SetMaxRateResponse], error) {
	return c.setMaxRate.CallUnary(ctx, req)
}

// GetConfiguration calls throttlerservice.Throttler.GetConfiguration.
func (c *throttlerClient) GetConfiguration(ctx context.Context, req *connect.Request[v18.GetConfigurationRequest]) (*connect.Response[v18.GetConfigurationResponse], error) {
	return c.getConfiguration.CallUnary(ctx, req)
}

// UpdateConfiguration calls throttlerservice.Throttler.UpdateConfiguration.
func (c *throttlerClient) UpdateConfiguration(ctx context.Context, req *connect.Request[v18.UpdateConfigurationRequest]) (*connect.Response[v18.UpdateConfigurationResponse], error) {
	return c.updateConfiguration.CallUnary(ctx, req)
}

// ResetConfiguration calls throttlerservice.Throttler.ResetConfiguration.
func (c *throttlerClient) ResetConfiguration(ctx context.Context, req *connect.Request[v18.ResetConfigurationRequest]) (*connect.Response[v18.ResetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) MaxRates(context.Context, *connect.Request[v18.MaxRatesRequest]) (*connect.Response[v18.MaxRatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("throttlerservice.Throttler.MaxRates is not implemented"))
}

func (UnimplementedThrottlerHandler) SetMaxRate(context.Context, *connect.Request[v18.SetMaxRateRequest]) (*connect.Response[v18.SetMaxRateResponse], error) {
...
func (UnimplementedThrottlerHandler) GetConfiguration(context.Context, *connect.Request[v18.GetConfigurationRequest]) (*connect.Response[v18.GetConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) UpdateConfiguration(context.Context, *connect.Request[v18.UpdateConfigurationRequest]) (*connect.Response[v18.UpdateConfigurationResponse], error) {
...
func (UnimplementedThrottlerHandler) ResetConfiguration(context.Context, *connect.Request[v18.ResetConfigurationRequest]) (*connect.Response[v18.ResetConfigurationResponse], error) {
