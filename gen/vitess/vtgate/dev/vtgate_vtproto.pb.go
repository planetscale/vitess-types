...
func (m *Session_ShardSession) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &dev1.TabletAlias{}
			}
...
func (m *Session) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Warnings = append(m.Warnings, &dev.QueryWarning{})
		...
		case 13:
			...
			if m.UserDefinedVariables == nil {
				m.UserDefinedVariables = make(map[string]*dev.BindVariable)
			}
			var mapkey string
			var mapvalue *dev.BindVariable
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *ExecuteBatchRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Queries = append(m.Queries, &dev.BoundQuery{})
...
func (m *ExecuteBatchResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Results = append(m.Results, &dev.ResultWithError{})
			if unmarshal, ok := interface{}(m.Results[len(m.Results)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
...
func (m *VStreamResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Events = append(m.Events, &dev3.VEvent{})
