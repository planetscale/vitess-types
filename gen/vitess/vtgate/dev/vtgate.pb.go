...
const file_vitess_vtgate_dev_vtgate_proto_rawDesc = "" +
	"\n" +
	"\x1evitess/vtgate/dev/vtgate.proto\x12\x11vitess.vtgate.dev\x1a&vitess/binlogdata/dev/binlogdata.proto\x1a\x1cvitess/query/dev/query.proto\x1a\"vitess/topodata/dev/topodata.proto\x1a\x1cvitess/vtrpc/dev/vtrpc.proto\"\x82\x11\n" +
	"\aSession\x12%\n" +
	"\x0ein_transaction\x18\x01 \x01(\bR\rinTransaction\x12N\n" +
	"\x0eshard_sessions\x18\x02 \x03(\v2'.vitess.vtgate.dev.Session.ShardSessionR\rshardSessions\x12\x1e\n" +
	"\n" +
	"autocommit\x18\x04 \x01(\bR\n" +
	"autocommit\x12#\n" +
	"\rtarget_string\x18\x05 \x01(\tR\ftargetString\x12:\n" +
	"\aoptions\x18\x06 \x01(\v2 .vitess.query.dev.ExecuteOptionsR\aoptions\x12M\n" +
	"\x10transaction_mode\x18\a \x01(\x0e2\".vitess.vtgate.dev.TransactionModeR\x0ftransactionMode\x12:\n" +
	"\bwarnings\x18\b \x03(\v2\x1e.vitess.query.dev.QueryWarningR\bwarnings\x12J\n" +
	"\fpre_sessions\x18\t \x03(\v2'.vitess.vtgate.dev.Session.ShardSessionR\vpreSessions\x12L\n" +
	"\rpost_sessions\x18\n" +
	" \x03(\v2'.vitess.vtgate.dev.Session.ShardSessionR\fpostSessions\x12$\n" +
	"\x0elast_insert_id\x18\v \x01(\x04R\flastInsertId\x12\x1d\n" +
	"\n" +
	"found_rows\x18\f \x01(\x04R\tfoundRows\x12j\n" +
	"\x16user_defined_variables\x18\r \x03(\v24.vitess.vtgate.dev.Session.UserDefinedVariablesEntryR\x14userDefinedVariables\x12Z\n" +
	"\x10system_variables\x18\x0e \x03(\v2/.vitess.vtgate.dev.Session.SystemVariablesEntryR\x0fsystemVariables\x12\x1b\n" +
	...
	"\flock_session\x18\x12 \x01(\v2'.vitess.vtgate.dev.Session.ShardSessionR\vlockSession\x12.\n" +
	"\x13last_lock_heartbeat\x18\x13 \x01(\x03R\x11lastLockHeartbeat\x12K\n" +
	"\x10read_after_write\x18\x14 \x01(\v2!.vitess.vtgate.dev.ReadAfterWriteR\x0ereadAfterWrite\x12 \n" +
	...
	"\radvisory_lock\x18\x18 \x03(\v2,.vitess.vtgate.dev.Session.AdvisoryLockEntryR\fadvisoryLock\x12#\n" +
	"\rquery_timeout\x18\x19 \x01(\x03R\fqueryTimeout\x12]\n" +
	"\x11prepare_statement\x18\x1a \x03(\v20.vitess.vtgate.dev.Session.PrepareStatementEntryR\x10prepareStatement\x12+\n" +
	"\x11migration_context\x18\x1b \x01(\tR\x10migrationContext\x120\n" +
	"\x14error_until_rollback\x18\x1c \x01(\bR\x12errorUntilRollback\x1a\x93\x02\n" +
	"\fShardSession\x120\n" +
	...
	"\ftablet_alias\x18\x03 \x01(\v2 .vitess.topodata.dev.TabletAliasR\vtabletAlias\x12\x1f\n" +
	"\vreserved_id\x18\x04 \x01(\x03R\n" +
	"reservedId\x12\x1f\n" +
	"\vvindex_only\x18\x05 \x01(\bR\n" +
	"vindexOnly\x12#\n" +
	"\rrows_affected\x18\x06 \x01(\bR\frowsAffected\x1ag\n" +
	"\x19UserDefinedVariablesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.vitess.query.dev.BindVariableR\x05value:\x028\x01\x1aB\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.vitess.vtgate.dev.PrepareDataR\x05value:\x028\x01J\x04\b\x03\x10\x04\"]\n" +
	"\vPrepareData\x12+\n" +
	...
	"\x13session_track_gtids\x18\x03 \x01(\bR\x11sessionTrackGtids\"\xe7\x01\n" +
	"\x0eExecuteRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x122\n" +
	"\x05query\x18\x03 \x01(\v2\x1c.vitess.query.dev.BoundQueryR\x05query\x12\x1a\n" +
	"\bprepared\x18\b \x01(\bR\bpreparedJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\b\"\xb0\x01\n" +
	"\x0fExecuteResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x125\n" +
	"\x06result\x18\x03 \x01(\v2\x1d.vitess.query.dev.QueryResultR\x06result\"\xd4\x01\n" +
	"\x13ExecuteBatchRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x126\n" +
	"\aqueries\x18\x03 \x03(\v2\x1c.vitess.query.dev.BoundQueryR\aqueriesJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\b\"\xbb\x01\n" +
	"\x14ExecuteBatchResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x12;\n" +
	"\aresults\x18\x03 \x03(\v2!.vitess.query.dev.ResultWithErrorR\aresults\"\xcb\x01\n" +
	"\x14StreamExecuteRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x122\n" +
	"\x05query\x18\x02 \x01(\v2\x1c.vitess.query.dev.BoundQueryR\x05query\x124\n" +
	"\asession\x18\x06 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asessionJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"\x84\x01\n" +
	"\x15StreamExecuteResponse\x125\n" +
	"\x06result\x18\x01 \x01(\v2\x1d.vitess.query.dev.QueryResultR\x06result\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\"h\n" +
	"\x19ResolveTransactionRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x12\x12\n" +
	...
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x12@\n" +
	"\vtablet_type\x18\x02 \x01(\x0e2\x1f.vitess.topodata.dev.TabletTypeR\n" +
	"tabletType\x122\n" +
	"\x05vgtid\x18\x03 \x01(\v2\x1c.vitess.binlogdata.dev.VGtidR\x05vgtid\x125\n" +
	"\x06filter\x18\x04 \x01(\v2\x1d.vitess.binlogdata.dev.FilterR\x06filter\x125\n" +
	"\x05flags\x18\x05 \x01(\v2\x1f.vitess.vtgate.dev.VStreamFlagsR\x05flags\"H\n" +
	"\x0fVStreamResponse\x125\n" +
	"\x06events\x18\x01 \x03(\v2\x1d.vitess.binlogdata.dev.VEventR\x06events\"\xb3\x01\n" +
	"\x0ePrepareRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x122\n" +
	"\x05query\x18\x03 \x01(\v2\x1c.vitess.query.dev.BoundQueryR\x05query\"\xcd\x01\n" +
	"\x0fPrepareResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\x12/\n" +
	"\x06fields\x18\x03 \x03(\v2\x17.vitess.query.dev.FieldR\x06fields\x12!\n" +
	"\fparams_count\x18\x04 \x01(\rR\vparamsCount\"\x84\x01\n" +
	"\x13CloseSessionRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.dev.SessionR\asession\"H\n" +
	"\x14CloseSessionResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.dev.RPCErrorR\x05error*D\n" +
	...
	"\n" +
	"AUTOCOMMIT\x10\x03BEZCgithub.com/planetscale/vitess-types/gen/vitess/vtgate/dev;vtgatedevb\x06proto3"
