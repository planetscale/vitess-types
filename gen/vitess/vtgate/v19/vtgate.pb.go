...
type Session struct {
	...
	UserDefinedVariables map[string]*v19.BindVariable `protobuf:"bytes,13,rep,name=user_defined_variables,json=userDefinedVariables,proto3" json:"user_defined_variables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_vitess_vtgate_v19_vtgate_proto_rawDesc = "" +
	"\n" +
	"\x1evitess/vtgate/v19/vtgate.proto\x12\x11vitess.vtgate.v19\x1a&vitess/binlogdata/v19/binlogdata.proto\x1a\x1cvitess/query/v19/query.proto\x1a\"vitess/topodata/v19/topodata.proto\x1a\x1cvitess/vtrpc/v19/vtrpc.proto\"\xab\x10\n" +
	"\aSession\x12%\n" +
	"\x0ein_transaction\x18\x01 \x01(\bR\rinTransaction\x12N\n" +
	"\x0eshard_sessions\x18\x02 \x03(\v2'.vitess.vtgate.v19.Session.ShardSessionR\rshardSessions\x12\x1e\n" +
	"\n" +
	"autocommit\x18\x04 \x01(\bR\n" +
	"autocommit\x12#\n" +
	"\rtarget_string\x18\x05 \x01(\tR\ftargetString\x12:\n" +
	"\aoptions\x18\x06 \x01(\v2 .vitess.query.v19.ExecuteOptionsR\aoptions\x12M\n" +
	"\x10transaction_mode\x18\a \x01(\x0e2\".vitess.vtgate.v19.TransactionModeR\x0ftransactionMode\x12:\n" +
	"\bwarnings\x18\b \x03(\v2\x1e.vitess.query.v19.QueryWarningR\bwarnings\x12J\n" +
	"\fpre_sessions\x18\t \x03(\v2'.vitess.vtgate.v19.Session.ShardSessionR\vpreSessions\x12L\n" +
	"\rpost_sessions\x18\n" +
	" \x03(\v2'.vitess.vtgate.v19.Session.ShardSessionR\fpostSessions\x12$\n" +
	"\x0elast_insert_id\x18\v \x01(\x04R\flastInsertId\x12\x1d\n" +
	"\n" +
	"found_rows\x18\f \x01(\x04R\tfoundRows\x12j\n" +
	"\x16user_defined_variables\x18\r \x03(\v24.vitess.vtgate.v19.Session.UserDefinedVariablesEntryR\x14userDefinedVariables\x12Z\n" +
	"\x10system_variables\x18\x0e \x03(\v2/.vitess.vtgate.v19.Session.SystemVariablesEntryR\x0fsystemVariables\x12\x1b\n" +
	...
	"\flock_session\x18\x12 \x01(\v2'.vitess.vtgate.v19.Session.ShardSessionR\vlockSession\x12.\n" +
	"\x13last_lock_heartbeat\x18\x13 \x01(\x03R\x11lastLockHeartbeat\x12K\n" +
	"\x10read_after_write\x18\x14 \x01(\v2!.vitess.vtgate.v19.ReadAfterWriteR\x0ereadAfterWrite\x12 \n" +
	...
	"\radvisory_lock\x18\x18 \x03(\v2,.vitess.vtgate.v19.Session.AdvisoryLockEntryR\fadvisoryLock\x12#\n" +
	"\rquery_timeout\x18\x19 \x01(\x03R\fqueryTimeout\x12]\n" +
	"\x11prepare_statement\x18\x1a \x03(\v20.vitess.vtgate.v19.Session.PrepareStatementEntryR\x10prepareStatement\x12+\n" +
	...
	"\ftablet_alias\x18\x03 \x01(\v2 .vitess.topodata.v19.TabletAliasR\vtabletAlias\x12\x1f\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1e.vitess.query.v19.BindVariableR\x05value:\x028\x01\x1aB\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.vitess.vtgate.v19.PrepareDataR\x05value:\x028\x01J\x04\b\x03\x10\x04\"]\n" +
	"\vPrepareData\x12+\n" +
	...
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x122\n" +
	"\x05query\x18\x03 \x01(\v2\x1c.vitess.query.v19.BoundQueryR\x05queryJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\b\"\xb0\x01\n" +
	"\x0fExecuteResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x125\n" +
	"\x06result\x18\x03 \x01(\v2\x1d.vitess.query.v19.QueryResultR\x06result\"\xd4\x01\n" +
	"\x13ExecuteBatchRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x126\n" +
	"\aqueries\x18\x03 \x03(\v2\x1c.vitess.query.v19.BoundQueryR\aqueriesJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\b\"\xbb\x01\n" +
	"\x14ExecuteBatchResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x12;\n" +
	"\aresults\x18\x03 \x03(\v2!.vitess.query.v19.ResultWithErrorR\aresults\"\xcb\x01\n" +
	"\x14StreamExecuteRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x122\n" +
	"\x05query\x18\x02 \x01(\v2\x1c.vitess.query.v19.BoundQueryR\x05query\x124\n" +
	"\asession\x18\x06 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asessionJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06\"\x84\x01\n" +
	"\x15StreamExecuteResponse\x125\n" +
	"\x06result\x18\x01 \x01(\v2\x1d.vitess.query.v19.QueryResultR\x06result\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\"h\n" +
	"\x19ResolveTransactionRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x12\x12\n" +
	"\x04dtid\x18\x02 \x01(\tR\x04dtid\"\x1c\n" +
	"\x1aResolveTransactionResponse\"\xec\x01\n" +
	"\fVStreamFlags\x12#\n" +
	...
	"\ftablet_order\x18\x06 \x01(\tR\vtabletOrder\"\xad\x02\n" +
	"\x0eVStreamRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x12@\n" +
	"\vtablet_type\x18\x02 \x01(\x0e2\x1f.vitess.topodata.v19.TabletTypeR\n" +
	"tabletType\x122\n" +
	"\x05vgtid\x18\x03 \x01(\v2\x1c.vitess.binlogdata.v19.VGtidR\x05vgtid\x125\n" +
	"\x06filter\x18\x04 \x01(\v2\x1d.vitess.binlogdata.v19.FilterR\x06filter\x125\n" +
	"\x05flags\x18\x05 \x01(\v2\x1f.vitess.vtgate.v19.VStreamFlagsR\x05flags\"H\n" +
	"\x0fVStreamResponse\x125\n" +
	"\x06events\x18\x01 \x03(\v2\x1d.vitess.binlogdata.v19.VEventR\x06events\"\xb3\x01\n" +
	"\x0ePrepareRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x122\n" +
	"\x05query\x18\x03 \x01(\v2\x1c.vitess.query.v19.BoundQueryR\x05query\"\xaa\x01\n" +
	"\x0fPrepareResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.RPCErrorR\x05error\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\x12/\n" +
	"\x06fields\x18\x03 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\"\x84\x01\n" +
	"\x13CloseSessionRequest\x127\n" +
	"\tcaller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\bcallerId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x1a.vitess.vtgate.v19.SessionR\asession\"H\n" +
	"\x14CloseSessionResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.RPCErrorR\x05error*D\n" +
	...
	"\n" +
	"AUTOCOMMIT\x10\x03BEZCgithub.com/planetscale/vitess-types/gen/vitess/vtgate/v19;vtgatev19b\x06proto3"

var (
	file_vitess_vtgate_v19_vtgate_proto_rawDescOnce sync.Once
	file_vitess_vtgate_v19_vtgate_proto_rawDescData []byte
)

func file_vitess_vtgate_v19_vtgate_proto_rawDescGZIP() []byte {
	file_vitess_vtgate_v19_vtgate_proto_rawDescOnce.Do(func() {
		file_vitess_vtgate_v19_vtgate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_vtgate_v19_vtgate_proto_rawDesc), len(file_vitess_vtgate_v19_vtgate_proto_rawDesc)))
	})
...
func file_vitess_vtgate_v19_vtgate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_vtgate_v19_vtgate_proto_rawDesc), len(file_vitess_vtgate_v19_vtgate_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   0,
