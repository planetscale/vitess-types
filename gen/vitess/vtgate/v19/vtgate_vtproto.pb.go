...
func (m *Session_ShardSession) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.TabletAlias == nil {
				m.TabletAlias = &v191.TabletAlias{}
			}
...
func (m *Session) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Warnings = append(m.Warnings, &v19.QueryWarning{})
		...
		case 13:
			...
			if m.UserDefinedVariables == nil {
				m.UserDefinedVariables = make(map[string]*v19.BindVariable)
			}
			var mapkey string
			var mapvalue *v19.BindVariable
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *ExecuteBatchRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Queries = append(m.Queries, &v19.BoundQuery{})
...
func (m *ExecuteBatchResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Results = append(m.Results, &v19.ResultWithError{})
...
func (m *VStreamResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Events = append(m.Events, &v193.VEvent{})
