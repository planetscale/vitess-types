...
package vtadminv23connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v23 "github.com/planetscale/vitess-types/gen/vitess/vtadmin/v23"
	v231 "github.com/planetscale/vitess-types/gen/vitess/vtctldata/v23"
	http "net/http"
	strings "strings"
)
...
type VTAdminClient interface {
	...
	ApplySchema(context.Context, *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v231.ApplySchemaResponse], error)
	// CancelSchemaMigration cancels one or all schema migrations in the given
	// cluster, terminating any running ones as needed.
	CancelSchemaMigration(context.Context, *connect.Request[v23.CancelSchemaMigrationRequest]) (*connect.Response[v231.CancelSchemaMigrationResponse], error)
	// CleanupSchemaMigration marks a schema migration in the given cluster as
	// ready for artifact cleanup.
	CleanupSchemaMigration(context.Context, *connect.Request[v23.CleanupSchemaMigrationRequest]) (*connect.Response[v231.CleanupSchemaMigrationResponse], error)
	// CompleteSchemaMigration completes one or all migrations in the given
	// cluster executed with --postpone-completion.
	CompleteSchemaMigration(context.Context, *connect.Request[v23.CompleteSchemaMigrationRequest]) (*connect.Response[v231.CompleteSchemaMigrationResponse], error)
	// ConcludeTransaction concludes a distributed transaction identified by the provided dtid.
	ConcludeTransaction(context.Context, *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v231.ConcludeTransactionResponse], error)
	...
	CreateShard(context.Context, *connect.Request[v23.CreateShardRequest]) (*connect.Response[v231.CreateShardResponse], error)
	// DeleteKeyspace deletes a keyspace in the given cluster.
	DeleteKeyspace(context.Context, *connect.Request[v23.DeleteKeyspaceRequest]) (*connect.Response[v231.DeleteKeyspaceResponse], error)
	// DeleteShard deletes one or more shards in the given cluster and keyspace.
	DeleteShards(context.Context, *connect.Request[v23.DeleteShardsRequest]) (*connect.Response[v231.DeleteShardsResponse], error)
	// DeleteTablet deletes a tablet from the topology
	DeleteTablet(context.Context, *connect.Request[v23.DeleteTabletRequest]) (*connect.Response[v23.DeleteTabletResponse], error)
	// EmergencyFailoverShard fails over a shard to a new primary. It assumes
	// the old primary is dead or otherwise not responding.
	EmergencyFailoverShard(context.Context, *connect.Request[v23.EmergencyFailoverShardRequest]) (*connect.Response[v23.EmergencyFailoverShardResponse], error)
	...
	FindSchema(context.Context, *connect.Request[v23.FindSchemaRequest]) (*connect.Response[v23.Schema], error)
	...
	GetCellInfos(context.Context, *connect.Request[v23.GetCellInfosRequest]) (*connect.Response[v23.GetCellInfosResponse], error)
	...
	GetClusters(context.Context, *connect.Request[v23.GetClustersRequest]) (*connect.Response[v23.GetClustersResponse], error)
	...
	GetFullStatus(context.Context, *connect.Request[v23.GetFullStatusRequest]) (*connect.Response[v231.GetFullStatusResponse], error)
	// GetGates returns all gates across all the specified clusters.
	GetGates(context.Context, *connect.Request[v23.GetGatesRequest]) (*connect.Response[v23.GetGatesResponse], error)
	// GetKeyspace returns a keyspace by name in the specified cluster.
	GetKeyspace(context.Context, *connect.Request[v23.GetKeyspaceRequest]) (*connect.Response[v23.Keyspace], error)
	...
	// tuple.
	GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest]) (*connect.Response[v23.Schema], error)
	// GetSchemas returns all schemas across the specified clusters.
	GetSchemas(context.Context, *connect.Request[v23.GetSchemasRequest]) (*connect.Response[v23.GetSchemasResponse], error)
	...
	// by cluster.
	GetShardReplicationPositions(context.Context, *connect.Request[v23.GetShardReplicationPositionsRequest]) (*connect.Response[v23.GetShardReplicationPositionsResponse], error)
	// GetSrvKeyspace returns the SrvKeyspace for a keyspace in one or more cells.
	GetSrvKeyspace(context.Context, *connect.Request[v23.GetSrvKeyspaceRequest]) (*connect.Response[v231.GetSrvKeyspacesResponse], error)
	...
	GetSrvVSchema(context.Context, *connect.Request[v23.GetSrvVSchemaRequest]) (*connect.Response[v23.SrvVSchema], error)
	...
	// the result.
	GetTablet(context.Context, *connect.Request[v23.GetTabletRequest]) (*connect.Response[v23.Tablet], error)
	...
	GetTopologyPath(context.Context, *connect.Request[v23.GetTopologyPathRequest]) (*connect.Response[v231.GetTopologyPathResponse], error)
	// GetTransactionInfo returns the information about a single transaction.
	GetTransactionInfo(context.Context, *connect.Request[v23.GetTransactionInfoRequest]) (*connect.Response[v231.GetTransactionInfoResponse], error)
	// GetUnresolvedTransactions returns the unresolved transactions for the request.
	GetUnresolvedTransactions(context.Context, *connect.Request[v23.GetUnresolvedTransactionsRequest]) (*connect.Response[v231.GetUnresolvedTransactionsResponse], error)
	// GetVSchema returns a VSchema for the specified keyspace in the specified
	// cluster.
	GetVSchema(context.Context, *connect.Request[v23.GetVSchemaRequest]) (*connect.Response[v23.VSchema], error)
	// GetVSchemas returns the VSchemas for all specified clusters.
	GetVSchemas(context.Context, *connect.Request[v23.GetVSchemasRequest]) (*connect.Response[v23.GetVSchemasResponse], error)
	// GetVtctlds returns the Vtctlds for all specified clusters.
	GetVtctlds(context.Context, *connect.Request[v23.GetVtctldsRequest]) (*connect.Response[v23.GetVtctldsResponse], error)
	// GetWorkflow returns a single Workflow for a given cluster, keyspace, and
	// workflow name.
	GetWorkflow(context.Context, *connect.Request[v23.GetWorkflowRequest]) (*connect.Response[v23.Workflow], error)
	...
	GetWorkflowStatus(context.Context, *connect.Request[v23.GetWorkflowStatusRequest]) (*connect.Response[v231.WorkflowStatusResponse], error)
	// StartWorkflow starts a vreplication workflow.
	StartWorkflow(context.Context, *connect.Request[v23.StartWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error)
	// StopWorkflow stops a vreplication workflow.
	StopWorkflow(context.Context, *connect.Request[v23.StopWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error)
	// LaunchSchemaMigration launches one or all migrations in the given
	// cluster executed with --postpone-launch.
	LaunchSchemaMigration(context.Context, *connect.Request[v23.LaunchSchemaMigrationRequest]) (*connect.Response[v231.LaunchSchemaMigrationResponse], error)
	// MoveTablesComplete completes the move and cleans up the workflow and
	// its related artifacts.
	MoveTablesComplete(context.Context, *connect.Request[v23.MoveTablesCompleteRequest]) (*connect.Response[v231.MoveTablesCompleteResponse], error)
	// MoveTablesCreate creates a workflow which moves one or more tables from a
	// source keyspace to a target keyspace.
	MoveTablesCreate(context.Context, *connect.Request[v23.MoveTablesCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error)
	...
	MaterializeCreate(context.Context, *connect.Request[v23.MaterializeCreateRequest]) (*connect.Response[v231.MaterializeCreateResponse], error)
	...
	PlannedFailoverShard(context.Context, *connect.Request[v23.PlannedFailoverShardRequest]) (*connect.Response[v23.PlannedFailoverShardResponse], error)
	...
	RefreshTabletReplicationSource(context.Context, *connect.Request[v23.RefreshTabletReplicationSourceRequest]) (*connect.Response[v23.RefreshTabletReplicationSourceResponse], error)
	...
	ReloadSchemas(context.Context, *connect.Request[v23.ReloadSchemasRequest]) (*connect.Response[v23.ReloadSchemasResponse], error)
	...
	// for retry.
	RetrySchemaMigration(context.Context, *connect.Request[v23.RetrySchemaMigrationRequest]) (*connect.Response[v231.RetrySchemaMigrationResponse], error)
	...
	ReshardCreate(context.Context, *connect.Request[v23.ReshardCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error)
	...
	TabletExternallyPromoted(context.Context, *connect.Request[v23.TabletExternallyPromotedRequest]) (*connect.Response[v23.TabletExternallyPromotedResponse], error)
	...
	Validate(context.Context, *connect.Request[v23.ValidateRequest]) (*connect.Response[v231.ValidateResponse], error)
	// ValidateKeyspace validates that all nodes reachable from the specified
	// keyspace are consistent.
	ValidateKeyspace(context.Context, *connect.Request[v23.ValidateKeyspaceRequest]) (*connect.Response[v231.ValidateKeyspaceResponse], error)
	...
	// keyspace.
	ValidateSchemaKeyspace(context.Context, *connect.Request[v23.ValidateSchemaKeyspaceRequest]) (*connect.Response[v231.ValidateSchemaKeyspaceResponse], error)
	// ValidateShard validates that that all nodes reachable from the specified shard are consistent.
	ValidateShard(context.Context, *connect.Request[v23.ValidateShardRequest]) (*connect.Response[v231.ValidateShardResponse], error)
	...
	ValidateVersionKeyspace(context.Context, *connect.Request[v23.ValidateVersionKeyspaceRequest]) (*connect.Response[v231.ValidateVersionKeyspaceResponse], error)
	// ValidateVersionShard validates that the version on the primary matches all of the replicas.
	ValidateVersionShard(context.Context, *connect.Request[v23.ValidateVersionShardRequest]) (*connect.Response[v231.ValidateVersionShardResponse], error)
	VDiffCreate(context.Context, *connect.Request[v23.VDiffCreateRequest]) (*connect.Response[v231.VDiffCreateResponse], error)
	...
	// particular query.
	VTExplain(context.Context, *connect.Request[v23.VTExplainRequest]) (*connect.Response[v23.VTExplainResponse], error)
	// VExplain provides information on how Vitess plans to execute a
	// particular query.
	VExplain(context.Context, *connect.Request[v23.VExplainRequest]) (*connect.Response[v23.VExplainResponse], error)
	// WorkflowDelete deletes a vreplication workflow.
	WorkflowDelete(context.Context, *connect.Request[v23.WorkflowDeleteRequest]) (*connect.Response[v231.WorkflowDeleteResponse], error)
	// WorkflowSwitchTraffic switches traffic for a VReplication workflow.
	WorkflowSwitchTraffic(context.Context, *connect.Request[v23.WorkflowSwitchTrafficRequest]) (*connect.Response[v231.WorkflowSwitchTrafficResponse], error)
}
...
func NewVTAdminClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VTAdminClient {
	...
	vTAdminMethods := v23.File_vitess_vtadmin_v23_vtadmin_proto.Services().ByName("VTAdmin").Methods()
	return &vTAdminClient{
		applySchema: connect.NewClient[v23.ApplySchemaRequest, v231.ApplySchemaResponse](
			httpClient,
			baseURL+VTAdminApplySchemaProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ApplySchema")),
			connect.WithClientOptions(opts...),
		),
		cancelSchemaMigration: connect.NewClient[v23.CancelSchemaMigrationRequest, v231.CancelSchemaMigrationResponse](
			httpClient,
			baseURL+VTAdminCancelSchemaMigrationProcedure,
			connect.WithSchema(vTAdminMethods.ByName("CancelSchemaMigration")),
			connect.WithClientOptions(opts...),
		),
		cleanupSchemaMigration: connect.NewClient[v23.CleanupSchemaMigrationRequest, v231.CleanupSchemaMigrationResponse](
			httpClient,
			baseURL+VTAdminCleanupSchemaMigrationProcedure,
			connect.WithSchema(vTAdminMethods.ByName("CleanupSchemaMigration")),
			connect.WithClientOptions(opts...),
		),
		completeSchemaMigration: connect.NewClient[v23.CompleteSchemaMigrationRequest, v231.CompleteSchemaMigrationResponse](
			httpClient,
			baseURL+VTAdminCompleteSchemaMigrationProcedure,
			connect.WithSchema(vTAdminMethods.ByName("CompleteSchemaMigration")),
			connect.WithClientOptions(opts...),
		),
		concludeTransaction: connect.NewClient[v23.ConcludeTransactionRequest, v231.ConcludeTransactionResponse](
			httpClient,
		...
		createShard: connect.NewClient[v23.CreateShardRequest, v231.CreateShardResponse](
			httpClient,
			baseURL+VTAdminCreateShardProcedure,
			connect.WithSchema(vTAdminMethods.ByName("CreateShard")),
			connect.WithClientOptions(opts...),
		),
		deleteKeyspace: connect.NewClient[v23.DeleteKeyspaceRequest, v231.DeleteKeyspaceResponse](
			httpClient,
			baseURL+VTAdminDeleteKeyspaceProcedure,
			connect.WithSchema(vTAdminMethods.ByName("DeleteKeyspace")),
			connect.WithClientOptions(opts...),
		),
		deleteShards: connect.NewClient[v23.DeleteShardsRequest, v231.DeleteShardsResponse](
			httpClient,
			baseURL+VTAdminDeleteShardsProcedure,
			connect.WithSchema(vTAdminMethods.ByName("DeleteShards")),
			connect.WithClientOptions(opts...),
		),
		deleteTablet: connect.NewClient[v23.DeleteTabletRequest, v23.DeleteTabletResponse](
			httpClient,
			baseURL+VTAdminDeleteTabletProcedure,
			connect.WithSchema(vTAdminMethods.ByName("DeleteTablet")),
			connect.WithClientOptions(opts...),
		),
		emergencyFailoverShard: connect.NewClient[v23.EmergencyFailoverShardRequest, v23.EmergencyFailoverShardResponse](
			httpClient,
			baseURL+VTAdminEmergencyFailoverShardProcedure,
			connect.WithSchema(vTAdminMethods.ByName("EmergencyFailoverShard")),
			connect.WithClientOptions(opts...),
		),
		findSchema: connect.NewClient[v23.FindSchemaRequest, v23.Schema](
			httpClient,
		...
		getCellInfos: connect.NewClient[v23.GetCellInfosRequest, v23.GetCellInfosResponse](
			httpClient,
		...
		getClusters: connect.NewClient[v23.GetClustersRequest, v23.GetClustersResponse](
			httpClient,
			baseURL+VTAdminGetClustersProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetClusters")),
			connect.WithClientOptions(opts...),
		),
		getFullStatus: connect.NewClient[v23.GetFullStatusRequest, v231.GetFullStatusResponse](
			httpClient,
			baseURL+VTAdminGetFullStatusProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetFullStatus")),
			connect.WithClientOptions(opts...),
		),
		getGates: connect.NewClient[v23.GetGatesRequest, v23.GetGatesResponse](
			httpClient,
			baseURL+VTAdminGetGatesProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetGates")),
			connect.WithClientOptions(opts...),
		),
		getKeyspace: connect.NewClient[v23.GetKeyspaceRequest, v23.Keyspace](
			httpClient,
		...
		getSchema: connect.NewClient[v23.GetSchemaRequest, v23.Schema](
			httpClient,
			baseURL+VTAdminGetSchemaProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetSchema")),
			connect.WithClientOptions(opts...),
		),
		getSchemas: connect.NewClient[v23.GetSchemasRequest, v23.GetSchemasResponse](
			httpClient,
		...
		getShardReplicationPositions: connect.NewClient[v23.GetShardReplicationPositionsRequest, v23.GetShardReplicationPositionsResponse](
			httpClient,
		...
		getSrvKeyspace: connect.NewClient[v23.GetSrvKeyspaceRequest, v231.GetSrvKeyspacesResponse](
			httpClient,
		...
		getSrvVSchema: connect.NewClient[v23.GetSrvVSchemaRequest, v23.SrvVSchema](
			httpClient,
		...
		getTablet: connect.NewClient[v23.GetTabletRequest, v23.Tablet](
			httpClient,
		...
		getTopologyPath: connect.NewClient[v23.GetTopologyPathRequest, v231.GetTopologyPathResponse](
			httpClient,
			baseURL+VTAdminGetTopologyPathProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetTopologyPath")),
			connect.WithClientOptions(opts...),
		),
		getTransactionInfo: connect.NewClient[v23.GetTransactionInfoRequest, v231.GetTransactionInfoResponse](
			httpClient,
			baseURL+VTAdminGetTransactionInfoProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetTransactionInfo")),
			connect.WithClientOptions(opts...),
		),
		getUnresolvedTransactions: connect.NewClient[v23.GetUnresolvedTransactionsRequest, v231.GetUnresolvedTransactionsResponse](
			httpClient,
			baseURL+VTAdminGetUnresolvedTransactionsProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetUnresolvedTransactions")),
			connect.WithClientOptions(opts...),
		),
		getVSchema: connect.NewClient[v23.GetVSchemaRequest, v23.VSchema](
			httpClient,
			baseURL+VTAdminGetVSchemaProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetVSchema")),
			connect.WithClientOptions(opts...),
		),
		getVSchemas: connect.NewClient[v23.GetVSchemasRequest, v23.GetVSchemasResponse](
			httpClient,
			baseURL+VTAdminGetVSchemasProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetVSchemas")),
			connect.WithClientOptions(opts...),
		),
		getVtctlds: connect.NewClient[v23.GetVtctldsRequest, v23.GetVtctldsResponse](
			httpClient,
			baseURL+VTAdminGetVtctldsProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetVtctlds")),
			connect.WithClientOptions(opts...),
		),
		getWorkflow: connect.NewClient[v23.GetWorkflowRequest, v23.Workflow](
			httpClient,
		...
		getWorkflowStatus: connect.NewClient[v23.GetWorkflowStatusRequest, v231.WorkflowStatusResponse](
			httpClient,
			baseURL+VTAdminGetWorkflowStatusProcedure,
			connect.WithSchema(vTAdminMethods.ByName("GetWorkflowStatus")),
			connect.WithClientOptions(opts...),
		),
		startWorkflow: connect.NewClient[v23.StartWorkflowRequest, v231.WorkflowUpdateResponse](
			httpClient,
			baseURL+VTAdminStartWorkflowProcedure,
			connect.WithSchema(vTAdminMethods.ByName("StartWorkflow")),
			connect.WithClientOptions(opts...),
		),
		stopWorkflow: connect.NewClient[v23.StopWorkflowRequest, v231.WorkflowUpdateResponse](
			httpClient,
			baseURL+VTAdminStopWorkflowProcedure,
			connect.WithSchema(vTAdminMethods.ByName("StopWorkflow")),
			connect.WithClientOptions(opts...),
		),
		launchSchemaMigration: connect.NewClient[v23.LaunchSchemaMigrationRequest, v231.LaunchSchemaMigrationResponse](
			httpClient,
			baseURL+VTAdminLaunchSchemaMigrationProcedure,
			connect.WithSchema(vTAdminMethods.ByName("LaunchSchemaMigration")),
			connect.WithClientOptions(opts...),
		),
		moveTablesComplete: connect.NewClient[v23.MoveTablesCompleteRequest, v231.MoveTablesCompleteResponse](
			httpClient,
			baseURL+VTAdminMoveTablesCompleteProcedure,
			connect.WithSchema(vTAdminMethods.ByName("MoveTablesComplete")),
			connect.WithClientOptions(opts...),
		),
		moveTablesCreate: connect.NewClient[v23.MoveTablesCreateRequest, v231.WorkflowStatusResponse](
			httpClient,
			baseURL+VTAdminMoveTablesCreateProcedure,
			connect.WithSchema(vTAdminMethods.ByName("MoveTablesCreate")),
			connect.WithClientOptions(opts...),
		),
		materializeCreate: connect.NewClient[v23.MaterializeCreateRequest, v231.MaterializeCreateResponse](
			httpClient,
		...
		plannedFailoverShard: connect.NewClient[v23.PlannedFailoverShardRequest, v23.PlannedFailoverShardResponse](
			httpClient,
		...
		refreshTabletReplicationSource: connect.NewClient[v23.RefreshTabletReplicationSourceRequest, v23.RefreshTabletReplicationSourceResponse](
			httpClient,
		...
		reloadSchemas: connect.NewClient[v23.ReloadSchemasRequest, v23.ReloadSchemasResponse](
			httpClient,
		...
		retrySchemaMigration: connect.NewClient[v23.RetrySchemaMigrationRequest, v231.RetrySchemaMigrationResponse](
			httpClient,
		...
		reshardCreate: connect.NewClient[v23.ReshardCreateRequest, v231.WorkflowStatusResponse](
			httpClient,
		...
		tabletExternallyPromoted: connect.NewClient[v23.TabletExternallyPromotedRequest, v23.TabletExternallyPromotedResponse](
			httpClient,
			baseURL+VTAdminTabletExternallyPromotedProcedure,
			connect.WithSchema(vTAdminMethods.ByName("TabletExternallyPromoted")),
			connect.WithClientOptions(opts...),
		),
		validate: connect.NewClient[v23.ValidateRequest, v231.ValidateResponse](
			httpClient,
			baseURL+VTAdminValidateProcedure,
			connect.WithSchema(vTAdminMethods.ByName("Validate")),
			connect.WithClientOptions(opts...),
		),
		validateKeyspace: connect.NewClient[v23.ValidateKeyspaceRequest, v231.ValidateKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateKeyspaceProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ValidateKeyspace")),
			connect.WithClientOptions(opts...),
		),
		validateSchemaKeyspace: connect.NewClient[v23.ValidateSchemaKeyspaceRequest, v231.ValidateSchemaKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateSchemaKeyspaceProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ValidateSchemaKeyspace")),
			connect.WithClientOptions(opts...),
		),
		validateShard: connect.NewClient[v23.ValidateShardRequest, v231.ValidateShardResponse](
			httpClient,
			baseURL+VTAdminValidateShardProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ValidateShard")),
			connect.WithClientOptions(opts...),
		),
		validateVersionKeyspace: connect.NewClient[v23.ValidateVersionKeyspaceRequest, v231.ValidateVersionKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateVersionKeyspaceProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ValidateVersionKeyspace")),
			connect.WithClientOptions(opts...),
		),
		validateVersionShard: connect.NewClient[v23.ValidateVersionShardRequest, v231.ValidateVersionShardResponse](
			httpClient,
			baseURL+VTAdminValidateVersionShardProcedure,
			connect.WithSchema(vTAdminMethods.ByName("ValidateVersionShard")),
			connect.WithClientOptions(opts...),
		),
		vDiffCreate: connect.NewClient[v23.VDiffCreateRequest, v231.VDiffCreateResponse](
			httpClient,
		...
		vTExplain: connect.NewClient[v23.VTExplainRequest, v23.VTExplainResponse](
			httpClient,
			baseURL+VTAdminVTExplainProcedure,
			connect.WithSchema(vTAdminMethods.ByName("VTExplain")),
			connect.WithClientOptions(opts...),
		),
		vExplain: connect.NewClient[v23.VExplainRequest, v23.VExplainResponse](
			httpClient,
			baseURL+VTAdminVExplainProcedure,
			connect.WithSchema(vTAdminMethods.ByName("VExplain")),
			connect.WithClientOptions(opts...),
		),
		workflowDelete: connect.NewClient[v23.WorkflowDeleteRequest, v231.WorkflowDeleteResponse](
			httpClient,
			baseURL+VTAdminWorkflowDeleteProcedure,
			connect.WithSchema(vTAdminMethods.ByName("WorkflowDelete")),
			connect.WithClientOptions(opts...),
		),
		workflowSwitchTraffic: connect.NewClient[v23.WorkflowSwitchTrafficRequest, v231.WorkflowSwitchTrafficResponse](
			httpClient,
...
type vTAdminClient struct {
	applySchema                    *connect.Client[v23.ApplySchemaRequest, v231.ApplySchemaResponse]
	cancelSchemaMigration          *connect.Client[v23.CancelSchemaMigrationRequest, v231.CancelSchemaMigrationResponse]
	cleanupSchemaMigration         *connect.Client[v23.CleanupSchemaMigrationRequest, v231.CleanupSchemaMigrationResponse]
	completeSchemaMigration        *connect.Client[v23.CompleteSchemaMigrationRequest, v231.CompleteSchemaMigrationResponse]
	concludeTransaction            *connect.Client[v23.ConcludeTransactionRequest, v231.ConcludeTransactionResponse]
	createKeyspace                 *connect.Client[v23.CreateKeyspaceRequest, v23.CreateKeyspaceResponse]
	createShard                    *connect.Client[v23.CreateShardRequest, v231.CreateShardResponse]
	deleteKeyspace                 *connect.Client[v23.DeleteKeyspaceRequest, v231.DeleteKeyspaceResponse]
	deleteShards                   *connect.Client[v23.DeleteShardsRequest, v231.DeleteShardsResponse]
	deleteTablet                   *connect.Client[v23.DeleteTabletRequest, v23.DeleteTabletResponse]
	emergencyFailoverShard         *connect.Client[v23.EmergencyFailoverShardRequest, v23.EmergencyFailoverShardResponse]
	findSchema                     *connect.Client[v23.FindSchemaRequest, v23.Schema]
	getBackups                     *connect.Client[v23.GetBackupsRequest, v23.GetBackupsResponse]
	getCellInfos                   *connect.Client[v23.GetCellInfosRequest, v23.GetCellInfosResponse]
	getCellsAliases                *connect.Client[v23.GetCellsAliasesRequest, v23.GetCellsAliasesResponse]
	getClusters                    *connect.Client[v23.GetClustersRequest, v23.GetClustersResponse]
	getFullStatus                  *connect.Client[v23.GetFullStatusRequest, v231.GetFullStatusResponse]
	getGates                       *connect.Client[v23.GetGatesRequest, v23.GetGatesResponse]
	getKeyspace                    *connect.Client[v23.GetKeyspaceRequest, v23.Keyspace]
	getKeyspaces                   *connect.Client[v23.GetKeyspacesRequest, v23.GetKeyspacesResponse]
	getSchema                      *connect.Client[v23.GetSchemaRequest, v23.Schema]
	getSchemas                     *connect.Client[v23.GetSchemasRequest, v23.GetSchemasResponse]
	getSchemaMigrations            *connect.Client[v23.GetSchemaMigrationsRequest, v23.GetSchemaMigrationsResponse]
	getShardReplicationPositions   *connect.Client[v23.GetShardReplicationPositionsRequest, v23.GetShardReplicationPositionsResponse]
	getSrvKeyspace                 *connect.Client[v23.GetSrvKeyspaceRequest, v231.GetSrvKeyspacesResponse]
	getSrvKeyspaces                *connect.Client[v23.GetSrvKeyspacesRequest, v23.GetSrvKeyspacesResponse]
	getSrvVSchema                  *connect.Client[v23.GetSrvVSchemaRequest, v23.SrvVSchema]
	getSrvVSchemas                 *connect.Client[v23.GetSrvVSchemasRequest, v23.GetSrvVSchemasResponse]
	getTablet                      *connect.Client[v23.GetTabletRequest, v23.Tablet]
	getTablets                     *connect.Client[v23.GetTabletsRequest, v23.GetTabletsResponse]
	getTopologyPath                *connect.Client[v23.GetTopologyPathRequest, v231.GetTopologyPathResponse]
	getTransactionInfo             *connect.Client[v23.GetTransactionInfoRequest, v231.GetTransactionInfoResponse]
	getUnresolvedTransactions      *connect.Client[v23.GetUnresolvedTransactionsRequest, v231.GetUnresolvedTransactionsResponse]
	getVSchema                     *connect.Client[v23.GetVSchemaRequest, v23.VSchema]
	getVSchemas                    *connect.Client[v23.GetVSchemasRequest, v23.GetVSchemasResponse]
	getVtctlds                     *connect.Client[v23.GetVtctldsRequest, v23.GetVtctldsResponse]
	getWorkflow                    *connect.Client[v23.GetWorkflowRequest, v23.Workflow]
	getWorkflows                   *connect.Client[v23.GetWorkflowsRequest, v23.GetWorkflowsResponse]
	getWorkflowStatus              *connect.Client[v23.GetWorkflowStatusRequest, v231.WorkflowStatusResponse]
	startWorkflow                  *connect.Client[v23.StartWorkflowRequest, v231.WorkflowUpdateResponse]
	stopWorkflow                   *connect.Client[v23.StopWorkflowRequest, v231.WorkflowUpdateResponse]
	launchSchemaMigration          *connect.Client[v23.LaunchSchemaMigrationRequest, v231.LaunchSchemaMigrationResponse]
	moveTablesComplete             *connect.Client[v23.MoveTablesCompleteRequest, v231.MoveTablesCompleteResponse]
	moveTablesCreate               *connect.Client[v23.MoveTablesCreateRequest, v231.WorkflowStatusResponse]
	materializeCreate              *connect.Client[v23.MaterializeCreateRequest, v231.MaterializeCreateResponse]
	pingTablet                     *connect.Client[v23.PingTabletRequest, v23.PingTabletResponse]
	plannedFailoverShard           *connect.Client[v23.PlannedFailoverShardRequest, v23.PlannedFailoverShardResponse]
	...
	refreshTabletReplicationSource *connect.Client[v23.RefreshTabletReplicationSourceRequest, v23.RefreshTabletReplicationSourceResponse]
	reloadSchemas                  *connect.Client[v23.ReloadSchemasRequest, v23.ReloadSchemasResponse]
	...
	retrySchemaMigration           *connect.Client[v23.RetrySchemaMigrationRequest, v231.RetrySchemaMigrationResponse]
	runHealthCheck                 *connect.Client[v23.RunHealthCheckRequest, v23.RunHealthCheckResponse]
	reshardCreate                  *connect.Client[v23.ReshardCreateRequest, v231.WorkflowStatusResponse]
	...
	tabletExternallyPromoted       *connect.Client[v23.TabletExternallyPromotedRequest, v23.TabletExternallyPromotedResponse]
	validate                       *connect.Client[v23.ValidateRequest, v231.ValidateResponse]
	validateKeyspace               *connect.Client[v23.ValidateKeyspaceRequest, v231.ValidateKeyspaceResponse]
	validateSchemaKeyspace         *connect.Client[v23.ValidateSchemaKeyspaceRequest, v231.ValidateSchemaKeyspaceResponse]
	validateShard                  *connect.Client[v23.ValidateShardRequest, v231.ValidateShardResponse]
	validateVersionKeyspace        *connect.Client[v23.ValidateVersionKeyspaceRequest, v231.ValidateVersionKeyspaceResponse]
	validateVersionShard           *connect.Client[v23.ValidateVersionShardRequest, v231.ValidateVersionShardResponse]
	vDiffCreate                    *connect.Client[v23.VDiffCreateRequest, v231.VDiffCreateResponse]
	vDiffShow                      *connect.Client[v23.VDiffShowRequest, v23.VDiffShowResponse]
	vTExplain                      *connect.Client[v23.VTExplainRequest, v23.VTExplainResponse]
	vExplain                       *connect.Client[v23.VExplainRequest, v23.VExplainResponse]
	workflowDelete                 *connect.Client[v23.WorkflowDeleteRequest, v231.WorkflowDeleteResponse]
	workflowSwitchTraffic          *connect.Client[v23.WorkflowSwitchTrafficRequest, v231.WorkflowSwitchTrafficResponse]
}

// ApplySchema calls vtadmin.VTAdmin.ApplySchema.
func (c *vTAdminClient) ApplySchema(ctx context.Context, req *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v231.ApplySchemaResponse], error) {
	return c.applySchema.CallUnary(ctx, req)
}

// CancelSchemaMigration calls vtadmin.VTAdmin.CancelSchemaMigration.
func (c *vTAdminClient) CancelSchemaMigration(ctx context.Context, req *connect.Request[v23.CancelSchemaMigrationRequest]) (*connect.Response[v231.CancelSchemaMigrationResponse], error) {
	return c.cancelSchemaMigration.CallUnary(ctx, req)
}

// CleanupSchemaMigration calls vtadmin.VTAdmin.CleanupSchemaMigration.
func (c *vTAdminClient) CleanupSchemaMigration(ctx context.Context, req *connect.Request[v23.CleanupSchemaMigrationRequest]) (*connect.Response[v231.CleanupSchemaMigrationResponse], error) {
	return c.cleanupSchemaMigration.CallUnary(ctx, req)
}

// CompleteSchemaMigration calls vtadmin.VTAdmin.CompleteSchemaMigration.
func (c *vTAdminClient) CompleteSchemaMigration(ctx context.Context, req *connect.Request[v23.CompleteSchemaMigrationRequest]) (*connect.Response[v231.CompleteSchemaMigrationResponse], error) {
	return c.completeSchemaMigration.CallUnary(ctx, req)
}

// ConcludeTransaction calls vtadmin.VTAdmin.ConcludeTransaction.
func (c *vTAdminClient) ConcludeTransaction(ctx context.Context, req *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v231.ConcludeTransactionResponse], error) {
	return c.concludeTransaction.CallUnary(ctx, req)
}

// CreateKeyspace calls vtadmin.VTAdmin.CreateKeyspace.
func (c *vTAdminClient) CreateKeyspace(ctx context.Context, req *connect.Request[v23.CreateKeyspaceRequest]) (*connect.Response[v23.CreateKeyspaceResponse], error) {
	return c.createKeyspace.CallUnary(ctx, req)
}

// CreateShard calls vtadmin.VTAdmin.CreateShard.
func (c *vTAdminClient) CreateShard(ctx context.Context, req *connect.Request[v23.CreateShardRequest]) (*connect.Response[v231.CreateShardResponse], error) {
	return c.createShard.CallUnary(ctx, req)
}

// DeleteKeyspace calls vtadmin.VTAdmin.DeleteKeyspace.
func (c *vTAdminClient) DeleteKeyspace(ctx context.Context, req *connect.Request[v23.DeleteKeyspaceRequest]) (*connect.Response[v231.DeleteKeyspaceResponse], error) {
	return c.deleteKeyspace.CallUnary(ctx, req)
}

// DeleteShards calls vtadmin.VTAdmin.DeleteShards.
func (c *vTAdminClient) DeleteShards(ctx context.Context, req *connect.Request[v23.DeleteShardsRequest]) (*connect.Response[v231.DeleteShardsResponse], error) {
	return c.deleteShards.CallUnary(ctx, req)
}

// DeleteTablet calls vtadmin.VTAdmin.DeleteTablet.
func (c *vTAdminClient) DeleteTablet(ctx context.Context, req *connect.Request[v23.DeleteTabletRequest]) (*connect.Response[v23.DeleteTabletResponse], error) {
	return c.deleteTablet.CallUnary(ctx, req)
}

// EmergencyFailoverShard calls vtadmin.VTAdmin.EmergencyFailoverShard.
func (c *vTAdminClient) EmergencyFailoverShard(ctx context.Context, req *connect.Request[v23.EmergencyFailoverShardRequest]) (*connect.Response[v23.EmergencyFailoverShardResponse], error) {
	return c.emergencyFailoverShard.CallUnary(ctx, req)
}

// FindSchema calls vtadmin.VTAdmin.FindSchema.
func (c *vTAdminClient) FindSchema(ctx context.Context, req *connect.Request[v23.FindSchemaRequest]) (*connect.Response[v23.Schema], error) {
	return c.findSchema.CallUnary(ctx, req)
}

// GetBackups calls vtadmin.VTAdmin.GetBackups.
func (c *vTAdminClient) GetBackups(ctx context.Context, req *connect.Request[v23.GetBackupsRequest]) (*connect.Response[v23.GetBackupsResponse], error) {
	return c.getBackups.CallUnary(ctx, req)
}

// GetCellInfos calls vtadmin.VTAdmin.GetCellInfos.
func (c *vTAdminClient) GetCellInfos(ctx context.Context, req *connect.Request[v23.GetCellInfosRequest]) (*connect.Response[v23.GetCellInfosResponse], error) {
	return c.getCellInfos.CallUnary(ctx, req)
}

// GetCellsAliases calls vtadmin.VTAdmin.GetCellsAliases.
func (c *vTAdminClient) GetCellsAliases(ctx context.Context, req *connect.Request[v23.GetCellsAliasesRequest]) (*connect.Response[v23.GetCellsAliasesResponse], error) {
	return c.getCellsAliases.CallUnary(ctx, req)
}

// GetClusters calls vtadmin.VTAdmin.GetClusters.
func (c *vTAdminClient) GetClusters(ctx context.Context, req *connect.Request[v23.GetClustersRequest]) (*connect.Response[v23.GetClustersResponse], error) {
	return c.getClusters.CallUnary(ctx, req)
}

// GetFullStatus calls vtadmin.VTAdmin.GetFullStatus.
func (c *vTAdminClient) GetFullStatus(ctx context.Context, req *connect.Request[v23.GetFullStatusRequest]) (*connect.Response[v231.GetFullStatusResponse], error) {
	return c.getFullStatus.CallUnary(ctx, req)
}

// GetGates calls vtadmin.VTAdmin.GetGates.
func (c *vTAdminClient) GetGates(ctx context.Context, req *connect.Request[v23.GetGatesRequest]) (*connect.Response[v23.GetGatesResponse], error) {
	return c.getGates.CallUnary(ctx, req)
}

// GetKeyspace calls vtadmin.VTAdmin.GetKeyspace.
func (c *vTAdminClient) GetKeyspace(ctx context.Context, req *connect.Request[v23.GetKeyspaceRequest]) (*connect.Response[v23.Keyspace], error) {
	return c.getKeyspace.CallUnary(ctx, req)
}

// GetKeyspaces calls vtadmin.VTAdmin.GetKeyspaces.
func (c *vTAdminClient) GetKeyspaces(ctx context.Context, req *connect.Request[v23.GetKeyspacesRequest]) (*connect.Response[v23.GetKeyspacesResponse], error) {
	return c.getKeyspaces.CallUnary(ctx, req)
}

// GetSchema calls vtadmin.VTAdmin.GetSchema.
func (c *vTAdminClient) GetSchema(ctx context.Context, req *connect.Request[v23.GetSchemaRequest]) (*connect.Response[v23.Schema], error) {
	return c.getSchema.CallUnary(ctx, req)
}

// GetSchemas calls vtadmin.VTAdmin.GetSchemas.
func (c *vTAdminClient) GetSchemas(ctx context.Context, req *connect.Request[v23.GetSchemasRequest]) (*connect.Response[v23.GetSchemasResponse], error) {
	return c.getSchemas.CallUnary(ctx, req)
}

// GetSchemaMigrations calls vtadmin.VTAdmin.GetSchemaMigrations.
func (c *vTAdminClient) GetSchemaMigrations(ctx context.Context, req *connect.Request[v23.GetSchemaMigrationsRequest]) (*connect.Response[v23.GetSchemaMigrationsResponse], error) {
...
func (c *vTAdminClient) GetShardReplicationPositions(ctx context.Context, req *connect.Request[v23.GetShardReplicationPositionsRequest]) (*connect.Response[v23.GetShardReplicationPositionsResponse], error) {
	return c.getShardReplicationPositions.CallUnary(ctx, req)
}

// GetSrvKeyspace calls vtadmin.VTAdmin.GetSrvKeyspace.
func (c *vTAdminClient) GetSrvKeyspace(ctx context.Context, req *connect.Request[v23.GetSrvKeyspaceRequest]) (*connect.Response[v231.GetSrvKeyspacesResponse], error) {
	return c.getSrvKeyspace.CallUnary(ctx, req)
}

// GetSrvKeyspaces calls vtadmin.VTAdmin.GetSrvKeyspaces.
func (c *vTAdminClient) GetSrvKeyspaces(ctx context.Context, req *connect.Request[v23.GetSrvKeyspacesRequest]) (*connect.Response[v23.GetSrvKeyspacesResponse], error) {
	return c.getSrvKeyspaces.CallUnary(ctx, req)
}

// GetSrvVSchema calls vtadmin.VTAdmin.GetSrvVSchema.
func (c *vTAdminClient) GetSrvVSchema(ctx context.Context, req *connect.Request[v23.GetSrvVSchemaRequest]) (*connect.Response[v23.SrvVSchema], error) {
	return c.getSrvVSchema.CallUnary(ctx, req)
}

// GetSrvVSchemas calls vtadmin.VTAdmin.GetSrvVSchemas.
func (c *vTAdminClient) GetSrvVSchemas(ctx context.Context, req *connect.Request[v23.GetSrvVSchemasRequest]) (*connect.Response[v23.GetSrvVSchemasResponse], error) {
	return c.getSrvVSchemas.CallUnary(ctx, req)
}

// GetTablet calls vtadmin.VTAdmin.GetTablet.
func (c *vTAdminClient) GetTablet(ctx context.Context, req *connect.Request[v23.GetTabletRequest]) (*connect.Response[v23.Tablet], error) {
	return c.getTablet.CallUnary(ctx, req)
}

// GetTablets calls vtadmin.VTAdmin.GetTablets.
func (c *vTAdminClient) GetTablets(ctx context.Context, req *connect.Request[v23.GetTabletsRequest]) (*connect.Response[v23.GetTabletsResponse], error) {
	return c.getTablets.CallUnary(ctx, req)
}

// GetTopologyPath calls vtadmin.VTAdmin.GetTopologyPath.
func (c *vTAdminClient) GetTopologyPath(ctx context.Context, req *connect.Request[v23.GetTopologyPathRequest]) (*connect.Response[v231.GetTopologyPathResponse], error) {
	return c.getTopologyPath.CallUnary(ctx, req)
}

// GetTransactionInfo calls vtadmin.VTAdmin.GetTransactionInfo.
func (c *vTAdminClient) GetTransactionInfo(ctx context.Context, req *connect.Request[v23.GetTransactionInfoRequest]) (*connect.Response[v231.GetTransactionInfoResponse], error) {
	return c.getTransactionInfo.CallUnary(ctx, req)
}

// GetUnresolvedTransactions calls vtadmin.VTAdmin.GetUnresolvedTransactions.
func (c *vTAdminClient) GetUnresolvedTransactions(ctx context.Context, req *connect.Request[v23.GetUnresolvedTransactionsRequest]) (*connect.Response[v231.GetUnresolvedTransactionsResponse], error) {
	return c.getUnresolvedTransactions.CallUnary(ctx, req)
}

// GetVSchema calls vtadmin.VTAdmin.GetVSchema.
func (c *vTAdminClient) GetVSchema(ctx context.Context, req *connect.Request[v23.GetVSchemaRequest]) (*connect.Response[v23.VSchema], error) {
	return c.getVSchema.CallUnary(ctx, req)
}

// GetVSchemas calls vtadmin.VTAdmin.GetVSchemas.
func (c *vTAdminClient) GetVSchemas(ctx context.Context, req *connect.Request[v23.GetVSchemasRequest]) (*connect.Response[v23.GetVSchemasResponse], error) {
	return c.getVSchemas.CallUnary(ctx, req)
}

// GetVtctlds calls vtadmin.VTAdmin.GetVtctlds.
func (c *vTAdminClient) GetVtctlds(ctx context.Context, req *connect.Request[v23.GetVtctldsRequest]) (*connect.Response[v23.GetVtctldsResponse], error) {
	return c.getVtctlds.CallUnary(ctx, req)
}

// GetWorkflow calls vtadmin.VTAdmin.GetWorkflow.
func (c *vTAdminClient) GetWorkflow(ctx context.Context, req *connect.Request[v23.GetWorkflowRequest]) (*connect.Response[v23.Workflow], error) {
	return c.getWorkflow.CallUnary(ctx, req)
}

// GetWorkflows calls vtadmin.VTAdmin.GetWorkflows.
func (c *vTAdminClient) GetWorkflows(ctx context.Context, req *connect.Request[v23.GetWorkflowsRequest]) (*connect.Response[v23.GetWorkflowsResponse], error) {
	return c.getWorkflows.CallUnary(ctx, req)
}

// GetWorkflowStatus calls vtadmin.VTAdmin.GetWorkflowStatus.
func (c *vTAdminClient) GetWorkflowStatus(ctx context.Context, req *connect.Request[v23.GetWorkflowStatusRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return c.getWorkflowStatus.CallUnary(ctx, req)
}

// StartWorkflow calls vtadmin.VTAdmin.StartWorkflow.
func (c *vTAdminClient) StartWorkflow(ctx context.Context, req *connect.Request[v23.StartWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error) {
	return c.startWorkflow.CallUnary(ctx, req)
}

// StopWorkflow calls vtadmin.VTAdmin.StopWorkflow.
func (c *vTAdminClient) StopWorkflow(ctx context.Context, req *connect.Request[v23.StopWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error) {
	return c.stopWorkflow.CallUnary(ctx, req)
}

// LaunchSchemaMigration calls vtadmin.VTAdmin.LaunchSchemaMigration.
func (c *vTAdminClient) LaunchSchemaMigration(ctx context.Context, req *connect.Request[v23.LaunchSchemaMigrationRequest]) (*connect.Response[v231.LaunchSchemaMigrationResponse], error) {
	return c.launchSchemaMigration.CallUnary(ctx, req)
}

// MoveTablesComplete calls vtadmin.VTAdmin.MoveTablesComplete.
func (c *vTAdminClient) MoveTablesComplete(ctx context.Context, req *connect.Request[v23.MoveTablesCompleteRequest]) (*connect.Response[v231.MoveTablesCompleteResponse], error) {
	return c.moveTablesComplete.CallUnary(ctx, req)
}

// MoveTablesCreate calls vtadmin.VTAdmin.MoveTablesCreate.
func (c *vTAdminClient) MoveTablesCreate(ctx context.Context, req *connect.Request[v23.MoveTablesCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return c.moveTablesCreate.CallUnary(ctx, req)
}

// MaterializeCreate calls vtadmin.VTAdmin.MaterializeCreate.
func (c *vTAdminClient) MaterializeCreate(ctx context.Context, req *connect.Request[v23.MaterializeCreateRequest]) (*connect.Response[v231.MaterializeCreateResponse], error) {
	return c.materializeCreate.CallUnary(ctx, req)
}

// PingTablet calls vtadmin.VTAdmin.PingTablet.
func (c *vTAdminClient) PingTablet(ctx context.Context, req *connect.Request[v23.PingTabletRequest]) (*connect.Response[v23.PingTabletResponse], error) {
	return c.pingTablet.CallUnary(ctx, req)
}

// PlannedFailoverShard calls vtadmin.VTAdmin.PlannedFailoverShard.
func (c *vTAdminClient) PlannedFailoverShard(ctx context.Context, req *connect.Request[v23.PlannedFailoverShardRequest]) (*connect.Response[v23.PlannedFailoverShardResponse], error) {
	return c.plannedFailoverShard.CallUnary(ctx, req)
}

// RebuildKeyspaceGraph calls vtadmin.VTAdmin.RebuildKeyspaceGraph.
func (c *vTAdminClient) RebuildKeyspaceGraph(ctx context.Context, req *connect.Request[v23.RebuildKeyspaceGraphRequest]) (*connect.Response[v23.RebuildKeyspaceGraphResponse], error) {
	return c.rebuildKeyspaceGraph.CallUnary(ctx, req)
}

// RefreshState calls vtadmin.VTAdmin.RefreshState.
func (c *vTAdminClient) RefreshState(ctx context.Context, req *connect.Request[v23.RefreshStateRequest]) (*connect.Response[v23.RefreshStateResponse], error) {
...
func (c *vTAdminClient) RefreshTabletReplicationSource(ctx context.Context, req *connect.Request[v23.RefreshTabletReplicationSourceRequest]) (*connect.Response[v23.RefreshTabletReplicationSourceResponse], error) {
	return c.refreshTabletReplicationSource.CallUnary(ctx, req)
}

// ReloadSchemas calls vtadmin.VTAdmin.ReloadSchemas.
func (c *vTAdminClient) ReloadSchemas(ctx context.Context, req *connect.Request[v23.ReloadSchemasRequest]) (*connect.Response[v23.ReloadSchemasResponse], error) {
	return c.reloadSchemas.CallUnary(ctx, req)
}

// ReloadSchemaShard calls vtadmin.VTAdmin.ReloadSchemaShard.
func (c *vTAdminClient) ReloadSchemaShard(ctx context.Context, req *connect.Request[v23.ReloadSchemaShardRequest]) (*connect.Response[v23.ReloadSchemaShardResponse], error) {
	return c.reloadSchemaShard.CallUnary(ctx, req)
}

// RemoveKeyspaceCell calls vtadmin.VTAdmin.RemoveKeyspaceCell.
func (c *vTAdminClient) RemoveKeyspaceCell(ctx context.Context, req *connect.Request[v23.RemoveKeyspaceCellRequest]) (*connect.Response[v23.RemoveKeyspaceCellResponse], error) {
	return c.removeKeyspaceCell.CallUnary(ctx, req)
}

// RetrySchemaMigration calls vtadmin.VTAdmin.RetrySchemaMigration.
func (c *vTAdminClient) RetrySchemaMigration(ctx context.Context, req *connect.Request[v23.RetrySchemaMigrationRequest]) (*connect.Response[v231.RetrySchemaMigrationResponse], error) {
	return c.retrySchemaMigration.CallUnary(ctx, req)
}

// RunHealthCheck calls vtadmin.VTAdmin.RunHealthCheck.
func (c *vTAdminClient) RunHealthCheck(ctx context.Context, req *connect.Request[v23.RunHealthCheckRequest]) (*connect.Response[v23.RunHealthCheckResponse], error) {
	return c.runHealthCheck.CallUnary(ctx, req)
}

// ReshardCreate calls vtadmin.VTAdmin.ReshardCreate.
func (c *vTAdminClient) ReshardCreate(ctx context.Context, req *connect.Request[v23.ReshardCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return c.reshardCreate.CallUnary(ctx, req)
}

// SetReadOnly calls vtadmin.VTAdmin.SetReadOnly.
func (c *vTAdminClient) SetReadOnly(ctx context.Context, req *connect.Request[v23.SetReadOnlyRequest]) (*connect.Response[v23.SetReadOnlyResponse], error) {
	return c.setReadOnly.CallUnary(ctx, req)
}

// SetReadWrite calls vtadmin.VTAdmin.SetReadWrite.
func (c *vTAdminClient) SetReadWrite(ctx context.Context, req *connect.Request[v23.SetReadWriteRequest]) (*connect.Response[v23.SetReadWriteResponse], error) {
	return c.setReadWrite.CallUnary(ctx, req)
}

// StartReplication calls vtadmin.VTAdmin.StartReplication.
func (c *vTAdminClient) StartReplication(ctx context.Context, req *connect.Request[v23.StartReplicationRequest]) (*connect.Response[v23.StartReplicationResponse], error) {
	return c.startReplication.CallUnary(ctx, req)
}

// StopReplication calls vtadmin.VTAdmin.StopReplication.
func (c *vTAdminClient) StopReplication(ctx context.Context, req *connect.Request[v23.StopReplicationRequest]) (*connect.Response[v23.StopReplicationResponse], error) {
	return c.stopReplication.CallUnary(ctx, req)
}

// TabletExternallyPromoted calls vtadmin.VTAdmin.TabletExternallyPromoted.
func (c *vTAdminClient) TabletExternallyPromoted(ctx context.Context, req *connect.Request[v23.TabletExternallyPromotedRequest]) (*connect.Response[v23.TabletExternallyPromotedResponse], error) {
	return c.tabletExternallyPromoted.CallUnary(ctx, req)
}

// Validate calls vtadmin.VTAdmin.Validate.
func (c *vTAdminClient) Validate(ctx context.Context, req *connect.Request[v23.ValidateRequest]) (*connect.Response[v231.ValidateResponse], error) {
	return c.validate.CallUnary(ctx, req)
}

// ValidateKeyspace calls vtadmin.VTAdmin.ValidateKeyspace.
func (c *vTAdminClient) ValidateKeyspace(ctx context.Context, req *connect.Request[v23.ValidateKeyspaceRequest]) (*connect.Response[v231.ValidateKeyspaceResponse], error) {
	return c.validateKeyspace.CallUnary(ctx, req)
}

// ValidateSchemaKeyspace calls vtadmin.VTAdmin.ValidateSchemaKeyspace.
func (c *vTAdminClient) ValidateSchemaKeyspace(ctx context.Context, req *connect.Request[v23.ValidateSchemaKeyspaceRequest]) (*connect.Response[v231.ValidateSchemaKeyspaceResponse], error) {
	return c.validateSchemaKeyspace.CallUnary(ctx, req)
}

// ValidateShard calls vtadmin.VTAdmin.ValidateShard.
func (c *vTAdminClient) ValidateShard(ctx context.Context, req *connect.Request[v23.ValidateShardRequest]) (*connect.Response[v231.ValidateShardResponse], error) {
	return c.validateShard.CallUnary(ctx, req)
}

// ValidateVersionKeyspace calls vtadmin.VTAdmin.ValidateVersionKeyspace.
func (c *vTAdminClient) ValidateVersionKeyspace(ctx context.Context, req *connect.Request[v23.ValidateVersionKeyspaceRequest]) (*connect.Response[v231.ValidateVersionKeyspaceResponse], error) {
	return c.validateVersionKeyspace.CallUnary(ctx, req)
}

// ValidateVersionShard calls vtadmin.VTAdmin.ValidateVersionShard.
func (c *vTAdminClient) ValidateVersionShard(ctx context.Context, req *connect.Request[v23.ValidateVersionShardRequest]) (*connect.Response[v231.ValidateVersionShardResponse], error) {
	return c.validateVersionShard.CallUnary(ctx, req)
}

// VDiffCreate calls vtadmin.VTAdmin.VDiffCreate.
func (c *vTAdminClient) VDiffCreate(ctx context.Context, req *connect.Request[v23.VDiffCreateRequest]) (*connect.Response[v231.VDiffCreateResponse], error) {
	return c.vDiffCreate.CallUnary(ctx, req)
}

// VDiffShow calls vtadmin.VTAdmin.VDiffShow.
func (c *vTAdminClient) VDiffShow(ctx context.Context, req *connect.Request[v23.VDiffShowRequest]) (*connect.Response[v23.VDiffShowResponse], error) {
	return c.vDiffShow.CallUnary(ctx, req)
}

// VTExplain calls vtadmin.VTAdmin.VTExplain.
func (c *vTAdminClient) VTExplain(ctx context.Context, req *connect.Request[v23.VTExplainRequest]) (*connect.Response[v23.VTExplainResponse], error) {
	return c.vTExplain.CallUnary(ctx, req)
}

// VExplain calls vtadmin.VTAdmin.VExplain.
func (c *vTAdminClient) VExplain(ctx context.Context, req *connect.Request[v23.VExplainRequest]) (*connect.Response[v23.VExplainResponse], error) {
	return c.vExplain.CallUnary(ctx, req)
}

// WorkflowDelete calls vtadmin.VTAdmin.WorkflowDelete.
func (c *vTAdminClient) WorkflowDelete(ctx context.Context, req *connect.Request[v23.WorkflowDeleteRequest]) (*connect.Response[v231.WorkflowDeleteResponse], error) {
	return c.workflowDelete.CallUnary(ctx, req)
}

// WorkflowSwitchTraffic calls vtadmin.VTAdmin.WorkflowSwitchTraffic.
func (c *vTAdminClient) WorkflowSwitchTraffic(ctx context.Context, req *connect.Request[v23.WorkflowSwitchTrafficRequest]) (*connect.Response[v231.WorkflowSwitchTrafficResponse], error) {
...
func (UnimplementedVTAdminHandler) ApplySchema(context.Context, *connect.Request[v23.ApplySchemaRequest]) (*connect.Response[v231.ApplySchemaResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ApplySchema is not implemented"))
}

func (UnimplementedVTAdminHandler) CancelSchemaMigration(context.Context, *connect.Request[v23.CancelSchemaMigrationRequest]) (*connect.Response[v231.CancelSchemaMigrationResponse], error) {
...
func (UnimplementedVTAdminHandler) CleanupSchemaMigration(context.Context, *connect.Request[v23.CleanupSchemaMigrationRequest]) (*connect.Response[v231.CleanupSchemaMigrationResponse], error) {
...
func (UnimplementedVTAdminHandler) CompleteSchemaMigration(context.Context, *connect.Request[v23.CompleteSchemaMigrationRequest]) (*connect.Response[v231.CompleteSchemaMigrationResponse], error) {
...
func (UnimplementedVTAdminHandler) ConcludeTransaction(context.Context, *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v231.ConcludeTransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ConcludeTransaction is not implemented"))
}

func (UnimplementedVTAdminHandler) CreateKeyspace(context.Context, *connect.Request[v23.CreateKeyspaceRequest]) (*connect.Response[v23.CreateKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.CreateKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) CreateShard(context.Context, *connect.Request[v23.CreateShardRequest]) (*connect.Response[v231.CreateShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.CreateShard is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteKeyspace(context.Context, *connect.Request[v23.DeleteKeyspaceRequest]) (*connect.Response[v231.DeleteKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteShards(context.Context, *connect.Request[v23.DeleteShardsRequest]) (*connect.Response[v231.DeleteShardsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteShards is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteTablet(context.Context, *connect.Request[v23.DeleteTabletRequest]) (*connect.Response[v23.DeleteTabletResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) EmergencyFailoverShard(context.Context, *connect.Request[v23.EmergencyFailoverShardRequest]) (*connect.Response[v23.EmergencyFailoverShardResponse], error) {
...
func (UnimplementedVTAdminHandler) FindSchema(context.Context, *connect.Request[v23.FindSchemaRequest]) (*connect.Response[v23.Schema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.FindSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetBackups(context.Context, *connect.Request[v23.GetBackupsRequest]) (*connect.Response[v23.GetBackupsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetBackups is not implemented"))
}

func (UnimplementedVTAdminHandler) GetCellInfos(context.Context, *connect.Request[v23.GetCellInfosRequest]) (*connect.Response[v23.GetCellInfosResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetCellInfos is not implemented"))
}

func (UnimplementedVTAdminHandler) GetCellsAliases(context.Context, *connect.Request[v23.GetCellsAliasesRequest]) (*connect.Response[v23.GetCellsAliasesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetCellsAliases is not implemented"))
}

func (UnimplementedVTAdminHandler) GetClusters(context.Context, *connect.Request[v23.GetClustersRequest]) (*connect.Response[v23.GetClustersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetClusters is not implemented"))
}

func (UnimplementedVTAdminHandler) GetFullStatus(context.Context, *connect.Request[v23.GetFullStatusRequest]) (*connect.Response[v231.GetFullStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetFullStatus is not implemented"))
}

func (UnimplementedVTAdminHandler) GetGates(context.Context, *connect.Request[v23.GetGatesRequest]) (*connect.Response[v23.GetGatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetGates is not implemented"))
}

func (UnimplementedVTAdminHandler) GetKeyspace(context.Context, *connect.Request[v23.GetKeyspaceRequest]) (*connect.Response[v23.Keyspace], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) GetKeyspaces(context.Context, *connect.Request[v23.GetKeyspacesRequest]) (*connect.Response[v23.GetKeyspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetKeyspaces is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest]) (*connect.Response[v23.Schema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSchemas(context.Context, *connect.Request[v23.GetSchemasRequest]) (*connect.Response[v23.GetSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSchemaMigrations(context.Context, *connect.Request[v23.GetSchemaMigrationsRequest]) (*connect.Response[v23.GetSchemaMigrationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSchemaMigrations is not implemented"))
}

func (UnimplementedVTAdminHandler) GetShardReplicationPositions(context.Context, *connect.Request[v23.GetShardReplicationPositionsRequest]) (*connect.Response[v23.GetShardReplicationPositionsResponse], error) {
...
func (UnimplementedVTAdminHandler) GetSrvKeyspace(context.Context, *connect.Request[v23.GetSrvKeyspaceRequest]) (*connect.Response[v231.GetSrvKeyspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSrvKeyspaces(context.Context, *connect.Request[v23.GetSrvKeyspacesRequest]) (*connect.Response[v23.GetSrvKeyspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvKeyspaces is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSrvVSchema(context.Context, *connect.Request[v23.GetSrvVSchemaRequest]) (*connect.Response[v23.SrvVSchema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvVSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSrvVSchemas(context.Context, *connect.Request[v23.GetSrvVSchemasRequest]) (*connect.Response[v23.GetSrvVSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvVSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTablet(context.Context, *connect.Request[v23.GetTabletRequest]) (*connect.Response[v23.Tablet], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTablets(context.Context, *connect.Request[v23.GetTabletsRequest]) (*connect.Response[v23.GetTabletsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTablets is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTopologyPath(context.Context, *connect.Request[v23.GetTopologyPathRequest]) (*connect.Response[v231.GetTopologyPathResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTopologyPath is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTransactionInfo(context.Context, *connect.Request[v23.GetTransactionInfoRequest]) (*connect.Response[v231.GetTransactionInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTransactionInfo is not implemented"))
}

func (UnimplementedVTAdminHandler) GetUnresolvedTransactions(context.Context, *connect.Request[v23.GetUnresolvedTransactionsRequest]) (*connect.Response[v231.GetUnresolvedTransactionsResponse], error) {
...
func (UnimplementedVTAdminHandler) GetVSchema(context.Context, *connect.Request[v23.GetVSchemaRequest]) (*connect.Response[v23.VSchema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetVSchemas(context.Context, *connect.Request[v23.GetVSchemasRequest]) (*connect.Response[v23.GetVSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetVtctlds(context.Context, *connect.Request[v23.GetVtctldsRequest]) (*connect.Response[v23.GetVtctldsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVtctlds is not implemented"))
}

func (UnimplementedVTAdminHandler) GetWorkflow(context.Context, *connect.Request[v23.GetWorkflowRequest]) (*connect.Response[v23.Workflow], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetWorkflow is not implemented"))
}

func (UnimplementedVTAdminHandler) GetWorkflows(context.Context, *connect.Request[v23.GetWorkflowsRequest]) (*connect.Response[v23.GetWorkflowsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetWorkflows is not implemented"))
}

func (UnimplementedVTAdminHandler) GetWorkflowStatus(context.Context, *connect.Request[v23.GetWorkflowStatusRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetWorkflowStatus is not implemented"))
}

func (UnimplementedVTAdminHandler) StartWorkflow(context.Context, *connect.Request[v23.StartWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StartWorkflow is not implemented"))
}

func (UnimplementedVTAdminHandler) StopWorkflow(context.Context, *connect.Request[v23.StopWorkflowRequest]) (*connect.Response[v231.WorkflowUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StopWorkflow is not implemented"))
}

func (UnimplementedVTAdminHandler) LaunchSchemaMigration(context.Context, *connect.Request[v23.LaunchSchemaMigrationRequest]) (*connect.Response[v231.LaunchSchemaMigrationResponse], error) {
...
func (UnimplementedVTAdminHandler) MoveTablesComplete(context.Context, *connect.Request[v23.MoveTablesCompleteRequest]) (*connect.Response[v231.MoveTablesCompleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.MoveTablesComplete is not implemented"))
}

func (UnimplementedVTAdminHandler) MoveTablesCreate(context.Context, *connect.Request[v23.MoveTablesCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.MoveTablesCreate is not implemented"))
}

func (UnimplementedVTAdminHandler) MaterializeCreate(context.Context, *connect.Request[v23.MaterializeCreateRequest]) (*connect.Response[v231.MaterializeCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.MaterializeCreate is not implemented"))
}

func (UnimplementedVTAdminHandler) PingTablet(context.Context, *connect.Request[v23.PingTabletRequest]) (*connect.Response[v23.PingTabletResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.PingTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) PlannedFailoverShard(context.Context, *connect.Request[v23.PlannedFailoverShardRequest]) (*connect.Response[v23.PlannedFailoverShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.PlannedFailoverShard is not implemented"))
}

func (UnimplementedVTAdminHandler) RebuildKeyspaceGraph(context.Context, *connect.Request[v23.RebuildKeyspaceGraphRequest]) (*connect.Response[v23.RebuildKeyspaceGraphResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RebuildKeyspaceGraph is not implemented"))
}

func (UnimplementedVTAdminHandler) RefreshState(context.Context, *connect.Request[v23.RefreshStateRequest]) (*connect.Response[v23.RefreshStateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RefreshState is not implemented"))
}

func (UnimplementedVTAdminHandler) RefreshTabletReplicationSource(context.Context, *connect.Request[v23.RefreshTabletReplicationSourceRequest]) (*connect.Response[v23.RefreshTabletReplicationSourceResponse], error) {
...
func (UnimplementedVTAdminHandler) ReloadSchemas(context.Context, *connect.Request[v23.ReloadSchemasRequest]) (*connect.Response[v23.ReloadSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ReloadSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) ReloadSchemaShard(context.Context, *connect.Request[v23.ReloadSchemaShardRequest]) (*connect.Response[v23.ReloadSchemaShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ReloadSchemaShard is not implemented"))
}

func (UnimplementedVTAdminHandler) RemoveKeyspaceCell(context.Context, *connect.Request[v23.RemoveKeyspaceCellRequest]) (*connect.Response[v23.RemoveKeyspaceCellResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RemoveKeyspaceCell is not implemented"))
}

func (UnimplementedVTAdminHandler) RetrySchemaMigration(context.Context, *connect.Request[v23.RetrySchemaMigrationRequest]) (*connect.Response[v231.RetrySchemaMigrationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RetrySchemaMigration is not implemented"))
}

func (UnimplementedVTAdminHandler) RunHealthCheck(context.Context, *connect.Request[v23.RunHealthCheckRequest]) (*connect.Response[v23.RunHealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RunHealthCheck is not implemented"))
}

func (UnimplementedVTAdminHandler) ReshardCreate(context.Context, *connect.Request[v23.ReshardCreateRequest]) (*connect.Response[v231.WorkflowStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ReshardCreate is not implemented"))
}

func (UnimplementedVTAdminHandler) SetReadOnly(context.Context, *connect.Request[v23.SetReadOnlyRequest]) (*connect.Response[v23.SetReadOnlyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.SetReadOnly is not implemented"))
}

func (UnimplementedVTAdminHandler) SetReadWrite(context.Context, *connect.Request[v23.SetReadWriteRequest]) (*connect.Response[v23.SetReadWriteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.SetReadWrite is not implemented"))
}

func (UnimplementedVTAdminHandler) StartReplication(context.Context, *connect.Request[v23.StartReplicationRequest]) (*connect.Response[v23.StartReplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StartReplication is not implemented"))
}

func (UnimplementedVTAdminHandler) StopReplication(context.Context, *connect.Request[v23.StopReplicationRequest]) (*connect.Response[v23.StopReplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StopReplication is not implemented"))
}

func (UnimplementedVTAdminHandler) TabletExternallyPromoted(context.Context, *connect.Request[v23.TabletExternallyPromotedRequest]) (*connect.Response[v23.TabletExternallyPromotedResponse], error) {
...
func (UnimplementedVTAdminHandler) Validate(context.Context, *connect.Request[v23.ValidateRequest]) (*connect.Response[v231.ValidateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.Validate is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateKeyspace(context.Context, *connect.Request[v23.ValidateKeyspaceRequest]) (*connect.Response[v231.ValidateKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateSchemaKeyspace(context.Context, *connect.Request[v23.ValidateSchemaKeyspaceRequest]) (*connect.Response[v231.ValidateSchemaKeyspaceResponse], error) {
...
func (UnimplementedVTAdminHandler) ValidateShard(context.Context, *connect.Request[v23.ValidateShardRequest]) (*connect.Response[v231.ValidateShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateShard is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateVersionKeyspace(context.Context, *connect.Request[v23.ValidateVersionKeyspaceRequest]) (*connect.Response[v231.ValidateVersionKeyspaceResponse], error) {
...
func (UnimplementedVTAdminHandler) ValidateVersionShard(context.Context, *connect.Request[v23.ValidateVersionShardRequest]) (*connect.Response[v231.ValidateVersionShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateVersionShard is not implemented"))
}

func (UnimplementedVTAdminHandler) VDiffCreate(context.Context, *connect.Request[v23.VDiffCreateRequest]) (*connect.Response[v231.VDiffCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.VDiffCreate is not implemented"))
}

func (UnimplementedVTAdminHandler) VDiffShow(context.Context, *connect.Request[v23.VDiffShowRequest]) (*connect.Response[v23.VDiffShowResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.VDiffShow is not implemented"))
}

func (UnimplementedVTAdminHandler) VTExplain(context.Context, *connect.Request[v23.VTExplainRequest]) (*connect.Response[v23.VTExplainResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.VTExplain is not implemented"))
}

func (UnimplementedVTAdminHandler) VExplain(context.Context, *connect.Request[v23.VExplainRequest]) (*connect.Response[v23.VExplainResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.VExplain is not implemented"))
}

func (UnimplementedVTAdminHandler) WorkflowDelete(context.Context, *connect.Request[v23.WorkflowDeleteRequest]) (*connect.Response[v231.WorkflowDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.WorkflowDelete is not implemented"))
}

func (UnimplementedVTAdminHandler) WorkflowSwitchTraffic(context.Context, *connect.Request[v23.WorkflowSwitchTrafficRequest]) (*connect.Response[v231.WorkflowSwitchTrafficResponse], error) {
