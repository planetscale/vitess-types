...
package vtadminv21connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v21 "github.com/planetscale/vitess-types/gen/vitess/vtadmin/v21"
...
type VTAdminClient interface {
	...
	CancelSchemaMigration(context.Context, *connect.Request[v21.CancelSchemaMigrationRequest]) (*connect.Response[v211.CancelSchemaMigrationResponse], error)
	// CleanupSchemaMigration marks a schema migration in the given cluster as
	// ready for artifact cleanup.
	CleanupSchemaMigration(context.Context, *connect.Request[v21.CleanupSchemaMigrationRequest]) (*connect.Response[v211.CleanupSchemaMigrationResponse], error)
	// CompleteSchemaMigration completes one or all migrations in the given
	// cluster executed with --postpone-completion.
	CompleteSchemaMigration(context.Context, *connect.Request[v21.CompleteSchemaMigrationRequest]) (*connect.Response[v211.CompleteSchemaMigrationResponse], error)
	// ConcludeTransaction concludes a distributed transaction identified by the provided dtid.
	ConcludeTransaction(context.Context, *connect.Request[v21.ConcludeTransactionRequest]) (*connect.Response[v211.ConcludeTransactionResponse], error)
	...
	CreateShard(context.Context, *connect.Request[v21.CreateShardRequest]) (*connect.Response[v211.CreateShardResponse], error)
	// DeleteKeyspace deletes a keyspace in the given cluster.
	DeleteKeyspace(context.Context, *connect.Request[v21.DeleteKeyspaceRequest]) (*connect.Response[v211.DeleteKeyspaceResponse], error)
	// DeleteShard deletes one or more shards in the given cluster and keyspace.
	DeleteShards(context.Context, *connect.Request[v21.DeleteShardsRequest]) (*connect.Response[v211.DeleteShardsResponse], error)
	// DeleteTablet deletes a tablet from the topology
	DeleteTablet(context.Context, *connect.Request[v21.DeleteTabletRequest]) (*connect.Response[v21.DeleteTabletResponse], error)
	// EmergencyFailoverShard fails over a shard to a new primary. It assumes
	// the old primary is dead or otherwise not responding.
	EmergencyFailoverShard(context.Context, *connect.Request[v21.EmergencyFailoverShardRequest]) (*connect.Response[v21.EmergencyFailoverShardResponse], error)
	...
	FindSchema(context.Context, *connect.Request[v21.FindSchemaRequest]) (*connect.Response[v21.Schema], error)
	...
	GetCellInfos(context.Context, *connect.Request[v21.GetCellInfosRequest]) (*connect.Response[v21.GetCellInfosResponse], error)
	...
	GetClusters(context.Context, *connect.Request[v21.GetClustersRequest]) (*connect.Response[v21.GetClustersResponse], error)
	...
	GetFullStatus(context.Context, *connect.Request[v21.GetFullStatusRequest]) (*connect.Response[v211.GetFullStatusResponse], error)
	// GetGates returns all gates across all the specified clusters.
	GetGates(context.Context, *connect.Request[v21.GetGatesRequest]) (*connect.Response[v21.GetGatesResponse], error)
	// GetKeyspace returns a keyspace by name in the specified cluster.
	GetKeyspace(context.Context, *connect.Request[v21.GetKeyspaceRequest]) (*connect.Response[v21.Keyspace], error)
	...
	// tuple.
	GetSchema(context.Context, *connect.Request[v21.GetSchemaRequest]) (*connect.Response[v21.Schema], error)
	// GetSchemas returns all schemas across the specified clusters.
	GetSchemas(context.Context, *connect.Request[v21.GetSchemasRequest]) (*connect.Response[v21.GetSchemasResponse], error)
	...
	// by cluster.
	GetShardReplicationPositions(context.Context, *connect.Request[v21.GetShardReplicationPositionsRequest]) (*connect.Response[v21.GetShardReplicationPositionsResponse], error)
	// GetSrvKeyspace returns the SrvKeyspace for a keyspace in one or more cells.
	GetSrvKeyspace(context.Context, *connect.Request[v21.GetSrvKeyspaceRequest]) (*connect.Response[v211.GetSrvKeyspacesResponse], error)
	...
	GetSrvVSchema(context.Context, *connect.Request[v21.GetSrvVSchemaRequest]) (*connect.Response[v21.SrvVSchema], error)
	...
	// the result.
	GetTablet(context.Context, *connect.Request[v21.GetTabletRequest]) (*connect.Response[v21.Tablet], error)
	...
	GetTopologyPath(context.Context, *connect.Request[v21.GetTopologyPathRequest]) (*connect.Response[v211.GetTopologyPathResponse], error)
	// GetUnresolvedTransactions returns the unresolved transactions for the request.
	GetUnresolvedTransactions(context.Context, *connect.Request[v21.GetUnresolvedTransactionsRequest]) (*connect.Response[v211.GetUnresolvedTransactionsResponse], error)
	// GetVSchema returns a VSchema for the specified keyspace in the specified
	// cluster.
	GetVSchema(context.Context, *connect.Request[v21.GetVSchemaRequest]) (*connect.Response[v21.VSchema], error)
	// GetVSchemas returns the VSchemas for all specified clusters.
	GetVSchemas(context.Context, *connect.Request[v21.GetVSchemasRequest]) (*connect.Response[v21.GetVSchemasResponse], error)
	// GetVtctlds returns the Vtctlds for all specified clusters.
	GetVtctlds(context.Context, *connect.Request[v21.GetVtctldsRequest]) (*connect.Response[v21.GetVtctldsResponse], error)
	// GetWorkflow returns a single Workflow for a given cluster, keyspace, and
	// workflow name.
	GetWorkflow(context.Context, *connect.Request[v21.GetWorkflowRequest]) (*connect.Response[v21.Workflow], error)
	...
	GetWorkflowStatus(context.Context, *connect.Request[v21.GetWorkflowStatusRequest]) (*connect.Response[v211.WorkflowStatusResponse], error)
	// StartWorkflow starts a vreplication workflow.
	StartWorkflow(context.Context, *connect.Request[v21.StartWorkflowRequest]) (*connect.Response[v211.WorkflowUpdateResponse], error)
	// StopWorkflow stops a vreplication workflow.
	StopWorkflow(context.Context, *connect.Request[v21.StopWorkflowRequest]) (*connect.Response[v211.WorkflowUpdateResponse], error)
	// LaunchSchemaMigration launches one or all migrations in the given
	// cluster executed with --postpone-launch.
	LaunchSchemaMigration(context.Context, *connect.Request[v21.LaunchSchemaMigrationRequest]) (*connect.Response[v211.LaunchSchemaMigrationResponse], error)
	// MoveTablesCreate creates a workflow which moves one or more tables from a
	// source keyspace to a target keyspace.
	MoveTablesCreate(context.Context, *connect.Request[v21.MoveTablesCreateRequest]) (*connect.Response[v211.WorkflowStatusResponse], error)
	...
	PlannedFailoverShard(context.Context, *connect.Request[v21.PlannedFailoverShardRequest]) (*connect.Response[v21.PlannedFailoverShardResponse], error)
	...
	RefreshTabletReplicationSource(context.Context, *connect.Request[v21.RefreshTabletReplicationSourceRequest]) (*connect.Response[v21.RefreshTabletReplicationSourceResponse], error)
	...
	ReloadSchemas(context.Context, *connect.Request[v21.ReloadSchemasRequest]) (*connect.Response[v21.ReloadSchemasResponse], error)
	...
	// for retry.
	RetrySchemaMigration(context.Context, *connect.Request[v21.RetrySchemaMigrationRequest]) (*connect.Response[v211.RetrySchemaMigrationResponse], error)
	...
	TabletExternallyPromoted(context.Context, *connect.Request[v21.TabletExternallyPromotedRequest]) (*connect.Response[v21.TabletExternallyPromotedResponse], error)
	...
	Validate(context.Context, *connect.Request[v21.ValidateRequest]) (*connect.Response[v211.ValidateResponse], error)
	// ValidateKeyspace validates that all nodes reachable from the specified
	// keyspace are consistent.
	ValidateKeyspace(context.Context, *connect.Request[v21.ValidateKeyspaceRequest]) (*connect.Response[v211.ValidateKeyspaceResponse], error)
	...
	// keyspace.
	ValidateSchemaKeyspace(context.Context, *connect.Request[v21.ValidateSchemaKeyspaceRequest]) (*connect.Response[v211.ValidateSchemaKeyspaceResponse], error)
	// ValidateShard validates that that all nodes reachable from the specified shard are consistent.
	ValidateShard(context.Context, *connect.Request[v21.ValidateShardRequest]) (*connect.Response[v211.ValidateShardResponse], error)
	...
	ValidateVersionKeyspace(context.Context, *connect.Request[v21.ValidateVersionKeyspaceRequest]) (*connect.Response[v211.ValidateVersionKeyspaceResponse], error)
	// ValidateVersionShard validates that the version on the primary matches all of the replicas.
	ValidateVersionShard(context.Context, *connect.Request[v21.ValidateVersionShardRequest]) (*connect.Response[v211.ValidateVersionShardResponse], error)
...
type vTAdminClient struct {
	applySchema                    *connect.Client[v21.ApplySchemaRequest, v211.ApplySchemaResponse]
	cancelSchemaMigration          *connect.Client[v21.CancelSchemaMigrationRequest, v211.CancelSchemaMigrationResponse]
	cleanupSchemaMigration         *connect.Client[v21.CleanupSchemaMigrationRequest, v211.CleanupSchemaMigrationResponse]
	completeSchemaMigration        *connect.Client[v21.CompleteSchemaMigrationRequest, v211.CompleteSchemaMigrationResponse]
	concludeTransaction            *connect.Client[v21.ConcludeTransactionRequest, v211.ConcludeTransactionResponse]
	createKeyspace                 *connect.Client[v21.CreateKeyspaceRequest, v21.CreateKeyspaceResponse]
	createShard                    *connect.Client[v21.CreateShardRequest, v211.CreateShardResponse]
	deleteKeyspace                 *connect.Client[v21.DeleteKeyspaceRequest, v211.DeleteKeyspaceResponse]
	deleteShards                   *connect.Client[v21.DeleteShardsRequest, v211.DeleteShardsResponse]
	deleteTablet                   *connect.Client[v21.DeleteTabletRequest, v21.DeleteTabletResponse]
	emergencyFailoverShard         *connect.Client[v21.EmergencyFailoverShardRequest, v21.EmergencyFailoverShardResponse]
	findSchema                     *connect.Client[v21.FindSchemaRequest, v21.Schema]
	getBackups                     *connect.Client[v21.GetBackupsRequest, v21.GetBackupsResponse]
	getCellInfos                   *connect.Client[v21.GetCellInfosRequest, v21.GetCellInfosResponse]
	getCellsAliases                *connect.Client[v21.GetCellsAliasesRequest, v21.GetCellsAliasesResponse]
	getClusters                    *connect.Client[v21.GetClustersRequest, v21.GetClustersResponse]
	getFullStatus                  *connect.Client[v21.GetFullStatusRequest, v211.GetFullStatusResponse]
	getGates                       *connect.Client[v21.GetGatesRequest, v21.GetGatesResponse]
	getKeyspace                    *connect.Client[v21.GetKeyspaceRequest, v21.Keyspace]
	getKeyspaces                   *connect.Client[v21.GetKeyspacesRequest, v21.GetKeyspacesResponse]
	getSchema                      *connect.Client[v21.GetSchemaRequest, v21.Schema]
	getSchemas                     *connect.Client[v21.GetSchemasRequest, v21.GetSchemasResponse]
	getSchemaMigrations            *connect.Client[v21.GetSchemaMigrationsRequest, v21.GetSchemaMigrationsResponse]
	getShardReplicationPositions   *connect.Client[v21.GetShardReplicationPositionsRequest, v21.GetShardReplicationPositionsResponse]
	getSrvKeyspace                 *connect.Client[v21.GetSrvKeyspaceRequest, v211.GetSrvKeyspacesResponse]
	getSrvKeyspaces                *connect.Client[v21.GetSrvKeyspacesRequest, v21.GetSrvKeyspacesResponse]
	getSrvVSchema                  *connect.Client[v21.GetSrvVSchemaRequest, v21.SrvVSchema]
	getSrvVSchemas                 *connect.Client[v21.GetSrvVSchemasRequest, v21.GetSrvVSchemasResponse]
	getTablet                      *connect.Client[v21.GetTabletRequest, v21.Tablet]
	getTablets                     *connect.Client[v21.GetTabletsRequest, v21.GetTabletsResponse]
	getTopologyPath                *connect.Client[v21.GetTopologyPathRequest, v211.GetTopologyPathResponse]
	getUnresolvedTransactions      *connect.Client[v21.GetUnresolvedTransactionsRequest, v211.GetUnresolvedTransactionsResponse]
	getVSchema                     *connect.Client[v21.GetVSchemaRequest, v21.VSchema]
	getVSchemas                    *connect.Client[v21.GetVSchemasRequest, v21.GetVSchemasResponse]
	getVtctlds                     *connect.Client[v21.GetVtctldsRequest, v21.GetVtctldsResponse]
	getWorkflow                    *connect.Client[v21.GetWorkflowRequest, v21.Workflow]
	getWorkflows                   *connect.Client[v21.GetWorkflowsRequest, v21.GetWorkflowsResponse]
	getWorkflowStatus              *connect.Client[v21.GetWorkflowStatusRequest, v211.WorkflowStatusResponse]
	startWorkflow                  *connect.Client[v21.StartWorkflowRequest, v211.WorkflowUpdateResponse]
	stopWorkflow                   *connect.Client[v21.StopWorkflowRequest, v211.WorkflowUpdateResponse]
	launchSchemaMigration          *connect.Client[v21.LaunchSchemaMigrationRequest, v211.LaunchSchemaMigrationResponse]
	moveTablesCreate               *connect.Client[v21.MoveTablesCreateRequest, v211.WorkflowStatusResponse]
	pingTablet                     *connect.Client[v21.PingTabletRequest, v21.PingTabletResponse]
	plannedFailoverShard           *connect.Client[v21.PlannedFailoverShardRequest, v21.PlannedFailoverShardResponse]
	...
	refreshTabletReplicationSource *connect.Client[v21.RefreshTabletReplicationSourceRequest, v21.RefreshTabletReplicationSourceResponse]
	reloadSchemas                  *connect.Client[v21.ReloadSchemasRequest, v21.ReloadSchemasResponse]
	...
	retrySchemaMigration           *connect.Client[v21.RetrySchemaMigrationRequest, v211.RetrySchemaMigrationResponse]
	...
	tabletExternallyPromoted       *connect.Client[v21.TabletExternallyPromotedRequest, v21.TabletExternallyPromotedResponse]
	validate                       *connect.Client[v21.ValidateRequest, v211.ValidateResponse]
	validateKeyspace               *connect.Client[v21.ValidateKeyspaceRequest, v211.ValidateKeyspaceResponse]
	validateSchemaKeyspace         *connect.Client[v21.ValidateSchemaKeyspaceRequest, v211.ValidateSchemaKeyspaceResponse]
	validateShard                  *connect.Client[v21.ValidateShardRequest, v211.ValidateShardResponse]
	validateVersionKeyspace        *connect.Client[v21.ValidateVersionKeyspaceRequest, v211.ValidateVersionKeyspaceResponse]
	validateVersionShard           *connect.Client[v21.ValidateVersionShardRequest, v211.ValidateVersionShardResponse]
