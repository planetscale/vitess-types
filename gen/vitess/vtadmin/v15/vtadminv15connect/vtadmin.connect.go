...
type VTAdminClient interface {
	...
	CreateShard(context.Context, *connect.Request[v15.CreateShardRequest]) (*connect.Response[v151.CreateShardResponse], error)
	// DeleteKeyspace deletes a keyspace in the given cluster.
	DeleteKeyspace(context.Context, *connect.Request[v15.DeleteKeyspaceRequest]) (*connect.Response[v151.DeleteKeyspaceResponse], error)
	// DeleteShard deletes one or more shards in the given cluster and keyspace.
	DeleteShards(context.Context, *connect.Request[v15.DeleteShardsRequest]) (*connect.Response[v151.DeleteShardsResponse], error)
	// DeleteTablet deletes a tablet from the topology
	DeleteTablet(context.Context, *connect.Request[v15.DeleteTabletRequest]) (*connect.Response[v15.DeleteTabletResponse], error)
	// EmergencyFailoverShard fails over a shard to a new primary. It assumes
	// the old primary is dead or otherwise not responding.
	EmergencyFailoverShard(context.Context, *connect.Request[v15.EmergencyFailoverShardRequest]) (*connect.Response[v15.EmergencyFailoverShardResponse], error)
	...
	FindSchema(context.Context, *connect.Request[v15.FindSchemaRequest]) (*connect.Response[v15.Schema], error)
	...
	GetCellInfos(context.Context, *connect.Request[v15.GetCellInfosRequest]) (*connect.Response[v15.GetCellInfosResponse], error)
	...
	GetClusters(context.Context, *connect.Request[v15.GetClustersRequest]) (*connect.Response[v15.GetClustersResponse], error)
	...
	GetFullStatus(context.Context, *connect.Request[v15.GetFullStatusRequest]) (*connect.Response[v151.GetFullStatusResponse], error)
	// GetGates returns all gates across all the specified clusters.
	GetGates(context.Context, *connect.Request[v15.GetGatesRequest]) (*connect.Response[v15.GetGatesResponse], error)
	// GetKeyspace returns a keyspace by name in the specified cluster.
	GetKeyspace(context.Context, *connect.Request[v15.GetKeyspaceRequest]) (*connect.Response[v15.Keyspace], error)
	...
	// tuple.
	GetSchema(context.Context, *connect.Request[v15.GetSchemaRequest]) (*connect.Response[v15.Schema], error)
	// GetSchemas returns all schemas across the specified clusters.
	GetSchemas(context.Context, *connect.Request[v15.GetSchemasRequest]) (*connect.Response[v15.GetSchemasResponse], error)
	// GetShardReplicationPositions returns shard replication positions grouped
	// by cluster.
	GetShardReplicationPositions(context.Context, *connect.Request[v15.GetShardReplicationPositionsRequest]) (*connect.Response[v15.GetShardReplicationPositionsResponse], error)
	// GetSrvVSchema returns the SrvVSchema for the given cluster and cell.
	GetSrvVSchema(context.Context, *connect.Request[v15.GetSrvVSchemaRequest]) (*connect.Response[v15.SrvVSchema], error)
	...
	// the result.
	GetTablet(context.Context, *connect.Request[v15.GetTabletRequest]) (*connect.Response[v15.Tablet], error)
	...
	GetTopologyPath(context.Context, *connect.Request[v15.GetTopologyPathRequest]) (*connect.Response[v151.GetTopologyPathResponse], error)
	// GetVSchema returns a VSchema for the specified keyspace in the specified
	// cluster.
	GetVSchema(context.Context, *connect.Request[v15.GetVSchemaRequest]) (*connect.Response[v15.VSchema], error)
	// GetVSchemas returns the VSchemas for all specified clusters.
	GetVSchemas(context.Context, *connect.Request[v15.GetVSchemasRequest]) (*connect.Response[v15.GetVSchemasResponse], error)
	// GetVtctlds returns the Vtctlds for all specified clusters.
	GetVtctlds(context.Context, *connect.Request[v15.GetVtctldsRequest]) (*connect.Response[v15.GetVtctldsResponse], error)
	// GetWorkflow returns a single Workflow for a given cluster, keyspace, and
	// workflow name.
	GetWorkflow(context.Context, *connect.Request[v15.GetWorkflowRequest]) (*connect.Response[v15.Workflow], error)
	...
	PlannedFailoverShard(context.Context, *connect.Request[v15.PlannedFailoverShardRequest]) (*connect.Response[v15.PlannedFailoverShardResponse], error)
	...
	RefreshTabletReplicationSource(context.Context, *connect.Request[v15.RefreshTabletReplicationSourceRequest]) (*connect.Response[v15.RefreshTabletReplicationSourceResponse], error)
	...
	ReloadSchemas(context.Context, *connect.Request[v15.ReloadSchemasRequest]) (*connect.Response[v15.ReloadSchemasResponse], error)
	...
	TabletExternallyPromoted(context.Context, *connect.Request[v15.TabletExternallyPromotedRequest]) (*connect.Response[v15.TabletExternallyPromotedResponse], error)
	...
	Validate(context.Context, *connect.Request[v15.ValidateRequest]) (*connect.Response[v151.ValidateResponse], error)
	// ValidateKeyspace validates that all nodes reachable from the specified
	// keyspace are consistent.
	ValidateKeyspace(context.Context, *connect.Request[v15.ValidateKeyspaceRequest]) (*connect.Response[v151.ValidateKeyspaceResponse], error)
	...
	// keyspace.
	ValidateSchemaKeyspace(context.Context, *connect.Request[v15.ValidateSchemaKeyspaceRequest]) (*connect.Response[v151.ValidateSchemaKeyspaceResponse], error)
	// ValidateShard validates that that all nodes reachable from the specified shard are consistent.
	ValidateShard(context.Context, *connect.Request[v15.ValidateShardRequest]) (*connect.Response[v151.ValidateShardResponse], error)
	...
	ValidateVersionKeyspace(context.Context, *connect.Request[v15.ValidateVersionKeyspaceRequest]) (*connect.Response[v151.ValidateVersionKeyspaceResponse], error)
	// ValidateVersionShard validates that the version on the primary matches all of the replicas.
	ValidateVersionShard(context.Context, *connect.Request[v15.ValidateVersionShardRequest]) (*connect.Response[v151.ValidateVersionShardResponse], error)
	// VTExplain provides information on how Vitess plans to execute a
	// particular query.
	VTExplain(context.Context, *connect.Request[v15.VTExplainRequest]) (*connect.Response[v15.VTExplainResponse], error)
}
...
func NewVTAdminClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VTAdminClient {
	...
	return &vTAdminClient{
		...
		createShard: connect.NewClient[v15.CreateShardRequest, v151.CreateShardResponse](
			httpClient,
			baseURL+VTAdminCreateShardProcedure,
			opts...,
		),
		deleteKeyspace: connect.NewClient[v15.DeleteKeyspaceRequest, v151.DeleteKeyspaceResponse](
			httpClient,
			baseURL+VTAdminDeleteKeyspaceProcedure,
			opts...,
		),
		deleteShards: connect.NewClient[v15.DeleteShardsRequest, v151.DeleteShardsResponse](
			httpClient,
			baseURL+VTAdminDeleteShardsProcedure,
			opts...,
		),
		deleteTablet: connect.NewClient[v15.DeleteTabletRequest, v15.DeleteTabletResponse](
			httpClient,
			baseURL+VTAdminDeleteTabletProcedure,
			opts...,
		),
		emergencyFailoverShard: connect.NewClient[v15.EmergencyFailoverShardRequest, v15.EmergencyFailoverShardResponse](
			httpClient,
			baseURL+VTAdminEmergencyFailoverShardProcedure,
			opts...,
		),
		findSchema: connect.NewClient[v15.FindSchemaRequest, v15.Schema](
			httpClient,
		...
		getCellInfos: connect.NewClient[v15.GetCellInfosRequest, v15.GetCellInfosResponse](
			httpClient,
		...
		getClusters: connect.NewClient[v15.GetClustersRequest, v15.GetClustersResponse](
			httpClient,
			baseURL+VTAdminGetClustersProcedure,
			opts...,
		),
		getFullStatus: connect.NewClient[v15.GetFullStatusRequest, v151.GetFullStatusResponse](
			httpClient,
			baseURL+VTAdminGetFullStatusProcedure,
			opts...,
		),
		getGates: connect.NewClient[v15.GetGatesRequest, v15.GetGatesResponse](
			httpClient,
			baseURL+VTAdminGetGatesProcedure,
			opts...,
		),
		getKeyspace: connect.NewClient[v15.GetKeyspaceRequest, v15.Keyspace](
			httpClient,
		...
		getSchema: connect.NewClient[v15.GetSchemaRequest, v15.Schema](
			httpClient,
			baseURL+VTAdminGetSchemaProcedure,
			opts...,
		),
		getSchemas: connect.NewClient[v15.GetSchemasRequest, v15.GetSchemasResponse](
			httpClient,
			baseURL+VTAdminGetSchemasProcedure,
			opts...,
		),
		getShardReplicationPositions: connect.NewClient[v15.GetShardReplicationPositionsRequest, v15.GetShardReplicationPositionsResponse](
			httpClient,
			baseURL+VTAdminGetShardReplicationPositionsProcedure,
			opts...,
		),
		getSrvVSchema: connect.NewClient[v15.GetSrvVSchemaRequest, v15.SrvVSchema](
			httpClient,
		...
		getTablet: connect.NewClient[v15.GetTabletRequest, v15.Tablet](
			httpClient,
		...
		getTopologyPath: connect.NewClient[v15.GetTopologyPathRequest, v151.GetTopologyPathResponse](
			httpClient,
			baseURL+VTAdminGetTopologyPathProcedure,
			opts...,
		),
		getVSchema: connect.NewClient[v15.GetVSchemaRequest, v15.VSchema](
			httpClient,
			baseURL+VTAdminGetVSchemaProcedure,
			opts...,
		),
		getVSchemas: connect.NewClient[v15.GetVSchemasRequest, v15.GetVSchemasResponse](
			httpClient,
			baseURL+VTAdminGetVSchemasProcedure,
			opts...,
		),
		getVtctlds: connect.NewClient[v15.GetVtctldsRequest, v15.GetVtctldsResponse](
			httpClient,
			baseURL+VTAdminGetVtctldsProcedure,
			opts...,
		),
		getWorkflow: connect.NewClient[v15.GetWorkflowRequest, v15.Workflow](
			httpClient,
		...
		plannedFailoverShard: connect.NewClient[v15.PlannedFailoverShardRequest, v15.PlannedFailoverShardResponse](
			httpClient,
		...
		refreshTabletReplicationSource: connect.NewClient[v15.RefreshTabletReplicationSourceRequest, v15.RefreshTabletReplicationSourceResponse](
			httpClient,
			baseURL+VTAdminRefreshTabletReplicationSourceProcedure,
			opts...,
		),
		reloadSchemas: connect.NewClient[v15.ReloadSchemasRequest, v15.ReloadSchemasResponse](
			httpClient,
		...
		tabletExternallyPromoted: connect.NewClient[v15.TabletExternallyPromotedRequest, v15.TabletExternallyPromotedResponse](
			httpClient,
			baseURL+VTAdminTabletExternallyPromotedProcedure,
			opts...,
		),
		validate: connect.NewClient[v15.ValidateRequest, v151.ValidateResponse](
			httpClient,
			baseURL+VTAdminValidateProcedure,
			opts...,
		),
		validateKeyspace: connect.NewClient[v15.ValidateKeyspaceRequest, v151.ValidateKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateKeyspaceProcedure,
			opts...,
		),
		validateSchemaKeyspace: connect.NewClient[v15.ValidateSchemaKeyspaceRequest, v151.ValidateSchemaKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateSchemaKeyspaceProcedure,
			opts...,
		),
		validateShard: connect.NewClient[v15.ValidateShardRequest, v151.ValidateShardResponse](
			httpClient,
			baseURL+VTAdminValidateShardProcedure,
			opts...,
		),
		validateVersionKeyspace: connect.NewClient[v15.ValidateVersionKeyspaceRequest, v151.ValidateVersionKeyspaceResponse](
			httpClient,
			baseURL+VTAdminValidateVersionKeyspaceProcedure,
			opts...,
		),
		validateVersionShard: connect.NewClient[v15.ValidateVersionShardRequest, v151.ValidateVersionShardResponse](
			httpClient,
			baseURL+VTAdminValidateVersionShardProcedure,
			opts...,
		),
		vTExplain: connect.NewClient[v15.VTExplainRequest, v15.VTExplainResponse](
			httpClient,
...
type vTAdminClient struct {
	...
	createShard                    *connect.Client[v15.CreateShardRequest, v151.CreateShardResponse]
	deleteKeyspace                 *connect.Client[v15.DeleteKeyspaceRequest, v151.DeleteKeyspaceResponse]
	deleteShards                   *connect.Client[v15.DeleteShardsRequest, v151.DeleteShardsResponse]
	deleteTablet                   *connect.Client[v15.DeleteTabletRequest, v15.DeleteTabletResponse]
	emergencyFailoverShard         *connect.Client[v15.EmergencyFailoverShardRequest, v15.EmergencyFailoverShardResponse]
	findSchema                     *connect.Client[v15.FindSchemaRequest, v15.Schema]
	getBackups                     *connect.Client[v15.GetBackupsRequest, v15.GetBackupsResponse]
	getCellInfos                   *connect.Client[v15.GetCellInfosRequest, v15.GetCellInfosResponse]
	getCellsAliases                *connect.Client[v15.GetCellsAliasesRequest, v15.GetCellsAliasesResponse]
	getClusters                    *connect.Client[v15.GetClustersRequest, v15.GetClustersResponse]
	getFullStatus                  *connect.Client[v15.GetFullStatusRequest, v151.GetFullStatusResponse]
	getGates                       *connect.Client[v15.GetGatesRequest, v15.GetGatesResponse]
	getKeyspace                    *connect.Client[v15.GetKeyspaceRequest, v15.Keyspace]
	getKeyspaces                   *connect.Client[v15.GetKeyspacesRequest, v15.GetKeyspacesResponse]
	getSchema                      *connect.Client[v15.GetSchemaRequest, v15.Schema]
	getSchemas                     *connect.Client[v15.GetSchemasRequest, v15.GetSchemasResponse]
	getShardReplicationPositions   *connect.Client[v15.GetShardReplicationPositionsRequest, v15.GetShardReplicationPositionsResponse]
	getSrvVSchema                  *connect.Client[v15.GetSrvVSchemaRequest, v15.SrvVSchema]
	getSrvVSchemas                 *connect.Client[v15.GetSrvVSchemasRequest, v15.GetSrvVSchemasResponse]
	getTablet                      *connect.Client[v15.GetTabletRequest, v15.Tablet]
	getTablets                     *connect.Client[v15.GetTabletsRequest, v15.GetTabletsResponse]
	getTopologyPath                *connect.Client[v15.GetTopologyPathRequest, v151.GetTopologyPathResponse]
	getVSchema                     *connect.Client[v15.GetVSchemaRequest, v15.VSchema]
	getVSchemas                    *connect.Client[v15.GetVSchemasRequest, v15.GetVSchemasResponse]
	getVtctlds                     *connect.Client[v15.GetVtctldsRequest, v15.GetVtctldsResponse]
	getWorkflow                    *connect.Client[v15.GetWorkflowRequest, v15.Workflow]
	...
	plannedFailoverShard           *connect.Client[v15.PlannedFailoverShardRequest, v15.PlannedFailoverShardResponse]
	...
	refreshTabletReplicationSource *connect.Client[v15.RefreshTabletReplicationSourceRequest, v15.RefreshTabletReplicationSourceResponse]
	reloadSchemas                  *connect.Client[v15.ReloadSchemasRequest, v15.ReloadSchemasResponse]
	...
	tabletExternallyPromoted       *connect.Client[v15.TabletExternallyPromotedRequest, v15.TabletExternallyPromotedResponse]
	validate                       *connect.Client[v15.ValidateRequest, v151.ValidateResponse]
	validateKeyspace               *connect.Client[v15.ValidateKeyspaceRequest, v151.ValidateKeyspaceResponse]
	validateSchemaKeyspace         *connect.Client[v15.ValidateSchemaKeyspaceRequest, v151.ValidateSchemaKeyspaceResponse]
	validateShard                  *connect.Client[v15.ValidateShardRequest, v151.ValidateShardResponse]
	validateVersionKeyspace        *connect.Client[v15.ValidateVersionKeyspaceRequest, v151.ValidateVersionKeyspaceResponse]
	validateVersionShard           *connect.Client[v15.ValidateVersionShardRequest, v151.ValidateVersionShardResponse]
	vTExplain                      *connect.Client[v15.VTExplainRequest, v15.VTExplainResponse]
}

// CreateKeyspace calls vtadmin.VTAdmin.CreateKeyspace.
func (c *vTAdminClient) CreateKeyspace(ctx context.Context, req *connect.Request[v15.CreateKeyspaceRequest]) (*connect.Response[v15.CreateKeyspaceResponse], error) {
	return c.createKeyspace.CallUnary(ctx, req)
}

// CreateShard calls vtadmin.VTAdmin.CreateShard.
func (c *vTAdminClient) CreateShard(ctx context.Context, req *connect.Request[v15.CreateShardRequest]) (*connect.Response[v151.CreateShardResponse], error) {
	return c.createShard.CallUnary(ctx, req)
}

// DeleteKeyspace calls vtadmin.VTAdmin.DeleteKeyspace.
func (c *vTAdminClient) DeleteKeyspace(ctx context.Context, req *connect.Request[v15.DeleteKeyspaceRequest]) (*connect.Response[v151.DeleteKeyspaceResponse], error) {
	return c.deleteKeyspace.CallUnary(ctx, req)
}

// DeleteShards calls vtadmin.VTAdmin.DeleteShards.
func (c *vTAdminClient) DeleteShards(ctx context.Context, req *connect.Request[v15.DeleteShardsRequest]) (*connect.Response[v151.DeleteShardsResponse], error) {
	return c.deleteShards.CallUnary(ctx, req)
}

// DeleteTablet calls vtadmin.VTAdmin.DeleteTablet.
func (c *vTAdminClient) DeleteTablet(ctx context.Context, req *connect.Request[v15.DeleteTabletRequest]) (*connect.Response[v15.DeleteTabletResponse], error) {
	return c.deleteTablet.CallUnary(ctx, req)
}

// EmergencyFailoverShard calls vtadmin.VTAdmin.EmergencyFailoverShard.
func (c *vTAdminClient) EmergencyFailoverShard(ctx context.Context, req *connect.Request[v15.EmergencyFailoverShardRequest]) (*connect.Response[v15.EmergencyFailoverShardResponse], error) {
	return c.emergencyFailoverShard.CallUnary(ctx, req)
}

// FindSchema calls vtadmin.VTAdmin.FindSchema.
func (c *vTAdminClient) FindSchema(ctx context.Context, req *connect.Request[v15.FindSchemaRequest]) (*connect.Response[v15.Schema], error) {
	return c.findSchema.CallUnary(ctx, req)
}

// GetBackups calls vtadmin.VTAdmin.GetBackups.
func (c *vTAdminClient) GetBackups(ctx context.Context, req *connect.Request[v15.GetBackupsRequest]) (*connect.Response[v15.GetBackupsResponse], error) {
	return c.getBackups.CallUnary(ctx, req)
}

// GetCellInfos calls vtadmin.VTAdmin.GetCellInfos.
func (c *vTAdminClient) GetCellInfos(ctx context.Context, req *connect.Request[v15.GetCellInfosRequest]) (*connect.Response[v15.GetCellInfosResponse], error) {
	return c.getCellInfos.CallUnary(ctx, req)
}

// GetCellsAliases calls vtadmin.VTAdmin.GetCellsAliases.
func (c *vTAdminClient) GetCellsAliases(ctx context.Context, req *connect.Request[v15.GetCellsAliasesRequest]) (*connect.Response[v15.GetCellsAliasesResponse], error) {
	return c.getCellsAliases.CallUnary(ctx, req)
}

// GetClusters calls vtadmin.VTAdmin.GetClusters.
func (c *vTAdminClient) GetClusters(ctx context.Context, req *connect.Request[v15.GetClustersRequest]) (*connect.Response[v15.GetClustersResponse], error) {
	return c.getClusters.CallUnary(ctx, req)
}

// GetFullStatus calls vtadmin.VTAdmin.GetFullStatus.
func (c *vTAdminClient) GetFullStatus(ctx context.Context, req *connect.Request[v15.GetFullStatusRequest]) (*connect.Response[v151.GetFullStatusResponse], error) {
	return c.getFullStatus.CallUnary(ctx, req)
}

// GetGates calls vtadmin.VTAdmin.GetGates.
func (c *vTAdminClient) GetGates(ctx context.Context, req *connect.Request[v15.GetGatesRequest]) (*connect.Response[v15.GetGatesResponse], error) {
	return c.getGates.CallUnary(ctx, req)
}

// GetKeyspace calls vtadmin.VTAdmin.GetKeyspace.
func (c *vTAdminClient) GetKeyspace(ctx context.Context, req *connect.Request[v15.GetKeyspaceRequest]) (*connect.Response[v15.Keyspace], error) {
	return c.getKeyspace.CallUnary(ctx, req)
}

// GetKeyspaces calls vtadmin.VTAdmin.GetKeyspaces.
func (c *vTAdminClient) GetKeyspaces(ctx context.Context, req *connect.Request[v15.GetKeyspacesRequest]) (*connect.Response[v15.GetKeyspacesResponse], error) {
	return c.getKeyspaces.CallUnary(ctx, req)
}

// GetSchema calls vtadmin.VTAdmin.GetSchema.
func (c *vTAdminClient) GetSchema(ctx context.Context, req *connect.Request[v15.GetSchemaRequest]) (*connect.Response[v15.Schema], error) {
	return c.getSchema.CallUnary(ctx, req)
}

// GetSchemas calls vtadmin.VTAdmin.GetSchemas.
func (c *vTAdminClient) GetSchemas(ctx context.Context, req *connect.Request[v15.GetSchemasRequest]) (*connect.Response[v15.GetSchemasResponse], error) {
	return c.getSchemas.CallUnary(ctx, req)
}

// GetShardReplicationPositions calls vtadmin.VTAdmin.GetShardReplicationPositions.
func (c *vTAdminClient) GetShardReplicationPositions(ctx context.Context, req *connect.Request[v15.GetShardReplicationPositionsRequest]) (*connect.Response[v15.GetShardReplicationPositionsResponse], error) {
	return c.getShardReplicationPositions.CallUnary(ctx, req)
}

// GetSrvVSchema calls vtadmin.VTAdmin.GetSrvVSchema.
func (c *vTAdminClient) GetSrvVSchema(ctx context.Context, req *connect.Request[v15.GetSrvVSchemaRequest]) (*connect.Response[v15.SrvVSchema], error) {
	return c.getSrvVSchema.CallUnary(ctx, req)
}

// GetSrvVSchemas calls vtadmin.VTAdmin.GetSrvVSchemas.
func (c *vTAdminClient) GetSrvVSchemas(ctx context.Context, req *connect.Request[v15.GetSrvVSchemasRequest]) (*connect.Response[v15.GetSrvVSchemasResponse], error) {
	return c.getSrvVSchemas.CallUnary(ctx, req)
}

// GetTablet calls vtadmin.VTAdmin.GetTablet.
func (c *vTAdminClient) GetTablet(ctx context.Context, req *connect.Request[v15.GetTabletRequest]) (*connect.Response[v15.Tablet], error) {
	return c.getTablet.CallUnary(ctx, req)
}

// GetTablets calls vtadmin.VTAdmin.GetTablets.
func (c *vTAdminClient) GetTablets(ctx context.Context, req *connect.Request[v15.GetTabletsRequest]) (*connect.Response[v15.GetTabletsResponse], error) {
	return c.getTablets.CallUnary(ctx, req)
}

// GetTopologyPath calls vtadmin.VTAdmin.GetTopologyPath.
func (c *vTAdminClient) GetTopologyPath(ctx context.Context, req *connect.Request[v15.GetTopologyPathRequest]) (*connect.Response[v151.GetTopologyPathResponse], error) {
	return c.getTopologyPath.CallUnary(ctx, req)
}

// GetVSchema calls vtadmin.VTAdmin.GetVSchema.
func (c *vTAdminClient) GetVSchema(ctx context.Context, req *connect.Request[v15.GetVSchemaRequest]) (*connect.Response[v15.VSchema], error) {
	return c.getVSchema.CallUnary(ctx, req)
}

// GetVSchemas calls vtadmin.VTAdmin.GetVSchemas.
func (c *vTAdminClient) GetVSchemas(ctx context.Context, req *connect.Request[v15.GetVSchemasRequest]) (*connect.Response[v15.GetVSchemasResponse], error) {
	return c.getVSchemas.CallUnary(ctx, req)
}

// GetVtctlds calls vtadmin.VTAdmin.GetVtctlds.
func (c *vTAdminClient) GetVtctlds(ctx context.Context, req *connect.Request[v15.GetVtctldsRequest]) (*connect.Response[v15.GetVtctldsResponse], error) {
	return c.getVtctlds.CallUnary(ctx, req)
}

// GetWorkflow calls vtadmin.VTAdmin.GetWorkflow.
func (c *vTAdminClient) GetWorkflow(ctx context.Context, req *connect.Request[v15.GetWorkflowRequest]) (*connect.Response[v15.Workflow], error) {
	return c.getWorkflow.CallUnary(ctx, req)
}

// GetWorkflows calls vtadmin.VTAdmin.GetWorkflows.
func (c *vTAdminClient) GetWorkflows(ctx context.Context, req *connect.Request[v15.GetWorkflowsRequest]) (*connect.Response[v15.GetWorkflowsResponse], error) {
	return c.getWorkflows.CallUnary(ctx, req)
}

// PingTablet calls vtadmin.VTAdmin.PingTablet.
func (c *vTAdminClient) PingTablet(ctx context.Context, req *connect.Request[v15.PingTabletRequest]) (*connect.Response[v15.PingTabletResponse], error) {
	return c.pingTablet.CallUnary(ctx, req)
}

// PlannedFailoverShard calls vtadmin.VTAdmin.PlannedFailoverShard.
func (c *vTAdminClient) PlannedFailoverShard(ctx context.Context, req *connect.Request[v15.PlannedFailoverShardRequest]) (*connect.Response[v15.PlannedFailoverShardResponse], error) {
	return c.plannedFailoverShard.CallUnary(ctx, req)
}

// RebuildKeyspaceGraph calls vtadmin.VTAdmin.RebuildKeyspaceGraph.
func (c *vTAdminClient) RebuildKeyspaceGraph(ctx context.Context, req *connect.Request[v15.RebuildKeyspaceGraphRequest]) (*connect.Response[v15.RebuildKeyspaceGraphResponse], error) {
	return c.rebuildKeyspaceGraph.CallUnary(ctx, req)
}

// RefreshState calls vtadmin.VTAdmin.RefreshState.
func (c *vTAdminClient) RefreshState(ctx context.Context, req *connect.Request[v15.RefreshStateRequest]) (*connect.Response[v15.RefreshStateResponse], error) {
...
func (c *vTAdminClient) RefreshTabletReplicationSource(ctx context.Context, req *connect.Request[v15.RefreshTabletReplicationSourceRequest]) (*connect.Response[v15.RefreshTabletReplicationSourceResponse], error) {
	return c.refreshTabletReplicationSource.CallUnary(ctx, req)
}

// ReloadSchemas calls vtadmin.VTAdmin.ReloadSchemas.
func (c *vTAdminClient) ReloadSchemas(ctx context.Context, req *connect.Request[v15.ReloadSchemasRequest]) (*connect.Response[v15.ReloadSchemasResponse], error) {
	return c.reloadSchemas.CallUnary(ctx, req)
}

// ReloadSchemaShard calls vtadmin.VTAdmin.ReloadSchemaShard.
func (c *vTAdminClient) ReloadSchemaShard(ctx context.Context, req *connect.Request[v15.ReloadSchemaShardRequest]) (*connect.Response[v15.ReloadSchemaShardResponse], error) {
	return c.reloadSchemaShard.CallUnary(ctx, req)
}

// RemoveKeyspaceCell calls vtadmin.VTAdmin.RemoveKeyspaceCell.
func (c *vTAdminClient) RemoveKeyspaceCell(ctx context.Context, req *connect.Request[v15.RemoveKeyspaceCellRequest]) (*connect.Response[v15.RemoveKeyspaceCellResponse], error) {
	return c.removeKeyspaceCell.CallUnary(ctx, req)
}

// RunHealthCheck calls vtadmin.VTAdmin.RunHealthCheck.
func (c *vTAdminClient) RunHealthCheck(ctx context.Context, req *connect.Request[v15.RunHealthCheckRequest]) (*connect.Response[v15.RunHealthCheckResponse], error) {
	return c.runHealthCheck.CallUnary(ctx, req)
}

// SetReadOnly calls vtadmin.VTAdmin.SetReadOnly.
func (c *vTAdminClient) SetReadOnly(ctx context.Context, req *connect.Request[v15.SetReadOnlyRequest]) (*connect.Response[v15.SetReadOnlyResponse], error) {
	return c.setReadOnly.CallUnary(ctx, req)
}

// SetReadWrite calls vtadmin.VTAdmin.SetReadWrite.
func (c *vTAdminClient) SetReadWrite(ctx context.Context, req *connect.Request[v15.SetReadWriteRequest]) (*connect.Response[v15.SetReadWriteResponse], error) {
	return c.setReadWrite.CallUnary(ctx, req)
}

// StartReplication calls vtadmin.VTAdmin.StartReplication.
func (c *vTAdminClient) StartReplication(ctx context.Context, req *connect.Request[v15.StartReplicationRequest]) (*connect.Response[v15.StartReplicationResponse], error) {
	return c.startReplication.CallUnary(ctx, req)
}

// StopReplication calls vtadmin.VTAdmin.StopReplication.
func (c *vTAdminClient) StopReplication(ctx context.Context, req *connect.Request[v15.StopReplicationRequest]) (*connect.Response[v15.StopReplicationResponse], error) {
	return c.stopReplication.CallUnary(ctx, req)
}

// TabletExternallyPromoted calls vtadmin.VTAdmin.TabletExternallyPromoted.
func (c *vTAdminClient) TabletExternallyPromoted(ctx context.Context, req *connect.Request[v15.TabletExternallyPromotedRequest]) (*connect.Response[v15.TabletExternallyPromotedResponse], error) {
	return c.tabletExternallyPromoted.CallUnary(ctx, req)
}

// Validate calls vtadmin.VTAdmin.Validate.
func (c *vTAdminClient) Validate(ctx context.Context, req *connect.Request[v15.ValidateRequest]) (*connect.Response[v151.ValidateResponse], error) {
	return c.validate.CallUnary(ctx, req)
}

// ValidateKeyspace calls vtadmin.VTAdmin.ValidateKeyspace.
func (c *vTAdminClient) ValidateKeyspace(ctx context.Context, req *connect.Request[v15.ValidateKeyspaceRequest]) (*connect.Response[v151.ValidateKeyspaceResponse], error) {
	return c.validateKeyspace.CallUnary(ctx, req)
}

// ValidateSchemaKeyspace calls vtadmin.VTAdmin.ValidateSchemaKeyspace.
func (c *vTAdminClient) ValidateSchemaKeyspace(ctx context.Context, req *connect.Request[v15.ValidateSchemaKeyspaceRequest]) (*connect.Response[v151.ValidateSchemaKeyspaceResponse], error) {
	return c.validateSchemaKeyspace.CallUnary(ctx, req)
}

// ValidateShard calls vtadmin.VTAdmin.ValidateShard.
func (c *vTAdminClient) ValidateShard(ctx context.Context, req *connect.Request[v15.ValidateShardRequest]) (*connect.Response[v151.ValidateShardResponse], error) {
	return c.validateShard.CallUnary(ctx, req)
}

// ValidateVersionKeyspace calls vtadmin.VTAdmin.ValidateVersionKeyspace.
func (c *vTAdminClient) ValidateVersionKeyspace(ctx context.Context, req *connect.Request[v15.ValidateVersionKeyspaceRequest]) (*connect.Response[v151.ValidateVersionKeyspaceResponse], error) {
	return c.validateVersionKeyspace.CallUnary(ctx, req)
}

// ValidateVersionShard calls vtadmin.VTAdmin.ValidateVersionShard.
func (c *vTAdminClient) ValidateVersionShard(ctx context.Context, req *connect.Request[v15.ValidateVersionShardRequest]) (*connect.Response[v151.ValidateVersionShardResponse], error) {
	return c.validateVersionShard.CallUnary(ctx, req)
}

// VTExplain calls vtadmin.VTAdmin.VTExplain.
func (c *vTAdminClient) VTExplain(ctx context.Context, req *connect.Request[v15.VTExplainRequest]) (*connect.Response[v15.VTExplainResponse], error) {
...
func (UnimplementedVTAdminHandler) CreateKeyspace(context.Context, *connect.Request[v15.CreateKeyspaceRequest]) (*connect.Response[v15.CreateKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.CreateKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) CreateShard(context.Context, *connect.Request[v15.CreateShardRequest]) (*connect.Response[v151.CreateShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.CreateShard is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteKeyspace(context.Context, *connect.Request[v15.DeleteKeyspaceRequest]) (*connect.Response[v151.DeleteKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteShards(context.Context, *connect.Request[v15.DeleteShardsRequest]) (*connect.Response[v151.DeleteShardsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteShards is not implemented"))
}

func (UnimplementedVTAdminHandler) DeleteTablet(context.Context, *connect.Request[v15.DeleteTabletRequest]) (*connect.Response[v15.DeleteTabletResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.DeleteTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) EmergencyFailoverShard(context.Context, *connect.Request[v15.EmergencyFailoverShardRequest]) (*connect.Response[v15.EmergencyFailoverShardResponse], error) {
...
func (UnimplementedVTAdminHandler) FindSchema(context.Context, *connect.Request[v15.FindSchemaRequest]) (*connect.Response[v15.Schema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.FindSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetBackups(context.Context, *connect.Request[v15.GetBackupsRequest]) (*connect.Response[v15.GetBackupsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetBackups is not implemented"))
}

func (UnimplementedVTAdminHandler) GetCellInfos(context.Context, *connect.Request[v15.GetCellInfosRequest]) (*connect.Response[v15.GetCellInfosResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetCellInfos is not implemented"))
}

func (UnimplementedVTAdminHandler) GetCellsAliases(context.Context, *connect.Request[v15.GetCellsAliasesRequest]) (*connect.Response[v15.GetCellsAliasesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetCellsAliases is not implemented"))
}

func (UnimplementedVTAdminHandler) GetClusters(context.Context, *connect.Request[v15.GetClustersRequest]) (*connect.Response[v15.GetClustersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetClusters is not implemented"))
}

func (UnimplementedVTAdminHandler) GetFullStatus(context.Context, *connect.Request[v15.GetFullStatusRequest]) (*connect.Response[v151.GetFullStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetFullStatus is not implemented"))
}

func (UnimplementedVTAdminHandler) GetGates(context.Context, *connect.Request[v15.GetGatesRequest]) (*connect.Response[v15.GetGatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetGates is not implemented"))
}

func (UnimplementedVTAdminHandler) GetKeyspace(context.Context, *connect.Request[v15.GetKeyspaceRequest]) (*connect.Response[v15.Keyspace], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) GetKeyspaces(context.Context, *connect.Request[v15.GetKeyspacesRequest]) (*connect.Response[v15.GetKeyspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetKeyspaces is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSchema(context.Context, *connect.Request[v15.GetSchemaRequest]) (*connect.Response[v15.Schema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSchemas(context.Context, *connect.Request[v15.GetSchemasRequest]) (*connect.Response[v15.GetSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetShardReplicationPositions(context.Context, *connect.Request[v15.GetShardReplicationPositionsRequest]) (*connect.Response[v15.GetShardReplicationPositionsResponse], error) {
...
func (UnimplementedVTAdminHandler) GetSrvVSchema(context.Context, *connect.Request[v15.GetSrvVSchemaRequest]) (*connect.Response[v15.SrvVSchema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvVSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetSrvVSchemas(context.Context, *connect.Request[v15.GetSrvVSchemasRequest]) (*connect.Response[v15.GetSrvVSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetSrvVSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTablet(context.Context, *connect.Request[v15.GetTabletRequest]) (*connect.Response[v15.Tablet], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTablets(context.Context, *connect.Request[v15.GetTabletsRequest]) (*connect.Response[v15.GetTabletsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTablets is not implemented"))
}

func (UnimplementedVTAdminHandler) GetTopologyPath(context.Context, *connect.Request[v15.GetTopologyPathRequest]) (*connect.Response[v151.GetTopologyPathResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetTopologyPath is not implemented"))
}

func (UnimplementedVTAdminHandler) GetVSchema(context.Context, *connect.Request[v15.GetVSchemaRequest]) (*connect.Response[v15.VSchema], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVSchema is not implemented"))
}

func (UnimplementedVTAdminHandler) GetVSchemas(context.Context, *connect.Request[v15.GetVSchemasRequest]) (*connect.Response[v15.GetVSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) GetVtctlds(context.Context, *connect.Request[v15.GetVtctldsRequest]) (*connect.Response[v15.GetVtctldsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetVtctlds is not implemented"))
}

func (UnimplementedVTAdminHandler) GetWorkflow(context.Context, *connect.Request[v15.GetWorkflowRequest]) (*connect.Response[v15.Workflow], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetWorkflow is not implemented"))
}

func (UnimplementedVTAdminHandler) GetWorkflows(context.Context, *connect.Request[v15.GetWorkflowsRequest]) (*connect.Response[v15.GetWorkflowsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.GetWorkflows is not implemented"))
}

func (UnimplementedVTAdminHandler) PingTablet(context.Context, *connect.Request[v15.PingTabletRequest]) (*connect.Response[v15.PingTabletResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.PingTablet is not implemented"))
}

func (UnimplementedVTAdminHandler) PlannedFailoverShard(context.Context, *connect.Request[v15.PlannedFailoverShardRequest]) (*connect.Response[v15.PlannedFailoverShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.PlannedFailoverShard is not implemented"))
}

func (UnimplementedVTAdminHandler) RebuildKeyspaceGraph(context.Context, *connect.Request[v15.RebuildKeyspaceGraphRequest]) (*connect.Response[v15.RebuildKeyspaceGraphResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RebuildKeyspaceGraph is not implemented"))
}

func (UnimplementedVTAdminHandler) RefreshState(context.Context, *connect.Request[v15.RefreshStateRequest]) (*connect.Response[v15.RefreshStateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RefreshState is not implemented"))
}

func (UnimplementedVTAdminHandler) RefreshTabletReplicationSource(context.Context, *connect.Request[v15.RefreshTabletReplicationSourceRequest]) (*connect.Response[v15.RefreshTabletReplicationSourceResponse], error) {
...
func (UnimplementedVTAdminHandler) ReloadSchemas(context.Context, *connect.Request[v15.ReloadSchemasRequest]) (*connect.Response[v15.ReloadSchemasResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ReloadSchemas is not implemented"))
}

func (UnimplementedVTAdminHandler) ReloadSchemaShard(context.Context, *connect.Request[v15.ReloadSchemaShardRequest]) (*connect.Response[v15.ReloadSchemaShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ReloadSchemaShard is not implemented"))
}

func (UnimplementedVTAdminHandler) RemoveKeyspaceCell(context.Context, *connect.Request[v15.RemoveKeyspaceCellRequest]) (*connect.Response[v15.RemoveKeyspaceCellResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RemoveKeyspaceCell is not implemented"))
}

func (UnimplementedVTAdminHandler) RunHealthCheck(context.Context, *connect.Request[v15.RunHealthCheckRequest]) (*connect.Response[v15.RunHealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.RunHealthCheck is not implemented"))
}

func (UnimplementedVTAdminHandler) SetReadOnly(context.Context, *connect.Request[v15.SetReadOnlyRequest]) (*connect.Response[v15.SetReadOnlyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.SetReadOnly is not implemented"))
}

func (UnimplementedVTAdminHandler) SetReadWrite(context.Context, *connect.Request[v15.SetReadWriteRequest]) (*connect.Response[v15.SetReadWriteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.SetReadWrite is not implemented"))
}

func (UnimplementedVTAdminHandler) StartReplication(context.Context, *connect.Request[v15.StartReplicationRequest]) (*connect.Response[v15.StartReplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StartReplication is not implemented"))
}

func (UnimplementedVTAdminHandler) StopReplication(context.Context, *connect.Request[v15.StopReplicationRequest]) (*connect.Response[v15.StopReplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.StopReplication is not implemented"))
}

func (UnimplementedVTAdminHandler) TabletExternallyPromoted(context.Context, *connect.Request[v15.TabletExternallyPromotedRequest]) (*connect.Response[v15.TabletExternallyPromotedResponse], error) {
...
func (UnimplementedVTAdminHandler) Validate(context.Context, *connect.Request[v15.ValidateRequest]) (*connect.Response[v151.ValidateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.Validate is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateKeyspace(context.Context, *connect.Request[v15.ValidateKeyspaceRequest]) (*connect.Response[v151.ValidateKeyspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateKeyspace is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateSchemaKeyspace(context.Context, *connect.Request[v15.ValidateSchemaKeyspaceRequest]) (*connect.Response[v151.ValidateSchemaKeyspaceResponse], error) {
...
func (UnimplementedVTAdminHandler) ValidateShard(context.Context, *connect.Request[v15.ValidateShardRequest]) (*connect.Response[v151.ValidateShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateShard is not implemented"))
}

func (UnimplementedVTAdminHandler) ValidateVersionKeyspace(context.Context, *connect.Request[v15.ValidateVersionKeyspaceRequest]) (*connect.Response[v151.ValidateVersionKeyspaceResponse], error) {
...
func (UnimplementedVTAdminHandler) ValidateVersionShard(context.Context, *connect.Request[v15.ValidateVersionShardRequest]) (*connect.Response[v151.ValidateVersionShardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vtadmin.VTAdmin.ValidateVersionShard is not implemented"))
}

func (UnimplementedVTAdminHandler) VTExplain(context.Context, *connect.Request[v15.VTExplainRequest]) (*connect.Response[v15.VTExplainResponse], error) {
