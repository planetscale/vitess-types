...
package queryservicev23connect
...
import (
	...
	v232 "github.com/planetscale/vitess-types/gen/vitess/queryservice/v23"
	http "net/http"
	strings "strings"
)
...
type QueryClient interface {
	...
	// Begin a transaction.
	Begin(context.Context, *connect.Request[v23.BeginRequest]) (*connect.Response[v23.BeginResponse], error)
	// Commit a transaction.
	Commit(context.Context, *connect.Request[v23.CommitRequest]) (*connect.Response[v23.CommitResponse], error)
	// Rollback a transaction.
	Rollback(context.Context, *connect.Request[v23.RollbackRequest]) (*connect.Response[v23.RollbackResponse], error)
	...
	CommitPrepared(context.Context, *connect.Request[v23.CommitPreparedRequest]) (*connect.Response[v23.CommitPreparedResponse], error)
	// RollbackPrepared rolls back a prepared transaction.
	RollbackPrepared(context.Context, *connect.Request[v23.RollbackPreparedRequest]) (*connect.Response[v23.RollbackPreparedResponse], error)
	// CreateTransaction creates the metadata for a 2pc transaction.
	CreateTransaction(context.Context, *connect.Request[v23.CreateTransactionRequest]) (*connect.Response[v23.CreateTransactionResponse], error)
	// StartCommit initiates a commit for a 2pc transaction.
	StartCommit(context.Context, *connect.Request[v23.StartCommitRequest]) (*connect.Response[v23.StartCommitResponse], error)
	// SetRollback marks the 2pc transaction for rollback.
	SetRollback(context.Context, *connect.Request[v23.SetRollbackRequest]) (*connect.Response[v23.SetRollbackResponse], error)
	...
	UnresolvedTransactions(context.Context, *connect.Request[v23.UnresolvedTransactionsRequest]) (*connect.Response[v23.UnresolvedTransactionsResponse], error)
	// BeginExecute executes a begin and the specified SQL query.
	BeginExecute(context.Context, *connect.Request[v23.BeginExecuteRequest]) (*connect.Response[v23.BeginExecuteResponse], error)
	// BeginStreamExecute executes a begin and the specified SQL query.
	BeginStreamExecute(context.Context, *connect.Request[v23.BeginStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.BeginStreamExecuteResponse], error)
	// MessageStream streams messages from a message table.
	MessageStream(context.Context, *connect.Request[v23.MessageStreamRequest]) (*connect.ServerStreamForClient[v23.MessageStreamResponse], error)
	// MessageAck acks messages for a table.
	MessageAck(context.Context, *connect.Request[v23.MessageAckRequest]) (*connect.Response[v23.MessageAckResponse], error)
	// ReserveExecute executes a query on a reserved connection
	ReserveExecute(context.Context, *connect.Request[v23.ReserveExecuteRequest]) (*connect.Response[v23.ReserveExecuteResponse], error)
	// ReserveBeginExecute starts a transaction and executes a query in the transaction on a reserved connection
	ReserveBeginExecute(context.Context, *connect.Request[v23.ReserveBeginExecuteRequest]) (*connect.Response[v23.ReserveBeginExecuteResponse], error)
	// ReserveStreamExecute executes a streaming query on a reserved connection
	ReserveStreamExecute(context.Context, *connect.Request[v23.ReserveStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.ReserveStreamExecuteResponse], error)
	...
	ReserveBeginStreamExecute(context.Context, *connect.Request[v23.ReserveBeginStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.ReserveBeginStreamExecuteResponse], error)
	// Release releases the connection
	Release(context.Context, *connect.Request[v23.ReleaseRequest]) (*connect.Response[v23.ReleaseResponse], error)
	// StreamHealth runs a streaming RPC to the tablet, that returns the
	// current health of the tablet on a regular basis.
	StreamHealth(context.Context, *connect.Request[v23.StreamHealthRequest]) (*connect.ServerStreamForClient[v23.StreamHealthResponse], error)
	// VStream streams vreplication events.
	VStream(context.Context, *connect.Request[v231.VStreamRequest]) (*connect.ServerStreamForClient[v231.VStreamResponse], error)
	// VStreamRows streams rows from the specified starting point.
	VStreamRows(context.Context, *connect.Request[v231.VStreamRowsRequest]) (*connect.ServerStreamForClient[v231.VStreamRowsResponse], error)
	// VStreamTables streams rows from the specified starting point.
	VStreamTables(context.Context, *connect.Request[v231.VStreamTablesRequest]) (*connect.ServerStreamForClient[v231.VStreamTablesResponse], error)
	// VStreamResults streams results along with the gtid of the snapshot.
	VStreamResults(context.Context, *connect.Request[v231.VStreamResultsRequest]) (*connect.ServerStreamForClient[v231.VStreamResultsResponse], error)
	// GetSchema returns the schema information.
	GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest]) (*connect.ServerStreamForClient[v23.GetSchemaResponse], error)
}
...
func NewQueryClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) QueryClient {
	...
	queryMethods := v232.File_vitess_queryservice_v23_queryservice_proto.Services().ByName("Query").Methods()
	return &queryClient{
		...
		begin: connect.NewClient[v23.BeginRequest, v23.BeginResponse](
			httpClient,
			baseURL+QueryBeginProcedure,
			connect.WithSchema(queryMethods.ByName("Begin")),
			connect.WithClientOptions(opts...),
		),
		commit: connect.NewClient[v23.CommitRequest, v23.CommitResponse](
			httpClient,
			baseURL+QueryCommitProcedure,
			connect.WithSchema(queryMethods.ByName("Commit")),
			connect.WithClientOptions(opts...),
		),
		rollback: connect.NewClient[v23.RollbackRequest, v23.RollbackResponse](
			httpClient,
		...
		commitPrepared: connect.NewClient[v23.CommitPreparedRequest, v23.CommitPreparedResponse](
			httpClient,
			baseURL+QueryCommitPreparedProcedure,
			connect.WithSchema(queryMethods.ByName("CommitPrepared")),
			connect.WithClientOptions(opts...),
		),
		rollbackPrepared: connect.NewClient[v23.RollbackPreparedRequest, v23.RollbackPreparedResponse](
			httpClient,
			baseURL+QueryRollbackPreparedProcedure,
			connect.WithSchema(queryMethods.ByName("RollbackPrepared")),
			connect.WithClientOptions(opts...),
		),
		createTransaction: connect.NewClient[v23.CreateTransactionRequest, v23.CreateTransactionResponse](
			httpClient,
			baseURL+QueryCreateTransactionProcedure,
			connect.WithSchema(queryMethods.ByName("CreateTransaction")),
			connect.WithClientOptions(opts...),
		),
		startCommit: connect.NewClient[v23.StartCommitRequest, v23.StartCommitResponse](
			httpClient,
			baseURL+QueryStartCommitProcedure,
			connect.WithSchema(queryMethods.ByName("StartCommit")),
			connect.WithClientOptions(opts...),
		),
		setRollback: connect.NewClient[v23.SetRollbackRequest, v23.SetRollbackResponse](
			httpClient,
		...
		unresolvedTransactions: connect.NewClient[v23.UnresolvedTransactionsRequest, v23.UnresolvedTransactionsResponse](
			httpClient,
			baseURL+QueryUnresolvedTransactionsProcedure,
			connect.WithSchema(queryMethods.ByName("UnresolvedTransactions")),
			connect.WithClientOptions(opts...),
		),
		beginExecute: connect.NewClient[v23.BeginExecuteRequest, v23.BeginExecuteResponse](
			httpClient,
			baseURL+QueryBeginExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("BeginExecute")),
			connect.WithClientOptions(opts...),
		),
		beginStreamExecute: connect.NewClient[v23.BeginStreamExecuteRequest, v23.BeginStreamExecuteResponse](
			httpClient,
			baseURL+QueryBeginStreamExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("BeginStreamExecute")),
			connect.WithClientOptions(opts...),
		),
		messageStream: connect.NewClient[v23.MessageStreamRequest, v23.MessageStreamResponse](
			httpClient,
			baseURL+QueryMessageStreamProcedure,
			connect.WithSchema(queryMethods.ByName("MessageStream")),
			connect.WithClientOptions(opts...),
		),
		messageAck: connect.NewClient[v23.MessageAckRequest, v23.MessageAckResponse](
			httpClient,
			baseURL+QueryMessageAckProcedure,
			connect.WithSchema(queryMethods.ByName("MessageAck")),
			connect.WithClientOptions(opts...),
		),
		reserveExecute: connect.NewClient[v23.ReserveExecuteRequest, v23.ReserveExecuteResponse](
			httpClient,
			baseURL+QueryReserveExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("ReserveExecute")),
			connect.WithClientOptions(opts...),
		),
		reserveBeginExecute: connect.NewClient[v23.ReserveBeginExecuteRequest, v23.ReserveBeginExecuteResponse](
			httpClient,
			baseURL+QueryReserveBeginExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("ReserveBeginExecute")),
			connect.WithClientOptions(opts...),
		),
		reserveStreamExecute: connect.NewClient[v23.ReserveStreamExecuteRequest, v23.ReserveStreamExecuteResponse](
			httpClient,
			baseURL+QueryReserveStreamExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("ReserveStreamExecute")),
			connect.WithClientOptions(opts...),
		),
		reserveBeginStreamExecute: connect.NewClient[v23.ReserveBeginStreamExecuteRequest, v23.ReserveBeginStreamExecuteResponse](
			httpClient,
			baseURL+QueryReserveBeginStreamExecuteProcedure,
			connect.WithSchema(queryMethods.ByName("ReserveBeginStreamExecute")),
			connect.WithClientOptions(opts...),
		),
		release: connect.NewClient[v23.ReleaseRequest, v23.ReleaseResponse](
			httpClient,
			baseURL+QueryReleaseProcedure,
			connect.WithSchema(queryMethods.ByName("Release")),
			connect.WithClientOptions(opts...),
		),
		streamHealth: connect.NewClient[v23.StreamHealthRequest, v23.StreamHealthResponse](
			httpClient,
			baseURL+QueryStreamHealthProcedure,
			connect.WithSchema(queryMethods.ByName("StreamHealth")),
			connect.WithClientOptions(opts...),
		),
		vStream: connect.NewClient[v231.VStreamRequest, v231.VStreamResponse](
			httpClient,
			baseURL+QueryVStreamProcedure,
			connect.WithSchema(queryMethods.ByName("VStream")),
			connect.WithClientOptions(opts...),
		),
		vStreamRows: connect.NewClient[v231.VStreamRowsRequest, v231.VStreamRowsResponse](
			httpClient,
			baseURL+QueryVStreamRowsProcedure,
			connect.WithSchema(queryMethods.ByName("VStreamRows")),
			connect.WithClientOptions(opts...),
		),
		vStreamTables: connect.NewClient[v231.VStreamTablesRequest, v231.VStreamTablesResponse](
			httpClient,
			baseURL+QueryVStreamTablesProcedure,
			connect.WithSchema(queryMethods.ByName("VStreamTables")),
			connect.WithClientOptions(opts...),
		),
		vStreamResults: connect.NewClient[v231.VStreamResultsRequest, v231.VStreamResultsResponse](
			httpClient,
...
type queryClient struct {
	...
	begin                     *connect.Client[v23.BeginRequest, v23.BeginResponse]
	commit                    *connect.Client[v23.CommitRequest, v23.CommitResponse]
	rollback                  *connect.Client[v23.RollbackRequest, v23.RollbackResponse]
	prepare                   *connect.Client[v23.PrepareRequest, v23.PrepareResponse]
	commitPrepared            *connect.Client[v23.CommitPreparedRequest, v23.CommitPreparedResponse]
	rollbackPrepared          *connect.Client[v23.RollbackPreparedRequest, v23.RollbackPreparedResponse]
	createTransaction         *connect.Client[v23.CreateTransactionRequest, v23.CreateTransactionResponse]
	startCommit               *connect.Client[v23.StartCommitRequest, v23.StartCommitResponse]
	setRollback               *connect.Client[v23.SetRollbackRequest, v23.SetRollbackResponse]
	...
	unresolvedTransactions    *connect.Client[v23.UnresolvedTransactionsRequest, v23.UnresolvedTransactionsResponse]
	beginExecute              *connect.Client[v23.BeginExecuteRequest, v23.BeginExecuteResponse]
	beginStreamExecute        *connect.Client[v23.BeginStreamExecuteRequest, v23.BeginStreamExecuteResponse]
	messageStream             *connect.Client[v23.MessageStreamRequest, v23.MessageStreamResponse]
	messageAck                *connect.Client[v23.MessageAckRequest, v23.MessageAckResponse]
	reserveExecute            *connect.Client[v23.ReserveExecuteRequest, v23.ReserveExecuteResponse]
	reserveBeginExecute       *connect.Client[v23.ReserveBeginExecuteRequest, v23.ReserveBeginExecuteResponse]
	reserveStreamExecute      *connect.Client[v23.ReserveStreamExecuteRequest, v23.ReserveStreamExecuteResponse]
	reserveBeginStreamExecute *connect.Client[v23.ReserveBeginStreamExecuteRequest, v23.ReserveBeginStreamExecuteResponse]
	release                   *connect.Client[v23.ReleaseRequest, v23.ReleaseResponse]
	streamHealth              *connect.Client[v23.StreamHealthRequest, v23.StreamHealthResponse]
	vStream                   *connect.Client[v231.VStreamRequest, v231.VStreamResponse]
	vStreamRows               *connect.Client[v231.VStreamRowsRequest, v231.VStreamRowsResponse]
	vStreamTables             *connect.Client[v231.VStreamTablesRequest, v231.VStreamTablesResponse]
	vStreamResults            *connect.Client[v231.VStreamResultsRequest, v231.VStreamResultsResponse]
	getSchema                 *connect.Client[v23.GetSchemaRequest, v23.GetSchemaResponse]
}

// Execute calls queryservice.Query.Execute.
func (c *queryClient) Execute(ctx context.Context, req *connect.Request[v23.ExecuteRequest]) (*connect.Response[v23.ExecuteResponse], error) {
	return c.execute.CallUnary(ctx, req)
}

// StreamExecute calls queryservice.Query.StreamExecute.
func (c *queryClient) StreamExecute(ctx context.Context, req *connect.Request[v23.StreamExecuteRequest]) (*connect.ServerStreamForClient[v23.StreamExecuteResponse], error) {
	return c.streamExecute.CallServerStream(ctx, req)
}

// Begin calls queryservice.Query.Begin.
func (c *queryClient) Begin(ctx context.Context, req *connect.Request[v23.BeginRequest]) (*connect.Response[v23.BeginResponse], error) {
	return c.begin.CallUnary(ctx, req)
}

// Commit calls queryservice.Query.Commit.
func (c *queryClient) Commit(ctx context.Context, req *connect.Request[v23.CommitRequest]) (*connect.Response[v23.CommitResponse], error) {
	return c.commit.CallUnary(ctx, req)
}

// Rollback calls queryservice.Query.Rollback.
func (c *queryClient) Rollback(ctx context.Context, req *connect.Request[v23.RollbackRequest]) (*connect.Response[v23.RollbackResponse], error) {
	return c.rollback.CallUnary(ctx, req)
}

// Prepare calls queryservice.Query.Prepare.
func (c *queryClient) Prepare(ctx context.Context, req *connect.Request[v23.PrepareRequest]) (*connect.Response[v23.PrepareResponse], error) {
	return c.prepare.CallUnary(ctx, req)
}

// CommitPrepared calls queryservice.Query.CommitPrepared.
func (c *queryClient) CommitPrepared(ctx context.Context, req *connect.Request[v23.CommitPreparedRequest]) (*connect.Response[v23.CommitPreparedResponse], error) {
	return c.commitPrepared.CallUnary(ctx, req)
}

// RollbackPrepared calls queryservice.Query.RollbackPrepared.
func (c *queryClient) RollbackPrepared(ctx context.Context, req *connect.Request[v23.RollbackPreparedRequest]) (*connect.Response[v23.RollbackPreparedResponse], error) {
	return c.rollbackPrepared.CallUnary(ctx, req)
}

// CreateTransaction calls queryservice.Query.CreateTransaction.
func (c *queryClient) CreateTransaction(ctx context.Context, req *connect.Request[v23.CreateTransactionRequest]) (*connect.Response[v23.CreateTransactionResponse], error) {
	return c.createTransaction.CallUnary(ctx, req)
}

// StartCommit calls queryservice.Query.StartCommit.
func (c *queryClient) StartCommit(ctx context.Context, req *connect.Request[v23.StartCommitRequest]) (*connect.Response[v23.StartCommitResponse], error) {
	return c.startCommit.CallUnary(ctx, req)
}

// SetRollback calls queryservice.Query.SetRollback.
func (c *queryClient) SetRollback(ctx context.Context, req *connect.Request[v23.SetRollbackRequest]) (*connect.Response[v23.SetRollbackResponse], error) {
	return c.setRollback.CallUnary(ctx, req)
}

// ConcludeTransaction calls queryservice.Query.ConcludeTransaction.
func (c *queryClient) ConcludeTransaction(ctx context.Context, req *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v23.ConcludeTransactionResponse], error) {
	return c.concludeTransaction.CallUnary(ctx, req)
}

// ReadTransaction calls queryservice.Query.ReadTransaction.
func (c *queryClient) ReadTransaction(ctx context.Context, req *connect.Request[v23.ReadTransactionRequest]) (*connect.Response[v23.ReadTransactionResponse], error) {
	return c.readTransaction.CallUnary(ctx, req)
}

// UnresolvedTransactions calls queryservice.Query.UnresolvedTransactions.
func (c *queryClient) UnresolvedTransactions(ctx context.Context, req *connect.Request[v23.UnresolvedTransactionsRequest]) (*connect.Response[v23.UnresolvedTransactionsResponse], error) {
	return c.unresolvedTransactions.CallUnary(ctx, req)
}

// BeginExecute calls queryservice.Query.BeginExecute.
func (c *queryClient) BeginExecute(ctx context.Context, req *connect.Request[v23.BeginExecuteRequest]) (*connect.Response[v23.BeginExecuteResponse], error) {
	return c.beginExecute.CallUnary(ctx, req)
}

// BeginStreamExecute calls queryservice.Query.BeginStreamExecute.
func (c *queryClient) BeginStreamExecute(ctx context.Context, req *connect.Request[v23.BeginStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.BeginStreamExecuteResponse], error) {
	return c.beginStreamExecute.CallServerStream(ctx, req)
}

// MessageStream calls queryservice.Query.MessageStream.
func (c *queryClient) MessageStream(ctx context.Context, req *connect.Request[v23.MessageStreamRequest]) (*connect.ServerStreamForClient[v23.MessageStreamResponse], error) {
	return c.messageStream.CallServerStream(ctx, req)
}

// MessageAck calls queryservice.Query.MessageAck.
func (c *queryClient) MessageAck(ctx context.Context, req *connect.Request[v23.MessageAckRequest]) (*connect.Response[v23.MessageAckResponse], error) {
	return c.messageAck.CallUnary(ctx, req)
}

// ReserveExecute calls queryservice.Query.ReserveExecute.
func (c *queryClient) ReserveExecute(ctx context.Context, req *connect.Request[v23.ReserveExecuteRequest]) (*connect.Response[v23.ReserveExecuteResponse], error) {
	return c.reserveExecute.CallUnary(ctx, req)
}

// ReserveBeginExecute calls queryservice.Query.ReserveBeginExecute.
func (c *queryClient) ReserveBeginExecute(ctx context.Context, req *connect.Request[v23.ReserveBeginExecuteRequest]) (*connect.Response[v23.ReserveBeginExecuteResponse], error) {
	return c.reserveBeginExecute.CallUnary(ctx, req)
}

// ReserveStreamExecute calls queryservice.Query.ReserveStreamExecute.
func (c *queryClient) ReserveStreamExecute(ctx context.Context, req *connect.Request[v23.ReserveStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.ReserveStreamExecuteResponse], error) {
...
func (c *queryClient) ReserveBeginStreamExecute(ctx context.Context, req *connect.Request[v23.ReserveBeginStreamExecuteRequest]) (*connect.ServerStreamForClient[v23.ReserveBeginStreamExecuteResponse], error) {
	return c.reserveBeginStreamExecute.CallServerStream(ctx, req)
}

// Release calls queryservice.Query.Release.
func (c *queryClient) Release(ctx context.Context, req *connect.Request[v23.ReleaseRequest]) (*connect.Response[v23.ReleaseResponse], error) {
	return c.release.CallUnary(ctx, req)
}

// StreamHealth calls queryservice.Query.StreamHealth.
func (c *queryClient) StreamHealth(ctx context.Context, req *connect.Request[v23.StreamHealthRequest]) (*connect.ServerStreamForClient[v23.StreamHealthResponse], error) {
	return c.streamHealth.CallServerStream(ctx, req)
}

// VStream calls queryservice.Query.VStream.
func (c *queryClient) VStream(ctx context.Context, req *connect.Request[v231.VStreamRequest]) (*connect.ServerStreamForClient[v231.VStreamResponse], error) {
	return c.vStream.CallServerStream(ctx, req)
}

// VStreamRows calls queryservice.Query.VStreamRows.
func (c *queryClient) VStreamRows(ctx context.Context, req *connect.Request[v231.VStreamRowsRequest]) (*connect.ServerStreamForClient[v231.VStreamRowsResponse], error) {
	return c.vStreamRows.CallServerStream(ctx, req)
}

// VStreamTables calls queryservice.Query.VStreamTables.
func (c *queryClient) VStreamTables(ctx context.Context, req *connect.Request[v231.VStreamTablesRequest]) (*connect.ServerStreamForClient[v231.VStreamTablesResponse], error) {
	return c.vStreamTables.CallServerStream(ctx, req)
}

// VStreamResults calls queryservice.Query.VStreamResults.
func (c *queryClient) VStreamResults(ctx context.Context, req *connect.Request[v231.VStreamResultsRequest]) (*connect.ServerStreamForClient[v231.VStreamResultsResponse], error) {
	return c.vStreamResults.CallServerStream(ctx, req)
}

// GetSchema calls queryservice.Query.GetSchema.
func (c *queryClient) GetSchema(ctx context.Context, req *connect.Request[v23.GetSchemaRequest]) (*connect.ServerStreamForClient[v23.GetSchemaResponse], error) {
...
type QueryHandler interface {
	...
	BeginExecute(context.Context, *connect.Request[v23.BeginExecuteRequest]) (*connect.Response[v23.BeginExecuteResponse], error)
	// BeginStreamExecute executes a begin and the specified SQL query.
	BeginStreamExecute(context.Context, *connect.Request[v23.BeginStreamExecuteRequest], *connect.ServerStream[v23.BeginStreamExecuteResponse]) error
	// MessageStream streams messages from a message table.
	MessageStream(context.Context, *connect.Request[v23.MessageStreamRequest], *connect.ServerStream[v23.MessageStreamResponse]) error
	// MessageAck acks messages for a table.
	MessageAck(context.Context, *connect.Request[v23.MessageAckRequest]) (*connect.Response[v23.MessageAckResponse], error)
	// ReserveExecute executes a query on a reserved connection
	ReserveExecute(context.Context, *connect.Request[v23.ReserveExecuteRequest]) (*connect.Response[v23.ReserveExecuteResponse], error)
	...
	ReserveBeginExecute(context.Context, *connect.Request[v23.ReserveBeginExecuteRequest]) (*connect.Response[v23.ReserveBeginExecuteResponse], error)
	// ReserveStreamExecute executes a streaming query on a reserved connection
	ReserveStreamExecute(context.Context, *connect.Request[v23.ReserveStreamExecuteRequest], *connect.ServerStream[v23.ReserveStreamExecuteResponse]) error
	// ReserveBeginStreamExecute starts a transaction and executes a streaming query in the transaction on a reserved connection
	ReserveBeginStreamExecute(context.Context, *connect.Request[v23.ReserveBeginStreamExecuteRequest], *connect.ServerStream[v23.ReserveBeginStreamExecuteResponse]) error
	// Release releases the connection
	Release(context.Context, *connect.Request[v23.ReleaseRequest]) (*connect.Response[v23.ReleaseResponse], error)
	// StreamHealth runs a streaming RPC to the tablet, that returns the
	// current health of the tablet on a regular basis.
	StreamHealth(context.Context, *connect.Request[v23.StreamHealthRequest], *connect.ServerStream[v23.StreamHealthResponse]) error
	// VStream streams vreplication events.
	VStream(context.Context, *connect.Request[v231.VStreamRequest], *connect.ServerStream[v231.VStreamResponse]) error
	// VStreamRows streams rows from the specified starting point.
	VStreamRows(context.Context, *connect.Request[v231.VStreamRowsRequest], *connect.ServerStream[v231.VStreamRowsResponse]) error
	// VStreamTables streams rows from the specified starting point.
	VStreamTables(context.Context, *connect.Request[v231.VStreamTablesRequest], *connect.ServerStream[v231.VStreamTablesResponse]) error
	// VStreamResults streams results along with the gtid of the snapshot.
	VStreamResults(context.Context, *connect.Request[v231.VStreamResultsRequest], *connect.ServerStream[v231.VStreamResultsResponse]) error
	// GetSchema returns the schema information.
	GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest], *connect.ServerStream[v23.GetSchemaResponse]) error
}
...
func (UnimplementedQueryHandler) Execute(context.Context, *connect.Request[v23.ExecuteRequest]) (*connect.Response[v23.ExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Execute is not implemented"))
}

func (UnimplementedQueryHandler) StreamExecute(context.Context, *connect.Request[v23.StreamExecuteRequest], *connect.ServerStream[v23.StreamExecuteResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.StreamExecute is not implemented"))
}

func (UnimplementedQueryHandler) Begin(context.Context, *connect.Request[v23.BeginRequest]) (*connect.Response[v23.BeginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Begin is not implemented"))
}

func (UnimplementedQueryHandler) Commit(context.Context, *connect.Request[v23.CommitRequest]) (*connect.Response[v23.CommitResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Commit is not implemented"))
}

func (UnimplementedQueryHandler) Rollback(context.Context, *connect.Request[v23.RollbackRequest]) (*connect.Response[v23.RollbackResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Rollback is not implemented"))
}

func (UnimplementedQueryHandler) Prepare(context.Context, *connect.Request[v23.PrepareRequest]) (*connect.Response[v23.PrepareResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Prepare is not implemented"))
}

func (UnimplementedQueryHandler) CommitPrepared(context.Context, *connect.Request[v23.CommitPreparedRequest]) (*connect.Response[v23.CommitPreparedResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.CommitPrepared is not implemented"))
}

func (UnimplementedQueryHandler) RollbackPrepared(context.Context, *connect.Request[v23.RollbackPreparedRequest]) (*connect.Response[v23.RollbackPreparedResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.RollbackPrepared is not implemented"))
}

func (UnimplementedQueryHandler) CreateTransaction(context.Context, *connect.Request[v23.CreateTransactionRequest]) (*connect.Response[v23.CreateTransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.CreateTransaction is not implemented"))
}

func (UnimplementedQueryHandler) StartCommit(context.Context, *connect.Request[v23.StartCommitRequest]) (*connect.Response[v23.StartCommitResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.StartCommit is not implemented"))
}

func (UnimplementedQueryHandler) SetRollback(context.Context, *connect.Request[v23.SetRollbackRequest]) (*connect.Response[v23.SetRollbackResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.SetRollback is not implemented"))
}

func (UnimplementedQueryHandler) ConcludeTransaction(context.Context, *connect.Request[v23.ConcludeTransactionRequest]) (*connect.Response[v23.ConcludeTransactionResponse], error) {
...
func (UnimplementedQueryHandler) ReadTransaction(context.Context, *connect.Request[v23.ReadTransactionRequest]) (*connect.Response[v23.ReadTransactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.ReadTransaction is not implemented"))
}

func (UnimplementedQueryHandler) UnresolvedTransactions(context.Context, *connect.Request[v23.UnresolvedTransactionsRequest]) (*connect.Response[v23.UnresolvedTransactionsResponse], error) {
...
func (UnimplementedQueryHandler) BeginExecute(context.Context, *connect.Request[v23.BeginExecuteRequest]) (*connect.Response[v23.BeginExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.BeginExecute is not implemented"))
}

func (UnimplementedQueryHandler) BeginStreamExecute(context.Context, *connect.Request[v23.BeginStreamExecuteRequest], *connect.ServerStream[v23.BeginStreamExecuteResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.BeginStreamExecute is not implemented"))
}

func (UnimplementedQueryHandler) MessageStream(context.Context, *connect.Request[v23.MessageStreamRequest], *connect.ServerStream[v23.MessageStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.MessageStream is not implemented"))
}

func (UnimplementedQueryHandler) MessageAck(context.Context, *connect.Request[v23.MessageAckRequest]) (*connect.Response[v23.MessageAckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.MessageAck is not implemented"))
}

func (UnimplementedQueryHandler) ReserveExecute(context.Context, *connect.Request[v23.ReserveExecuteRequest]) (*connect.Response[v23.ReserveExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.ReserveExecute is not implemented"))
}

func (UnimplementedQueryHandler) ReserveBeginExecute(context.Context, *connect.Request[v23.ReserveBeginExecuteRequest]) (*connect.Response[v23.ReserveBeginExecuteResponse], error) {
...
func (UnimplementedQueryHandler) ReserveStreamExecute(context.Context, *connect.Request[v23.ReserveStreamExecuteRequest], *connect.ServerStream[v23.ReserveStreamExecuteResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.ReserveStreamExecute is not implemented"))
}

func (UnimplementedQueryHandler) ReserveBeginStreamExecute(context.Context, *connect.Request[v23.ReserveBeginStreamExecuteRequest], *connect.ServerStream[v23.ReserveBeginStreamExecuteResponse]) error {
...
func (UnimplementedQueryHandler) Release(context.Context, *connect.Request[v23.ReleaseRequest]) (*connect.Response[v23.ReleaseResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.Release is not implemented"))
}

func (UnimplementedQueryHandler) StreamHealth(context.Context, *connect.Request[v23.StreamHealthRequest], *connect.ServerStream[v23.StreamHealthResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.StreamHealth is not implemented"))
}

func (UnimplementedQueryHandler) VStream(context.Context, *connect.Request[v231.VStreamRequest], *connect.ServerStream[v231.VStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.VStream is not implemented"))
}

func (UnimplementedQueryHandler) VStreamRows(context.Context, *connect.Request[v231.VStreamRowsRequest], *connect.ServerStream[v231.VStreamRowsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.VStreamRows is not implemented"))
}

func (UnimplementedQueryHandler) VStreamTables(context.Context, *connect.Request[v231.VStreamTablesRequest], *connect.ServerStream[v231.VStreamTablesResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.VStreamTables is not implemented"))
}

func (UnimplementedQueryHandler) VStreamResults(context.Context, *connect.Request[v231.VStreamResultsRequest], *connect.ServerStream[v231.VStreamResultsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("queryservice.Query.VStreamResults is not implemented"))
}

func (UnimplementedQueryHandler) GetSchema(context.Context, *connect.Request[v23.GetSchemaRequest], *connect.ServerStream[v23.GetSchemaResponse]) error {
