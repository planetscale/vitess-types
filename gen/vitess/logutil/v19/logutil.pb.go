...
const file_vitess_logutil_v19_logutil_proto_rawDesc = "" +
	"\n" +
	" vitess/logutil/v19/logutil.proto\x12\x12vitess.logutil.v19\x1a\x1evitess/vttime/v19/vttime.proto\"\xa3\x01\n" +
	"\x05Event\x12+\n" +
	"\x04time\x18\x01 \x01(\v2\x17.vitess.vttime.v19.TimeR\x04time\x12/\n" +
	"\x05level\x18\x02 \x01(\x0e2\x19.vitess.logutil.v19.LevelR\x05level\x12\x12\n" +
	...
	"\aCONSOLE\x10\x03BGZEgithub.com/planetscale/vitess-types/gen/vitess/logutil/v19;logutilv19b\x06proto3"

var (
	file_vitess_logutil_v19_logutil_proto_rawDescOnce sync.Once
	file_vitess_logutil_v19_logutil_proto_rawDescData []byte
)

func file_vitess_logutil_v19_logutil_proto_rawDescGZIP() []byte {
	file_vitess_logutil_v19_logutil_proto_rawDescOnce.Do(func() {
		file_vitess_logutil_v19_logutil_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_logutil_v19_logutil_proto_rawDesc), len(file_vitess_logutil_v19_logutil_proto_rawDesc)))
	})
...
func file_vitess_logutil_v19_logutil_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_logutil_v19_logutil_proto_rawDesc), len(file_vitess_logutil_v19_logutil_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
