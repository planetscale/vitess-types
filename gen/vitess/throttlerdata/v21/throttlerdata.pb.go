...
const file_vitess_throttlerdata_v21_throttlerdata_proto_rawDesc = "" +
	"\n" +
	",vitess/throttlerdata/v21/throttlerdata.proto\x12\x18vitess.throttlerdata.v21\"\x11\n" +
	"\x0fMaxRatesRequest\"\x99\x01\n" +
	"\x10MaxRatesResponse\x12K\n" +
	"\x05rates\x18\x01 \x03(\v25.vitess.throttlerdata.v21.MaxRatesResponse.RatesEntryR\x05rates\x1a8\n" +
	"\n" +
	"RatesEntry\x12\x10\n" +
	...
	"\x0econfigurations\x18\x01 \x03(\v2F.vitess.throttlerdata.v21.GetConfigurationResponse.ConfigurationsEntryR\x0econfigurations\x1aj\n" +
	"\x13ConfigurationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.vitess.throttlerdata.v21.ConfigurationR\x05value:\x028\x01\"\xbc\x01\n" +
	"\x1aUpdateConfigurationRequest\x12%\n" +
	"\x0ethrottler_name\x18\x01 \x01(\tR\rthrottlerName\x12M\n" +
	"\rconfiguration\x18\x02 \x01(\v2'.vitess.throttlerdata.v21.ConfigurationR\rconfiguration\x12(\n" +
	...
	"\x05names\x18\x01 \x03(\tR\x05namesBSZQgithub.com/planetscale/vitess-types/gen/vitess/throttlerdata/v21;throttlerdatav21b\x06proto3"
