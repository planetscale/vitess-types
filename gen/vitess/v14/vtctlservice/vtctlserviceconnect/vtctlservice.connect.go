...
type VtctldClient interface {
	...
	SetKeyspaceServedFrom(context.Context, *connect_go.Request[vtctldata.SetKeyspaceServedFromRequest]) (*connect_go.Response[vtctldata.SetKeyspaceServedFromResponse], error)
	// SetKeyspaceShardingInfo updates the sharding information for a keyspace.
	SetKeyspaceShardingInfo(context.Context, *connect_go.Request[vtctldata.SetKeyspaceShardingInfoRequest]) (*connect_go.Response[vtctldata.SetKeyspaceShardingInfoResponse], error)
...
func NewVtctldClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) VtctldClient {
	...
	return &vtctldClient{
		...
		setKeyspaceServedFrom: connect_go.NewClient[vtctldata.SetKeyspaceServedFromRequest, vtctldata.SetKeyspaceServedFromResponse](
			httpClient,
			baseURL+"/vtctlservice.Vtctld/SetKeyspaceServedFrom",
			opts...,
		),
		setKeyspaceShardingInfo: connect_go.NewClient[vtctldata.SetKeyspaceShardingInfoRequest, vtctldata.SetKeyspaceShardingInfoResponse](
			httpClient,
			baseURL+"/vtctlservice.Vtctld/SetKeyspaceShardingInfo",
			opts...,
		),
...
type vtctldClient struct {
	...
	setKeyspaceServedFrom       *connect_go.Client[vtctldata.SetKeyspaceServedFromRequest, vtctldata.SetKeyspaceServedFromResponse]
	setKeyspaceShardingInfo     *connect_go.Client[vtctldata.SetKeyspaceShardingInfoRequest, vtctldata.SetKeyspaceShardingInfoResponse]
...
// SetKeyspaceServedFrom calls vtctlservice.Vtctld.SetKeyspaceServedFrom.
func (c *vtctldClient) SetKeyspaceServedFrom(ctx context.Context, req *connect_go.Request[vtctldata.SetKeyspaceServedFromRequest]) (*connect_go.Response[vtctldata.SetKeyspaceServedFromResponse], error) {
	return c.setKeyspaceServedFrom.CallUnary(ctx, req)
}

// SetKeyspaceShardingInfo calls vtctlservice.Vtctld.SetKeyspaceShardingInfo.
func (c *vtctldClient) SetKeyspaceShardingInfo(ctx context.Context, req *connect_go.Request[vtctldata.SetKeyspaceShardingInfoRequest]) (*connect_go.Response[vtctldata.SetKeyspaceShardingInfoResponse], error) {
	return c.setKeyspaceShardingInfo.CallUnary(ctx, req)
}
...
func NewVtctldHandler(svc VtctldHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/vtctlservice.Vtctld/SetKeyspaceServedFrom", connect_go.NewUnaryHandler(
		"/vtctlservice.Vtctld/SetKeyspaceServedFrom",
		svc.SetKeyspaceServedFrom,
		opts...,
	))
	mux.Handle("/vtctlservice.Vtctld/SetKeyspaceShardingInfo", connect_go.NewUnaryHandler(
		"/vtctlservice.Vtctld/SetKeyspaceShardingInfo",
		svc.SetKeyspaceShardingInfo,
		opts...,
	))
...
func (UnimplementedVtctldHandler) SetKeyspaceServedFrom(context.Context, *connect_go.Request[vtctldata.SetKeyspaceServedFromRequest]) (*connect_go.Response[vtctldata.SetKeyspaceServedFromResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("vtctlservice.Vtctld.SetKeyspaceServedFrom is not implemented"))
}

func (UnimplementedVtctldHandler) SetKeyspaceShardingInfo(context.Context, *connect_go.Request[vtctldata.SetKeyspaceShardingInfoRequest]) (*connect_go.Response[vtctldata.SetKeyspaceShardingInfoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("vtctlservice.Vtctld.SetKeyspaceShardingInfo is not implemented"))
}
