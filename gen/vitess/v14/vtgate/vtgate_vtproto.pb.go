...
func (m *Session) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Warnings) > 0 {
		for iNdEx := len(m.Warnings) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Warnings[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
...
func (m *ExecuteRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Query != nil {
		if marshalto, ok := interface{}(m.Query).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *ExecuteBatchRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Queries) > 0 {
		for iNdEx := len(m.Queries) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Queries[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
...
func (m *VStreamRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Vgtid != nil {
		if marshalto, ok := interface{}(m.Vgtid).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
