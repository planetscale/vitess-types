...
func (m *BinlogTransaction) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EventToken != nil {
		if marshalto, ok := interface{}(m.EventToken).(interface {
...
func (m *FieldEvent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Fields) > 0 {
		for iNdEx := len(m.Fields) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Fields[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
...
func (m *VStreamRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Target != nil {
		if marshalto, ok := interface{}(m.Target).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.ImmediateCallerId != nil {
		if marshalto, ok := interface{}(m.ImmediateCallerId).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *VStreamRowsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Lastpk != nil {
		if marshalto, ok := interface{}(m.Lastpk).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *VStreamRowsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Rows) > 0 {
		for iNdEx := len(m.Rows) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Rows[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
	...
	if len(m.Pkfields) > 0 {
		for iNdEx := len(m.Pkfields) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Pkfields[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
