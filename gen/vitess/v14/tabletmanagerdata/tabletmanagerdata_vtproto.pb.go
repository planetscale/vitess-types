...
func (m *PopulateReparentJournalRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PrimaryAlias != nil {
		if marshalto, ok := interface{}(m.PrimaryAlias).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *InitReplicaRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Parent != nil {
		if marshalto, ok := interface{}(m.Parent).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *DemotePrimaryResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PrimaryStatus != nil {
		if marshalto, ok := interface{}(m.PrimaryStatus).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *StopReplicationAndGetStatusResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HybridStatus != nil {
		if marshalto, ok := interface{}(m.HybridStatus).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.HybridStatus)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *VDiffResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Output != nil {
		if marshalto, ok := interface{}(m.Output).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *StopReplicationAndGetStatusResponse) SizeVT() (n int) {
	...
	_ = l
	if m.HybridStatus != nil {
		if size, ok := interface{}(m.HybridStatus).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.HybridStatus)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.Status != nil {
...
func (m *StopReplicationAndGetStatusResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if unmarshal, ok := interface{}(m.HybridStatus).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.HybridStatus); err != nil {
					return err
				}
			}
			iNdEx = postIndex
