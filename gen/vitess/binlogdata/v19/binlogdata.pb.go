...
const file_vitess_binlogdata_v19_binlogdata_proto_rawDesc = "" +
	"\n" +
	"&vitess/binlogdata/v19/binlogdata.proto\x12\x15vitess.binlogdata.v19\x1a\x1cvitess/vtrpc/v19/vtrpc.proto\x1a\x1cvitess/query/v19/query.proto\x1a\"vitess/topodata/v19/topodata.proto\"M\n" +
	"\aCharset\x12\x16\n" +
	...
	"\n" +
	"statements\x18\x01 \x03(\v22.vitess.binlogdata.v19.BinlogTransaction.StatementR\n" +
	"statements\x12=\n" +
	"\vevent_token\x18\x04 \x01(\v2\x1c.vitess.query.v19.EventTokenR\n" +
	"eventToken\x1a\xdc\x02\n" +
	"\tStatement\x12W\n" +
	"\bcategory\x18\x01 \x01(\x0e2;.vitess.binlogdata.v19.BinlogTransaction.Statement.CategoryR\bcategory\x128\n" +
	"\acharset\x18\x02 \x01(\v2\x1e.vitess.binlogdata.v19.CharsetR\acharset\x12\x10\n" +
	...
	"\tkey_range\x18\x02 \x01(\v2\x1d.vitess.topodata.v19.KeyRangeR\bkeyRange\x128\n" +
	"\acharset\x18\x03 \x01(\v2\x1e.vitess.binlogdata.v19.CharsetR\acharset\"q\n" +
	"\x16StreamKeyRangeResponse\x12W\n" +
	"\x12binlog_transaction\x18\x01 \x01(\v2(.vitess.binlogdata.v19.BinlogTransactionR\x11binlogTransaction\"\x83\x01\n" +
	"\x13StreamTablesRequest\x12\x1a\n" +
	"\bposition\x18\x01 \x01(\tR\bposition\x12\x16\n" +
	"\x06tables\x18\x02 \x03(\tR\x06tables\x128\n" +
	"\acharset\x18\x03 \x01(\v2\x1e.vitess.binlogdata.v19.CharsetR\acharset\"o\n" +
	"\x14StreamTablesResponse\x12W\n" +
	"\x12binlog_transaction\x18\x01 \x01(\v2(.vitess.binlogdata.v19.BinlogTransactionR\x11binlogTransaction\"U\n" +
	...
	"\x14convert_enum_to_text\x18\x03 \x03(\v22.vitess.binlogdata.v19.Rule.ConvertEnumToTextEntryR\x11convertEnumToText\x12X\n" +
	"\x0fconvert_charset\x18\x04 \x03(\v2/.vitess.binlogdata.v19.Rule.ConvertCharsetEntryR\x0econvertCharset\x129\n" +
	...
	"\x13convert_int_to_enum\x18\b \x03(\v21.vitess.binlogdata.v19.Rule.ConvertIntToEnumEntryR\x10convertIntToEnum\x12(\n" +
	...
	"\x05value\x18\x02 \x01(\v2(.vitess.binlogdata.v19.CharsetConversionR\x05value:\x028\x01\x1aC\n" +
	"\x15ConvertIntToEnumEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\x95\x02\n" +
	"\x06Filter\x121\n" +
	"\x05rules\x18\x01 \x03(\v2\x1b.vitess.binlogdata.v19.RuleR\x05rules\x12V\n" +
	"\x10field_event_mode\x18\x02 \x01(\x0e2,.vitess.binlogdata.v19.Filter.FieldEventModeR\x0efieldEventMode\x12#\n" +
	...
	"tabletType\x12:\n" +
	"\tkey_range\x18\x04 \x01(\v2\x1d.vitess.topodata.v19.KeyRangeR\bkeyRange\x12\x16\n" +
	"\x06tables\x18\x05 \x03(\tR\x06tables\x125\n" +
	"\x06filter\x18\x06 \x01(\v2\x1d.vitess.binlogdata.v19.FilterR\x06filter\x129\n" +
	"\x06on_ddl\x18\a \x01(\x0e2\".vitess.binlogdata.v19.OnDDLActionR\x05onDdl\x12%\n" +
	...
	"\tRowChange\x12-\n" +
	"\x06before\x18\x01 \x01(\v2\x15.vitess.query.v19.RowR\x06before\x12+\n" +
	"\x05after\x18\x02 \x01(\v2\x15.vitess.query.v19.RowR\x05after\x12J\n" +
	"\fdata_columns\x18\x03 \x01(\v2'.vitess.binlogdata.v19.RowChange.BitmapR\vdataColumns\x1a2\n" +
	"\x06Bitmap\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\x12\x12\n" +
	"\x04cols\x18\x02 \x01(\fR\x04cols\"\xb4\x01\n" +
	"\bRowEvent\x12\x1d\n" +
	"\n" +
	"table_name\x18\x01 \x01(\tR\ttableName\x12A\n" +
	"\vrow_changes\x18\x02 \x03(\v2 .vitess.binlogdata.v19.RowChangeR\n" +
	"rowChanges\x12\x1a\n" +
	...
	"\x06fields\x18\x02 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\x12\x1a\n" +
	"\bkeyspace\x18\x03 \x01(\tR\bkeyspace\x12\x14\n" +
	"\x05shard\x18\x04 \x01(\tR\x05shard\"\x93\x01\n" +
	"\tShardGtid\x12\x1a\n" +
	"\bkeyspace\x18\x01 \x01(\tR\bkeyspace\x12\x14\n" +
	"\x05shard\x18\x02 \x01(\tR\x05shard\x12\x12\n" +
	"\x04gtid\x18\x03 \x01(\tR\x04gtid\x12@\n" +
	"\n" +
	"table_p_ks\x18\x04 \x03(\v2\".vitess.binlogdata.v19.TableLastPKR\btablePKs\"J\n" +
	"\x05VGtid\x12A\n" +
	"\vshard_gtids\x18\x01 \x03(\v2 .vitess.binlogdata.v19.ShardGtidR\n" +
	"shardGtids\"A\n" +
	...
	"\x0emigration_type\x18\x02 \x01(\x0e2$.vitess.binlogdata.v19.MigrationTypeR\rmigrationType\x12\x16\n" +
	"\x06tables\x18\x03 \x03(\tR\x06tables\x12%\n" +
	"\x0elocal_position\x18\x04 \x01(\tR\rlocalPosition\x12A\n" +
	"\vshard_gtids\x18\x05 \x03(\v2 .vitess.binlogdata.v19.ShardGtidR\n" +
	"shardGtids\x12H\n" +
	"\fparticipants\x18\x06 \x03(\v2$.vitess.binlogdata.v19.KeyspaceShardR\fparticipants\x12)\n" +
	"\x10source_workflows\x18\a \x03(\tR\x0fsourceWorkflows\"\xcd\x04\n" +
	"\x06VEvent\x125\n" +
	"\x04type\x18\x01 \x01(\x0e2!.vitess.binlogdata.v19.VEventTypeR\x04type\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\x03R\ttimestamp\x12\x12\n" +
	"\x04gtid\x18\x03 \x01(\tR\x04gtid\x12\x1c\n" +
	"\tstatement\x18\x04 \x01(\tR\tstatement\x12<\n" +
	"\trow_event\x18\x05 \x01(\v2\x1f.vitess.binlogdata.v19.RowEventR\browEvent\x12B\n" +
	"\vfield_event\x18\x06 \x01(\v2!.vitess.binlogdata.v19.FieldEventR\n" +
	"fieldEvent\x122\n" +
	"\x05vgtid\x18\a \x01(\v2\x1c.vitess.binlogdata.v19.VGtidR\x05vgtid\x128\n" +
	"\ajournal\x18\b \x01(\v2\x1e.vitess.binlogdata.v19.JournalR\ajournal\x12\x10\n" +
	"\x03dml\x18\t \x01(\tR\x03dml\x12!\n" +
	"\fcurrent_time\x18\x14 \x01(\x03R\vcurrentTime\x12G\n" +
	"\x0elast_p_k_event\x18\x15 \x01(\v2\".vitess.binlogdata.v19.LastPKEventR\vlastPKEvent\x12\x1a\n" +
	"\bkeyspace\x18\x16 \x01(\tR\bkeyspace\x12\x14\n" +
	"\x05shard\x18\x17 \x01(\tR\x05shard\x12\x1c\n" +
	"\tthrottled\x18\x18 \x01(\bR\tthrottled\"\x98\x01\n" +
	"\fMinimalTable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12/\n" +
	"\x06fields\x18\x02 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\x12\x1e\n" +
	"\vp_k_columns\x18\x03 \x03(\x03R\tpKColumns\x12#\n" +
	"\x0ep_k_index_name\x18\x04 \x01(\tR\vpKIndexName\"L\n" +
	"\rMinimalSchema\x12;\n" +
	"\x06tables\x18\x01 \x03(\v2#.vitess.binlogdata.v19.MinimalTableR\x06tables\"\xfe\x02\n" +
	...
	"\x06target\x18\x03 \x01(\v2\x18.vitess.query.v19.TargetR\x06target\x12\x1a\n" +
	"\bposition\x18\x04 \x01(\tR\bposition\x125\n" +
	"\x06filter\x18\x05 \x01(\v2\x1d.vitess.binlogdata.v19.FilterR\x06filter\x12I\n" +
	"\x0ftable_last_p_ks\x18\x06 \x03(\v2\".vitess.binlogdata.v19.TableLastPKR\ftableLastPKs\"H\n" +
	"\x0fVStreamResponse\x125\n" +
	"\x06events\x18\x01 \x03(\v2\x1d.vitess.binlogdata.v19.VEventR\x06events\"\xb1\x02\n" +
	"\x12VStreamRowsRequest\x12J\n" +
	"\x13effective_caller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\x11effectiveCallerId\x12P\n" +
	"\x13immediate_caller_id\x18\x02 \x01(\v2 .vitess.query.v19.VTGateCallerIDR\x11immediateCallerId\x120\n" +
	"\x06target\x18\x03 \x01(\v2\x18.vitess.query.v19.TargetR\x06target\x12\x14\n" +
	"\x05query\x18\x04 \x01(\tR\x05query\x125\n" +
	"\x06lastpk\x18\x05 \x01(\v2\x1d.vitess.query.v19.QueryResultR\x06lastpk\"\xa5\x02\n" +
	"\x13VStreamRowsResponse\x12/\n" +
	"\x06fields\x18\x01 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\x123\n" +
	"\bpkfields\x18\x02 \x03(\v2\x17.vitess.query.v19.FieldR\bpkfields\x12\x12\n" +
	"\x04gtid\x18\x03 \x01(\tR\x04gtid\x12)\n" +
	"\x04rows\x18\x04 \x03(\v2\x15.vitess.query.v19.RowR\x04rows\x12-\n" +
	"\x06lastpk\x18\x05 \x01(\v2\x15.vitess.query.v19.RowR\x06lastpk\x12\x1c\n" +
	"\tthrottled\x18\x06 \x01(\bR\tthrottled\x12\x1c\n" +
	"\theartbeat\x18\a \x01(\bR\theartbeat\"\xe6\x01\n" +
	"\x14VStreamTablesRequest\x12J\n" +
	"\x13effective_caller_id\x18\x01 \x01(\v2\x1a.vitess.vtrpc.v19.CallerIDR\x11effectiveCallerId\x12P\n" +
	"\x13immediate_caller_id\x18\x02 \x01(\v2 .vitess.query.v19.VTGateCallerIDR\x11immediateCallerId\x120\n" +
	"\x06target\x18\x03 \x01(\v2\x18.vitess.query.v19.TargetR\x06target\"\x8a\x02\n" +
	"\x15VStreamTablesResponse\x12\x1d\n" +
	"\n" +
	"table_name\x18\x01 \x01(\tR\ttableName\x12/\n" +
	"\x06fields\x18\x02 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\x123\n" +
	"\bpkfields\x18\x03 \x03(\v2\x17.vitess.query.v19.FieldR\bpkfields\x12\x12\n" +
	"\x04gtid\x18\x04 \x01(\tR\x04gtid\x12)\n" +
	"\x04rows\x18\x05 \x03(\v2\x15.vitess.query.v19.RowR\x04rows\x12-\n" +
	"\x06lastpk\x18\x06 \x01(\v2\x15.vitess.query.v19.RowR\x06lastpk\"t\n" +
	"\vLastPKEvent\x12G\n" +
	"\x0etable_last_p_k\x18\x01 \x01(\v2\".vitess.binlogdata.v19.TableLastPKR\vtableLastPK\x12\x1c\n" +
	"\tcompleted\x18\x02 \x01(\bR\tcompleted\"c\n" +
	"\vTableLastPK\x12\x1d\n" +
	"\n" +
	"table_name\x18\x01 \x01(\tR\ttableName\x125\n" +
	"\x06lastpk\x18\x03 \x01(\v2\x1d.vitess.query.v19.QueryResultR\x06lastpk\"\xfd\x01\n" +
	...
	"\x06fields\x18\x01 \x03(\v2\x17.vitess.query.v19.FieldR\x06fields\x12\x12\n" +
	"\x04gtid\x18\x03 \x01(\tR\x04gtid\x12)\n" +
	"\x04rows\x18\x04 \x03(\v2\x15.vitess.query.v19.RowR\x04rows*>\n" +
	"\vOnDDLAction\x12\n" +
	"\n" +
	...
	"\n" +
	"\x06SHARDS\x10\x01BMZKgithub.com/planetscale/vitess-types/gen/vitess/binlogdata/v19;binlogdatav19b\x06proto3"

var (
	file_vitess_binlogdata_v19_binlogdata_proto_rawDescOnce sync.Once
	file_vitess_binlogdata_v19_binlogdata_proto_rawDescData []byte
)
...
func file_vitess_binlogdata_v19_binlogdata_proto_rawDescGZIP() []byte {
	file_vitess_binlogdata_v19_binlogdata_proto_rawDescOnce.Do(func() {
		file_vitess_binlogdata_v19_binlogdata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vitess_binlogdata_v19_binlogdata_proto_rawDesc), len(file_vitess_binlogdata_v19_binlogdata_proto_rawDesc)))
	})
...
func file_vitess_binlogdata_v19_binlogdata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vitess_binlogdata_v19_binlogdata_proto_rawDesc), len(file_vitess_binlogdata_v19_binlogdata_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   35,
			NumExtensions: 0,
			NumServices:   0,
