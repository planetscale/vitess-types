...
func (m *BinlogTransaction) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EventToken != nil {
		if vtmsg, ok := interface{}(m.EventToken).(interface {
			...
			encoded, err := proto.Marshal(m.EventToken)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *VStreamRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ImmediateCallerId != nil {
		if vtmsg, ok := interface{}(m.ImmediateCallerId).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.ImmediateCallerId)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
	...
	if m.EffectiveCallerId != nil {
		if vtmsg, ok := interface{}(m.EffectiveCallerId).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *VStreamRowsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Lastpk != nil {
		if vtmsg, ok := interface{}(m.Lastpk).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.Lastpk)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *VStreamRowsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Rows) > 0 {
		for iNdEx := len(m.Rows) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.Rows[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.Rows[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
	...
	if len(m.Pkfields) > 0 {
		for iNdEx := len(m.Pkfields) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.Pkfields[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.Pkfields[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
...
func (m *BinlogTransaction) SizeVT() (n int) {
	...
	if m.EventToken != nil {
		if size, ok := interface{}(m.EventToken).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.EventToken)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *VStreamRequest) SizeVT() (n int) {
	...
	if m.ImmediateCallerId != nil {
		if size, ok := interface{}(m.ImmediateCallerId).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.ImmediateCallerId)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.Target != nil {
...
func (m *VStreamRowsRequest) SizeVT() (n int) {
	...
	if m.Lastpk != nil {
		if size, ok := interface{}(m.Lastpk).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.Lastpk)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.Options != nil {
...
func (m *BinlogTransaction) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.EventToken == nil {
				m.EventToken = &v24.EventToken{}
			}
			if unmarshal, ok := interface{}(m.EventToken).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.EventToken); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *VStreamRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.EffectiveCallerId == nil {
				m.EffectiveCallerId = &v242.CallerID{}
			}
		...
		case 2:
			...
			if m.ImmediateCallerId == nil {
				m.ImmediateCallerId = &v24.VTGateCallerID{}
			}
			if unmarshal, ok := interface{}(m.ImmediateCallerId).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.ImmediateCallerId); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *VStreamRowsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Lastpk == nil {
				m.Lastpk = &v24.QueryResult{}
			}
			if unmarshal, ok := interface{}(m.Lastpk).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Lastpk); err != nil {
					return err
				}
			}
			iNdEx = postIndex
	...
	for iNdEx < l {
		...
		case 1:
			...
			if len(m.Fields) == cap(m.Fields) {
				...
				if m.Fields[len(m.Fields)-1] == nil {
					m.Fields[len(m.Fields)-1] = &v24.Field{}
				}
			}
			if unmarshal, ok := interface{}(m.Fields[len(m.Fields)-1]).(interface {
				UnmarshalVT([]byte) error
		...
		case 2:
			...
			if len(m.Pkfields) == cap(m.Pkfields) {
				m.Pkfields = append(m.Pkfields, &v24.Field{})
			} else {
				m.Pkfields = m.Pkfields[:len(m.Pkfields)+1]
				if m.Pkfields[len(m.Pkfields)-1] == nil {
					m.Pkfields[len(m.Pkfields)-1] = &v24.Field{}
				}
			}
			if unmarshal, ok := interface{}(m.Pkfields[len(m.Pkfields)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Pkfields[len(m.Pkfields)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		...
		case 4:
			...
			if len(m.Rows) == cap(m.Rows) {
				m.Rows = append(m.Rows, &v24.Row{})
			} else {
				m.Rows = m.Rows[:len(m.Rows)+1]
				if m.Rows[len(m.Rows)-1] == nil {
					m.Rows[len(m.Rows)-1] = &v24.Row{}
				}
			}
			if unmarshal, ok := interface{}(m.Rows[len(m.Rows)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Rows[len(m.Rows)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
